...
`}static get properties(){return{boardId:{type:Number},threadNo:{type:Number},no:{type:Number},tripId:{type:String},createdAt:{type:String},flagAdminThreadStop:{type:Boolean,value:!1}}}formatCreatedAt(t){return lr(t).calendar()}fullyFormatCreatedAt(t){return lr(t).toString()}_onPostHeaderNoClick(t){if(this.flagAdminThreadStop)return!1;this.dispatchEvent(new CustomEvent("post-header-no-click",{composed:!0,bubbles:!0,detail:{boardId:this.get("boardId"),threadNo:this.get("threadNo"),no:this.get("no")}}))}});window.customElements.define("moe-post-image",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
    max-width: 100%;
...
`}static get properties(){return{data:{type:Array,value:[],observer:"_dataChanged",notify:!0},width:{type:String},height:{type:String},showList:{type:Boolean,reflectToAttribute:!0,computed:"_computeShowList(data)"},listLength:{type:Number,value:0},playing:{type:Boolean,value:!1,notify:!0,reflectToAttribute:!0},playingVideoId:{type:String,reflectToAttribute:!0,notify:!0},prevPlayedVideo:{type:String},showPlaceHolder:{type:Boolean,computed:"_computeShowPlaceHolder(playing)"},placeHolderStyle:{type:String,computed:"_computePlaceHolderStyle(selectedVideoIndex, data)"},startVideoIndex:{type:Number,value:0},selectedVideoIndex:{type:Number,reflectToAttribute:!0},selectedVideoIndexDisplay:{type:Number,computed:"_computeSelectedVideoIndexDisplay(selectedVideoIndex)"},holderHref:{type:String,reflectToAttribute:!0,computed:"_computeHolderHref(selectedVideoIndex)"},holderTitle:{type:String,reflectToAttribute:!0,computed:"_computeHolderTitle(selectedVideoIndex)"},playSupported:{type:Boolean},playIcon:{type:String,computed:"_computePlayIcon(data)"},mobile:{type:Boolean,reflectToAttribute:!0},layoutClasses:{type:String,reflectToAttribute:!0,computed:"_computeLayoutClasses(mobile)"}}}ready(){super.ready(),this._mediaQuery(),window.addEventListener("resize",()=>this._mediaQuery())}_mediaQuery(){this.set("mobile",window.matchMedia("(max-width: 600px)").matches)}play(t){if(void 0!==t&&""!==t)this.mobile&&(this._checkPlaySupport(),this.playSupported&&(this.set("playing",!0),this.set("playingVideoId",t))),this.set("playing",!0),this.set("playingVideoId",t);else{if(!this.data||!Hc(this.data,"0.res_id"))return;this.play(this.data[0].res_id)}}stop(){this.set("prevPlayedVideo",this.playingVideoId),this.set("playingVideoId",""),this.set("playing",!1)}_dataChanged(){void 0!==this.data&&void 0!==this.data[0]&&(this.selectedVideoIndex=this.startVideoIndex?this.startVideoIndex:0,this.listLength=this.data.length,this.listLength>1&&this.set("list-toggle",!0),this.set("selectedVideoIndex",0),this.set("playing",!1))}_computePlaceHolderStyle(t,e){if(e.length>0&&t>=0)return"background-image: url("+this.data[t].thumb+");"}_handleStateChanged(t){0===Hc(t,"detail.data")&&this._nextVideo()}_handleHolderTap(t){this.play(Hc(this.data,`${this.selectedVideoIndex}.res_id`))}_handleChipTap(t){this.play(t.model.item.res_id)}_handlePlayControl(t){switch(t.currentTarget.getAttribute("action-type")){case"next":this._nextVideo();break;case"prev":this._prevVideo();break;case"stop":this.stop()}}_nextVideo(){this.selectedVideoIndex<this.data.length-1?this.selectedVideoIndex++:this.selectedVideoIndex=0;var t=Hc(this.data,this.selectedVideoIndex+".res_id");t?this.play(t):console.warn("videoId not found at data[selectedVideoIndex]: "+this.selectedVideoIndex)}_prevVideo(){this.selectedVideoIndex>0?this.selectedVideoIndex--:this.selectedVideoIndex=this.data.length-1,this.play(this.data[this.selectedVideoIndex].res_id)}_computeLayoutClasses(t){return t?"layout vertical":"layout horizontal"}_computeShowList(t){return(t||[]).length>1}_computePlayIcon(t){return t[0]&&void 0!==t?"av:play-arrow":"refresh"}_computeContainerClass(t){return t?"layout vertical":"layout horizontal"}_computeSelectedVideoIndexDisplay(t){return t+1}_computeShowPlaceHolder(t){return!t}_computeHolderHref(t){return"https://www.youtube.com/watch?v="+this.data[t].res_id}_computeHolderTitle(t){return this.data[t].title}_computeStartIndex(t){return t}_checkPlaySupport(){}_mobilePlay(t){}});window.customElements.define("moe-embeds",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
    width: 100%;
...
`,is:"iron-a11y-announcer",properties:{mode:{type:String,value:"polite"},_text:{type:String,value:""}},created:function(){qc.instance||(qc.instance=this),document.body.addEventListener("iron-announce",this._onIronAnnounce.bind(this))},announce:function(t){this._text="",this.async(function(){this._text=t},100)},_onIronAnnounce:function(t){t.detail&&t.detail.text&&this.announce(t.detail.text)}});qc.instance=null,qc.requestAvailability=function(){qc.instance||(qc.instance=document.createElement("iron-a11y-announcer")),document.body.appendChild(qc.instance)};let Uc=null;const Wc={properties:{validator:{type:String},invalid:{notify:!0,reflectToAttribute:!0,type:Boolean,value:!1,observer:"_invalidChanged"}},registered:function(){Uc=new ua({type:"validator"})},_invalidChanged:function(){this.invalid?this.setAttribute("aria-invalid","true"):this.removeAttribute("aria-invalid")},get _validator(){return Uc&&Uc.byKey(this.validator)},hasValidator:function(){return null!=this._validator},validate:function(t){return void 0===t&&void 0!==this.value?this.invalid=!this._getValidity(this.value):this.invalid=!this._getValidity(t),!this.invalid},_getValidity:function(t){return!this.hasValidator()||this._validator.validate(t)}};Cn({_template:jt`
    <style>
      :host {
        display: inline-block;
      }
...
`,is:"paper-input-char-counter",behaviors:[Kc],properties:{_charCounterStr:{type:String,value:"0"}},update:function(t){if(t.inputElement){t.value=t.value||"";var e=t.value.toString().length.toString();t.inputElement.hasAttribute("maxlength")&&(e+="/"+t.inputElement.getAttribute("maxlength")),this._charCounterStr=e}}});const Gc=jt`
<custom-style>
  <style is="custom-style">
    html {
...
`;Gc.setAttribute("style","display: none;"),document.head.appendChild(Gc.content),Cn({_template:jt`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
`,is:"paper-input-container",properties:{noLabelFloat:{type:Boolean,value:!1},alwaysFloatLabel:{type:Boolean,value:!1},attrForValue:{type:String,value:"bind-value"},autoValidate:{type:Boolean,value:!1},invalid:{observer:"_invalidChanged",type:Boolean,value:!1},focused:{readOnly:!0,type:Boolean,value:!1,notify:!0},_addons:{type:Array},_inputHasContent:{type:Boolean,value:!1},_inputSelector:{type:String,value:"input,iron-input,textarea,.paper-input-input"},_boundOnFocus:{type:Function,value:function(){return this._onFocus.bind(this)}},_boundOnBlur:{type:Function,value:function(){return this._onBlur.bind(this)}},_boundOnInput:{type:Function,value:function(){return this._onInput.bind(this)}},_boundValueChanged:{type:Function,value:function(){return this._onValueChanged.bind(this)}}},listeners:{"addon-attached":"_onAddonAttached","iron-input-validate":"_onIronInputValidate"},get _valueChangedEvent(){return this.attrForValue+"-changed"},get _propertyForValue(){return D(this.attrForValue)},get _inputElement(){return bn(this).querySelector(this._inputSelector)},get _inputElementValue(){return this._inputElement[this._propertyForValue]||this._inputElement.value},ready:function(){this.__isFirstValueUpdate=!0,this._addons||(this._addons=[]),this.addEventListener("focus",this._boundOnFocus,!0),this.addEventListener("blur",this._boundOnBlur,!0)},attached:function(){this.attrForValue?this._inputElement.addEventListener(this._valueChangedEvent,this._boundValueChanged):this.addEventListener("input",this._onInput),this._inputElementValue&&""!=this._inputElementValue?this._handleValueAndAutoValidate(this._inputElement):this._handleValue(this._inputElement)},_onAddonAttached:function(t){this._addons||(this._addons=[]);var e=t.target;-1===this._addons.indexOf(e)&&(this._addons.push(e),this.isAttached&&this._handleValue(this._inputElement))},_onFocus:function(){this._setFocused(!0)},_onBlur:function(){this._setFocused(!1),this._handleValueAndAutoValidate(this._inputElement)},_onInput:function(t){this._handleValueAndAutoValidate(t.target)},_onValueChanged:function(t){var e=t.target;this.__isFirstValueUpdate&&(this.__isFirstValueUpdate=!1,void 0===e.value||""===e.value)||this._handleValueAndAutoValidate(t.target)},_handleValue:function(t){var e=this._inputElementValue;e||0===e||"number"===t.type&&!t.checkValidity()?this._inputHasContent=!0:this._inputHasContent=!1,this.updateAddons({inputElement:t,value:e,invalid:this.invalid})},_handleValueAndAutoValidate:function(t){var e;this.autoValidate&&t&&(e=t.validate?t.validate(this._inputElementValue):t.checkValidity(),this.invalid=!e);this._handleValue(t)},_onIronInputValidate:function(t){this.invalid=this._inputElement.invalid},_invalidChanged:function(){this._addons&&this.updateAddons({invalid:this.invalid})},updateAddons:function(t){for(var e,i=0;e=this._addons[i];i++)e.update(t)},_computeInputContentClass:function(t,e,i,n,a){var o="input-content";if(t)a&&(o+=" label-is-hidden"),n&&(o+=" is-invalid");else{var r=this.querySelector("label");e||a?(o+=" label-is-floating",this.$.labelAndInputContainer.style.position="static",n?o+=" is-invalid":i&&(o+=" label-is-highlighted")):(r&&(this.$.labelAndInputContainer.style.position="relative"),n&&(o+=" is-invalid"))}return i&&(o+=" focused"),o},_computeUnderlineClass:function(t,e){var i="underline";return e?i+=" is-invalid":t&&(i+=" is-highlighted"),i},_computeAddOnContentClass:function(t,e){var i="add-on-content";return e?i+=" is-invalid":t&&(i+=" is-highlighted"),i}}),Cn({_template:jt`
    ...
    <slot></slot>
`,is:"paper-input-error",behaviors:[Kc],properties:{invalid:{readOnly:!0,reflectToAttribute:!0,type:Boolean}},update:function(t){this._setInvalid(t.invalid)}});const Qc={properties:{name:{type:String},value:{notify:!0,type:String},required:{type:Boolean,value:!1}},attached:function(){},detached:function(){}},Zc={NextLabelID:1,NextAddonID:1,NextInputID:1},Xc={properties:{label:{type:String},value:{notify:!0,type:String},disabled:{type:Boolean,value:!1},invalid:{type:Boolean,value:!1,notify:!0},allowedPattern:{type:String},type:{type:String},list:{type:String},pattern:{type:String},required:{type:Boolean,value:!1},errorMessage:{type:String},charCounter:{type:Boolean,value:!1},noLabelFloat:{type:Boolean,value:!1},alwaysFloatLabel:{type:Boolean,value:!1},autoValidate:{type:Boolean,value:!1},validator:{type:String},autocomplete:{type:String,value:"off"},autofocus:{type:Boolean,observer:"_autofocusChanged"},inputmode:{type:String},minlength:{type:Number},maxlength:{type:Number},min:{type:String},max:{type:String},step:{type:String},name:{type:String},placeholder:{type:String,value:""},readonly:{type:Boolean,value:!1},size:{type:Number},autocapitalize:{type:String,value:"none"},autocorrect:{type:String,value:"off"},autosave:{type:String},results:{type:Number},accept:{type:String},multiple:{type:Boolean},_ariaDescribedBy:{type:String,value:""},_ariaLabelledBy:{type:String,value:""},_inputId:{type:String,value:""}},listeners:{"addon-attached":"_onAddonAttached"},keyBindings:{"shift+tab:keydown":"_onShiftTabDown"},hostAttributes:{tabindex:0},get inputElement(){return this.$||(this.$={}),this.$.input||(this._generateInputId(),this.$.input=this.$$("#"+this._inputId)),this.$.input},get _focusableElement(){return this.inputElement},created:function(){this._typesThatHaveText=["date","datetime","datetime-local","month","time","week","file"]},attached:function(){this._updateAriaLabelledBy(),!qt&&this.inputElement&&-1!==this._typesThatHaveText.indexOf(this.inputElement.type)&&(this.alwaysFloatLabel=!0)},_appendStringWithSpace:function(t,e){return t=t?t+" "+e:e},_onAddonAttached:function(t){var e=bn(t).rootTarget;if(e.id)this._ariaDescribedBy=this._appendStringWithSpace(this._ariaDescribedBy,e.id);else{var i="paper-input-add-on-"+Zc.NextAddonID++;e.id=i,this._ariaDescribedBy=this._appendStringWithSpace(this._ariaDescribedBy,i)}},validate:function(){return this.inputElement.validate()},_focusBlurHandler:function(t){_a._focusBlurHandler.call(this,t),this.focused&&!this._shiftTabPressed&&this._focusableElement&&this._focusableElement.focus()},_onShiftTabDown:function(t){var e=this.getAttribute("tabindex");this._shiftTabPressed=!0,this.setAttribute("tabindex","-1"),this.async(function(){this.setAttribute("tabindex",e),this._shiftTabPressed=!1},1)},_handleAutoValidate:function(){this.autoValidate&&this.validate()},updateValueAndPreserveCaret:function(t){try{var e=this.inputElement.selectionStart;this.value=t,this.inputElement.selectionStart=e,this.inputElement.selectionEnd=e}catch(e){this.value=t}},_computeAlwaysFloatLabel:function(t,e){return e||t},_updateAriaLabelledBy:function(){var t,e=bn(this.root).querySelector("label");e?(e.id?t=e.id:(t="paper-input-label-"+Zc.NextLabelID++,e.id=t),this._ariaLabelledBy=t):this._ariaLabelledBy=""},_generateInputId:function(){this._inputId&&""!==this._inputId||(this._inputId="input-"+Zc.NextInputID++)},_onChange:function(t){this.shadowRoot&&this.fire(t.type,{sourceEvent:t},{node:this,bubbles:t.bubbles,cancelable:t.cancelable})},_autofocusChanged:function(){if(this.autofocus&&this._focusableElement){var t=document.activeElement;t instanceof HTMLElement&&t!==document.body&&t!==document.documentElement||this._focusableElement.focus()}}},Jc=[_a,Ta,Xc];Cn({is:"paper-input",_template:jt`
    <style>
      :host {
        display: block;
      }
...
`;td.setAttribute("strip-whitespace",""),Cn({_template:td,is:"paper-spinner",behaviors:[to]});window.customElements.define("moe-file-button",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
}
...
`}static get properties(){return{maxLength:{type:Number},value:{type:String,notify:!0,reflectToAttribute:!0},disabled:{type:Boolean,value:!1,reflectToAttribute:!0},index:{type:Number,reflectToAttribute:!0}}}focus(){this.$.input.focus()}_onCancelClick(t){this.dispatchEvent(new CustomEvent("remove"))}});function id(t){const e=typeof t;return"string"==e||"object"==e&&null!=t&&!Array.isArray(t)&&"[object String]"==cc(t)}window.customElements.define("moe-form-poll-items",class extends qt{static get template(){return jt`
<style>
:host {
    display: block
}
