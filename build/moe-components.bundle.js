...
`}static get properties(){return{boardId:{type:Number},no:{type:Number},action:{type:String},text:{type:String}}}_onClick(e){this.blur()}}window.customElements.define("moe-post-menu-action-button",MoePostMenuActionButton),window.customElements.define("moe-post-menu-action-item",MoePostMenuActionItem);class MoeQuoteLink extends PolymerElement{static get template(){return html`
<style>
:host {
    display: inline-block;
}
