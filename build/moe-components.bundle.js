...
</custom-style>`;oa.setAttribute("style","display: none;"),document.head.appendChild(oa.content);var sa=document.createElement("style");sa.textContent="[hidden] { display: none !important; }",document.head.appendChild(sa),Cn({_template:jt`
    <style>
      :host {
        position: fixed;
        top: -120px;
...
`;Ba.setAttribute("style","display: none;"),document.body.appendChild(Ba.content),Cn({is:"paper-icon-button",hostAttributes:{role:"button",tabindex:"0"},behaviors:[Fa],properties:{src:{type:String},icon:{type:String},alt:{type:String,observer:"_altChanged"}},_altChanged:function(t,e){var i=this.getAttribute("aria-label");i&&e!=i||this.setAttribute("aria-label",t)}});const Ya=jt`
<custom-style>
  <style is="custom-style">
    html {
...
</custom-style>`;Ya.setAttribute("style","display: none;"),document.head.appendChild(Ya.content);const $a=jt`
...
</dom-module>`;$a.setAttribute("style","display: none;"),document.head.appendChild($a.content);const ja={properties:{elevation:{type:Number,reflectToAttribute:!0,readOnly:!0}},observers:["_calculateElevation(focused, disabled, active, pressed, receivedFocusFromKeyboard)","_computeKeyboardClass(receivedFocusFromKeyboard)"],hostAttributes:{role:"button",tabindex:"0",animated:!0},_calculateElevation:function(){var t=1;this.disabled?t=0:this.active||this.pressed?t=4:this.receivedFocusFromKeyboard&&(t=3),this._setElevation(t)},_computeKeyboardClass:function(t){this.toggleClass("keyboard-focus",t)},_spaceKeyDownHandler:function(t){Ta._spaceKeyDownHandler.call(this,t),this.hasRipple()&&this.getRipple().ripples.length<1&&this._ripple.uiDownAction()},_spaceKeyUpHandler:function(t){Ta._spaceKeyUpHandler.call(this,t),this.hasRipple()&&this._ripple.uiUpAction()}},qa=[Ia,_a,Na,ja],Ua=jt`
...
`,is:"paper-menu-button",behaviors:[Ea,_a],properties:{opened:{type:Boolean,value:!1,notify:!0,observer:"_openedChanged"},horizontalAlign:{type:String,value:"left",reflectToAttribute:!0},verticalAlign:{type:String,value:"top",reflectToAttribute:!0},dynamicAlign:{type:Boolean},horizontalOffset:{type:Number,value:0,notify:!0},verticalOffset:{type:Number,value:0,notify:!0},noOverlap:{type:Boolean},noAnimations:{type:Boolean,value:!1},ignoreSelect:{type:Boolean,value:!1},closeOnActivate:{type:Boolean,value:!1},openAnimationConfig:{type:Object,value:function(){return[{name:"fade-in-animation",timing:{delay:100,duration:200}},{name:"paper-menu-grow-width-animation",timing:{delay:100,duration:150,easing:wo.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-grow-height-animation",timing:{delay:100,duration:275,easing:wo.ANIMATION_CUBIC_BEZIER}}]}},closeAnimationConfig:{type:Object,value:function(){return[{name:"fade-out-animation",timing:{duration:150}},{name:"paper-menu-shrink-width-animation",timing:{delay:100,duration:50,easing:wo.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-shrink-height-animation",timing:{duration:200,easing:"ease-in"}}]}},allowOutsideScroll:{type:Boolean,value:!1},restoreFocusOnClose:{type:Boolean,value:!0},_dropdownContent:{type:Object}},hostAttributes:{role:"group","aria-haspopup":"true"},listeners:{"iron-activate":"_onIronActivate","iron-select":"_onIronSelect"},get contentElement(){for(var t=bn(this.$.content).getDistributedNodes(),e=0,i=t.length;e<i;e++)if(t[e].nodeType===Node.ELEMENT_NODE)return t[e]},toggle:function(){this.opened?this.close():this.open()},open:function(){this.disabled||this.$.dropdown.open()},close:function(){this.$.dropdown.close()},_onIronSelect:function(t){this.ignoreSelect||this.close()},_onIronActivate:function(t){this.closeOnActivate&&this.close()},_openedChanged:function(t,e){t?(this._dropdownContent=this.contentElement,this.fire("paper-dropdown-open")):null!=e&&this.fire("paper-dropdown-close")},_disabledChanged:function(t){_a._disabledChanged.apply(this,arguments),t&&this.opened&&this.close()},__onIronOverlayCanceled:function(t){var e=t.detail,i=this.$.trigger;bn(e).path.indexOf(i)>-1&&t.preventDefault()}});Object.keys(wo).forEach(function(t){xo[t]=wo[t]});const Mo={properties:{multi:{type:Boolean,value:!1,observer:"multiChanged"},selectedValues:{type:Array,notify:!0,value:function(){return[]}},selectedItems:{type:Array,readOnly:!0,notify:!0,value:function(){return[]}}},observers:["_updateSelected(selectedValues.splices)"],select:function(t){this.multi?this._toggleSelected(t):this.selected=t},multiChanged:function(t){this._selection.multi=t,this._updateSelected()},get _shouldUpdateSelection(){return null!=this.selected||null!=this.selectedValues&&this.selectedValues.length},_updateAttrForSelected:function(){this.multi?this.selectedItems&&this.selectedItems.length>0&&(this.selectedValues=this.selectedItems.map(function(t){return this._indexToValue(this.indexOf(t))},this).filter(function(t){return null!=t},this)):Xa._updateAttrForSelected.apply(this)},_updateSelected:function(){this.multi?this._selectMulti(this.selectedValues):this._selectSelected(this.selected)},_selectMulti:function(t){t=t||[];var e=(this._valuesToItems(t)||[]).filter(function(t){return null!=t});this._selection.clear(e);for(var i=0;i<e.length;i++)this._selection.setItemSelected(e[i],!0);this.fallbackSelection&&!this._selection.get().length&&(this._valueToItem(this.fallbackSelection)&&this.select(this.fallbackSelection))},_selectionChange:function(){var t=this._selection.get();this.multi?(this._setSelectedItems(t),this._setSelectedItem(t.length?t[0]:null)):null!=t?(this._setSelectedItems([t]),this._setSelectedItem(t)):(this._setSelectedItems([]),this._setSelectedItem(null))},_toggleSelected:function(t){var e=this.selectedValues.indexOf(t);e<0?this.push("selectedValues",t):this.splice("selectedValues",e,1)},_valuesToItems:function(t){return null==t?null:t.map(function(t){return this._valueToItem(t)},this)}},So=[Xa,Mo],Co={properties:{focusedItem:{observer:"_focusedItemChanged",readOnly:!0,type:Object},attrForItemTitle:{type:String},disabled:{type:Boolean,value:!1,observer:"_disabledChanged"}},_MODIFIER_KEYS:["Alt","AltGraph","CapsLock","Control","Fn","FnLock","Hyper","Meta","NumLock","OS","ScrollLock","Shift","Super","Symbol","SymbolLock"],_SEARCH_RESET_TIMEOUT_MS:1e3,_previousTabIndex:0,hostAttributes:{role:"menu"},observers:["_updateMultiselectable(multi)"],listeners:{focus:"_onFocus",keydown:"_onKeydown","iron-items-changed":"_onIronItemsChanged"},keyBindings:{up:"_onUpKey",down:"_onDownKey",esc:"_onEscKey","shift+tab:keydown":"_onShiftTabDown"},attached:function(){this._resetTabindices()},select:function(t){this._defaultFocusAsync&&(this.cancelAsync(this._defaultFocusAsync),this._defaultFocusAsync=null);var e=this._valueToItem(t);e&&e.hasAttribute("disabled")||(this._setFocusedItem(e),Mo.select.apply(this,arguments))},_resetTabindices:function(){var t=this.multi?this.selectedItems&&this.selectedItems[0]:this.selectedItem;this.items.forEach(function(e){e.setAttribute("tabindex",e===t?"0":"-1")},this)},_updateMultiselectable:function(t){t?this.setAttribute("aria-multiselectable","true"):this.removeAttribute("aria-multiselectable")},_focusWithKeyboardEvent:function(t){if(-1===this._MODIFIER_KEYS.indexOf(t.key)){this.cancelDebouncer("_clearSearchText");for(var e,i=this._searchText||"",n=(i+=(t.key&&1==t.key.length?t.key:String.fromCharCode(t.keyCode)).toLocaleLowerCase()).length,a=0;e=this.items[a];a++)if(!e.hasAttribute("disabled")){var o=this.attrForItemTitle||"textContent",s=(e[o]||e.getAttribute(o)||"").trim();if(!(s.length<n)&&s.slice(0,n).toLocaleLowerCase()==i){this._setFocusedItem(e);break}}this._searchText=i,this.debounce("_clearSearchText",this._clearSearchText,this._SEARCH_RESET_TIMEOUT_MS)}},_clearSearchText:function(){this._searchText=""},_focusPrevious:function(){for(var t=this.items.length,e=Number(this.indexOf(this.focusedItem)),i=1;i<t+1;i++){var n=this.items[(e-i+t)%t];if(!n.hasAttribute("disabled")){var a=bn(n).getOwnerRoot()||document;if(this._setFocusedItem(n),bn(a).activeElement==n)return}}},_focusNext:function(){for(var t=this.items.length,e=Number(this.indexOf(this.focusedItem)),i=1;i<t+1;i++){var n=this.items[(e+i)%t];if(!n.hasAttribute("disabled")){var a=bn(n).getOwnerRoot()||document;if(this._setFocusedItem(n),bn(a).activeElement==n)return}}},_applySelection:function(t,e){e?t.setAttribute("aria-selected","true"):t.removeAttribute("aria-selected"),Xa._applySelection.apply(this,arguments)},_focusedItemChanged:function(t,e){e&&e.setAttribute("tabindex","-1"),!t||t.hasAttribute("disabled")||this.disabled||(t.setAttribute("tabindex","0"),t.focus())},_onIronItemsChanged:function(t){t.detail.addedNodes.length&&this._resetTabindices()},_onShiftTabDown:function(t){var e=this.getAttribute("tabindex");Co._shiftTabPressed=!0,this._setFocusedItem(null),this.setAttribute("tabindex","-1"),this.async(function(){this.setAttribute("tabindex",e),Co._shiftTabPressed=!1},1)},_onFocus:function(t){if(!Co._shiftTabPressed){var e=bn(t).rootTarget;(e===this||void 0===e.tabIndex||this.isLightDescendant(e))&&(this._defaultFocusAsync=this.async(function(){var t=this.multi?this.selectedItems&&this.selectedItems[0]:this.selectedItem;this._setFocusedItem(null),t?this._setFocusedItem(t):this.items[0]&&this._focusNext()}))}},_onUpKey:function(t){this._focusPrevious(),t.detail.keyboardEvent.preventDefault()},_onDownKey:function(t){this._focusNext(),t.detail.keyboardEvent.preventDefault()},_onEscKey:function(t){var e=this.focusedItem;e&&e.blur()},_onKeydown:function(t){this.keyboardEventMatchesKeys(t,"up down esc")||this._focusWithKeyboardEvent(t),t.stopPropagation()},_activateHandler:function(t){Xa._activateHandler.call(this,t),t.stopPropagation()},_disabledChanged:function(t){t?(this._previousTabIndex=this.hasAttribute("tabindex")?this.tabIndex:0,this.removeAttribute("tabindex")):this.hasAttribute("tabindex")||this.setAttribute("tabindex",this._previousTabIndex)},_shiftTabPressed:!1};Cn({_template:jt`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[[So,Ea,Co]],hostAttributes:{role:"listbox"}}),Cn({_template:jt`
...
</iron-iconset-svg>`;document.head.appendChild(Ho.content);const ko=jt`<iron-iconset-svg name="communication" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(ko.content);var Vo=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),Lo=Vo&&Vo[1]>=8,Eo=null!=mn,To=Eo?K:0,Io=Eo?G:1,Po=Eo?Q:2;ea||(Polymer.OptionalMutableDataBehavior={}),Cn({_template:jt`
    <style>
      :host {
        display: block;
      }
...
`}static get properties(){return{}}});const Ro=jt`<iron-iconset-svg name="social" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(Ro.content);window.customElements.define("moe-poll",class extends qt{static get template(){return jt`
<style>
:host {
    min-width: 300px;
    display: table;
...
`}static get properties(){return{text:{type:String}}}});var No=["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"],Do=["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","audio","canvas","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","video","view","vkern"],Fo=["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"],Bo=["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmuliscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mpspace","msqrt","mystyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"],Yo=["#text"],$o=["accept","action","align","alt","autocomplete","background","bgcolor","border","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","coords","crossorigin","datetime","default","dir","disabled","download","enctype","face","for","headers","height","hidden","high","href","hreflang","id","integrity","ismap","label","lang","list","loop","low","max","maxlength","media","method","min","multiple","name","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","type","usemap","valign","value","width","xmlns"],jo=["accent-height","accumulate","additivive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","tabindex","targetx","targety","transform","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"],qo=["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"],Uo=["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"];function Wo(t,e){for(var i=e.length;i--;)"string"==typeof e[i]&&(e[i]=e[i].toLowerCase()),t[e[i]]=!0;return t}function Ko(t){var e={},i=void 0;for(i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e}var Go=/\{\{[\s\S]*|[\s\S]*\}\}/gm,Qo=/<%[\s\S]*|[\s\S]*%>/gm,Zo=/^data-[\-\w.\u00B7-\uFFFF]/,Xo=/^aria-[\-\w]+$/,Jo=/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i,ts=/^(?:\w+script|data):/i,es=/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,is="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};function ns(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}var as=function(){return"undefined"==typeof window?null:window};var os,ss,rs=function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:as(),i=function(e){return t(e)};if(i.version="1.0.8",i.removed=[],!e||!e.document||9!==e.document.nodeType)return i.isSupported=!1,i;var n=e.document,a=!1,o=!1,s=e.document,r=e.DocumentFragment,l=e.HTMLTemplateElement,h=e.Node,c=e.NodeFilter,d=e.NamedNodeMap,p=void 0===d?e.NamedNodeMap||e.MozNamedAttrMap:d,u=e.Text,A=e.Comment,m=e.DOMParser;if("function"==typeof l){var f=s.createElement("template");f.content&&f.content.ownerDocument&&(s=f.content.ownerDocument)}var g=s,v=g.implementation,_=g.createNodeIterator,y=g.getElementsByTagName,b=g.createDocumentFragment,z=n.importNode,w={};i.isSupported=v&&void 0!==v.createHTMLDocument&&9!==s.documentMode;var x=Go,M=Qo,S=Zo,C=Xo,H=ts,k=es,V=Jo,L=null,E=Wo({},[].concat(ns(No),ns(Do),ns(Fo),ns(Bo),ns(Yo))),T=null,I=Wo({},[].concat(ns($o),ns(jo),ns(qo),ns(Uo))),P=null,O=null,R=!0,N=!0,D=!1,F=!1,B=!1,Y=!1,$=!1,j=!1,q=!1,U=!1,W=!1,K=!0,G=!0,Q=!1,Z={},X=Wo({},["audio","head","math","script","style","template","svg","video"]),J=Wo({},["audio","video","img","source","image"]),tt=Wo({},["alt","class","for","id","label","name","pattern","placeholder","summary","title","value","style","xmlns"]),et=null,it=s.createElement("form"),nt=function(t){"object"!==(void 0===t?"undefined":is(t))&&(t={}),L="ALLOWED_TAGS"in t?Wo({},t.ALLOWED_TAGS):E,T="ALLOWED_ATTR"in t?Wo({},t.ALLOWED_ATTR):I,P="FORBID_TAGS"in t?Wo({},t.FORBID_TAGS):{},O="FORBID_ATTR"in t?Wo({},t.FORBID_ATTR):{},Z="USE_PROFILES"in t&&t.USE_PROFILES,R=!1!==t.ALLOW_ARIA_ATTR,N=!1!==t.ALLOW_DATA_ATTR,D=t.ALLOW_UNKNOWN_PROTOCOLS||!1,F=t.SAFE_FOR_JQUERY||!1,B=t.SAFE_FOR_TEMPLATES||!1,Y=t.WHOLE_DOCUMENT||!1,q=t.RETURN_DOM||!1,U=t.RETURN_DOM_FRAGMENT||!1,W=t.RETURN_DOM_IMPORT||!1,j=t.FORCE_BODY||!1,K=!1!==t.SANITIZE_DOM,G=!1!==t.KEEP_CONTENT,Q=t.IN_PLACE||!1,V=t.ALLOWED_URI_REGEXP||V,B&&(N=!1),U&&(q=!0),Z&&(L=Wo({},[].concat(ns(Yo))),T=[],!0===Z.html&&(Wo(L,No),Wo(T,$o)),!0===Z.svg&&(Wo(L,Do),Wo(T,jo),Wo(T,Uo)),!0===Z.svgFilters&&(Wo(L,Fo),Wo(T,jo),Wo(T,Uo)),!0===Z.mathMl&&(Wo(L,Bo),Wo(T,qo),Wo(T,Uo))),t.ADD_TAGS&&(L===E&&(L=Ko(L)),Wo(L,t.ADD_TAGS)),t.ADD_ATTR&&(T===I&&(T=Ko(T)),Wo(T,t.ADD_ATTR)),t.ADD_URI_SAFE_ATTR&&Wo(tt,t.ADD_URI_SAFE_ATTR),G&&(L["#text"]=!0),Y&&Wo(L,["html","head","body"]),L.table&&Wo(L,["tbody"]),Object&&"freeze"in Object&&Object.freeze(t),et=t},at=function(t){i.removed.push({element:t});try{t.parentNode.removeChild(t)}catch(e){t.outerHTML=""}},ot=function(t,e){try{i.removed.push({attribute:e.getAttributeNode(t),from:e})}catch(t){i.removed.push({attribute:null,from:e})}e.removeAttribute(t)},st=function(t){var e=void 0;if(j&&(t="<remove></remove>"+t),a)try{e=(new m).parseFromString(t,"text/html")}catch(t){}if(o&&Wo(P,["title"]),!e||!e.documentElement){var i=(e=v.createHTMLDocument("")).body;i.parentNode.removeChild(i.parentNode.firstElementChild),i.outerHTML=t}return y.call(e,Y?"html":"body")[0]};i.isSupported&&(function(){try{st('<svg><p><style><img src="</style><img src=x onerror=alert(1)//">').querySelector("svg img")&&(a=!0)}catch(t){}}(),function(){try{st("<x/><title>&lt;/title&gt;&lt;img&gt;").querySelector("title").textContent.match(/<\/title/)&&(o=!0)}catch(t){}}());var rt=function(t){return _.call(t.ownerDocument||t,t,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT,function(){return c.FILTER_ACCEPT},!1)},lt=function(t){return"object"===(void 0===h?"undefined":is(h))?t instanceof h:t&&"object"===(void 0===t?"undefined":is(t))&&"number"==typeof t.nodeType&&"string"==typeof t.nodeName},ht=function(t,e,n){w[t]&&w[t].forEach(function(t){t.call(i,e,n,et)})},ct=function(t){var e,n=void 0;if(ht("beforeSanitizeElements",t,null),!((e=t)instanceof u||e instanceof A||"string"==typeof e.nodeName&&"string"==typeof e.textContent&&"function"==typeof e.removeChild&&e.attributes instanceof p&&"function"==typeof e.removeAttribute&&"function"==typeof e.setAttribute))return at(t),!0;var a=t.nodeName.toLowerCase();if(ht("uponSanitizeElement",t,{tagName:a,allowedTags:L}),!L[a]||P[a]){if(G&&!X[a]&&"function"==typeof t.insertAdjacentHTML)try{t.insertAdjacentHTML("AfterEnd",t.innerHTML)}catch(t){}return at(t),!0}return!F||t.firstElementChild||t.content&&t.content.firstElementChild||!/</g.test(t.textContent)||(i.removed.push({element:t.cloneNode()}),t.innerHTML?t.innerHTML=t.innerHTML.replace(/</g,"&lt;"):t.innerHTML=t.textContent.replace(/</g,"&lt;")),B&&3===t.nodeType&&(n=(n=(n=t.textContent).replace(x," ")).replace(M," "),t.textContent!==n&&(i.removed.push({element:t.cloneNode()}),t.textContent=n)),ht("afterSanitizeElements",t,null),!1},dt=function(t,e,i){if(K&&("id"===e||"name"===e)&&(i in s||i in it))return!1;if(B&&(i=(i=i.replace(x," ")).replace(M," ")),N&&S.test(e));else if(R&&C.test(e));else{if(!T[e]||O[e])return!1;if(tt[e]);else if(V.test(i.replace(k,"")));else if("src"!==e&&"xlink:href"!==e||"script"===t||0!==i.indexOf("data:")||!J[t])if(D&&!H.test(i.replace(k,"")));else if(i)return!1}return!0},pt=function(t){var e=void 0,n=void 0,a=void 0,o=void 0,s=void 0;ht("beforeSanitizeAttributes",t,null);var r=t.attributes;if(r){var l={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:T};for(s=r.length;s--;){var h=e=r[s],c=h.name,d=h.namespaceURI;if(n=e.value.trim(),a=c.toLowerCase(),l.attrName=a,l.attrValue=n,l.keepAttr=!0,ht("uponSanitizeAttribute",t,l),n=l.attrValue,"name"===a&&"IMG"===t.nodeName&&r.id)o=r.id,r=Array.prototype.slice.apply(r),ot("id",t),ot(c,t),r.indexOf(o)>s&&t.setAttribute("id",o.value);else{if("INPUT"===t.nodeName&&"type"===a&&"file"===n&&(T[a]||!O[a]))continue;"id"===c&&t.setAttribute(c,""),ot(c,t)}if(l.keepAttr){var p=t.nodeName.toLowerCase();if(dt(p,a,n))try{d?t.setAttributeNS(d,c,n):t.setAttribute(c,n),i.removed.pop()}catch(t){}}}ht("afterSanitizeAttributes",t,null)}},ut=function t(e){var i=void 0,n=rt(e);for(ht("beforeSanitizeShadowDOM",e,null);i=n.nextNode();)ht("uponSanitizeShadowNode",i,null),ct(i)||(i.content instanceof r&&t(i.content),pt(i));ht("afterSanitizeShadowDOM",e,null)};return i.sanitize=function(t,a){var o=void 0,s=void 0,l=void 0,c=void 0,d=void 0;if(t||(t="\x3c!--\x3e"),"string"!=typeof t&&!lt(t)){if("function"!=typeof t.toString)throw new TypeError("toString is not a function");if("string"!=typeof(t=t.toString()))throw new TypeError("dirty is not a string, aborting")}if(!i.isSupported){if("object"===is(e.toStaticHTML)||"function"==typeof e.toStaticHTML){if("string"==typeof t)return e.toStaticHTML(t);if(lt(t))return e.toStaticHTML(t.outerHTML)}return t}if($||nt(a),i.removed=[],Q);else if(t instanceof h)1===(s=(o=st("\x3c!--\x3e")).ownerDocument.importNode(t,!0)).nodeType&&"BODY"===s.nodeName?o=s:o.appendChild(s);else{if(!q&&!Y&&-1===t.indexOf("<"))return t;if(!(o=st(t)))return q?null:""}o&&j&&at(o.firstChild);for(var p=rt(Q?t:o);l=p.nextNode();)3===l.nodeType&&l===c||ct(l)||(l.content instanceof r&&ut(l.content),pt(l),c=l);if(Q)return t;if(q){if(U)for(d=b.call(o.ownerDocument);o.firstChild;)d.appendChild(o.firstChild);else d=o;return W&&(d=z.call(n,d,!0)),d}return Y?o.outerHTML:o.innerHTML},i.setConfig=function(t){nt(t),$=!0},i.clearConfig=function(){et=null,$=!1},i.isValidAttribute=function(t,e,i){et||nt({});var n=t.toLowerCase(),a=e.toLowerCase();return dt(n,a,i)},i.addHook=function(t,e){"function"==typeof e&&(w[t]=w[t]||[],w[t].push(e))},i.removeHook=function(t){w[t]&&w[t].pop()},i.removeHooks=function(t){w[t]&&(w[t]=[])},i.removeAllHooks=function(){w={}},i}();window.customElements.define("moe-quote-link",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline;
...
`}static get properties(){return{no:{type:Number}}}_onClick(t){this.dispatchEvent(new CustomEvent("quoteLinkClick",{bubbles:!0,composed:!0,detail:{no:this.no}}))}});function ls(){return os.apply(null,arguments)}function hs(t){return t instanceof Array||"[object Array]"===Object.prototype.toString.call(t)}function cs(t){return null!=t&&"[object Object]"===Object.prototype.toString.call(t)}function ds(t){return void 0===t}function ps(t){return"number"==typeof t||"[object Number]"===Object.prototype.toString.call(t)}function us(t){return t instanceof Date||"[object Date]"===Object.prototype.toString.call(t)}function As(t,e){var i,n=[];for(i=0;i<t.length;++i)n.push(e(t[i],i));return n}function ms(t,e){return Object.prototype.hasOwnProperty.call(t,e)}function fs(t,e){for(var i in e)ms(e,i)&&(t[i]=e[i]);return ms(e,"toString")&&(t.toString=e.toString),ms(e,"valueOf")&&(t.valueOf=e.valueOf),t}function gs(t,e,i,n){return Tl(t,e,i,n,!0).utc()}function vs(t){return null==t._pf&&(t._pf={empty:!1,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:!1,invalidMonth:null,invalidFormat:!1,userInvalidated:!1,iso:!1,parsedDateParts:[],meridiem:null,rfc2822:!1,weekdayMismatch:!1}),t._pf}function _s(t){if(null==t._isValid){var e=vs(t),i=ss.call(e.parsedDateParts,function(t){return null!=t}),n=!isNaN(t._d.getTime())&&e.overflow<0&&!e.empty&&!e.invalidMonth&&!e.invalidWeekday&&!e.weekdayMismatch&&!e.nullInput&&!e.invalidFormat&&!e.userInvalidated&&(!e.meridiem||e.meridiem&&i);if(t._strict&&(n=n&&0===e.charsLeftOver&&0===e.unusedTokens.length&&void 0===e.bigHour),null!=Object.isFrozen&&Object.isFrozen(t))return n;t._isValid=n}return t._isValid}function ys(t){var e=gs(NaN);return null!=t?fs(vs(e),t):vs(e).userInvalidated=!0,e}window.customElements.define("moe-post-comment",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
    height: auto;
...
`}static get properties(){return{comment:{type:String,observer:"_observeComment"}}}_observeComment(t){if(!t)return;let e=t;e=this._linkQuotes(e),e=this._highlightQuotes(e),e=this._modPushpost(e),this.$.content.innerHTML=rs.sanitize(e,{ALLOWED_TAGS:["br","code","pre","span","div","moe-quote-link"]}),this.$.content.querySelectorAll("img").forEach(t=>{t.addEventListener("load",()=>{this.dispatchEvent(new CustomEvent("processed"))})}),setTimeout(()=>this.dispatchEvent(new CustomEvent("processed")),0)}_highlightQuotes(t){return t.replace(/(^|<br(?: \/)?>)((?:&gt;|＞).*?)(?=<br(?: \/)?>|$)/gm,'$1<span class="highlight-quote">$2</span>')}_linkQuotes(t){return t.replace(/((?:&gt;|＞)+)(?:No\.)?(\d+)/i,'<moe-quote-link no="$2">No.$2</moe-quote-link>')}_modPushpost(t){const e=/\[MOD_PUSHPOST_USE\]<br(?: \/)?>([\w\W]+$)/gm,i=e.exec(t);return i&&(this.$.pushpost.innerHTML=i[1],this.$.pushpost.style.display="block"),t.replace(e,"")}}),ss=Array.prototype.some?Array.prototype.some:function(t){for(var e=Object(this),i=e.length>>>0,n=0;n<i;n++)if(n in e&&t.call(this,e[n],n,e))return!0;return!1};var bs=ls.momentProperties=[];function zs(t,e){var i,n,a;if(ds(e._isAMomentObject)||(t._isAMomentObject=e._isAMomentObject),ds(e._i)||(t._i=e._i),ds(e._f)||(t._f=e._f),ds(e._l)||(t._l=e._l),ds(e._strict)||(t._strict=e._strict),ds(e._tzm)||(t._tzm=e._tzm),ds(e._isUTC)||(t._isUTC=e._isUTC),ds(e._offset)||(t._offset=e._offset),ds(e._pf)||(t._pf=vs(e)),ds(e._locale)||(t._locale=e._locale),bs.length>0)for(i=0;i<bs.length;i++)ds(a=e[n=bs[i]])||(t[n]=a);return t}var ws=!1;function xs(t){zs(this,t),this._d=new Date(null!=t._d?t._d.getTime():NaN),this.isValid()||(this._d=new Date(NaN)),!1===ws&&(ws=!0,ls.updateOffset(this),ws=!1)}function Ms(t){return t instanceof xs||null!=t&&null!=t._isAMomentObject}function Ss(t){return t<0?Math.ceil(t)||0:Math.floor(t)}function Cs(t){var e=+t,i=0;return 0!==e&&isFinite(e)&&(i=Ss(e)),i}function Hs(t,e,i){var n,a=Math.min(t.length,e.length),o=Math.abs(t.length-e.length),s=0;for(n=0;n<a;n++)(i&&t[n]!==e[n]||!i&&Cs(t[n])!==Cs(e[n]))&&s++;return s+o}function ks(t){!1===ls.suppressDeprecationWarnings&&"undefined"!=typeof console&&console.warn&&console.warn("Deprecation warning: "+t)}function Vs(t,e){var i=!0;return fs(function(){if(null!=ls.deprecationHandler&&ls.deprecationHandler(null,t),i){for(var n,a=[],o=0;o<arguments.length;o++){if(n="","object"==typeof arguments[o]){for(var s in n+="\n["+o+"] ",arguments[0])n+=s+": "+arguments[0][s]+", ";n=n.slice(0,-2)}else n=arguments[o];a.push(n)}ks(t+"\nArguments: "+Array.prototype.slice.call(a).join("")+"\n"+(new Error).stack),i=!1}return e.apply(this,arguments)},e)}var Ls,Es={};function Ts(t,e){null!=ls.deprecationHandler&&ls.deprecationHandler(t,e),Es[t]||(ks(e),Es[t]=!0)}function Is(t){return t instanceof Function||"[object Function]"===Object.prototype.toString.call(t)}function Ps(t,e){var i,n=fs({},t);for(i in e)ms(e,i)&&(cs(t[i])&&cs(e[i])?(n[i]={},fs(n[i],t[i]),fs(n[i],e[i])):null!=e[i]?n[i]=e[i]:delete n[i]);for(i in t)ms(t,i)&&!ms(e,i)&&cs(t[i])&&(n[i]=fs({},n[i]));return n}function Os(t){null!=t&&this.set(t)}ls.suppressDeprecationWarnings=!1,ls.deprecationHandler=null,Ls=Object.keys?Object.keys:function(t){var e,i=[];for(e in t)ms(t,e)&&i.push(e);return i};var Rs={};function Ns(t,e){var i=t.toLowerCase();Rs[i]=Rs[i+"s"]=Rs[e]=t}function Ds(t){return"string"==typeof t?Rs[t]||Rs[t.toLowerCase()]:void 0}function Fs(t){var e,i,n={};for(i in t)ms(t,i)&&(e=Ds(i))&&(n[e]=t[i]);return n}var Bs={};function Ys(t,e){Bs[t]=e}function $s(t,e,i){var n=""+Math.abs(t),a=e-n.length;return(t>=0?i?"+":"":"-")+Math.pow(10,Math.max(0,a)).toString().substr(1)+n}var js=/(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,qs=/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,Us={},Ws={};function Ks(t,e,i,n){var a=n;"string"==typeof n&&(a=function(){return this[n]()}),t&&(Ws[t]=a),e&&(Ws[e[0]]=function(){return $s(a.apply(this,arguments),e[1],e[2])}),i&&(Ws[i]=function(){return this.localeData().ordinal(a.apply(this,arguments),t)})}function Gs(t,e){return t.isValid()?(e=Qs(e,t.localeData()),Us[e]=Us[e]||function(t){var e,i,n,a=t.match(js);for(e=0,i=a.length;e<i;e++)Ws[a[e]]?a[e]=Ws[a[e]]:a[e]=(n=a[e]).match(/\[[\s\S]/)?n.replace(/^\[|\]$/g,""):n.replace(/\\/g,"");return function(e){var n,o="";for(n=0;n<i;n++)o+=Is(a[n])?a[n].call(e,t):a[n];return o}}(e),Us[e](t)):t.localeData().invalidDate()}function Qs(t,e){var i=5;function n(t){return e.longDateFormat(t)||t}for(qs.lastIndex=0;i>=0&&qs.test(t);)t=t.replace(qs,n),qs.lastIndex=0,i-=1;return t}var Zs=/\d/,Xs=/\d\d/,Js=/\d{3}/,tr=/\d{4}/,er=/[+-]?\d{6}/,ir=/\d\d?/,nr=/\d\d\d\d?/,ar=/\d\d\d\d\d\d?/,or=/\d{1,3}/,sr=/\d{1,4}/,rr=/[+-]?\d{1,6}/,lr=/\d+/,hr=/[+-]?\d+/,cr=/Z|[+-]\d\d:?\d\d/gi,dr=/Z|[+-]\d\d(?::?\d\d)?/gi,pr=/[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i,ur={};function Ar(t,e,i){ur[t]=Is(e)?e:function(t,n){return t&&i?i:e}}function mr(t,e){return ms(ur,t)?ur[t](e._strict,e._locale):new RegExp(fr(t.replace("\\","").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(t,e,i,n,a){return e||i||n||a})))}function fr(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}var gr={};function vr(t,e){var i,n=e;for("string"==typeof t&&(t=[t]),ps(e)&&(n=function(t,i){i[e]=Cs(t)}),i=0;i<t.length;i++)gr[t[i]]=n}function _r(t,e){vr(t,function(t,i,n,a){n._w=n._w||{},e(t,n._w,n,a)})}function yr(t,e,i){null!=e&&ms(gr,t)&&gr[t](e,i._a,i,t)}var br=0,zr=1,wr=2,xr=3,Mr=4,Sr=5,Cr=6,Hr=7,kr=8;function Vr(t){return Lr(t)?366:365}function Lr(t){return t%4==0&&t%100!=0||t%400==0}Ks("Y",0,0,function(){var t=this.year();return t<=9999?""+t:"+"+t}),Ks(0,["YY",2],0,function(){return this.year()%100}),Ks(0,["YYYY",4],0,"year"),Ks(0,["YYYYY",5],0,"year"),Ks(0,["YYYYYY",6,!0],0,"year"),Ns("year","y"),Ys("year",1),Ar("Y",hr),Ar("YY",ir,Xs),Ar("YYYY",sr,tr),Ar("YYYYY",rr,er),Ar("YYYYYY",rr,er),vr(["YYYYY","YYYYYY"],br),vr("YYYY",function(t,e){e[br]=2===t.length?ls.parseTwoDigitYear(t):Cs(t)}),vr("YY",function(t,e){e[br]=ls.parseTwoDigitYear(t)}),vr("Y",function(t,e){e[br]=parseInt(t,10)}),ls.parseTwoDigitYear=function(t){return Cs(t)+(Cs(t)>68?1900:2e3)};var Er,Tr=Ir("FullYear",!0);function Ir(t,e){return function(i){return null!=i?(Or(this,t,i),ls.updateOffset(this,e),this):Pr(this,t)}}function Pr(t,e){return t.isValid()?t._d["get"+(t._isUTC?"UTC":"")+e]():NaN}function Or(t,e,i){t.isValid()&&!isNaN(i)&&("FullYear"===e&&Lr(t.year())&&1===t.month()&&29===t.date()?t._d["set"+(t._isUTC?"UTC":"")+e](i,t.month(),Rr(i,t.month())):t._d["set"+(t._isUTC?"UTC":"")+e](i))}function Rr(t,e){if(isNaN(t)||isNaN(e))return NaN;var i,n=(e%(i=12)+i)%i;return t+=(e-n)/12,1===n?Lr(t)?29:28:31-n%7%2}Er=Array.prototype.indexOf?Array.prototype.indexOf:function(t){var e;for(e=0;e<this.length;++e)if(this[e]===t)return e;return-1},Ks("M",["MM",2],"Mo",function(){return this.month()+1}),Ks("MMM",0,0,function(t){return this.localeData().monthsShort(this,t)}),Ks("MMMM",0,0,function(t){return this.localeData().months(this,t)}),Ns("month","M"),Ys("month",8),Ar("M",ir),Ar("MM",ir,Xs),Ar("MMM",function(t,e){return e.monthsShortRegex(t)}),Ar("MMMM",function(t,e){return e.monthsRegex(t)}),vr(["M","MM"],function(t,e){e[zr]=Cs(t)-1}),vr(["MMM","MMMM"],function(t,e,i,n){var a=i._locale.monthsParse(t,n,i._strict);null!=a?e[zr]=a:vs(i).invalidMonth=t});var Nr=/D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,Dr="January_February_March_April_May_June_July_August_September_October_November_December".split("_");var Fr="Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_");function Br(t,e){var i;if(!t.isValid())return t;if("string"==typeof e)if(/^\d+$/.test(e))e=Cs(e);else if(!ps(e=t.localeData().monthsParse(e)))return t;return i=Math.min(t.date(),Rr(t.year(),e)),t._d["set"+(t._isUTC?"UTC":"")+"Month"](e,i),t}function Yr(t){return null!=t?(Br(this,t),ls.updateOffset(this,!0),this):Pr(this,"Month")}var $r=pr;var jr=pr;function qr(){function t(t,e){return e.length-t.length}var e,i,n=[],a=[],o=[];for(e=0;e<12;e++)i=gs([2e3,e]),n.push(this.monthsShort(i,"")),a.push(this.months(i,"")),o.push(this.months(i,"")),o.push(this.monthsShort(i,""));for(n.sort(t),a.sort(t),o.sort(t),e=0;e<12;e++)n[e]=fr(n[e]),a[e]=fr(a[e]);for(e=0;e<24;e++)o[e]=fr(o[e]);this._monthsRegex=new RegExp("^("+o.join("|")+")","i"),this._monthsShortRegex=this._monthsRegex,this._monthsStrictRegex=new RegExp("^("+a.join("|")+")","i"),this._monthsShortStrictRegex=new RegExp("^("+n.join("|")+")","i")}function Ur(t){var e=new Date(Date.UTC.apply(null,arguments));return t<100&&t>=0&&isFinite(e.getUTCFullYear())&&e.setUTCFullYear(t),e}function Wr(t,e,i){var n=7+e-i;return-((7+Ur(t,0,n).getUTCDay()-e)%7)+n-1}function Kr(t,e,i,n,a){var o,s,r=1+7*(e-1)+(7+i-n)%7+Wr(t,n,a);return r<=0?s=Vr(o=t-1)+r:r>Vr(t)?(o=t+1,s=r-Vr(t)):(o=t,s=r),{year:o,dayOfYear:s}}function Gr(t,e,i){var n,a,o=Wr(t.year(),e,i),s=Math.floor((t.dayOfYear()-o-1)/7)+1;return s<1?n=s+Qr(a=t.year()-1,e,i):s>Qr(t.year(),e,i)?(n=s-Qr(t.year(),e,i),a=t.year()+1):(a=t.year(),n=s),{week:n,year:a}}function Qr(t,e,i){var n=Wr(t,e,i),a=Wr(t+1,e,i);return(Vr(t)-n+a)/7}Ks("w",["ww",2],"wo","week"),Ks("W",["WW",2],"Wo","isoWeek"),Ns("week","w"),Ns("isoWeek","W"),Ys("week",5),Ys("isoWeek",5),Ar("w",ir),Ar("ww",ir,Xs),Ar("W",ir),Ar("WW",ir,Xs),_r(["w","ww","W","WW"],function(t,e,i,n){e[n.substr(0,1)]=Cs(t)});Ks("d",0,"do","day"),Ks("dd",0,0,function(t){return this.localeData().weekdaysMin(this,t)}),Ks("ddd",0,0,function(t){return this.localeData().weekdaysShort(this,t)}),Ks("dddd",0,0,function(t){return this.localeData().weekdays(this,t)}),Ks("e",0,0,"weekday"),Ks("E",0,0,"isoWeekday"),Ns("day","d"),Ns("weekday","e"),Ns("isoWeekday","E"),Ys("day",11),Ys("weekday",11),Ys("isoWeekday",11),Ar("d",ir),Ar("e",ir),Ar("E",ir),Ar("dd",function(t,e){return e.weekdaysMinRegex(t)}),Ar("ddd",function(t,e){return e.weekdaysShortRegex(t)}),Ar("dddd",function(t,e){return e.weekdaysRegex(t)}),_r(["dd","ddd","dddd"],function(t,e,i,n){var a=i._locale.weekdaysParse(t,n,i._strict);null!=a?e.d=a:vs(i).invalidWeekday=t}),_r(["d","e","E"],function(t,e,i,n){e[n]=Cs(t)});var Zr="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_");var Xr="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_");var Jr="Su_Mo_Tu_We_Th_Fr_Sa".split("_");var tl=pr;var el=pr;var il=pr;function nl(){function t(t,e){return e.length-t.length}var e,i,n,a,o,s=[],r=[],l=[],h=[];for(e=0;e<7;e++)i=gs([2e3,1]).day(e),n=this.weekdaysMin(i,""),a=this.weekdaysShort(i,""),o=this.weekdays(i,""),s.push(n),r.push(a),l.push(o),h.push(n),h.push(a),h.push(o);for(s.sort(t),r.sort(t),l.sort(t),h.sort(t),e=0;e<7;e++)r[e]=fr(r[e]),l[e]=fr(l[e]),h[e]=fr(h[e]);this._weekdaysRegex=new RegExp("^("+h.join("|")+")","i"),this._weekdaysShortRegex=this._weekdaysRegex,this._weekdaysMinRegex=this._weekdaysRegex,this._weekdaysStrictRegex=new RegExp("^("+l.join("|")+")","i"),this._weekdaysShortStrictRegex=new RegExp("^("+r.join("|")+")","i"),this._weekdaysMinStrictRegex=new RegExp("^("+s.join("|")+")","i")}function al(){return this.hours()%12||12}function ol(t,e){Ks(t,0,0,function(){return this.localeData().meridiem(this.hours(),this.minutes(),e)})}function sl(t,e){return e._meridiemParse}Ks("H",["HH",2],0,"hour"),Ks("h",["hh",2],0,al),Ks("k",["kk",2],0,function(){return this.hours()||24}),Ks("hmm",0,0,function(){return""+al.apply(this)+$s(this.minutes(),2)}),Ks("hmmss",0,0,function(){return""+al.apply(this)+$s(this.minutes(),2)+$s(this.seconds(),2)}),Ks("Hmm",0,0,function(){return""+this.hours()+$s(this.minutes(),2)}),Ks("Hmmss",0,0,function(){return""+this.hours()+$s(this.minutes(),2)+$s(this.seconds(),2)}),ol("a",!0),ol("A",!1),Ns("hour","h"),Ys("hour",13),Ar("a",sl),Ar("A",sl),Ar("H",ir),Ar("h",ir),Ar("k",ir),Ar("HH",ir,Xs),Ar("hh",ir,Xs),Ar("kk",ir,Xs),Ar("hmm",nr),Ar("hmmss",ar),Ar("Hmm",nr),Ar("Hmmss",ar),vr(["H","HH"],xr),vr(["k","kk"],function(t,e,i){var n=Cs(t);e[xr]=24===n?0:n}),vr(["a","A"],function(t,e,i){i._isPm=i._locale.isPM(t),i._meridiem=t}),vr(["h","hh"],function(t,e,i){e[xr]=Cs(t),vs(i).bigHour=!0}),vr("hmm",function(t,e,i){var n=t.length-2;e[xr]=Cs(t.substr(0,n)),e[Mr]=Cs(t.substr(n)),vs(i).bigHour=!0}),vr("hmmss",function(t,e,i){var n=t.length-4,a=t.length-2;e[xr]=Cs(t.substr(0,n)),e[Mr]=Cs(t.substr(n,2)),e[Sr]=Cs(t.substr(a)),vs(i).bigHour=!0}),vr("Hmm",function(t,e,i){var n=t.length-2;e[xr]=Cs(t.substr(0,n)),e[Mr]=Cs(t.substr(n))}),vr("Hmmss",function(t,e,i){var n=t.length-4,a=t.length-2;e[xr]=Cs(t.substr(0,n)),e[Mr]=Cs(t.substr(n,2)),e[Sr]=Cs(t.substr(a))});var rl,ll=Ir("Hours",!0),hl={calendar:{sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},longDateFormat:{LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},invalidDate:"Invalid date",ordinal:"%d",dayOfMonthOrdinalParse:/\d{1,2}/,relativeTime:{future:"in %s",past:"%s ago",s:"a few seconds",ss:"%d seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},months:Dr,monthsShort:Fr,week:{dow:0,doy:6},weekdays:Zr,weekdaysMin:Jr,weekdaysShort:Xr,meridiemParse:/[ap]\.?m?\.?/i},cl={},dl={};function pl(t){return t?t.toLowerCase().replace("_","-"):t}function ul(t){var e=null;if(!cl[t]&&"undefined"!=typeof module&&module&&module.exports)try{e=rl._abbr,require("./locale/"+t),Al(e)}catch(t){}return cl[t]}function Al(t,e){var i;return t&&((i=ds(e)?fl(t):ml(t,e))?rl=i:"undefined"!=typeof console&&console.warn&&console.warn("Locale "+t+" not found. Did you forget to load it?")),rl._abbr}function ml(t,e){if(null!==e){var i,n=hl;if(e.abbr=t,null!=cl[t])Ts("defineLocaleOverride","use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."),n=cl[t]._config;else if(null!=e.parentLocale)if(null!=cl[e.parentLocale])n=cl[e.parentLocale]._config;else{if(null==(i=ul(e.parentLocale)))return dl[e.parentLocale]||(dl[e.parentLocale]=[]),dl[e.parentLocale].push({name:t,config:e}),null;n=i._config}return cl[t]=new Os(Ps(n,e)),dl[t]&&dl[t].forEach(function(t){ml(t.name,t.config)}),Al(t),cl[t]}return delete cl[t],null}function fl(t){var e;if(t&&t._locale&&t._locale._abbr&&(t=t._locale._abbr),!t)return rl;if(!hs(t)){if(e=ul(t))return e;t=[t]}return function(t){for(var e,i,n,a,o=0;o<t.length;){for(e=(a=pl(t[o]).split("-")).length,i=(i=pl(t[o+1]))?i.split("-"):null;e>0;){if(n=ul(a.slice(0,e).join("-")))return n;if(i&&i.length>=e&&Hs(a,i,!0)>=e-1)break;e--}o++}return rl}(t)}function gl(t){var e,i=t._a;return i&&-2===vs(t).overflow&&(e=i[zr]<0||i[zr]>11?zr:i[wr]<1||i[wr]>Rr(i[br],i[zr])?wr:i[xr]<0||i[xr]>24||24===i[xr]&&(0!==i[Mr]||0!==i[Sr]||0!==i[Cr])?xr:i[Mr]<0||i[Mr]>59?Mr:i[Sr]<0||i[Sr]>59?Sr:i[Cr]<0||i[Cr]>999?Cr:-1,vs(t)._overflowDayOfYear&&(e<br||e>wr)&&(e=wr),vs(t)._overflowWeeks&&-1===e&&(e=Hr),vs(t)._overflowWeekday&&-1===e&&(e=kr),vs(t).overflow=e),t}function vl(t,e,i){return null!=t?t:null!=e?e:i}function _l(t){var e,i,n,a,o,s=[];if(!t._d){for(n=function(t){var e=new Date(ls.now());return t._useUTC?[e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate()]:[e.getFullYear(),e.getMonth(),e.getDate()]}(t),t._w&&null==t._a[wr]&&null==t._a[zr]&&function(t){var e,i,n,a,o,s,r,l;if(null!=(e=t._w).GG||null!=e.W||null!=e.E)o=1,s=4,i=vl(e.GG,t._a[br],Gr(Il(),1,4).year),n=vl(e.W,1),((a=vl(e.E,1))<1||a>7)&&(l=!0);else{o=t._locale._week.dow,s=t._locale._week.doy;var h=Gr(Il(),o,s);i=vl(e.gg,t._a[br],h.year),n=vl(e.w,h.week),null!=e.d?((a=e.d)<0||a>6)&&(l=!0):null!=e.e?(a=e.e+o,(e.e<0||e.e>6)&&(l=!0)):a=o}n<1||n>Qr(i,o,s)?vs(t)._overflowWeeks=!0:null!=l?vs(t)._overflowWeekday=!0:(r=Kr(i,n,a,o,s),t._a[br]=r.year,t._dayOfYear=r.dayOfYear)}(t),null!=t._dayOfYear&&(o=vl(t._a[br],n[br]),(t._dayOfYear>Vr(o)||0===t._dayOfYear)&&(vs(t)._overflowDayOfYear=!0),i=Ur(o,0,t._dayOfYear),t._a[zr]=i.getUTCMonth(),t._a[wr]=i.getUTCDate()),e=0;e<3&&null==t._a[e];++e)t._a[e]=s[e]=n[e];for(;e<7;e++)t._a[e]=s[e]=null==t._a[e]?2===e?1:0:t._a[e];24===t._a[xr]&&0===t._a[Mr]&&0===t._a[Sr]&&0===t._a[Cr]&&(t._nextDay=!0,t._a[xr]=0),t._d=(t._useUTC?Ur:function(t,e,i,n,a,o,s){var r=new Date(t,e,i,n,a,o,s);return t<100&&t>=0&&isFinite(r.getFullYear())&&r.setFullYear(t),r}).apply(null,s),a=t._useUTC?t._d.getUTCDay():t._d.getDay(),null!=t._tzm&&t._d.setUTCMinutes(t._d.getUTCMinutes()-t._tzm),t._nextDay&&(t._a[xr]=24),t._w&&void 0!==t._w.d&&t._w.d!==a&&(vs(t).weekdayMismatch=!0)}}var yl=/^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,bl=/^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,zl=/Z|[+-]\d\d(?::?\d\d)?/,wl=[["YYYYYY-MM-DD",/[+-]\d{6}-\d\d-\d\d/],["YYYY-MM-DD",/\d{4}-\d\d-\d\d/],["GGGG-[W]WW-E",/\d{4}-W\d\d-\d/],["GGGG-[W]WW",/\d{4}-W\d\d/,!1],["YYYY-DDD",/\d{4}-\d{3}/],["YYYY-MM",/\d{4}-\d\d/,!1],["YYYYYYMMDD",/[+-]\d{10}/],["YYYYMMDD",/\d{8}/],["GGGG[W]WWE",/\d{4}W\d{3}/],["GGGG[W]WW",/\d{4}W\d{2}/,!1],["YYYYDDD",/\d{7}/]],xl=[["HH:mm:ss.SSSS",/\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss,SSSS",/\d\d:\d\d:\d\d,\d+/],["HH:mm:ss",/\d\d:\d\d:\d\d/],["HH:mm",/\d\d:\d\d/],["HHmmss.SSSS",/\d\d\d\d\d\d\.\d+/],["HHmmss,SSSS",/\d\d\d\d\d\d,\d+/],["HHmmss",/\d\d\d\d\d\d/],["HHmm",/\d\d\d\d/],["HH",/\d\d/]],Ml=/^\/?Date\((\-?\d+)/i;function Sl(t){var e,i,n,a,o,s,r=t._i,l=yl.exec(r)||bl.exec(r);if(l){for(vs(t).iso=!0,e=0,i=wl.length;e<i;e++)if(wl[e][1].exec(l[1])){a=wl[e][0],n=!1!==wl[e][2];break}if(null==a)return void(t._isValid=!1);if(l[3]){for(e=0,i=xl.length;e<i;e++)if(xl[e][1].exec(l[3])){o=(l[2]||" ")+xl[e][0];break}if(null==o)return void(t._isValid=!1)}if(!n&&null!=o)return void(t._isValid=!1);if(l[4]){if(!zl.exec(l[4]))return void(t._isValid=!1);s="Z"}t._f=a+(o||"")+(s||""),Ll(t)}else t._isValid=!1}var Cl=/^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;function Hl(t,e,i,n,a,o){var s=[function(t){var e=parseInt(t,10);if(e<=49)return 2e3+e;if(e<=999)return 1900+e;return e}(t),Fr.indexOf(e),parseInt(i,10),parseInt(n,10),parseInt(a,10)];return o&&s.push(parseInt(o,10)),s}var kl={UT:0,GMT:0,EDT:-240,EST:-300,CDT:-300,CST:-360,MDT:-360,MST:-420,PDT:-420,PST:-480};function Vl(t){var e=Cl.exec(t._i.replace(/\([^)]*\)|[\n\t]/g," ").replace(/(\s\s+)/g," ").replace(/^\s\s*/,"").replace(/\s\s*$/,""));if(e){var i=Hl(e[4],e[3],e[2],e[5],e[6],e[7]);if(!function(t,e,i){return!t||Xr.indexOf(t)===new Date(e[0],e[1],e[2]).getDay()||(vs(i).weekdayMismatch=!0,i._isValid=!1,!1)}(e[1],i,t))return;t._a=i,t._tzm=function(t,e,i){if(t)return kl[t];if(e)return 0;var n=parseInt(i,10),a=n%100;return(n-a)/100*60+a}(e[8],e[9],e[10]),t._d=Ur.apply(null,t._a),t._d.setUTCMinutes(t._d.getUTCMinutes()-t._tzm),vs(t).rfc2822=!0}else t._isValid=!1}function Ll(t){if(t._f!==ls.ISO_8601)if(t._f!==ls.RFC_2822){t._a=[],vs(t).empty=!0;var e,i,n,a,o,s=""+t._i,r=s.length,l=0;for(n=Qs(t._f,t._locale).match(js)||[],e=0;e<n.length;e++)a=n[e],(i=(s.match(mr(a,t))||[])[0])&&((o=s.substr(0,s.indexOf(i))).length>0&&vs(t).unusedInput.push(o),s=s.slice(s.indexOf(i)+i.length),l+=i.length),Ws[a]?(i?vs(t).empty=!1:vs(t).unusedTokens.push(a),yr(a,i,t)):t._strict&&!i&&vs(t).unusedTokens.push(a);vs(t).charsLeftOver=r-l,s.length>0&&vs(t).unusedInput.push(s),t._a[xr]<=12&&!0===vs(t).bigHour&&t._a[xr]>0&&(vs(t).bigHour=void 0),vs(t).parsedDateParts=t._a.slice(0),vs(t).meridiem=t._meridiem,t._a[xr]=function(t,e,i){var n;if(null==i)return e;return null!=t.meridiemHour?t.meridiemHour(e,i):null!=t.isPM?((n=t.isPM(i))&&e<12&&(e+=12),n||12!==e||(e=0),e):e}(t._locale,t._a[xr],t._meridiem),_l(t),gl(t)}else Vl(t);else Sl(t)}function El(t){var e=t._i,i=t._f;return t._locale=t._locale||fl(t._l),null===e||void 0===i&&""===e?ys({nullInput:!0}):("string"==typeof e&&(t._i=e=t._locale.preparse(e)),Ms(e)?new xs(gl(e)):(us(e)?t._d=e:hs(i)?function(t){var e,i,n,a,o;if(0===t._f.length)return vs(t).invalidFormat=!0,void(t._d=new Date(NaN));for(a=0;a<t._f.length;a++)o=0,e=zs({},t),null!=t._useUTC&&(e._useUTC=t._useUTC),e._f=t._f[a],Ll(e),_s(e)&&(o+=vs(e).charsLeftOver,o+=10*vs(e).unusedTokens.length,vs(e).score=o,(null==n||o<n)&&(n=o,i=e));fs(t,i||e)}(t):i?Ll(t):function(t){var e=t._i;ds(e)?t._d=new Date(ls.now()):us(e)?t._d=new Date(e.valueOf()):"string"==typeof e?function(t){var e=Ml.exec(t._i);null===e?(Sl(t),!1===t._isValid&&(delete t._isValid,Vl(t),!1===t._isValid&&(delete t._isValid,ls.createFromInputFallback(t)))):t._d=new Date(+e[1])}(t):hs(e)?(t._a=As(e.slice(0),function(t){return parseInt(t,10)}),_l(t)):cs(e)?function(t){if(!t._d){var e=Fs(t._i);t._a=As([e.year,e.month,e.day||e.date,e.hour,e.minute,e.second,e.millisecond],function(t){return t&&parseInt(t,10)}),_l(t)}}(t):ps(e)?t._d=new Date(e):ls.createFromInputFallback(t)}(t),_s(t)||(t._d=null),t))}function Tl(t,e,i,n,a){var o,s={};return!0!==i&&!1!==i||(n=i,i=void 0),(cs(t)&&function(t){if(Object.getOwnPropertyNames)return 0===Object.getOwnPropertyNames(t).length;var e;for(e in t)if(t.hasOwnProperty(e))return!1;return!0}(t)||hs(t)&&0===t.length)&&(t=void 0),s._isAMomentObject=!0,s._useUTC=s._isUTC=a,s._l=i,s._i=t,s._f=e,s._strict=n,(o=new xs(gl(El(s))))._nextDay&&(o.add(1,"d"),o._nextDay=void 0),o}function Il(t,e,i,n){return Tl(t,e,i,n,!1)}ls.createFromInputFallback=Vs("value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to js Date(), which is not reliable across all browsers and versions. Non RFC2822/ISO date formats are discouraged and will be removed in an upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.",function(t){t._d=new Date(t._i+(t._useUTC?" UTC":""))}),ls.ISO_8601=function(){},ls.RFC_2822=function(){};var Pl=Vs("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var t=Il.apply(null,arguments);return this.isValid()&&t.isValid()?t<this?this:t:ys()}),Ol=Vs("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var t=Il.apply(null,arguments);return this.isValid()&&t.isValid()?t>this?this:t:ys()});function Rl(t,e){var i,n;if(1===e.length&&hs(e[0])&&(e=e[0]),!e.length)return Il();for(i=e[0],n=1;n<e.length;++n)e[n].isValid()&&!e[n][t](i)||(i=e[n]);return i}var Nl=["year","quarter","month","week","day","hour","minute","second","millisecond"];function Dl(t){var e=Fs(t),i=e.year||0,n=e.quarter||0,a=e.month||0,o=e.week||0,s=e.day||0,r=e.hour||0,l=e.minute||0,h=e.second||0,c=e.millisecond||0;this._isValid=function(t){for(var e in t)if(-1===Er.call(Nl,e)||null!=t[e]&&isNaN(t[e]))return!1;for(var i=!1,n=0;n<Nl.length;++n)if(t[Nl[n]]){if(i)return!1;parseFloat(t[Nl[n]])!==Cs(t[Nl[n]])&&(i=!0)}return!0}(e),this._milliseconds=+c+1e3*h+6e4*l+1e3*r*60*60,this._days=+s+7*o,this._months=+a+3*n+12*i,this._data={},this._locale=fl(),this._bubble()}function Fl(t){return t instanceof Dl}function Bl(t){return t<0?-1*Math.round(-1*t):Math.round(t)}function Yl(t,e){Ks(t,0,0,function(){var t=this.utcOffset(),i="+";return t<0&&(t=-t,i="-"),i+$s(~~(t/60),2)+e+$s(~~t%60,2)})}Yl("Z",":"),Yl("ZZ",""),Ar("Z",dr),Ar("ZZ",dr),vr(["Z","ZZ"],function(t,e,i){i._useUTC=!0,i._tzm=jl(dr,t)});var $l=/([\+\-]|\d\d)/gi;function jl(t,e){var i=(e||"").match(t);if(null===i)return null;var n=((i[i.length-1]||[])+"").match($l)||["-",0,0],a=60*n[1]+Cs(n[2]);return 0===a?0:"+"===n[0]?a:-a}function ql(t,e){var i,n;return e._isUTC?(i=e.clone(),n=(Ms(t)||us(t)?t.valueOf():Il(t).valueOf())-i.valueOf(),i._d.setTime(i._d.valueOf()+n),ls.updateOffset(i,!1),i):Il(t).local()}function Ul(t){return 15*-Math.round(t._d.getTimezoneOffset()/15)}function Wl(){return!!this.isValid()&&(this._isUTC&&0===this._offset)}ls.updateOffset=function(){};var Kl=/^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/,Gl=/^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;function Ql(t,e){var i,n,a,o=t,s=null;return Fl(t)?o={ms:t._milliseconds,d:t._days,M:t._months}:ps(t)?(o={},e?o[e]=t:o.milliseconds=t):(s=Kl.exec(t))?(i="-"===s[1]?-1:1,o={y:0,d:Cs(s[wr])*i,h:Cs(s[xr])*i,m:Cs(s[Mr])*i,s:Cs(s[Sr])*i,ms:Cs(Bl(1e3*s[Cr]))*i}):(s=Gl.exec(t))?(i="-"===s[1]?-1:(s[1],1),o={y:Zl(s[2],i),M:Zl(s[3],i),w:Zl(s[4],i),d:Zl(s[5],i),h:Zl(s[6],i),m:Zl(s[7],i),s:Zl(s[8],i)}):null==o?o={}:"object"==typeof o&&("from"in o||"to"in o)&&(a=function(t,e){var i;if(!t.isValid()||!e.isValid())return{milliseconds:0,months:0};e=ql(e,t),t.isBefore(e)?i=Xl(t,e):((i=Xl(e,t)).milliseconds=-i.milliseconds,i.months=-i.months);return i}(Il(o.from),Il(o.to)),(o={}).ms=a.milliseconds,o.M=a.months),n=new Dl(o),Fl(t)&&ms(t,"_locale")&&(n._locale=t._locale),n}function Zl(t,e){var i=t&&parseFloat(t.replace(",","."));return(isNaN(i)?0:i)*e}function Xl(t,e){var i={milliseconds:0,months:0};return i.months=e.month()-t.month()+12*(e.year()-t.year()),t.clone().add(i.months,"M").isAfter(e)&&--i.months,i.milliseconds=+e-+t.clone().add(i.months,"M"),i}function Jl(t,e){return function(i,n){var a;return null===n||isNaN(+n)||(Ts(e,"moment()."+e+"(period, number) is deprecated. Please use moment()."+e+"(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),a=i,i=n,n=a),th(this,Ql(i="string"==typeof i?+i:i,n),t),this}}function th(t,e,i,n){var a=e._milliseconds,o=Bl(e._days),s=Bl(e._months);t.isValid()&&(n=null==n||n,s&&Br(t,Pr(t,"Month")+s*i),o&&Or(t,"Date",Pr(t,"Date")+o*i),a&&t._d.setTime(t._d.valueOf()+a*i),n&&ls.updateOffset(t,o||s))}Ql.fn=Dl.prototype,Ql.invalid=function(){return Ql(NaN)};var eh=Jl(1,"add"),ih=Jl(-1,"subtract");function nh(t,e){var i=12*(e.year()-t.year())+(e.month()-t.month()),n=t.clone().add(i,"months");return-(i+(e-n<0?(e-n)/(n-t.clone().add(i-1,"months")):(e-n)/(t.clone().add(i+1,"months")-n)))||0}function ah(t){var e;return void 0===t?this._locale._abbr:(null!=(e=fl(t))&&(this._locale=e),this)}ls.defaultFormat="YYYY-MM-DDTHH:mm:ssZ",ls.defaultFormatUtc="YYYY-MM-DDTHH:mm:ss[Z]";var oh=Vs("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(t){return void 0===t?this.localeData():this.locale(t)});function sh(){return this._locale}function rh(t,e){Ks(0,[t,t.length],0,e)}function lh(t,e,i,n,a){var o;return null==t?Gr(this,n,a).year:(e>(o=Qr(t,n,a))&&(e=o),function(t,e,i,n,a){var o=Kr(t,e,i,n,a),s=Ur(o.year,0,o.dayOfYear);return this.year(s.getUTCFullYear()),this.month(s.getUTCMonth()),this.date(s.getUTCDate()),this}.call(this,t,e,i,n,a))}Ks(0,["gg",2],0,function(){return this.weekYear()%100}),Ks(0,["GG",2],0,function(){return this.isoWeekYear()%100}),rh("gggg","weekYear"),rh("ggggg","weekYear"),rh("GGGG","isoWeekYear"),rh("GGGGG","isoWeekYear"),Ns("weekYear","gg"),Ns("isoWeekYear","GG"),Ys("weekYear",1),Ys("isoWeekYear",1),Ar("G",hr),Ar("g",hr),Ar("GG",ir,Xs),Ar("gg",ir,Xs),Ar("GGGG",sr,tr),Ar("gggg",sr,tr),Ar("GGGGG",rr,er),Ar("ggggg",rr,er),_r(["gggg","ggggg","GGGG","GGGGG"],function(t,e,i,n){e[n.substr(0,2)]=Cs(t)}),_r(["gg","GG"],function(t,e,i,n){e[n]=ls.parseTwoDigitYear(t)}),Ks("Q",0,"Qo","quarter"),Ns("quarter","Q"),Ys("quarter",7),Ar("Q",Zs),vr("Q",function(t,e){e[zr]=3*(Cs(t)-1)}),Ks("D",["DD",2],"Do","date"),Ns("date","D"),Ys("date",9),Ar("D",ir),Ar("DD",ir,Xs),Ar("Do",function(t,e){return t?e._dayOfMonthOrdinalParse||e._ordinalParse:e._dayOfMonthOrdinalParseLenient}),vr(["D","DD"],wr),vr("Do",function(t,e){e[wr]=Cs(t.match(ir)[0])});var hh=Ir("Date",!0);Ks("DDD",["DDDD",3],"DDDo","dayOfYear"),Ns("dayOfYear","DDD"),Ys("dayOfYear",4),Ar("DDD",or),Ar("DDDD",Js),vr(["DDD","DDDD"],function(t,e,i){i._dayOfYear=Cs(t)}),Ks("m",["mm",2],0,"minute"),Ns("minute","m"),Ys("minute",14),Ar("m",ir),Ar("mm",ir,Xs),vr(["m","mm"],Mr);var ch=Ir("Minutes",!1);Ks("s",["ss",2],0,"second"),Ns("second","s"),Ys("second",15),Ar("s",ir),Ar("ss",ir,Xs),vr(["s","ss"],Sr);var dh,ph=Ir("Seconds",!1);for(Ks("S",0,0,function(){return~~(this.millisecond()/100)}),Ks(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),Ks(0,["SSS",3],0,"millisecond"),Ks(0,["SSSS",4],0,function(){return 10*this.millisecond()}),Ks(0,["SSSSS",5],0,function(){return 100*this.millisecond()}),Ks(0,["SSSSSS",6],0,function(){return 1e3*this.millisecond()}),Ks(0,["SSSSSSS",7],0,function(){return 1e4*this.millisecond()}),Ks(0,["SSSSSSSS",8],0,function(){return 1e5*this.millisecond()}),Ks(0,["SSSSSSSSS",9],0,function(){return 1e6*this.millisecond()}),Ns("millisecond","ms"),Ys("millisecond",16),Ar("S",or,Zs),Ar("SS",or,Xs),Ar("SSS",or,Js),dh="SSSS";dh.length<=9;dh+="S")Ar(dh,lr);function uh(t,e){e[Cr]=Cs(1e3*("0."+t))}for(dh="S";dh.length<=9;dh+="S")vr(dh,uh);var Ah=Ir("Milliseconds",!1);Ks("z",0,0,"zoneAbbr"),Ks("zz",0,0,"zoneName");var mh=xs.prototype;function fh(t){return t}mh.add=eh,mh.calendar=function(t,e){var i=t||Il(),n=ql(i,this).startOf("day"),a=ls.calendarFormat(this,n)||"sameElse",o=e&&(Is(e[a])?e[a].call(this,i):e[a]);return this.format(o||this.localeData().calendar(a,this,Il(i)))},mh.clone=function(){return new xs(this)},mh.diff=function(t,e,i){var n,a,o;if(!this.isValid())return NaN;if(!(n=ql(t,this)).isValid())return NaN;switch(a=6e4*(n.utcOffset()-this.utcOffset()),e=Ds(e)){case"year":o=nh(this,n)/12;break;case"month":o=nh(this,n);break;case"quarter":o=nh(this,n)/3;break;case"second":o=(this-n)/1e3;break;case"minute":o=(this-n)/6e4;break;case"hour":o=(this-n)/36e5;break;case"day":o=(this-n-a)/864e5;break;case"week":o=(this-n-a)/6048e5;break;default:o=this-n}return i?o:Ss(o)},mh.endOf=function(t){return void 0===(t=Ds(t))||"millisecond"===t?this:("date"===t&&(t="day"),this.startOf(t).add(1,"isoWeek"===t?"week":t).subtract(1,"ms"))},mh.format=function(t){t||(t=this.isUtc()?ls.defaultFormatUtc:ls.defaultFormat);var e=Gs(this,t);return this.localeData().postformat(e)},mh.from=function(t,e){return this.isValid()&&(Ms(t)&&t.isValid()||Il(t).isValid())?Ql({to:this,from:t}).locale(this.locale()).humanize(!e):this.localeData().invalidDate()},mh.fromNow=function(t){return this.from(Il(),t)},mh.to=function(t,e){return this.isValid()&&(Ms(t)&&t.isValid()||Il(t).isValid())?Ql({from:this,to:t}).locale(this.locale()).humanize(!e):this.localeData().invalidDate()},mh.toNow=function(t){return this.to(Il(),t)},mh.get=function(t){return Is(this[t=Ds(t)])?this[t]():this},mh.invalidAt=function(){return vs(this).overflow},mh.isAfter=function(t,e){var i=Ms(t)?t:Il(t);return!(!this.isValid()||!i.isValid())&&("millisecond"===(e=Ds(ds(e)?"millisecond":e))?this.valueOf()>i.valueOf():i.valueOf()<this.clone().startOf(e).valueOf())},mh.isBefore=function(t,e){var i=Ms(t)?t:Il(t);return!(!this.isValid()||!i.isValid())&&("millisecond"===(e=Ds(ds(e)?"millisecond":e))?this.valueOf()<i.valueOf():this.clone().endOf(e).valueOf()<i.valueOf())},mh.isBetween=function(t,e,i,n){return("("===(n=n||"()")[0]?this.isAfter(t,i):!this.isBefore(t,i))&&(")"===n[1]?this.isBefore(e,i):!this.isAfter(e,i))},mh.isSame=function(t,e){var i,n=Ms(t)?t:Il(t);return!(!this.isValid()||!n.isValid())&&("millisecond"===(e=Ds(e||"millisecond"))?this.valueOf()===n.valueOf():(i=n.valueOf(),this.clone().startOf(e).valueOf()<=i&&i<=this.clone().endOf(e).valueOf()))},mh.isSameOrAfter=function(t,e){return this.isSame(t,e)||this.isAfter(t,e)},mh.isSameOrBefore=function(t,e){return this.isSame(t,e)||this.isBefore(t,e)},mh.isValid=function(){return _s(this)},mh.lang=oh,mh.locale=ah,mh.localeData=sh,mh.max=Ol,mh.min=Pl,mh.parsingFlags=function(){return fs({},vs(this))},mh.set=function(t,e){if("object"==typeof t)for(var i=function(t){var e=[];for(var i in t)e.push({unit:i,priority:Bs[i]});return e.sort(function(t,e){return t.priority-e.priority}),e}(t=Fs(t)),n=0;n<i.length;n++)this[i[n].unit](t[i[n].unit]);else if(Is(this[t=Ds(t)]))return this[t](e);return this},mh.startOf=function(t){switch(t=Ds(t)){case"year":this.month(0);case"quarter":case"month":this.date(1);case"week":case"isoWeek":case"day":case"date":this.hours(0);case"hour":this.minutes(0);case"minute":this.seconds(0);case"second":this.milliseconds(0)}return"week"===t&&this.weekday(0),"isoWeek"===t&&this.isoWeekday(1),"quarter"===t&&this.month(3*Math.floor(this.month()/3)),this},mh.subtract=ih,mh.toArray=function(){var t=this;return[t.year(),t.month(),t.date(),t.hour(),t.minute(),t.second(),t.millisecond()]},mh.toObject=function(){var t=this;return{years:t.year(),months:t.month(),date:t.date(),hours:t.hours(),minutes:t.minutes(),seconds:t.seconds(),milliseconds:t.milliseconds()}},mh.toDate=function(){return new Date(this.valueOf())},mh.toISOString=function(t){if(!this.isValid())return null;var e=!0!==t,i=e?this.clone().utc():this;return i.year()<0||i.year()>9999?Gs(i,e?"YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]":"YYYYYY-MM-DD[T]HH:mm:ss.SSSZ"):Is(Date.prototype.toISOString)?e?this.toDate().toISOString():new Date(this.valueOf()+60*this.utcOffset()*1e3).toISOString().replace("Z",Gs(i,"Z")):Gs(i,e?"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]":"YYYY-MM-DD[T]HH:mm:ss.SSSZ")},mh.inspect=function(){if(!this.isValid())return"moment.invalid(/* "+this._i+" */)";var t="moment",e="";this.isLocal()||(t=0===this.utcOffset()?"moment.utc":"moment.parseZone",e="Z");var i="["+t+'("]',n=0<=this.year()&&this.year()<=9999?"YYYY":"YYYYYY",a=e+'[")]';return this.format(i+n+"-MM-DD[T]HH:mm:ss.SSS"+a)},mh.toJSON=function(){return this.isValid()?this.toISOString():null},mh.toString=function(){return this.clone().locale("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")},mh.unix=function(){return Math.floor(this.valueOf()/1e3)},mh.valueOf=function(){return this._d.valueOf()-6e4*(this._offset||0)},mh.creationData=function(){return{input:this._i,format:this._f,locale:this._locale,isUTC:this._isUTC,strict:this._strict}},mh.year=Tr,mh.isLeapYear=function(){return Lr(this.year())},mh.weekYear=function(t){return lh.call(this,t,this.week(),this.weekday(),this.localeData()._week.dow,this.localeData()._week.doy)},mh.isoWeekYear=function(t){return lh.call(this,t,this.isoWeek(),this.isoWeekday(),1,4)},mh.quarter=mh.quarters=function(t){return null==t?Math.ceil((this.month()+1)/3):this.month(3*(t-1)+this.month()%3)},mh.month=Yr,mh.daysInMonth=function(){return Rr(this.year(),this.month())},mh.week=mh.weeks=function(t){var e=this.localeData().week(this);return null==t?e:this.add(7*(t-e),"d")},mh.isoWeek=mh.isoWeeks=function(t){var e=Gr(this,1,4).week;return null==t?e:this.add(7*(t-e),"d")},mh.weeksInYear=function(){var t=this.localeData()._week;return Qr(this.year(),t.dow,t.doy)},mh.isoWeeksInYear=function(){return Qr(this.year(),1,4)},mh.date=hh,mh.day=mh.days=function(t){if(!this.isValid())return null!=t?this:NaN;var e=this._isUTC?this._d.getUTCDay():this._d.getDay();return null!=t?(t=function(t,e){return"string"!=typeof t?t:isNaN(t)?"number"==typeof(t=e.weekdaysParse(t))?t:null:parseInt(t,10)}(t,this.localeData()),this.add(t-e,"d")):e},mh.weekday=function(t){if(!this.isValid())return null!=t?this:NaN;var e=(this.day()+7-this.localeData()._week.dow)%7;return null==t?e:this.add(t-e,"d")},mh.isoWeekday=function(t){if(!this.isValid())return null!=t?this:NaN;if(null!=t){var e=function(t,e){return"string"==typeof t?e.weekdaysParse(t)%7||7:isNaN(t)?null:t}(t,this.localeData());return this.day(this.day()%7?e:e-7)}return this.day()||7},mh.dayOfYear=function(t){var e=Math.round((this.clone().startOf("day")-this.clone().startOf("year"))/864e5)+1;return null==t?e:this.add(t-e,"d")},mh.hour=mh.hours=ll,mh.minute=mh.minutes=ch,mh.second=mh.seconds=ph,mh.millisecond=mh.milliseconds=Ah,mh.utcOffset=function(t,e,i){var n,a=this._offset||0;if(!this.isValid())return null!=t?this:NaN;if(null!=t){if("string"==typeof t){if(null===(t=jl(dr,t)))return this}else Math.abs(t)<16&&!i&&(t*=60);return!this._isUTC&&e&&(n=Ul(this)),this._offset=t,this._isUTC=!0,null!=n&&this.add(n,"m"),a!==t&&(!e||this._changeInProgress?th(this,Ql(t-a,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,ls.updateOffset(this,!0),this._changeInProgress=null)),this}return this._isUTC?a:Ul(this)},mh.utc=function(t){return this.utcOffset(0,t)},mh.local=function(t){return this._isUTC&&(this.utcOffset(0,t),this._isUTC=!1,t&&this.subtract(Ul(this),"m")),this},mh.parseZone=function(){if(null!=this._tzm)this.utcOffset(this._tzm,!1,!0);else if("string"==typeof this._i){var t=jl(cr,this._i);null!=t?this.utcOffset(t):this.utcOffset(0,!0)}return this},mh.hasAlignedHourOffset=function(t){return!!this.isValid()&&(t=t?Il(t).utcOffset():0,(this.utcOffset()-t)%60==0)},mh.isDST=function(){return this.utcOffset()>this.clone().month(0).utcOffset()||this.utcOffset()>this.clone().month(5).utcOffset()},mh.isLocal=function(){return!!this.isValid()&&!this._isUTC},mh.isUtcOffset=function(){return!!this.isValid()&&this._isUTC},mh.isUtc=Wl,mh.isUTC=Wl,mh.zoneAbbr=function(){return this._isUTC?"UTC":""},mh.zoneName=function(){return this._isUTC?"Coordinated Universal Time":""},mh.dates=Vs("dates accessor is deprecated. Use date instead.",hh),mh.months=Vs("months accessor is deprecated. Use month instead",Yr),mh.years=Vs("years accessor is deprecated. Use year instead",Tr),mh.zone=Vs("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/",function(t,e){return null!=t?("string"!=typeof t&&(t=-t),this.utcOffset(t,e),this):-this.utcOffset()}),mh.isDSTShifted=Vs("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information",function(){if(!ds(this._isDSTShifted))return this._isDSTShifted;var t={};if(zs(t,this),(t=El(t))._a){var e=t._isUTC?gs(t._a):Il(t._a);this._isDSTShifted=this.isValid()&&Hs(t._a,e.toArray())>0}else this._isDSTShifted=!1;return this._isDSTShifted});var gh=Os.prototype;function vh(t,e,i,n){var a=fl(),o=gs().set(n,e);return a[i](o,t)}function _h(t,e,i){if(ps(t)&&(e=t,t=void 0),t=t||"",null!=e)return vh(t,e,i,"month");var n,a=[];for(n=0;n<12;n++)a[n]=vh(t,n,i,"month");return a}function yh(t,e,i,n){"boolean"==typeof t?(ps(e)&&(i=e,e=void 0),e=e||""):(i=e=t,t=!1,ps(e)&&(i=e,e=void 0),e=e||"");var a,o=fl(),s=t?o._week.dow:0;if(null!=i)return vh(e,(i+s)%7,n,"day");var r=[];for(a=0;a<7;a++)r[a]=vh(e,(a+s)%7,n,"day");return r}gh.calendar=function(t,e,i){var n=this._calendar[t]||this._calendar.sameElse;return Is(n)?n.call(e,i):n},gh.longDateFormat=function(t){var e=this._longDateFormat[t],i=this._longDateFormat[t.toUpperCase()];return e||!i?e:(this._longDateFormat[t]=i.replace(/MMMM|MM|DD|dddd/g,function(t){return t.slice(1)}),this._longDateFormat[t])},gh.invalidDate=function(){return this._invalidDate},gh.ordinal=function(t){return this._ordinal.replace("%d",t)},gh.preparse=fh,gh.postformat=fh,gh.relativeTime=function(t,e,i,n){var a=this._relativeTime[i];return Is(a)?a(t,e,i,n):a.replace(/%d/i,t)},gh.pastFuture=function(t,e){var i=this._relativeTime[t>0?"future":"past"];return Is(i)?i(e):i.replace(/%s/i,e)},gh.set=function(t){var e,i;for(i in t)Is(e=t[i])?this[i]=e:this["_"+i]=e;this._config=t,this._dayOfMonthOrdinalParseLenient=new RegExp((this._dayOfMonthOrdinalParse.source||this._ordinalParse.source)+"|"+/\d{1,2}/.source)},gh.months=function(t,e){return t?hs(this._months)?this._months[t.month()]:this._months[(this._months.isFormat||Nr).test(e)?"format":"standalone"][t.month()]:hs(this._months)?this._months:this._months.standalone},gh.monthsShort=function(t,e){return t?hs(this._monthsShort)?this._monthsShort[t.month()]:this._monthsShort[Nr.test(e)?"format":"standalone"][t.month()]:hs(this._monthsShort)?this._monthsShort:this._monthsShort.standalone},gh.monthsParse=function(t,e,i){var n,a,o;if(this._monthsParseExact)return function(t,e,i){var n,a,o,s=t.toLocaleLowerCase();if(!this._monthsParse)for(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[],n=0;n<12;++n)o=gs([2e3,n]),this._shortMonthsParse[n]=this.monthsShort(o,"").toLocaleLowerCase(),this._longMonthsParse[n]=this.months(o,"").toLocaleLowerCase();return i?"MMM"===e?-1!==(a=Er.call(this._shortMonthsParse,s))?a:null:-1!==(a=Er.call(this._longMonthsParse,s))?a:null:"MMM"===e?-1!==(a=Er.call(this._shortMonthsParse,s))?a:-1!==(a=Er.call(this._longMonthsParse,s))?a:null:-1!==(a=Er.call(this._longMonthsParse,s))?a:-1!==(a=Er.call(this._shortMonthsParse,s))?a:null}.call(this,t,e,i);for(this._monthsParse||(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[]),n=0;n<12;n++){if(a=gs([2e3,n]),i&&!this._longMonthsParse[n]&&(this._longMonthsParse[n]=new RegExp("^"+this.months(a,"").replace(".","")+"$","i"),this._shortMonthsParse[n]=new RegExp("^"+this.monthsShort(a,"").replace(".","")+"$","i")),i||this._monthsParse[n]||(o="^"+this.months(a,"")+"|^"+this.monthsShort(a,""),this._monthsParse[n]=new RegExp(o.replace(".",""),"i")),i&&"MMMM"===e&&this._longMonthsParse[n].test(t))return n;if(i&&"MMM"===e&&this._shortMonthsParse[n].test(t))return n;if(!i&&this._monthsParse[n].test(t))return n}},gh.monthsRegex=function(t){return this._monthsParseExact?(ms(this,"_monthsRegex")||qr.call(this),t?this._monthsStrictRegex:this._monthsRegex):(ms(this,"_monthsRegex")||(this._monthsRegex=jr),this._monthsStrictRegex&&t?this._monthsStrictRegex:this._monthsRegex)},gh.monthsShortRegex=function(t){return this._monthsParseExact?(ms(this,"_monthsRegex")||qr.call(this),t?this._monthsShortStrictRegex:this._monthsShortRegex):(ms(this,"_monthsShortRegex")||(this._monthsShortRegex=$r),this._monthsShortStrictRegex&&t?this._monthsShortStrictRegex:this._monthsShortRegex)},gh.week=function(t){return Gr(t,this._week.dow,this._week.doy).week},gh.firstDayOfYear=function(){return this._week.doy},gh.firstDayOfWeek=function(){return this._week.dow},gh.weekdays=function(t,e){return t?hs(this._weekdays)?this._weekdays[t.day()]:this._weekdays[this._weekdays.isFormat.test(e)?"format":"standalone"][t.day()]:hs(this._weekdays)?this._weekdays:this._weekdays.standalone},gh.weekdaysMin=function(t){return t?this._weekdaysMin[t.day()]:this._weekdaysMin},gh.weekdaysShort=function(t){return t?this._weekdaysShort[t.day()]:this._weekdaysShort},gh.weekdaysParse=function(t,e,i){var n,a,o;if(this._weekdaysParseExact)return function(t,e,i){var n,a,o,s=t.toLocaleLowerCase();if(!this._weekdaysParse)for(this._weekdaysParse=[],this._shortWeekdaysParse=[],this._minWeekdaysParse=[],n=0;n<7;++n)o=gs([2e3,1]).day(n),this._minWeekdaysParse[n]=this.weekdaysMin(o,"").toLocaleLowerCase(),this._shortWeekdaysParse[n]=this.weekdaysShort(o,"").toLocaleLowerCase(),this._weekdaysParse[n]=this.weekdays(o,"").toLocaleLowerCase();return i?"dddd"===e?-1!==(a=Er.call(this._weekdaysParse,s))?a:null:"ddd"===e?-1!==(a=Er.call(this._shortWeekdaysParse,s))?a:null:-1!==(a=Er.call(this._minWeekdaysParse,s))?a:null:"dddd"===e?-1!==(a=Er.call(this._weekdaysParse,s))?a:-1!==(a=Er.call(this._shortWeekdaysParse,s))?a:-1!==(a=Er.call(this._minWeekdaysParse,s))?a:null:"ddd"===e?-1!==(a=Er.call(this._shortWeekdaysParse,s))?a:-1!==(a=Er.call(this._weekdaysParse,s))?a:-1!==(a=Er.call(this._minWeekdaysParse,s))?a:null:-1!==(a=Er.call(this._minWeekdaysParse,s))?a:-1!==(a=Er.call(this._weekdaysParse,s))?a:-1!==(a=Er.call(this._shortWeekdaysParse,s))?a:null}.call(this,t,e,i);for(this._weekdaysParse||(this._weekdaysParse=[],this._minWeekdaysParse=[],this._shortWeekdaysParse=[],this._fullWeekdaysParse=[]),n=0;n<7;n++){if(a=gs([2e3,1]).day(n),i&&!this._fullWeekdaysParse[n]&&(this._fullWeekdaysParse[n]=new RegExp("^"+this.weekdays(a,"").replace(".","\\.?")+"$","i"),this._shortWeekdaysParse[n]=new RegExp("^"+this.weekdaysShort(a,"").replace(".","\\.?")+"$","i"),this._minWeekdaysParse[n]=new RegExp("^"+this.weekdaysMin(a,"").replace(".","\\.?")+"$","i")),this._weekdaysParse[n]||(o="^"+this.weekdays(a,"")+"|^"+this.weekdaysShort(a,"")+"|^"+this.weekdaysMin(a,""),this._weekdaysParse[n]=new RegExp(o.replace(".",""),"i")),i&&"dddd"===e&&this._fullWeekdaysParse[n].test(t))return n;if(i&&"ddd"===e&&this._shortWeekdaysParse[n].test(t))return n;if(i&&"dd"===e&&this._minWeekdaysParse[n].test(t))return n;if(!i&&this._weekdaysParse[n].test(t))return n}},gh.weekdaysRegex=function(t){return this._weekdaysParseExact?(ms(this,"_weekdaysRegex")||nl.call(this),t?this._weekdaysStrictRegex:this._weekdaysRegex):(ms(this,"_weekdaysRegex")||(this._weekdaysRegex=tl),this._weekdaysStrictRegex&&t?this._weekdaysStrictRegex:this._weekdaysRegex)},gh.weekdaysShortRegex=function(t){return this._weekdaysParseExact?(ms(this,"_weekdaysRegex")||nl.call(this),t?this._weekdaysShortStrictRegex:this._weekdaysShortRegex):(ms(this,"_weekdaysShortRegex")||(this._weekdaysShortRegex=el),this._weekdaysShortStrictRegex&&t?this._weekdaysShortStrictRegex:this._weekdaysShortRegex)},gh.weekdaysMinRegex=function(t){return this._weekdaysParseExact?(ms(this,"_weekdaysRegex")||nl.call(this),t?this._weekdaysMinStrictRegex:this._weekdaysMinRegex):(ms(this,"_weekdaysMinRegex")||(this._weekdaysMinRegex=il),this._weekdaysMinStrictRegex&&t?this._weekdaysMinStrictRegex:this._weekdaysMinRegex)},gh.isPM=function(t){return"p"===(t+"").toLowerCase().charAt(0)},gh.meridiem=function(t,e,i){return t>11?i?"pm":"PM":i?"am":"AM"},Al("en",{dayOfMonthOrdinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(t){var e=t%10;return t+(1===Cs(t%100/10)?"th":1===e?"st":2===e?"nd":3===e?"rd":"th")}}),ls.lang=Vs("moment.lang is deprecated. Use moment.locale instead.",Al),ls.langData=Vs("moment.langData is deprecated. Use moment.localeData instead.",fl);var bh=Math.abs;function zh(t,e,i,n){var a=Ql(e,i);return t._milliseconds+=n*a._milliseconds,t._days+=n*a._days,t._months+=n*a._months,t._bubble()}function wh(t){return t<0?Math.floor(t):Math.ceil(t)}function xh(t){return 4800*t/146097}function Mh(t){return 146097*t/4800}function Sh(t){return function(){return this.as(t)}}var Ch=Sh("ms"),Hh=Sh("s"),kh=Sh("m"),Vh=Sh("h"),Lh=Sh("d"),Eh=Sh("w"),Th=Sh("M"),Ih=Sh("y");function Ph(t){return function(){return this.isValid()?this._data[t]:NaN}}var Oh=Ph("milliseconds"),Rh=Ph("seconds"),Nh=Ph("minutes"),Dh=Ph("hours"),Fh=Ph("days"),Bh=Ph("months"),Yh=Ph("years");var $h=Math.round,jh={ss:44,s:45,m:45,h:22,d:26,M:11};var qh=Math.abs;function Uh(t){return(t>0)-(t<0)||+t}function Wh(){if(!this.isValid())return this.localeData().invalidDate();var t,e,i=qh(this._milliseconds)/1e3,n=qh(this._days),a=qh(this._months);t=Ss(i/60),e=Ss(t/60),i%=60,t%=60;var o=Ss(a/12),s=a%=12,r=n,l=e,h=t,c=i?i.toFixed(3).replace(/\.?0+$/,""):"",d=this.asSeconds();if(!d)return"P0D";var p=d<0?"-":"",u=Uh(this._months)!==Uh(d)?"-":"",A=Uh(this._days)!==Uh(d)?"-":"",m=Uh(this._milliseconds)!==Uh(d)?"-":"";return p+"P"+(o?u+o+"Y":"")+(s?u+s+"M":"")+(r?A+r+"D":"")+(l||h||c?"T":"")+(l?m+l+"H":"")+(h?m+h+"M":"")+(c?m+c+"S":"")}var Kh=Dl.prototype;Kh.isValid=function(){return this._isValid},Kh.abs=function(){var t=this._data;return this._milliseconds=bh(this._milliseconds),this._days=bh(this._days),this._months=bh(this._months),t.milliseconds=bh(t.milliseconds),t.seconds=bh(t.seconds),t.minutes=bh(t.minutes),t.hours=bh(t.hours),t.months=bh(t.months),t.years=bh(t.years),this},Kh.add=function(t,e){return zh(this,t,e,1)},Kh.subtract=function(t,e){return zh(this,t,e,-1)},Kh.as=function(t){if(!this.isValid())return NaN;var e,i,n=this._milliseconds;if("month"===(t=Ds(t))||"year"===t)return e=this._days+n/864e5,i=this._months+xh(e),"month"===t?i:i/12;switch(e=this._days+Math.round(Mh(this._months)),t){case"week":return e/7+n/6048e5;case"day":return e+n/864e5;case"hour":return 24*e+n/36e5;case"minute":return 1440*e+n/6e4;case"second":return 86400*e+n/1e3;case"millisecond":return Math.floor(864e5*e)+n;default:throw new Error("Unknown unit "+t)}},Kh.asMilliseconds=Ch,Kh.asSeconds=Hh,Kh.asMinutes=kh,Kh.asHours=Vh,Kh.asDays=Lh,Kh.asWeeks=Eh,Kh.asMonths=Th,Kh.asYears=Ih,Kh.valueOf=function(){return this.isValid()?this._milliseconds+864e5*this._days+this._months%12*2592e6+31536e6*Cs(this._months/12):NaN},Kh._bubble=function(){var t,e,i,n,a,o=this._milliseconds,s=this._days,r=this._months,l=this._data;return o>=0&&s>=0&&r>=0||o<=0&&s<=0&&r<=0||(o+=864e5*wh(Mh(r)+s),s=0,r=0),l.milliseconds=o%1e3,t=Ss(o/1e3),l.seconds=t%60,e=Ss(t/60),l.minutes=e%60,i=Ss(e/60),l.hours=i%24,s+=Ss(i/24),r+=a=Ss(xh(s)),s-=wh(Mh(a)),n=Ss(r/12),r%=12,l.days=s,l.months=r,l.years=n,this},Kh.clone=function(){return Ql(this)},Kh.get=function(t){return t=Ds(t),this.isValid()?this[t+"s"]():NaN},Kh.milliseconds=Oh,Kh.seconds=Rh,Kh.minutes=Nh,Kh.hours=Dh,Kh.days=Fh,Kh.weeks=function(){return Ss(this.days()/7)},Kh.months=Bh,Kh.years=Yh,Kh.humanize=function(t){if(!this.isValid())return this.localeData().invalidDate();var e=this.localeData(),i=function(t,e,i){var n=Ql(t).abs(),a=$h(n.as("s")),o=$h(n.as("m")),s=$h(n.as("h")),r=$h(n.as("d")),l=$h(n.as("M")),h=$h(n.as("y")),c=a<=jh.ss&&["s",a]||a<jh.s&&["ss",a]||o<=1&&["m"]||o<jh.m&&["mm",o]||s<=1&&["h"]||s<jh.h&&["hh",s]||r<=1&&["d"]||r<jh.d&&["dd",r]||l<=1&&["M"]||l<jh.M&&["MM",l]||h<=1&&["y"]||["yy",h];return c[2]=e,c[3]=+t>0,c[4]=i,function(t,e,i,n,a){return a.relativeTime(e||1,!!i,t,n)}.apply(null,c)}(this,!t,e);return t&&(i=e.pastFuture(+this,i)),e.postformat(i)},Kh.toISOString=Wh,Kh.toString=Wh,Kh.toJSON=Wh,Kh.locale=ah,Kh.localeData=sh,Kh.toIsoString=Vs("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",Wh),Kh.lang=oh,Ks("X",0,0,"unix"),Ks("x",0,0,"valueOf"),Ar("x",hr),Ar("X",/[+-]?\d+(\.\d{1,3})?/),vr("X",function(t,e,i){i._d=new Date(1e3*parseFloat(t,10))}),vr("x",function(t,e,i){i._d=new Date(Cs(t))}),ls.version="2.22.2",os=Il,ls.fn=mh,ls.min=function(){return Rl("isBefore",[].slice.call(arguments,0))},ls.max=function(){return Rl("isAfter",[].slice.call(arguments,0))},ls.now=function(){return Date.now?Date.now():+new Date},ls.utc=gs,ls.unix=function(t){return Il(1e3*t)},ls.months=function(t,e){return _h(t,e,"months")},ls.isDate=us,ls.locale=Al,ls.invalid=ys,ls.duration=Ql,ls.isMoment=Ms,ls.weekdays=function(t,e,i){return yh(t,e,i,"weekdays")},ls.parseZone=function(){return Il.apply(null,arguments).parseZone()},ls.localeData=fl,ls.isDuration=Fl,ls.monthsShort=function(t,e){return _h(t,e,"monthsShort")},ls.weekdaysMin=function(t,e,i){return yh(t,e,i,"weekdaysMin")},ls.defineLocale=ml,ls.updateLocale=function(t,e){if(null!=e){var i,n,a=hl;null!=(n=ul(t))&&(a=n._config),(i=new Os(e=Ps(a,e))).parentLocale=cl[t],cl[t]=i,Al(t)}else null!=cl[t]&&(null!=cl[t].parentLocale?cl[t]=cl[t].parentLocale:null!=cl[t]&&delete cl[t]);return cl[t]},ls.locales=function(){return Ls(cl)},ls.weekdaysShort=function(t,e,i){return yh(t,e,i,"weekdaysShort")},ls.normalizeUnits=Ds,ls.relativeTimeRounding=function(t){return void 0===t?$h:"function"==typeof t&&($h=t,!0)},ls.relativeTimeThreshold=function(t,e){return void 0!==jh[t]&&(void 0===e?jh[t]:(jh[t]=e,"s"===t&&(jh.ss=e-1),!0))},ls.calendarFormat=function(t,e){var i=t.diff(e,"days",!0);return i<-6?"sameElse":i<-1?"lastWeek":i<0?"lastDay":i<1?"sameDay":i<2?"nextDay":i<7?"nextWeek":"sameElse"},ls.prototype=mh,ls.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"YYYY-[W]WW",MONTH:"YYYY-MM"},ls.defineLocale("zh-tw",{months:"一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),weekdaysShort:"週日_週一_週二_週三_週四_週五_週六".split("_"),weekdaysMin:"日_一_二_三_四_五_六".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日 HH:mm",LLLL:"YYYY年M月D日dddd HH:mm",l:"YYYY/M/D",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日dddd HH:mm"},meridiemParse:/凌晨|早上|上午|中午|下午|晚上/,meridiemHour:function(t,e){return 12===t&&(t=0),"凌晨"===e||"早上"===e||"上午"===e?t:"中午"===e?t>=11?t:t+12:"下午"===e||"晚上"===e?t+12:void 0},meridiem:function(t,e,i){var n=100*t+e;return n<600?"凌晨":n<900?"早上":n<1130?"上午":n<1230?"中午":n<1800?"下午":"晚上"},calendar:{sameDay:"[今天] LT",nextDay:"[明天] LT",nextWeek:"[下]dddd LT",lastDay:"[昨天] LT",lastWeek:"[上]dddd LT",sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}(日|月|週)/,ordinal:function(t,e){switch(e){case"d":case"D":case"DDD":return t+"日";case"M":return t+"月";case"w":case"W":return t+"週";default:return t}},relativeTime:{future:"%s內",past:"%s前",s:"幾秒",ss:"%d 秒",m:"1 分鐘",mm:"%d 分鐘",h:"1 小時",hh:"%d 小時",d:"1 天",dd:"%d 天",M:"1 個月",MM:"%d 個月",y:"1 年",yy:"%d 年"}}),ls.defineLocale("ja",{months:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"日曜日_月曜日_火曜日_水曜日_木曜日_金曜日_土曜日".split("_"),weekdaysShort:"日_月_火_水_木_金_土".split("_"),weekdaysMin:"日_月_火_水_木_金_土".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日 HH:mm",LLLL:"YYYY年M月D日 dddd HH:mm",l:"YYYY/MM/DD",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日(ddd) HH:mm"},meridiemParse:/午前|午後/i,isPM:function(t){return"午後"===t},meridiem:function(t,e,i){return t<12?"午前":"午後"},calendar:{sameDay:"[今日] LT",nextDay:"[明日] LT",nextWeek:function(t){return t.week()<this.week()?"[来週]dddd LT":"dddd LT"},lastDay:"[昨日] LT",lastWeek:function(t){return this.week()<t.week()?"[先週]dddd LT":"dddd LT"},sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}日/,ordinal:function(t,e){switch(e){case"d":case"D":case"DDD":return t+"日";default:return t}},relativeTime:{future:"%s後",past:"%s前",s:"数秒",ss:"%d秒",m:"1分",mm:"%d分",h:"1時間",hh:"%d時間",d:"1日",dd:"%d日",M:"1ヶ月",MM:"%dヶ月",y:"1年",yy:"%d年"}}),ls.locale(window.navigator.userLanguage||window.navigator.language);window.customElements.define("moe-post-header",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
}
...
`}static get properties(){return{boardId:{type:Number},threadNo:{type:Number},no:{type:Number},tripId:{type:String},createdAt:{type:String}}}formatCreatedAt(t){return ls(t).calendar()}fullyFormatCreatedAt(t){return ls(t).toString()}_onPostHeaderNoClick(t){this.dispatchEvent(new CustomEvent("post-header-no-click",{composed:!0,bubbles:!0,detail:{boardId:this.get("boardId"),threadNo:this.get("threadNo"),no:this.get("no")}}))}});window.customElements.define("moe-post-image",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
    max-width: 100%;
...
`}static get properties(){return{imageSrc:{type:String,reflectToAttribute:!0},imageHeight:{type:Number,reflectToAttribute:!0},imageWidth:{type:Number,reflectToAttribute:!0},thumbSrc:{type:String,reflectToAttribute:!0},thumbHeight:{type:Number,reflectToAttribute:!0},thumbWidth:{type:Number,reflectToAttribute:!0},ihoverPadding:{type:Number,value:40}}}_onMouseOver(t){this.$.ihover.style.display="block",this.$.ihover.src=this.imageSrc,this._updateIhoverSize(t),this._updateIhoverPosition(t)}_onMouseOut(t){this.$.ihover.src="",this.$.ihover.style.display="none"}_onMouseMove(t){this._updateIhoverSize(t),this._updateIhoverPosition(t)}_updateIhoverSize(t){const e=this.$.img.getBoundingClientRect(),i=window.document.documentElement;let n,a,o,s;n=i.clientHeight-2*this.ihoverPadding,a=t.clientX<i.clientWidth/2?i.clientWidth-e.right-2*this.ihoverPadding:e.left-2*this.ihoverPadding,this.imageWidth>this.imageHeight?(s=Math.min(a,this.imageWidth),o=this.imageHeight*(s/this.imageWidth)):(o=Math.min(n,this.imageHeight),s=this.imageWidth*(o/this.imageHeight)),this.$.ihover.height=`${o}`,this.$.ihover.width=`${s}`}_updateIhoverPosition(t){const e=window.document.documentElement,i=this.$.ihover;t.clientX>e.clientWidth/2?i.style.left=t.clientX-i.offsetWidth-this.ihoverPadding+"px":i.style.left=t.clientX+this.ihoverPadding+"px";let n=Math.min(Math.max(t.clientY-i.offsetHeight/2,0),e.clientHeight-i.offsetHeight);i.style.top=n+"px"}});const Gh=jt`
...
`}static get properties(){return{boardId:{type:Number},threadNo:{type:Number},no:{type:Number},action:{type:String},text:{type:String},icon:{type:String},flagAdminThreadStop:{type:Boolean,value:!1}}}_onClick(t){this.blur()}});window.customElements.define("moe-rate",class extends qt{static get template(){return jt`
      <style>
        :host {
          display: block;
...
`,is:"paper-input-char-counter",behaviors:[qc],properties:{_charCounterStr:{type:String,value:"0"}},update:function(t){if(t.inputElement){t.value=t.value||"";var e=t.value.toString().length.toString();t.inputElement.hasAttribute("maxlength")&&(e+="/"+t.inputElement.getAttribute("maxlength")),this._charCounterStr=e}}});const Uc=jt`
<custom-style>
  <style is="custom-style">
    html {
...
`;Uc.setAttribute("style","display: none;"),document.head.appendChild(Uc.content),Cn({_template:jt`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
`;Zc.setAttribute("strip-whitespace",""),Cn({_template:Zc,is:"paper-spinner",behaviors:[to]});window.customElements.define("moe-file-button",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
}
...
`}static get properties(){return{disabled:{type:Boolean,value:!1},loading:{type:Boolean,value:!1},boardId:{type:Number},threadNo:{type:Number},replyTo:{type:Number},comment:{type:String,notify:!0},commentMaxLength:{type:Number,reflectToAttribute:!0},file:{type:Object},fileSelected:{type:Boolean},fileMaxSize:{type:Number,reflectToAttribute:!0},videoEmbeds:{type:Array,notify:!0},embedRequestServer:{type:String}}}focus(){this.$.comment.focus();const t=this.$.comment.value.length;this.$.comment.inputElement.textarea.setSelectionRange(t,t)}reset(){this.$.comment.value="",this.$.file.cancel(),this.videoEmbeds=[],this.$.videoEmbedInput.cancel()}changed(){return this.videoEmbeds&&this.videoEmbeds.length||this.file||this.comment&&this.comment.length>0}_onButtonSubmitClick(){this.dispatchEvent(new CustomEvent("submit",{detail:{boardId:this.boardId,threadNo:this.threadNo,replyTo:this.replyTo,comment:this.comment,file:this.file,videoEmbeds:this.videoEmbeds}}))}_onButtonCancelClick(){this.dispatchEvent(new CustomEvent("cancel"))}_onCancelImageUploadsClick(t){this.$.file.cancel()}_onFileChange(t){if(t.detail.file)return t.detail.file.size>this.fileMaxSize?(alert(`附圖檔案大小超過 ${this.fileMaxSize/1024/1024} MB`),void this.$.file.cancel()):void(this.$.imageUploadsMessage.textContent=`${t.detail.file.name}`);this.$.imageUploadsMessage.textContent=""}_onVideoEmbedButtonClick(t){this.$.videoEmbedInput.hasAttribute("hidden")?(this.$.videoEmbedInput.removeAttribute("hidden"),this.$.videoEmbedInput.focus()):(this.$.videoEmbedInput.setAttribute("hidden","true"),this.$.videoEmbedInput.reset())}_onVideoEmbedInputSubmit(t){this.$.videoEmbedInput.disabled=!0,this.$.embedRequest.query(t.detail.value).then(t=>{this.$.videoEmbeds.add(t.thumb,t.title,t),this.$.videoEmbedInput.reset()}).catch(t=>{alert(t.message)}).finally(()=>{console.log(t),this.$.videoEmbedInput.disabled=!1})}_onVideoEmbedInputCancel(t){this.$.videoEmbedInput.setAttribute("hidden","true")}_computeVideoEmbedButtonDisabled(t){return t}});window.customElements.define("pixmicat-request",class extends qt{static get template(){return jt`<style>:host{display:none;}</style>
`}static get properties(){return{server:{type:String},method:{type:String},progress:{type:Object,notify:!0},request:{type:Object,value:null}}}inFlight(){return this.request&&4!==this.request.readyState}makeThread(t,e,i,n,a=null,o=null,s="",r="",l=""){if(this.inFlight())return Promise.reject("Request in progress");const h=this._makeRegistFormData(t,null,e,i,n,o,s,r,l);return this.$.ajax.generateRequest().send({url:this.server,body:h,withCredentials:!0})}makeReply(t,e,i,n,a=null,o=null,s="",r="",l=""){if(this.inFlight())return Promise.reject("Request in progress");const h=this._makeRegistFormData(t,e,i,n,a,o,s,r,l);return this._sendRequest(h)}_makeRegistFormData(t,e,i,n,a,o,s,r,l){const h=new FormData;return h.append("bvUFbdrIC",l),h.append("ObHGyhdTR",r),h.append("SJBgiFbhj",s),h.append("pOBvrtyJK",i),a&&h.append("upfile",new Blob([a],{type:a.type})),o&&o.length&&o.forEach(t=>{h.append("resid[]",`${t.data.type}:${t.data.res_id}`)}),h.append("mode","regist"),h.append("noimg","on"),h.append("pwd",n),e&&h.append("resto",`${e}`),h.append("email","foo@foo.bar"),h.append("name","spammer"),h.append("sub","DO NOT FIX THIS"),h.append("com","EID OG SMAPS"),h.append("reply",""),h}_sendRequest(t){return new Promise((e,i)=>{this.request=new XMLHttpRequest,this.request.addEventListener("progress",t=>{this.set("progress",{lengthComputable:t.lengthComputable,loaded:t.loaded,total:t.total})}),this.request.addEventListener("readystatechange",t=>{switch(this.request.readyState){case 0:i(new Error("Aborted"));break;case 4:200===this.request.status?e(this.request.response):i(this.request.response)}}),this.request.open("POST",this.server),this.request.setRequestHeader("x-requested-with","pixmicat-request"),this.request.withCredentials=!0,this.request.responseType="json",this.request.send(t)})}});window.customElements.define("moe-board",class extends(Fc(qt)){static get template(){return jt`
<style>
:host {
    display: block;
    font-family: 'Roboto', 'Noto', sans-serif;
