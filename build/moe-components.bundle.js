...
</custom-style>`;oa.setAttribute("style","display: none;"),document.head.appendChild(oa.content);var ra=document.createElement("style");ra.textContent="[hidden] { display: none !important; }",document.head.appendChild(ra),Cn({_template:jt`
    <style>
      :host {
        position: fixed;
        top: -120px;
...
`,is:"app-header-layout",behaviors:[ha],properties:{hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0}},observers:["resetLayout(isAttached, hasScrollingRegion)"],get header(){return bn(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function(){var t=this.header;if(this.isAttached&&t){this.$.wrapper.classList.remove("initializing"),t.scrollTarget=this.hasScrollingRegion?this.$.contentContainer:this.ownerDocument.documentElement;var e=t.offsetHeight;this.hasScrollingRegion?(t.style.left="",t.style.right=""):requestAnimationFrame(function(){var e=this.getBoundingClientRect(),i=document.documentElement.clientWidth-e.right;t.style.left=e.left+"px",t.style.right=i+"px"}.bind(this));var i=this.$.contentContainer.style;t.fixed&&!t.condenses&&this.hasScrollingRegion?(i.marginTop=e+"px",i.paddingTop=""):(i.paddingTop=e+"px",i.marginTop="")}}}),Cn({_template:jt`
    ...
    <slot></slot>
`,is:"app-toolbar"}),Cn({_template:jt`
    <style>
      :host {
        position: relative;
        display: block;
...
</iron-iconset-svg>`;document.head.appendChild(ma.content);const fa=jt`<iron-iconset-svg name="image" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(fa.content);const ga=jt`
<custom-style>
  <style is="custom-style">
    html {
...
`;ga.setAttribute("style","display: none;"),document.head.appendChild(ga.content);const va=jt`
<custom-style>
  <style is="custom-style">
    html {
      /*
...
`;Ba.setAttribute("style","display: none;"),document.body.appendChild(Ba.content),Cn({is:"paper-icon-button",hostAttributes:{role:"button",tabindex:"0"},behaviors:[Fa],properties:{src:{type:String},icon:{type:String},alt:{type:String,observer:"_altChanged"}},_altChanged:function(t,e){var i=this.getAttribute("aria-label");i&&e!=i||this.setAttribute("aria-label",t)}});const $a=jt`
<custom-style>
  <style is="custom-style">
    html {
...
</custom-style>`;$a.setAttribute("style","display: none;"),document.head.appendChild($a.content);const Ya=jt`
...
</dom-module>`;Ya.setAttribute("style","display: none;"),document.head.appendChild(Ya.content);const ja={properties:{elevation:{type:Number,reflectToAttribute:!0,readOnly:!0}},observers:["_calculateElevation(focused, disabled, active, pressed, receivedFocusFromKeyboard)","_computeKeyboardClass(receivedFocusFromKeyboard)"],hostAttributes:{role:"button",tabindex:"0",animated:!0},_calculateElevation:function(){var t=1;this.disabled?t=0:this.active||this.pressed?t=4:this.receivedFocusFromKeyboard&&(t=3),this._setElevation(t)},_computeKeyboardClass:function(t){this.toggleClass("keyboard-focus",t)},_spaceKeyDownHandler:function(t){Ea._spaceKeyDownHandler.call(this,t),this.hasRipple()&&this.getRipple().ripples.length<1&&this._ripple.uiDownAction()},_spaceKeyUpHandler:function(t){Ea._spaceKeyUpHandler.call(this,t),this.hasRipple()&&this._ripple.uiUpAction()}},qa=[Ia,_a,Na,ja],Ua=jt`
...
`;if(Ua.setAttribute("strip-whitespace",""),Cn({_template:Ua,is:"paper-fab",behaviors:[qa],properties:{src:{type:String,value:""},icon:{type:String,value:""},mini:{type:Boolean,value:!1,reflectToAttribute:!0},label:{type:String,observer:"_labelChanged"}},_labelChanged:function(){this.setAttribute("aria-label",this.label)},_computeIsIconFab:function(t,e){return t.length>0||e.length>0}}),!window.polymerSkipLoadingFontRoboto){const t=document.createElement("link");t.rel="stylesheet",t.type="text/css",t.crossOrigin="anonymous",t.href="https://fonts.googleapis.com/css?family=Roboto+Mono:400,700|Roboto:400,300,300italic,400italic,500,500italic,700,700italic",document.head.appendChild(t)}const Wa=jt`<custom-style>
  <style is="custom-style">
...
</custom-style>`;Wa.setAttribute("style","display: none;"),document.head.appendChild(Wa.content);const Ga=document.createElement("template");Ga.setAttribute("style","display: none;"),Ga.innerHTML="<dom-module id=\"paper-item-shared-styles\">\n  <template>\n    <style>\n      :host, .paper-item {\n        display: block;\n        position: relative;\n        min-height: var(--paper-item-min-height, 48px);\n        padding: 0px 16px;\n      }\n\n      .paper-item {\n        @apply --paper-font-subhead;\n        border:none;\n        outline: none;\n        background: white;\n        width: 100%;\n        text-align: left;\n      }\n\n      :host([hidden]), .paper-item[hidden] {\n        display: none !important;\n      }\n\n      :host(.iron-selected), .paper-item.iron-selected {\n        font-weight: var(--paper-item-selected-weight, bold);\n\n        @apply --paper-item-selected;\n      }\n\n      :host([disabled]), .paper-item[disabled] {\n        color: var(--paper-item-disabled-color, var(--disabled-text-color));\n\n        @apply --paper-item-disabled;\n      }\n\n      :host(:focus), .paper-item:focus {\n        position: relative;\n        outline: 0;\n\n        @apply --paper-item-focused;\n      }\n\n      :host(:focus):before, .paper-item:focus:before {\n        @apply --layout-fit;\n\n        background: currentColor;\n        content: '';\n        opacity: var(--dark-divider-opacity);\n        pointer-events: none;\n\n        @apply --paper-item-focused-before;\n      }\n    </style>\n  </template>\n</dom-module>",document.head.appendChild(Ga.content);const Ka=[Ia,_a,{hostAttributes:{role:"option",tabindex:"0"}}];Cn({_template:jt`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[Ka]});const Qa=Cn({_template:jt`
    <style>
      :host {
        display: inline-block;
        position: fixed;
...
`;bo.setAttribute("strip-whitespace",""),Cn({_template:bo,is:"paper-spinner-lite",behaviors:[yo]});const zo=jt`
  <style include="paper-material-styles">
  ...
  <slot></slot>`;zo.setAttribute("strip-whitespace",""),Cn({_template:zo,is:"paper-button",behaviors:[qa],properties:{raised:{type:Boolean,reflectToAttribute:!0,value:!1,observer:"_calculateElevation"}},_calculateElevation:function(){this.raised?ja._calculateElevation.apply(this):this._setElevation(0)}});const wo=jt`
<custom-style>
  <style is="custom-style">
    html {
...
`;wo.setAttribute("style","display: none;"),document.head.appendChild(wo.content),Cn({_template:jt`
    <style>
      :host {
        display: inline-block;
        overflow: hidden;
...
`,is:"paper-menu-button",behaviors:[Ta,_a],properties:{opened:{type:Boolean,value:!1,notify:!0,observer:"_openedChanged"},horizontalAlign:{type:String,value:"left",reflectToAttribute:!0},verticalAlign:{type:String,value:"top",reflectToAttribute:!0},dynamicAlign:{type:Boolean},horizontalOffset:{type:Number,value:0,notify:!0},verticalOffset:{type:Number,value:0,notify:!0},noOverlap:{type:Boolean},noAnimations:{type:Boolean,value:!1},ignoreSelect:{type:Boolean,value:!1},closeOnActivate:{type:Boolean,value:!1},openAnimationConfig:{type:Object,value:function(){return[{name:"fade-in-animation",timing:{delay:100,duration:200}},{name:"paper-menu-grow-width-animation",timing:{delay:100,duration:150,easing:So.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-grow-height-animation",timing:{delay:100,duration:275,easing:So.ANIMATION_CUBIC_BEZIER}}]}},closeAnimationConfig:{type:Object,value:function(){return[{name:"fade-out-animation",timing:{duration:150}},{name:"paper-menu-shrink-width-animation",timing:{delay:100,duration:50,easing:So.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-shrink-height-animation",timing:{duration:200,easing:"ease-in"}}]}},allowOutsideScroll:{type:Boolean,value:!1},restoreFocusOnClose:{type:Boolean,value:!0},_dropdownContent:{type:Object}},hostAttributes:{role:"group","aria-haspopup":"true"},listeners:{"iron-activate":"_onIronActivate","iron-select":"_onIronSelect"},get contentElement(){for(var t=bn(this.$.content).getDistributedNodes(),e=0,i=t.length;e<i;e++)if(t[e].nodeType===Node.ELEMENT_NODE)return t[e]},toggle:function(){this.opened?this.close():this.open()},open:function(){this.disabled||this.$.dropdown.open()},close:function(){this.$.dropdown.close()},_onIronSelect:function(t){this.ignoreSelect||this.close()},_onIronActivate:function(t){this.closeOnActivate&&this.close()},_openedChanged:function(t,e){t?(this._dropdownContent=this.contentElement,this.fire("paper-dropdown-open")):null!=e&&this.fire("paper-dropdown-close")},_disabledChanged:function(t){_a._disabledChanged.apply(this,arguments),t&&this.opened&&this.close()},__onIronOverlayCanceled:function(t){var e=t.detail,i=this.$.trigger;bn(e).path.indexOf(i)>-1&&t.preventDefault()}});Object.keys(So).forEach(function(t){Co[t]=So[t]});const ko={properties:{multi:{type:Boolean,value:!1,observer:"multiChanged"},selectedValues:{type:Array,notify:!0,value:function(){return[]}},selectedItems:{type:Array,readOnly:!0,notify:!0,value:function(){return[]}}},observers:["_updateSelected(selectedValues.splices)"],select:function(t){this.multi?this._toggleSelected(t):this.selected=t},multiChanged:function(t){this._selection.multi=t,this._updateSelected()},get _shouldUpdateSelection(){return null!=this.selected||null!=this.selectedValues&&this.selectedValues.length},_updateAttrForSelected:function(){this.multi?this.selectedItems&&this.selectedItems.length>0&&(this.selectedValues=this.selectedItems.map(function(t){return this._indexToValue(this.indexOf(t))},this).filter(function(t){return null!=t},this)):vo._updateAttrForSelected.apply(this)},_updateSelected:function(){this.multi?this._selectMulti(this.selectedValues):this._selectSelected(this.selected)},_selectMulti:function(t){t=t||[];var e=(this._valuesToItems(t)||[]).filter(function(t){return null!=t});this._selection.clear(e);for(var i=0;i<e.length;i++)this._selection.setItemSelected(e[i],!0);this.fallbackSelection&&!this._selection.get().length&&(this._valueToItem(this.fallbackSelection)&&this.select(this.fallbackSelection))},_selectionChange:function(){var t=this._selection.get();this.multi?(this._setSelectedItems(t),this._setSelectedItem(t.length?t[0]:null)):null!=t?(this._setSelectedItems([t]),this._setSelectedItem(t)):(this._setSelectedItems([]),this._setSelectedItem(null))},_toggleSelected:function(t){var e=this.selectedValues.indexOf(t);e<0?this.push("selectedValues",t):this.splice("selectedValues",e,1)},_valuesToItems:function(t){return null==t?null:t.map(function(t){return this._valueToItem(t)},this)}},Ho=[vo,ko],Vo={properties:{focusedItem:{observer:"_focusedItemChanged",readOnly:!0,type:Object},attrForItemTitle:{type:String},disabled:{type:Boolean,value:!1,observer:"_disabledChanged"}},_MODIFIER_KEYS:["Alt","AltGraph","CapsLock","Control","Fn","FnLock","Hyper","Meta","NumLock","OS","ScrollLock","Shift","Super","Symbol","SymbolLock"],_SEARCH_RESET_TIMEOUT_MS:1e3,_previousTabIndex:0,hostAttributes:{role:"menu"},observers:["_updateMultiselectable(multi)"],listeners:{focus:"_onFocus",keydown:"_onKeydown","iron-items-changed":"_onIronItemsChanged"},keyBindings:{up:"_onUpKey",down:"_onDownKey",esc:"_onEscKey","shift+tab:keydown":"_onShiftTabDown"},attached:function(){this._resetTabindices()},select:function(t){this._defaultFocusAsync&&(this.cancelAsync(this._defaultFocusAsync),this._defaultFocusAsync=null);var e=this._valueToItem(t);e&&e.hasAttribute("disabled")||(this._setFocusedItem(e),ko.select.apply(this,arguments))},_resetTabindices:function(){var t=this.multi?this.selectedItems&&this.selectedItems[0]:this.selectedItem;this.items.forEach(function(e){e.setAttribute("tabindex",e===t?"0":"-1")},this)},_updateMultiselectable:function(t){t?this.setAttribute("aria-multiselectable","true"):this.removeAttribute("aria-multiselectable")},_focusWithKeyboardEvent:function(t){if(-1===this._MODIFIER_KEYS.indexOf(t.key)){this.cancelDebouncer("_clearSearchText");for(var e,i=this._searchText||"",n=(i+=(t.key&&1==t.key.length?t.key:String.fromCharCode(t.keyCode)).toLocaleLowerCase()).length,a=0;e=this.items[a];a++)if(!e.hasAttribute("disabled")){var o=this.attrForItemTitle||"textContent",r=(e[o]||e.getAttribute(o)||"").trim();if(!(r.length<n)&&r.slice(0,n).toLocaleLowerCase()==i){this._setFocusedItem(e);break}}this._searchText=i,this.debounce("_clearSearchText",this._clearSearchText,this._SEARCH_RESET_TIMEOUT_MS)}},_clearSearchText:function(){this._searchText=""},_focusPrevious:function(){for(var t=this.items.length,e=Number(this.indexOf(this.focusedItem)),i=1;i<t+1;i++){var n=this.items[(e-i+t)%t];if(!n.hasAttribute("disabled")){var a=bn(n).getOwnerRoot()||document;if(this._setFocusedItem(n),bn(a).activeElement==n)return}}},_focusNext:function(){for(var t=this.items.length,e=Number(this.indexOf(this.focusedItem)),i=1;i<t+1;i++){var n=this.items[(e+i)%t];if(!n.hasAttribute("disabled")){var a=bn(n).getOwnerRoot()||document;if(this._setFocusedItem(n),bn(a).activeElement==n)return}}},_applySelection:function(t,e){e?t.setAttribute("aria-selected","true"):t.removeAttribute("aria-selected"),vo._applySelection.apply(this,arguments)},_focusedItemChanged:function(t,e){e&&e.setAttribute("tabindex","-1"),!t||t.hasAttribute("disabled")||this.disabled||(t.setAttribute("tabindex","0"),t.focus())},_onIronItemsChanged:function(t){t.detail.addedNodes.length&&this._resetTabindices()},_onShiftTabDown:function(t){var e=this.getAttribute("tabindex");Vo._shiftTabPressed=!0,this._setFocusedItem(null),this.setAttribute("tabindex","-1"),this.async(function(){this.setAttribute("tabindex",e),Vo._shiftTabPressed=!1},1)},_onFocus:function(t){if(!Vo._shiftTabPressed){var e=bn(t).rootTarget;(e===this||void 0===e.tabIndex||this.isLightDescendant(e))&&(this._defaultFocusAsync=this.async(function(){var t=this.multi?this.selectedItems&&this.selectedItems[0]:this.selectedItem;this._setFocusedItem(null),t?this._setFocusedItem(t):this.items[0]&&this._focusNext()}))}},_onUpKey:function(t){this._focusPrevious(),t.detail.keyboardEvent.preventDefault()},_onDownKey:function(t){this._focusNext(),t.detail.keyboardEvent.preventDefault()},_onEscKey:function(t){var e=this.focusedItem;e&&e.blur()},_onKeydown:function(t){this.keyboardEventMatchesKeys(t,"up down esc")||this._focusWithKeyboardEvent(t),t.stopPropagation()},_activateHandler:function(t){vo._activateHandler.call(this,t),t.stopPropagation()},_disabledChanged:function(t){t?(this._previousTabIndex=this.hasAttribute("tabindex")?this.tabIndex:0,this.removeAttribute("tabindex")):this.hasAttribute("tabindex")||this.setAttribute("tabindex",this._previousTabIndex)},_shiftTabPressed:!1};Cn({_template:jt`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[[Ho,Ta,Vo]],hostAttributes:{role:"listbox"}}),Cn({_template:jt`
    ...
    <slot></slot>
`,is:"paper-item",behaviors:[Ka]}),Cn({_template:jt`
    <style>
      :host {
        display: block;
        position: absolute;
...
</iron-iconset-svg>`;document.head.appendChild(Lo.content);const To=jt`<iron-iconset-svg name="communication" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(To.content);var Eo=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),Io=Eo&&Eo[1]>=8,Po=null!=mn,Oo=Po?G:0,Ro=Po?K:1,No=Po?Q:2;ea||(Polymer.OptionalMutableDataBehavior={}),Cn({_template:jt`
    <style>
      :host {
        display: block;
      }
...
</iron-iconset-svg>`;document.head.appendChild(Do.content);window.customElements.define("moe-pixmicat-pushpost",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
    background: white;
...
`}static get properties(){return{}}});const Fo=jt`<iron-iconset-svg name="social" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(Fo.content);window.customElements.define("moe-poll",class extends(Hn(qt)){static get template(){return jt`
<style>
:host {
    min-width: 300px;
    display: table;
...
`}static get properties(){return{text:{type:String}}}});var Bo="object"==typeof global&&global&&global.Object===Object&&global,$o="object"==typeof self&&self&&self.Object===Object&&self,Yo=Bo||$o||Function("return this")(),jo=Yo.Symbol,qo=Object.prototype,Uo=qo.hasOwnProperty,Wo=qo.toString,Go=jo?jo.toStringTag:void 0;var Ko=Object.prototype.toString;var Qo="[object Null]",Zo="[object Undefined]",Xo=jo?jo.toStringTag:void 0;function Jo(t){return null==t?void 0===t?Zo:Qo:Xo&&Xo in Object(t)?function(t){var e=Uo.call(t,Go),i=t[Go];try{t[Go]=void 0}catch(t){}var n=Wo.call(t);return e?t[Go]=i:delete t[Go],n}(t):function(t){return Ko.call(t)}(t)}function tr(t){var e=typeof t;return null!=t&&("object"==e||"function"==e)}var er="[object AsyncFunction]",ir="[object Function]",nr="[object GeneratorFunction]",ar="[object Proxy]";function or(t){if(!tr(t))return!1;var e=Jo(t);return e==ir||e==nr||e==er||e==ar}var rr=9007199254740991;function sr(t){return"number"==typeof t&&t>-1&&t%1==0&&t<=rr}function lr(t){return null!=t&&sr(t.length)&&!or(t)}class hr extends qt{static get template(){return jt`<style>:host{display:none;}</style>
`}static get properties(){return{server:{type:String}}}static errorMessage(t){switch(t){case"VOTED":return"你已經投過了";case"NOT_FOUND":return"投票已被刪除";default:return t}}vote(t,e){return fetch(this.server,{method:"POST",mode:"cors",headers:{"Content-Type":"application/json; charset=utf-8","X-Requested-With":"moe-poll-request"},body:JSON.stringify({poll_no:t,poll_item:e})}).then(t=>t.json()).then(t=>{if(t.error)return Promise.reject(new Error(hr.errorMessage(t.error)));if(!(t.items&&tr(t.items)&&lr(t.items.k)&&lr(t.items.v)))return Promise.reject(new Error("Invalid response"));const e=[];for(let i in t.items.k)e.push({text:t.items.k[i],votes:parseInt(t.items.v[i])});return Promise.resolve(e)})}}window.customElements.define("moe-poll-request",hr);var cr=["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"],dr=["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","audio","canvas","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","video","view","vkern"],pr=["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"],ur=["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmuliscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mpspace","msqrt","mystyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"],Ar=["#text"],mr=["accept","action","align","alt","autocomplete","background","bgcolor","border","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","coords","crossorigin","datetime","default","dir","disabled","download","enctype","face","for","headers","height","hidden","high","href","hreflang","id","integrity","ismap","label","lang","list","loop","low","max","maxlength","media","method","min","multiple","name","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","type","usemap","valign","value","width","xmlns"],fr=["accent-height","accumulate","additivive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","tabindex","targetx","targety","transform","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"],gr=["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"],vr=["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"];function _r(t,e){for(var i=e.length;i--;)"string"==typeof e[i]&&(e[i]=e[i].toLowerCase()),t[e[i]]=!0;return t}function yr(t){var e={},i=void 0;for(i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e}var br=/\{\{[\s\S]*|[\s\S]*\}\}/gm,zr=/<%[\s\S]*|[\s\S]*%>/gm,wr=/^data-[\-\w.\u00B7-\uFFFF]/,xr=/^aria-[\-\w]+$/,Mr=/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i,Sr=/^(?:\w+script|data):/i,Cr=/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,kr="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};function Hr(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}var Vr=function(){return"undefined"==typeof window?null:window};var Lr,Tr,Er=function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Vr(),i=function(e){return t(e)};if(i.version="1.0.8",i.removed=[],!e||!e.document||9!==e.document.nodeType)return i.isSupported=!1,i;var n=e.document,a=!1,o=!1,r=e.document,s=e.DocumentFragment,l=e.HTMLTemplateElement,h=e.Node,c=e.NodeFilter,d=e.NamedNodeMap,p=void 0===d?e.NamedNodeMap||e.MozNamedAttrMap:d,u=e.Text,A=e.Comment,m=e.DOMParser;if("function"==typeof l){var f=r.createElement("template");f.content&&f.content.ownerDocument&&(r=f.content.ownerDocument)}var g=r,v=g.implementation,_=g.createNodeIterator,y=g.getElementsByTagName,b=g.createDocumentFragment,z=n.importNode,w={};i.isSupported=v&&void 0!==v.createHTMLDocument&&9!==r.documentMode;var x=br,M=zr,S=wr,C=xr,k=Sr,H=Cr,V=Mr,L=null,T=_r({},[].concat(Hr(cr),Hr(dr),Hr(pr),Hr(ur),Hr(Ar))),E=null,I=_r({},[].concat(Hr(mr),Hr(fr),Hr(gr),Hr(vr))),P=null,O=null,R=!0,N=!0,D=!1,F=!1,B=!1,$=!1,Y=!1,j=!1,q=!1,U=!1,W=!1,G=!0,K=!0,Q=!1,Z={},X=_r({},["audio","head","math","script","style","template","svg","video"]),J=_r({},["audio","video","img","source","image"]),tt=_r({},["alt","class","for","id","label","name","pattern","placeholder","summary","title","value","style","xmlns"]),et=null,it=r.createElement("form"),nt=function(t){"object"!==(void 0===t?"undefined":kr(t))&&(t={}),L="ALLOWED_TAGS"in t?_r({},t.ALLOWED_TAGS):T,E="ALLOWED_ATTR"in t?_r({},t.ALLOWED_ATTR):I,P="FORBID_TAGS"in t?_r({},t.FORBID_TAGS):{},O="FORBID_ATTR"in t?_r({},t.FORBID_ATTR):{},Z="USE_PROFILES"in t&&t.USE_PROFILES,R=!1!==t.ALLOW_ARIA_ATTR,N=!1!==t.ALLOW_DATA_ATTR,D=t.ALLOW_UNKNOWN_PROTOCOLS||!1,F=t.SAFE_FOR_JQUERY||!1,B=t.SAFE_FOR_TEMPLATES||!1,$=t.WHOLE_DOCUMENT||!1,q=t.RETURN_DOM||!1,U=t.RETURN_DOM_FRAGMENT||!1,W=t.RETURN_DOM_IMPORT||!1,j=t.FORCE_BODY||!1,G=!1!==t.SANITIZE_DOM,K=!1!==t.KEEP_CONTENT,Q=t.IN_PLACE||!1,V=t.ALLOWED_URI_REGEXP||V,B&&(N=!1),U&&(q=!0),Z&&(L=_r({},[].concat(Hr(Ar))),E=[],!0===Z.html&&(_r(L,cr),_r(E,mr)),!0===Z.svg&&(_r(L,dr),_r(E,fr),_r(E,vr)),!0===Z.svgFilters&&(_r(L,pr),_r(E,fr),_r(E,vr)),!0===Z.mathMl&&(_r(L,ur),_r(E,gr),_r(E,vr))),t.ADD_TAGS&&(L===T&&(L=yr(L)),_r(L,t.ADD_TAGS)),t.ADD_ATTR&&(E===I&&(E=yr(E)),_r(E,t.ADD_ATTR)),t.ADD_URI_SAFE_ATTR&&_r(tt,t.ADD_URI_SAFE_ATTR),K&&(L["#text"]=!0),$&&_r(L,["html","head","body"]),L.table&&_r(L,["tbody"]),Object&&"freeze"in Object&&Object.freeze(t),et=t},at=function(t){i.removed.push({element:t});try{t.parentNode.removeChild(t)}catch(e){t.outerHTML=""}},ot=function(t,e){try{i.removed.push({attribute:e.getAttributeNode(t),from:e})}catch(t){i.removed.push({attribute:null,from:e})}e.removeAttribute(t)},rt=function(t){var e=void 0;if(j&&(t="<remove></remove>"+t),a)try{e=(new m).parseFromString(t,"text/html")}catch(t){}if(o&&_r(P,["title"]),!e||!e.documentElement){var i=(e=v.createHTMLDocument("")).body;i.parentNode.removeChild(i.parentNode.firstElementChild),i.outerHTML=t}return y.call(e,$?"html":"body")[0]};i.isSupported&&(function(){try{rt('<svg><p><style><img src="</style><img src=x onerror=alert(1)//">').querySelector("svg img")&&(a=!0)}catch(t){}}(),function(){try{rt("<x/><title>&lt;/title&gt;&lt;img&gt;").querySelector("title").textContent.match(/<\/title/)&&(o=!0)}catch(t){}}());var st=function(t){return _.call(t.ownerDocument||t,t,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT,function(){return c.FILTER_ACCEPT},!1)},lt=function(t){return"object"===(void 0===h?"undefined":kr(h))?t instanceof h:t&&"object"===(void 0===t?"undefined":kr(t))&&"number"==typeof t.nodeType&&"string"==typeof t.nodeName},ht=function(t,e,n){w[t]&&w[t].forEach(function(t){t.call(i,e,n,et)})},ct=function(t){var e,n=void 0;if(ht("beforeSanitizeElements",t,null),!((e=t)instanceof u||e instanceof A||"string"==typeof e.nodeName&&"string"==typeof e.textContent&&"function"==typeof e.removeChild&&e.attributes instanceof p&&"function"==typeof e.removeAttribute&&"function"==typeof e.setAttribute))return at(t),!0;var a=t.nodeName.toLowerCase();if(ht("uponSanitizeElement",t,{tagName:a,allowedTags:L}),!L[a]||P[a]){if(K&&!X[a]&&"function"==typeof t.insertAdjacentHTML)try{t.insertAdjacentHTML("AfterEnd",t.innerHTML)}catch(t){}return at(t),!0}return!F||t.firstElementChild||t.content&&t.content.firstElementChild||!/</g.test(t.textContent)||(i.removed.push({element:t.cloneNode()}),t.innerHTML?t.innerHTML=t.innerHTML.replace(/</g,"&lt;"):t.innerHTML=t.textContent.replace(/</g,"&lt;")),B&&3===t.nodeType&&(n=(n=(n=t.textContent).replace(x," ")).replace(M," "),t.textContent!==n&&(i.removed.push({element:t.cloneNode()}),t.textContent=n)),ht("afterSanitizeElements",t,null),!1},dt=function(t,e,i){if(G&&("id"===e||"name"===e)&&(i in r||i in it))return!1;if(B&&(i=(i=i.replace(x," ")).replace(M," ")),N&&S.test(e));else if(R&&C.test(e));else{if(!E[e]||O[e])return!1;if(tt[e]);else if(V.test(i.replace(H,"")));else if("src"!==e&&"xlink:href"!==e||"script"===t||0!==i.indexOf("data:")||!J[t])if(D&&!k.test(i.replace(H,"")));else if(i)return!1}return!0},pt=function(t){var e=void 0,n=void 0,a=void 0,o=void 0,r=void 0;ht("beforeSanitizeAttributes",t,null);var s=t.attributes;if(s){var l={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:E};for(r=s.length;r--;){var h=e=s[r],c=h.name,d=h.namespaceURI;if(n=e.value.trim(),a=c.toLowerCase(),l.attrName=a,l.attrValue=n,l.keepAttr=!0,ht("uponSanitizeAttribute",t,l),n=l.attrValue,"name"===a&&"IMG"===t.nodeName&&s.id)o=s.id,s=Array.prototype.slice.apply(s),ot("id",t),ot(c,t),s.indexOf(o)>r&&t.setAttribute("id",o.value);else{if("INPUT"===t.nodeName&&"type"===a&&"file"===n&&(E[a]||!O[a]))continue;"id"===c&&t.setAttribute(c,""),ot(c,t)}if(l.keepAttr){var p=t.nodeName.toLowerCase();if(dt(p,a,n))try{d?t.setAttributeNS(d,c,n):t.setAttribute(c,n),i.removed.pop()}catch(t){}}}ht("afterSanitizeAttributes",t,null)}},ut=function t(e){var i=void 0,n=st(e);for(ht("beforeSanitizeShadowDOM",e,null);i=n.nextNode();)ht("uponSanitizeShadowNode",i,null),ct(i)||(i.content instanceof s&&t(i.content),pt(i));ht("afterSanitizeShadowDOM",e,null)};return i.sanitize=function(t,a){var o=void 0,r=void 0,l=void 0,c=void 0,d=void 0;if(t||(t="\x3c!--\x3e"),"string"!=typeof t&&!lt(t)){if("function"!=typeof t.toString)throw new TypeError("toString is not a function");if("string"!=typeof(t=t.toString()))throw new TypeError("dirty is not a string, aborting")}if(!i.isSupported){if("object"===kr(e.toStaticHTML)||"function"==typeof e.toStaticHTML){if("string"==typeof t)return e.toStaticHTML(t);if(lt(t))return e.toStaticHTML(t.outerHTML)}return t}if(Y||nt(a),i.removed=[],Q);else if(t instanceof h)1===(r=(o=rt("\x3c!--\x3e")).ownerDocument.importNode(t,!0)).nodeType&&"BODY"===r.nodeName?o=r:o.appendChild(r);else{if(!q&&!$&&-1===t.indexOf("<"))return t;if(!(o=rt(t)))return q?null:""}o&&j&&at(o.firstChild);for(var p=st(Q?t:o);l=p.nextNode();)3===l.nodeType&&l===c||ct(l)||(l.content instanceof s&&ut(l.content),pt(l),c=l);if(Q)return t;if(q){if(U)for(d=b.call(o.ownerDocument);o.firstChild;)d.appendChild(o.firstChild);else d=o;return W&&(d=z.call(n,d,!0)),d}return $?o.outerHTML:o.innerHTML},i.setConfig=function(t){nt(t),Y=!0},i.clearConfig=function(){et=null,Y=!1},i.isValidAttribute=function(t,e,i){et||nt({});var n=t.toLowerCase(),a=e.toLowerCase();return dt(n,a,i)},i.addHook=function(t,e){"function"==typeof e&&(w[t]=w[t]||[],w[t].push(e))},i.removeHook=function(t){w[t]&&w[t].pop()},i.removeHooks=function(t){w[t]&&(w[t]=[])},i.removeAllHooks=function(){w={}},i}();window.customElements.define("moe-quote-link",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline;
...
`}static get properties(){return{no:{type:Number}}}_onClick(t){this.dispatchEvent(new CustomEvent("quoteLinkClick",{bubbles:!0,composed:!0,detail:{no:this.no}}))}});function Ir(){return Lr.apply(null,arguments)}function Pr(t){return t instanceof Array||"[object Array]"===Object.prototype.toString.call(t)}function Or(t){return null!=t&&"[object Object]"===Object.prototype.toString.call(t)}function Rr(t){return void 0===t}function Nr(t){return"number"==typeof t||"[object Number]"===Object.prototype.toString.call(t)}function Dr(t){return t instanceof Date||"[object Date]"===Object.prototype.toString.call(t)}function Fr(t,e){var i,n=[];for(i=0;i<t.length;++i)n.push(e(t[i],i));return n}function Br(t,e){return Object.prototype.hasOwnProperty.call(t,e)}function $r(t,e){for(var i in e)Br(e,i)&&(t[i]=e[i]);return Br(e,"toString")&&(t.toString=e.toString),Br(e,"valueOf")&&(t.valueOf=e.valueOf),t}function Yr(t,e,i,n){return oh(t,e,i,n,!0).utc()}function jr(t){return null==t._pf&&(t._pf={empty:!1,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:!1,invalidMonth:null,invalidFormat:!1,userInvalidated:!1,iso:!1,parsedDateParts:[],meridiem:null,rfc2822:!1,weekdayMismatch:!1}),t._pf}function qr(t){if(null==t._isValid){var e=jr(t),i=Tr.call(e.parsedDateParts,function(t){return null!=t}),n=!isNaN(t._d.getTime())&&e.overflow<0&&!e.empty&&!e.invalidMonth&&!e.invalidWeekday&&!e.weekdayMismatch&&!e.nullInput&&!e.invalidFormat&&!e.userInvalidated&&(!e.meridiem||e.meridiem&&i);if(t._strict&&(n=n&&0===e.charsLeftOver&&0===e.unusedTokens.length&&void 0===e.bigHour),null!=Object.isFrozen&&Object.isFrozen(t))return n;t._isValid=n}return t._isValid}function Ur(t){var e=Yr(NaN);return null!=t?$r(jr(e),t):jr(e).userInvalidated=!0,e}window.customElements.define("moe-post-comment",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
    height: auto;
...
`}static get properties(){return{comment:{type:String,observer:"_observeComment"}}}_observeComment(t){if(!t)return;let e=t;e=this._linkQuotes(e),e=this._highlightQuotes(e),e=this._modPushpost(e),this.$.content.innerHTML=Er.sanitize(e,{ALLOWED_TAGS:["br","code","pre","span","div","moe-quote-link"]}),this.$.content.querySelectorAll("img").forEach(t=>{t.addEventListener("load",()=>{this.dispatchEvent(new CustomEvent("processed"))})}),setTimeout(()=>this.dispatchEvent(new CustomEvent("processed")),0)}_highlightQuotes(t){return t.replace(/(^|<br(?: \/)?>)((?:&gt;|＞).*?)(?=<br(?: \/)?>|$)/gm,'$1<span class="highlight-quote">$2</span>')}_linkQuotes(t){return t.replace(/((?:&gt;|＞)+)(?:No\.)?(\d+)/i,'<moe-quote-link no="$2">No.$2</moe-quote-link>')}_modPushpost(t){const e=/\[MOD_PUSHPOST_USE\]<br(?: \/)?>([\w\W]+$)/gm,i=e.exec(t);return i?(this.$.pushpost.innerHTML=i[1],this.$.pushpost.style.display="block"):(this.$.pushpost.innerHTML="",this.$.pushpost.style.display="none"),t.replace(e,"")}}),Tr=Array.prototype.some?Array.prototype.some:function(t){for(var e=Object(this),i=e.length>>>0,n=0;n<i;n++)if(n in e&&t.call(this,e[n],n,e))return!0;return!1};var Wr=Ir.momentProperties=[];function Gr(t,e){var i,n,a;if(Rr(e._isAMomentObject)||(t._isAMomentObject=e._isAMomentObject),Rr(e._i)||(t._i=e._i),Rr(e._f)||(t._f=e._f),Rr(e._l)||(t._l=e._l),Rr(e._strict)||(t._strict=e._strict),Rr(e._tzm)||(t._tzm=e._tzm),Rr(e._isUTC)||(t._isUTC=e._isUTC),Rr(e._offset)||(t._offset=e._offset),Rr(e._pf)||(t._pf=jr(e)),Rr(e._locale)||(t._locale=e._locale),Wr.length>0)for(i=0;i<Wr.length;i++)Rr(a=e[n=Wr[i]])||(t[n]=a);return t}var Kr=!1;function Qr(t){Gr(this,t),this._d=new Date(null!=t._d?t._d.getTime():NaN),this.isValid()||(this._d=new Date(NaN)),!1===Kr&&(Kr=!0,Ir.updateOffset(this),Kr=!1)}function Zr(t){return t instanceof Qr||null!=t&&null!=t._isAMomentObject}function Xr(t){return t<0?Math.ceil(t)||0:Math.floor(t)}function Jr(t){var e=+t,i=0;return 0!==e&&isFinite(e)&&(i=Xr(e)),i}function ts(t,e,i){var n,a=Math.min(t.length,e.length),o=Math.abs(t.length-e.length),r=0;for(n=0;n<a;n++)(i&&t[n]!==e[n]||!i&&Jr(t[n])!==Jr(e[n]))&&r++;return r+o}function es(t){!1===Ir.suppressDeprecationWarnings&&"undefined"!=typeof console&&console.warn&&console.warn("Deprecation warning: "+t)}function is(t,e){var i=!0;return $r(function(){if(null!=Ir.deprecationHandler&&Ir.deprecationHandler(null,t),i){for(var n,a=[],o=0;o<arguments.length;o++){if(n="","object"==typeof arguments[o]){for(var r in n+="\n["+o+"] ",arguments[0])n+=r+": "+arguments[0][r]+", ";n=n.slice(0,-2)}else n=arguments[o];a.push(n)}es(t+"\nArguments: "+Array.prototype.slice.call(a).join("")+"\n"+(new Error).stack),i=!1}return e.apply(this,arguments)},e)}var ns,as={};function os(t,e){null!=Ir.deprecationHandler&&Ir.deprecationHandler(t,e),as[t]||(es(e),as[t]=!0)}function rs(t){return t instanceof Function||"[object Function]"===Object.prototype.toString.call(t)}function ss(t,e){var i,n=$r({},t);for(i in e)Br(e,i)&&(Or(t[i])&&Or(e[i])?(n[i]={},$r(n[i],t[i]),$r(n[i],e[i])):null!=e[i]?n[i]=e[i]:delete n[i]);for(i in t)Br(t,i)&&!Br(e,i)&&Or(t[i])&&(n[i]=$r({},n[i]));return n}function ls(t){null!=t&&this.set(t)}Ir.suppressDeprecationWarnings=!1,Ir.deprecationHandler=null,ns=Object.keys?Object.keys:function(t){var e,i=[];for(e in t)Br(t,e)&&i.push(e);return i};var hs={};function cs(t,e){var i=t.toLowerCase();hs[i]=hs[i+"s"]=hs[e]=t}function ds(t){return"string"==typeof t?hs[t]||hs[t.toLowerCase()]:void 0}function ps(t){var e,i,n={};for(i in t)Br(t,i)&&(e=ds(i))&&(n[e]=t[i]);return n}var us={};function As(t,e){us[t]=e}function ms(t,e,i){var n=""+Math.abs(t),a=e-n.length;return(t>=0?i?"+":"":"-")+Math.pow(10,Math.max(0,a)).toString().substr(1)+n}var fs=/(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,gs=/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,vs={},_s={};function ys(t,e,i,n){var a=n;"string"==typeof n&&(a=function(){return this[n]()}),t&&(_s[t]=a),e&&(_s[e[0]]=function(){return ms(a.apply(this,arguments),e[1],e[2])}),i&&(_s[i]=function(){return this.localeData().ordinal(a.apply(this,arguments),t)})}function bs(t,e){return t.isValid()?(e=zs(e,t.localeData()),vs[e]=vs[e]||function(t){var e,i,n,a=t.match(fs);for(e=0,i=a.length;e<i;e++)_s[a[e]]?a[e]=_s[a[e]]:a[e]=(n=a[e]).match(/\[[\s\S]/)?n.replace(/^\[|\]$/g,""):n.replace(/\\/g,"");return function(e){var n,o="";for(n=0;n<i;n++)o+=rs(a[n])?a[n].call(e,t):a[n];return o}}(e),vs[e](t)):t.localeData().invalidDate()}function zs(t,e){var i=5;function n(t){return e.longDateFormat(t)||t}for(gs.lastIndex=0;i>=0&&gs.test(t);)t=t.replace(gs,n),gs.lastIndex=0,i-=1;return t}var ws=/\d/,xs=/\d\d/,Ms=/\d{3}/,Ss=/\d{4}/,Cs=/[+-]?\d{6}/,ks=/\d\d?/,Hs=/\d\d\d\d?/,Vs=/\d\d\d\d\d\d?/,Ls=/\d{1,3}/,Ts=/\d{1,4}/,Es=/[+-]?\d{1,6}/,Is=/\d+/,Ps=/[+-]?\d+/,Os=/Z|[+-]\d\d:?\d\d/gi,Rs=/Z|[+-]\d\d(?::?\d\d)?/gi,Ns=/[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i,Ds={};function Fs(t,e,i){Ds[t]=rs(e)?e:function(t,n){return t&&i?i:e}}function Bs(t,e){return Br(Ds,t)?Ds[t](e._strict,e._locale):new RegExp($s(t.replace("\\","").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(t,e,i,n,a){return e||i||n||a})))}function $s(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}var Ys={};function js(t,e){var i,n=e;for("string"==typeof t&&(t=[t]),Nr(e)&&(n=function(t,i){i[e]=Jr(t)}),i=0;i<t.length;i++)Ys[t[i]]=n}function qs(t,e){js(t,function(t,i,n,a){n._w=n._w||{},e(t,n._w,n,a)})}function Us(t,e,i){null!=e&&Br(Ys,t)&&Ys[t](e,i._a,i,t)}var Ws=0,Gs=1,Ks=2,Qs=3,Zs=4,Xs=5,Js=6,tl=7,el=8;function il(t){return nl(t)?366:365}function nl(t){return t%4==0&&t%100!=0||t%400==0}ys("Y",0,0,function(){var t=this.year();return t<=9999?""+t:"+"+t}),ys(0,["YY",2],0,function(){return this.year()%100}),ys(0,["YYYY",4],0,"year"),ys(0,["YYYYY",5],0,"year"),ys(0,["YYYYYY",6,!0],0,"year"),cs("year","y"),As("year",1),Fs("Y",Ps),Fs("YY",ks,xs),Fs("YYYY",Ts,Ss),Fs("YYYYY",Es,Cs),Fs("YYYYYY",Es,Cs),js(["YYYYY","YYYYYY"],Ws),js("YYYY",function(t,e){e[Ws]=2===t.length?Ir.parseTwoDigitYear(t):Jr(t)}),js("YY",function(t,e){e[Ws]=Ir.parseTwoDigitYear(t)}),js("Y",function(t,e){e[Ws]=parseInt(t,10)}),Ir.parseTwoDigitYear=function(t){return Jr(t)+(Jr(t)>68?1900:2e3)};var al,ol=rl("FullYear",!0);function rl(t,e){return function(i){return null!=i?(ll(this,t,i),Ir.updateOffset(this,e),this):sl(this,t)}}function sl(t,e){return t.isValid()?t._d["get"+(t._isUTC?"UTC":"")+e]():NaN}function ll(t,e,i){t.isValid()&&!isNaN(i)&&("FullYear"===e&&nl(t.year())&&1===t.month()&&29===t.date()?t._d["set"+(t._isUTC?"UTC":"")+e](i,t.month(),hl(i,t.month())):t._d["set"+(t._isUTC?"UTC":"")+e](i))}function hl(t,e){if(isNaN(t)||isNaN(e))return NaN;var i,n=(e%(i=12)+i)%i;return t+=(e-n)/12,1===n?nl(t)?29:28:31-n%7%2}al=Array.prototype.indexOf?Array.prototype.indexOf:function(t){var e;for(e=0;e<this.length;++e)if(this[e]===t)return e;return-1},ys("M",["MM",2],"Mo",function(){return this.month()+1}),ys("MMM",0,0,function(t){return this.localeData().monthsShort(this,t)}),ys("MMMM",0,0,function(t){return this.localeData().months(this,t)}),cs("month","M"),As("month",8),Fs("M",ks),Fs("MM",ks,xs),Fs("MMM",function(t,e){return e.monthsShortRegex(t)}),Fs("MMMM",function(t,e){return e.monthsRegex(t)}),js(["M","MM"],function(t,e){e[Gs]=Jr(t)-1}),js(["MMM","MMMM"],function(t,e,i,n){var a=i._locale.monthsParse(t,n,i._strict);null!=a?e[Gs]=a:jr(i).invalidMonth=t});var cl=/D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,dl="January_February_March_April_May_June_July_August_September_October_November_December".split("_");var pl="Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_");function ul(t,e){var i;if(!t.isValid())return t;if("string"==typeof e)if(/^\d+$/.test(e))e=Jr(e);else if(!Nr(e=t.localeData().monthsParse(e)))return t;return i=Math.min(t.date(),hl(t.year(),e)),t._d["set"+(t._isUTC?"UTC":"")+"Month"](e,i),t}function Al(t){return null!=t?(ul(this,t),Ir.updateOffset(this,!0),this):sl(this,"Month")}var ml=Ns;var fl=Ns;function gl(){function t(t,e){return e.length-t.length}var e,i,n=[],a=[],o=[];for(e=0;e<12;e++)i=Yr([2e3,e]),n.push(this.monthsShort(i,"")),a.push(this.months(i,"")),o.push(this.months(i,"")),o.push(this.monthsShort(i,""));for(n.sort(t),a.sort(t),o.sort(t),e=0;e<12;e++)n[e]=$s(n[e]),a[e]=$s(a[e]);for(e=0;e<24;e++)o[e]=$s(o[e]);this._monthsRegex=new RegExp("^("+o.join("|")+")","i"),this._monthsShortRegex=this._monthsRegex,this._monthsStrictRegex=new RegExp("^("+a.join("|")+")","i"),this._monthsShortStrictRegex=new RegExp("^("+n.join("|")+")","i")}function vl(t){var e=new Date(Date.UTC.apply(null,arguments));return t<100&&t>=0&&isFinite(e.getUTCFullYear())&&e.setUTCFullYear(t),e}function _l(t,e,i){var n=7+e-i;return-((7+vl(t,0,n).getUTCDay()-e)%7)+n-1}function yl(t,e,i,n,a){var o,r,s=1+7*(e-1)+(7+i-n)%7+_l(t,n,a);return s<=0?r=il(o=t-1)+s:s>il(t)?(o=t+1,r=s-il(t)):(o=t,r=s),{year:o,dayOfYear:r}}function bl(t,e,i){var n,a,o=_l(t.year(),e,i),r=Math.floor((t.dayOfYear()-o-1)/7)+1;return r<1?n=r+zl(a=t.year()-1,e,i):r>zl(t.year(),e,i)?(n=r-zl(t.year(),e,i),a=t.year()+1):(a=t.year(),n=r),{week:n,year:a}}function zl(t,e,i){var n=_l(t,e,i),a=_l(t+1,e,i);return(il(t)-n+a)/7}ys("w",["ww",2],"wo","week"),ys("W",["WW",2],"Wo","isoWeek"),cs("week","w"),cs("isoWeek","W"),As("week",5),As("isoWeek",5),Fs("w",ks),Fs("ww",ks,xs),Fs("W",ks),Fs("WW",ks,xs),qs(["w","ww","W","WW"],function(t,e,i,n){e[n.substr(0,1)]=Jr(t)});ys("d",0,"do","day"),ys("dd",0,0,function(t){return this.localeData().weekdaysMin(this,t)}),ys("ddd",0,0,function(t){return this.localeData().weekdaysShort(this,t)}),ys("dddd",0,0,function(t){return this.localeData().weekdays(this,t)}),ys("e",0,0,"weekday"),ys("E",0,0,"isoWeekday"),cs("day","d"),cs("weekday","e"),cs("isoWeekday","E"),As("day",11),As("weekday",11),As("isoWeekday",11),Fs("d",ks),Fs("e",ks),Fs("E",ks),Fs("dd",function(t,e){return e.weekdaysMinRegex(t)}),Fs("ddd",function(t,e){return e.weekdaysShortRegex(t)}),Fs("dddd",function(t,e){return e.weekdaysRegex(t)}),qs(["dd","ddd","dddd"],function(t,e,i,n){var a=i._locale.weekdaysParse(t,n,i._strict);null!=a?e.d=a:jr(i).invalidWeekday=t}),qs(["d","e","E"],function(t,e,i,n){e[n]=Jr(t)});var wl="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_");var xl="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_");var Ml="Su_Mo_Tu_We_Th_Fr_Sa".split("_");var Sl=Ns;var Cl=Ns;var kl=Ns;function Hl(){function t(t,e){return e.length-t.length}var e,i,n,a,o,r=[],s=[],l=[],h=[];for(e=0;e<7;e++)i=Yr([2e3,1]).day(e),n=this.weekdaysMin(i,""),a=this.weekdaysShort(i,""),o=this.weekdays(i,""),r.push(n),s.push(a),l.push(o),h.push(n),h.push(a),h.push(o);for(r.sort(t),s.sort(t),l.sort(t),h.sort(t),e=0;e<7;e++)s[e]=$s(s[e]),l[e]=$s(l[e]),h[e]=$s(h[e]);this._weekdaysRegex=new RegExp("^("+h.join("|")+")","i"),this._weekdaysShortRegex=this._weekdaysRegex,this._weekdaysMinRegex=this._weekdaysRegex,this._weekdaysStrictRegex=new RegExp("^("+l.join("|")+")","i"),this._weekdaysShortStrictRegex=new RegExp("^("+s.join("|")+")","i"),this._weekdaysMinStrictRegex=new RegExp("^("+r.join("|")+")","i")}function Vl(){return this.hours()%12||12}function Ll(t,e){ys(t,0,0,function(){return this.localeData().meridiem(this.hours(),this.minutes(),e)})}function Tl(t,e){return e._meridiemParse}ys("H",["HH",2],0,"hour"),ys("h",["hh",2],0,Vl),ys("k",["kk",2],0,function(){return this.hours()||24}),ys("hmm",0,0,function(){return""+Vl.apply(this)+ms(this.minutes(),2)}),ys("hmmss",0,0,function(){return""+Vl.apply(this)+ms(this.minutes(),2)+ms(this.seconds(),2)}),ys("Hmm",0,0,function(){return""+this.hours()+ms(this.minutes(),2)}),ys("Hmmss",0,0,function(){return""+this.hours()+ms(this.minutes(),2)+ms(this.seconds(),2)}),Ll("a",!0),Ll("A",!1),cs("hour","h"),As("hour",13),Fs("a",Tl),Fs("A",Tl),Fs("H",ks),Fs("h",ks),Fs("k",ks),Fs("HH",ks,xs),Fs("hh",ks,xs),Fs("kk",ks,xs),Fs("hmm",Hs),Fs("hmmss",Vs),Fs("Hmm",Hs),Fs("Hmmss",Vs),js(["H","HH"],Qs),js(["k","kk"],function(t,e,i){var n=Jr(t);e[Qs]=24===n?0:n}),js(["a","A"],function(t,e,i){i._isPm=i._locale.isPM(t),i._meridiem=t}),js(["h","hh"],function(t,e,i){e[Qs]=Jr(t),jr(i).bigHour=!0}),js("hmm",function(t,e,i){var n=t.length-2;e[Qs]=Jr(t.substr(0,n)),e[Zs]=Jr(t.substr(n)),jr(i).bigHour=!0}),js("hmmss",function(t,e,i){var n=t.length-4,a=t.length-2;e[Qs]=Jr(t.substr(0,n)),e[Zs]=Jr(t.substr(n,2)),e[Xs]=Jr(t.substr(a)),jr(i).bigHour=!0}),js("Hmm",function(t,e,i){var n=t.length-2;e[Qs]=Jr(t.substr(0,n)),e[Zs]=Jr(t.substr(n))}),js("Hmmss",function(t,e,i){var n=t.length-4,a=t.length-2;e[Qs]=Jr(t.substr(0,n)),e[Zs]=Jr(t.substr(n,2)),e[Xs]=Jr(t.substr(a))});var El,Il=rl("Hours",!0),Pl={calendar:{sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},longDateFormat:{LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},invalidDate:"Invalid date",ordinal:"%d",dayOfMonthOrdinalParse:/\d{1,2}/,relativeTime:{future:"in %s",past:"%s ago",s:"a few seconds",ss:"%d seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},months:dl,monthsShort:pl,week:{dow:0,doy:6},weekdays:wl,weekdaysMin:Ml,weekdaysShort:xl,meridiemParse:/[ap]\.?m?\.?/i},Ol={},Rl={};function Nl(t){return t?t.toLowerCase().replace("_","-"):t}function Dl(t){var e=null;if(!Ol[t]&&"undefined"!=typeof module&&module&&module.exports)try{e=El._abbr,require("./locale/"+t),Fl(e)}catch(t){}return Ol[t]}function Fl(t,e){var i;return t&&((i=Rr(e)?$l(t):Bl(t,e))?El=i:"undefined"!=typeof console&&console.warn&&console.warn("Locale "+t+" not found. Did you forget to load it?")),El._abbr}function Bl(t,e){if(null!==e){var i,n=Pl;if(e.abbr=t,null!=Ol[t])os("defineLocaleOverride","use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."),n=Ol[t]._config;else if(null!=e.parentLocale)if(null!=Ol[e.parentLocale])n=Ol[e.parentLocale]._config;else{if(null==(i=Dl(e.parentLocale)))return Rl[e.parentLocale]||(Rl[e.parentLocale]=[]),Rl[e.parentLocale].push({name:t,config:e}),null;n=i._config}return Ol[t]=new ls(ss(n,e)),Rl[t]&&Rl[t].forEach(function(t){Bl(t.name,t.config)}),Fl(t),Ol[t]}return delete Ol[t],null}function $l(t){var e;if(t&&t._locale&&t._locale._abbr&&(t=t._locale._abbr),!t)return El;if(!Pr(t)){if(e=Dl(t))return e;t=[t]}return function(t){for(var e,i,n,a,o=0;o<t.length;){for(e=(a=Nl(t[o]).split("-")).length,i=(i=Nl(t[o+1]))?i.split("-"):null;e>0;){if(n=Dl(a.slice(0,e).join("-")))return n;if(i&&i.length>=e&&ts(a,i,!0)>=e-1)break;e--}o++}return El}(t)}function Yl(t){var e,i=t._a;return i&&-2===jr(t).overflow&&(e=i[Gs]<0||i[Gs]>11?Gs:i[Ks]<1||i[Ks]>hl(i[Ws],i[Gs])?Ks:i[Qs]<0||i[Qs]>24||24===i[Qs]&&(0!==i[Zs]||0!==i[Xs]||0!==i[Js])?Qs:i[Zs]<0||i[Zs]>59?Zs:i[Xs]<0||i[Xs]>59?Xs:i[Js]<0||i[Js]>999?Js:-1,jr(t)._overflowDayOfYear&&(e<Ws||e>Ks)&&(e=Ks),jr(t)._overflowWeeks&&-1===e&&(e=tl),jr(t)._overflowWeekday&&-1===e&&(e=el),jr(t).overflow=e),t}function jl(t,e,i){return null!=t?t:null!=e?e:i}function ql(t){var e,i,n,a,o,r=[];if(!t._d){for(n=function(t){var e=new Date(Ir.now());return t._useUTC?[e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate()]:[e.getFullYear(),e.getMonth(),e.getDate()]}(t),t._w&&null==t._a[Ks]&&null==t._a[Gs]&&function(t){var e,i,n,a,o,r,s,l;if(null!=(e=t._w).GG||null!=e.W||null!=e.E)o=1,r=4,i=jl(e.GG,t._a[Ws],bl(rh(),1,4).year),n=jl(e.W,1),((a=jl(e.E,1))<1||a>7)&&(l=!0);else{o=t._locale._week.dow,r=t._locale._week.doy;var h=bl(rh(),o,r);i=jl(e.gg,t._a[Ws],h.year),n=jl(e.w,h.week),null!=e.d?((a=e.d)<0||a>6)&&(l=!0):null!=e.e?(a=e.e+o,(e.e<0||e.e>6)&&(l=!0)):a=o}n<1||n>zl(i,o,r)?jr(t)._overflowWeeks=!0:null!=l?jr(t)._overflowWeekday=!0:(s=yl(i,n,a,o,r),t._a[Ws]=s.year,t._dayOfYear=s.dayOfYear)}(t),null!=t._dayOfYear&&(o=jl(t._a[Ws],n[Ws]),(t._dayOfYear>il(o)||0===t._dayOfYear)&&(jr(t)._overflowDayOfYear=!0),i=vl(o,0,t._dayOfYear),t._a[Gs]=i.getUTCMonth(),t._a[Ks]=i.getUTCDate()),e=0;e<3&&null==t._a[e];++e)t._a[e]=r[e]=n[e];for(;e<7;e++)t._a[e]=r[e]=null==t._a[e]?2===e?1:0:t._a[e];24===t._a[Qs]&&0===t._a[Zs]&&0===t._a[Xs]&&0===t._a[Js]&&(t._nextDay=!0,t._a[Qs]=0),t._d=(t._useUTC?vl:function(t,e,i,n,a,o,r){var s=new Date(t,e,i,n,a,o,r);return t<100&&t>=0&&isFinite(s.getFullYear())&&s.setFullYear(t),s}).apply(null,r),a=t._useUTC?t._d.getUTCDay():t._d.getDay(),null!=t._tzm&&t._d.setUTCMinutes(t._d.getUTCMinutes()-t._tzm),t._nextDay&&(t._a[Qs]=24),t._w&&void 0!==t._w.d&&t._w.d!==a&&(jr(t).weekdayMismatch=!0)}}var Ul=/^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,Wl=/^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,Gl=/Z|[+-]\d\d(?::?\d\d)?/,Kl=[["YYYYYY-MM-DD",/[+-]\d{6}-\d\d-\d\d/],["YYYY-MM-DD",/\d{4}-\d\d-\d\d/],["GGGG-[W]WW-E",/\d{4}-W\d\d-\d/],["GGGG-[W]WW",/\d{4}-W\d\d/,!1],["YYYY-DDD",/\d{4}-\d{3}/],["YYYY-MM",/\d{4}-\d\d/,!1],["YYYYYYMMDD",/[+-]\d{10}/],["YYYYMMDD",/\d{8}/],["GGGG[W]WWE",/\d{4}W\d{3}/],["GGGG[W]WW",/\d{4}W\d{2}/,!1],["YYYYDDD",/\d{7}/]],Ql=[["HH:mm:ss.SSSS",/\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss,SSSS",/\d\d:\d\d:\d\d,\d+/],["HH:mm:ss",/\d\d:\d\d:\d\d/],["HH:mm",/\d\d:\d\d/],["HHmmss.SSSS",/\d\d\d\d\d\d\.\d+/],["HHmmss,SSSS",/\d\d\d\d\d\d,\d+/],["HHmmss",/\d\d\d\d\d\d/],["HHmm",/\d\d\d\d/],["HH",/\d\d/]],Zl=/^\/?Date\((\-?\d+)/i;function Xl(t){var e,i,n,a,o,r,s=t._i,l=Ul.exec(s)||Wl.exec(s);if(l){for(jr(t).iso=!0,e=0,i=Kl.length;e<i;e++)if(Kl[e][1].exec(l[1])){a=Kl[e][0],n=!1!==Kl[e][2];break}if(null==a)return void(t._isValid=!1);if(l[3]){for(e=0,i=Ql.length;e<i;e++)if(Ql[e][1].exec(l[3])){o=(l[2]||" ")+Ql[e][0];break}if(null==o)return void(t._isValid=!1)}if(!n&&null!=o)return void(t._isValid=!1);if(l[4]){if(!Gl.exec(l[4]))return void(t._isValid=!1);r="Z"}t._f=a+(o||"")+(r||""),nh(t)}else t._isValid=!1}var Jl=/^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;function th(t,e,i,n,a,o){var r=[function(t){var e=parseInt(t,10);if(e<=49)return 2e3+e;if(e<=999)return 1900+e;return e}(t),pl.indexOf(e),parseInt(i,10),parseInt(n,10),parseInt(a,10)];return o&&r.push(parseInt(o,10)),r}var eh={UT:0,GMT:0,EDT:-240,EST:-300,CDT:-300,CST:-360,MDT:-360,MST:-420,PDT:-420,PST:-480};function ih(t){var e=Jl.exec(t._i.replace(/\([^)]*\)|[\n\t]/g," ").replace(/(\s\s+)/g," ").replace(/^\s\s*/,"").replace(/\s\s*$/,""));if(e){var i=th(e[4],e[3],e[2],e[5],e[6],e[7]);if(!function(t,e,i){return!t||xl.indexOf(t)===new Date(e[0],e[1],e[2]).getDay()||(jr(i).weekdayMismatch=!0,i._isValid=!1,!1)}(e[1],i,t))return;t._a=i,t._tzm=function(t,e,i){if(t)return eh[t];if(e)return 0;var n=parseInt(i,10),a=n%100;return(n-a)/100*60+a}(e[8],e[9],e[10]),t._d=vl.apply(null,t._a),t._d.setUTCMinutes(t._d.getUTCMinutes()-t._tzm),jr(t).rfc2822=!0}else t._isValid=!1}function nh(t){if(t._f!==Ir.ISO_8601)if(t._f!==Ir.RFC_2822){t._a=[],jr(t).empty=!0;var e,i,n,a,o,r=""+t._i,s=r.length,l=0;for(n=zs(t._f,t._locale).match(fs)||[],e=0;e<n.length;e++)a=n[e],(i=(r.match(Bs(a,t))||[])[0])&&((o=r.substr(0,r.indexOf(i))).length>0&&jr(t).unusedInput.push(o),r=r.slice(r.indexOf(i)+i.length),l+=i.length),_s[a]?(i?jr(t).empty=!1:jr(t).unusedTokens.push(a),Us(a,i,t)):t._strict&&!i&&jr(t).unusedTokens.push(a);jr(t).charsLeftOver=s-l,r.length>0&&jr(t).unusedInput.push(r),t._a[Qs]<=12&&!0===jr(t).bigHour&&t._a[Qs]>0&&(jr(t).bigHour=void 0),jr(t).parsedDateParts=t._a.slice(0),jr(t).meridiem=t._meridiem,t._a[Qs]=function(t,e,i){var n;if(null==i)return e;return null!=t.meridiemHour?t.meridiemHour(e,i):null!=t.isPM?((n=t.isPM(i))&&e<12&&(e+=12),n||12!==e||(e=0),e):e}(t._locale,t._a[Qs],t._meridiem),ql(t),Yl(t)}else ih(t);else Xl(t)}function ah(t){var e=t._i,i=t._f;return t._locale=t._locale||$l(t._l),null===e||void 0===i&&""===e?Ur({nullInput:!0}):("string"==typeof e&&(t._i=e=t._locale.preparse(e)),Zr(e)?new Qr(Yl(e)):(Dr(e)?t._d=e:Pr(i)?function(t){var e,i,n,a,o;if(0===t._f.length)return jr(t).invalidFormat=!0,void(t._d=new Date(NaN));for(a=0;a<t._f.length;a++)o=0,e=Gr({},t),null!=t._useUTC&&(e._useUTC=t._useUTC),e._f=t._f[a],nh(e),qr(e)&&(o+=jr(e).charsLeftOver,o+=10*jr(e).unusedTokens.length,jr(e).score=o,(null==n||o<n)&&(n=o,i=e));$r(t,i||e)}(t):i?nh(t):function(t){var e=t._i;Rr(e)?t._d=new Date(Ir.now()):Dr(e)?t._d=new Date(e.valueOf()):"string"==typeof e?function(t){var e=Zl.exec(t._i);null===e?(Xl(t),!1===t._isValid&&(delete t._isValid,ih(t),!1===t._isValid&&(delete t._isValid,Ir.createFromInputFallback(t)))):t._d=new Date(+e[1])}(t):Pr(e)?(t._a=Fr(e.slice(0),function(t){return parseInt(t,10)}),ql(t)):Or(e)?function(t){if(!t._d){var e=ps(t._i);t._a=Fr([e.year,e.month,e.day||e.date,e.hour,e.minute,e.second,e.millisecond],function(t){return t&&parseInt(t,10)}),ql(t)}}(t):Nr(e)?t._d=new Date(e):Ir.createFromInputFallback(t)}(t),qr(t)||(t._d=null),t))}function oh(t,e,i,n,a){var o,r={};return!0!==i&&!1!==i||(n=i,i=void 0),(Or(t)&&function(t){if(Object.getOwnPropertyNames)return 0===Object.getOwnPropertyNames(t).length;var e;for(e in t)if(t.hasOwnProperty(e))return!1;return!0}(t)||Pr(t)&&0===t.length)&&(t=void 0),r._isAMomentObject=!0,r._useUTC=r._isUTC=a,r._l=i,r._i=t,r._f=e,r._strict=n,(o=new Qr(Yl(ah(r))))._nextDay&&(o.add(1,"d"),o._nextDay=void 0),o}function rh(t,e,i,n){return oh(t,e,i,n,!1)}Ir.createFromInputFallback=is("value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to js Date(), which is not reliable across all browsers and versions. Non RFC2822/ISO date formats are discouraged and will be removed in an upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.",function(t){t._d=new Date(t._i+(t._useUTC?" UTC":""))}),Ir.ISO_8601=function(){},Ir.RFC_2822=function(){};var sh=is("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var t=rh.apply(null,arguments);return this.isValid()&&t.isValid()?t<this?this:t:Ur()}),lh=is("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var t=rh.apply(null,arguments);return this.isValid()&&t.isValid()?t>this?this:t:Ur()});function hh(t,e){var i,n;if(1===e.length&&Pr(e[0])&&(e=e[0]),!e.length)return rh();for(i=e[0],n=1;n<e.length;++n)e[n].isValid()&&!e[n][t](i)||(i=e[n]);return i}var ch=["year","quarter","month","week","day","hour","minute","second","millisecond"];function dh(t){var e=ps(t),i=e.year||0,n=e.quarter||0,a=e.month||0,o=e.week||0,r=e.day||0,s=e.hour||0,l=e.minute||0,h=e.second||0,c=e.millisecond||0;this._isValid=function(t){for(var e in t)if(-1===al.call(ch,e)||null!=t[e]&&isNaN(t[e]))return!1;for(var i=!1,n=0;n<ch.length;++n)if(t[ch[n]]){if(i)return!1;parseFloat(t[ch[n]])!==Jr(t[ch[n]])&&(i=!0)}return!0}(e),this._milliseconds=+c+1e3*h+6e4*l+1e3*s*60*60,this._days=+r+7*o,this._months=+a+3*n+12*i,this._data={},this._locale=$l(),this._bubble()}function ph(t){return t instanceof dh}function uh(t){return t<0?-1*Math.round(-1*t):Math.round(t)}function Ah(t,e){ys(t,0,0,function(){var t=this.utcOffset(),i="+";return t<0&&(t=-t,i="-"),i+ms(~~(t/60),2)+e+ms(~~t%60,2)})}Ah("Z",":"),Ah("ZZ",""),Fs("Z",Rs),Fs("ZZ",Rs),js(["Z","ZZ"],function(t,e,i){i._useUTC=!0,i._tzm=fh(Rs,t)});var mh=/([\+\-]|\d\d)/gi;function fh(t,e){var i=(e||"").match(t);if(null===i)return null;var n=((i[i.length-1]||[])+"").match(mh)||["-",0,0],a=60*n[1]+Jr(n[2]);return 0===a?0:"+"===n[0]?a:-a}function gh(t,e){var i,n;return e._isUTC?(i=e.clone(),n=(Zr(t)||Dr(t)?t.valueOf():rh(t).valueOf())-i.valueOf(),i._d.setTime(i._d.valueOf()+n),Ir.updateOffset(i,!1),i):rh(t).local()}function vh(t){return 15*-Math.round(t._d.getTimezoneOffset()/15)}function _h(){return!!this.isValid()&&(this._isUTC&&0===this._offset)}Ir.updateOffset=function(){};var yh=/^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/,bh=/^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;function zh(t,e){var i,n,a,o=t,r=null;return ph(t)?o={ms:t._milliseconds,d:t._days,M:t._months}:Nr(t)?(o={},e?o[e]=t:o.milliseconds=t):(r=yh.exec(t))?(i="-"===r[1]?-1:1,o={y:0,d:Jr(r[Ks])*i,h:Jr(r[Qs])*i,m:Jr(r[Zs])*i,s:Jr(r[Xs])*i,ms:Jr(uh(1e3*r[Js]))*i}):(r=bh.exec(t))?(i="-"===r[1]?-1:(r[1],1),o={y:wh(r[2],i),M:wh(r[3],i),w:wh(r[4],i),d:wh(r[5],i),h:wh(r[6],i),m:wh(r[7],i),s:wh(r[8],i)}):null==o?o={}:"object"==typeof o&&("from"in o||"to"in o)&&(a=function(t,e){var i;if(!t.isValid()||!e.isValid())return{milliseconds:0,months:0};e=gh(e,t),t.isBefore(e)?i=xh(t,e):((i=xh(e,t)).milliseconds=-i.milliseconds,i.months=-i.months);return i}(rh(o.from),rh(o.to)),(o={}).ms=a.milliseconds,o.M=a.months),n=new dh(o),ph(t)&&Br(t,"_locale")&&(n._locale=t._locale),n}function wh(t,e){var i=t&&parseFloat(t.replace(",","."));return(isNaN(i)?0:i)*e}function xh(t,e){var i={milliseconds:0,months:0};return i.months=e.month()-t.month()+12*(e.year()-t.year()),t.clone().add(i.months,"M").isAfter(e)&&--i.months,i.milliseconds=+e-+t.clone().add(i.months,"M"),i}function Mh(t,e){return function(i,n){var a;return null===n||isNaN(+n)||(os(e,"moment()."+e+"(period, number) is deprecated. Please use moment()."+e+"(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),a=i,i=n,n=a),Sh(this,zh(i="string"==typeof i?+i:i,n),t),this}}function Sh(t,e,i,n){var a=e._milliseconds,o=uh(e._days),r=uh(e._months);t.isValid()&&(n=null==n||n,r&&ul(t,sl(t,"Month")+r*i),o&&ll(t,"Date",sl(t,"Date")+o*i),a&&t._d.setTime(t._d.valueOf()+a*i),n&&Ir.updateOffset(t,o||r))}zh.fn=dh.prototype,zh.invalid=function(){return zh(NaN)};var Ch=Mh(1,"add"),kh=Mh(-1,"subtract");function Hh(t,e){var i=12*(e.year()-t.year())+(e.month()-t.month()),n=t.clone().add(i,"months");return-(i+(e-n<0?(e-n)/(n-t.clone().add(i-1,"months")):(e-n)/(t.clone().add(i+1,"months")-n)))||0}function Vh(t){var e;return void 0===t?this._locale._abbr:(null!=(e=$l(t))&&(this._locale=e),this)}Ir.defaultFormat="YYYY-MM-DDTHH:mm:ssZ",Ir.defaultFormatUtc="YYYY-MM-DDTHH:mm:ss[Z]";var Lh=is("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(t){return void 0===t?this.localeData():this.locale(t)});function Th(){return this._locale}function Eh(t,e){ys(0,[t,t.length],0,e)}function Ih(t,e,i,n,a){var o;return null==t?bl(this,n,a).year:(e>(o=zl(t,n,a))&&(e=o),function(t,e,i,n,a){var o=yl(t,e,i,n,a),r=vl(o.year,0,o.dayOfYear);return this.year(r.getUTCFullYear()),this.month(r.getUTCMonth()),this.date(r.getUTCDate()),this}.call(this,t,e,i,n,a))}ys(0,["gg",2],0,function(){return this.weekYear()%100}),ys(0,["GG",2],0,function(){return this.isoWeekYear()%100}),Eh("gggg","weekYear"),Eh("ggggg","weekYear"),Eh("GGGG","isoWeekYear"),Eh("GGGGG","isoWeekYear"),cs("weekYear","gg"),cs("isoWeekYear","GG"),As("weekYear",1),As("isoWeekYear",1),Fs("G",Ps),Fs("g",Ps),Fs("GG",ks,xs),Fs("gg",ks,xs),Fs("GGGG",Ts,Ss),Fs("gggg",Ts,Ss),Fs("GGGGG",Es,Cs),Fs("ggggg",Es,Cs),qs(["gggg","ggggg","GGGG","GGGGG"],function(t,e,i,n){e[n.substr(0,2)]=Jr(t)}),qs(["gg","GG"],function(t,e,i,n){e[n]=Ir.parseTwoDigitYear(t)}),ys("Q",0,"Qo","quarter"),cs("quarter","Q"),As("quarter",7),Fs("Q",ws),js("Q",function(t,e){e[Gs]=3*(Jr(t)-1)}),ys("D",["DD",2],"Do","date"),cs("date","D"),As("date",9),Fs("D",ks),Fs("DD",ks,xs),Fs("Do",function(t,e){return t?e._dayOfMonthOrdinalParse||e._ordinalParse:e._dayOfMonthOrdinalParseLenient}),js(["D","DD"],Ks),js("Do",function(t,e){e[Ks]=Jr(t.match(ks)[0])});var Ph=rl("Date",!0);ys("DDD",["DDDD",3],"DDDo","dayOfYear"),cs("dayOfYear","DDD"),As("dayOfYear",4),Fs("DDD",Ls),Fs("DDDD",Ms),js(["DDD","DDDD"],function(t,e,i){i._dayOfYear=Jr(t)}),ys("m",["mm",2],0,"minute"),cs("minute","m"),As("minute",14),Fs("m",ks),Fs("mm",ks,xs),js(["m","mm"],Zs);var Oh=rl("Minutes",!1);ys("s",["ss",2],0,"second"),cs("second","s"),As("second",15),Fs("s",ks),Fs("ss",ks,xs),js(["s","ss"],Xs);var Rh,Nh=rl("Seconds",!1);for(ys("S",0,0,function(){return~~(this.millisecond()/100)}),ys(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),ys(0,["SSS",3],0,"millisecond"),ys(0,["SSSS",4],0,function(){return 10*this.millisecond()}),ys(0,["SSSSS",5],0,function(){return 100*this.millisecond()}),ys(0,["SSSSSS",6],0,function(){return 1e3*this.millisecond()}),ys(0,["SSSSSSS",7],0,function(){return 1e4*this.millisecond()}),ys(0,["SSSSSSSS",8],0,function(){return 1e5*this.millisecond()}),ys(0,["SSSSSSSSS",9],0,function(){return 1e6*this.millisecond()}),cs("millisecond","ms"),As("millisecond",16),Fs("S",Ls,ws),Fs("SS",Ls,xs),Fs("SSS",Ls,Ms),Rh="SSSS";Rh.length<=9;Rh+="S")Fs(Rh,Is);function Dh(t,e){e[Js]=Jr(1e3*("0."+t))}for(Rh="S";Rh.length<=9;Rh+="S")js(Rh,Dh);var Fh=rl("Milliseconds",!1);ys("z",0,0,"zoneAbbr"),ys("zz",0,0,"zoneName");var Bh=Qr.prototype;function $h(t){return t}Bh.add=Ch,Bh.calendar=function(t,e){var i=t||rh(),n=gh(i,this).startOf("day"),a=Ir.calendarFormat(this,n)||"sameElse",o=e&&(rs(e[a])?e[a].call(this,i):e[a]);return this.format(o||this.localeData().calendar(a,this,rh(i)))},Bh.clone=function(){return new Qr(this)},Bh.diff=function(t,e,i){var n,a,o;if(!this.isValid())return NaN;if(!(n=gh(t,this)).isValid())return NaN;switch(a=6e4*(n.utcOffset()-this.utcOffset()),e=ds(e)){case"year":o=Hh(this,n)/12;break;case"month":o=Hh(this,n);break;case"quarter":o=Hh(this,n)/3;break;case"second":o=(this-n)/1e3;break;case"minute":o=(this-n)/6e4;break;case"hour":o=(this-n)/36e5;break;case"day":o=(this-n-a)/864e5;break;case"week":o=(this-n-a)/6048e5;break;default:o=this-n}return i?o:Xr(o)},Bh.endOf=function(t){return void 0===(t=ds(t))||"millisecond"===t?this:("date"===t&&(t="day"),this.startOf(t).add(1,"isoWeek"===t?"week":t).subtract(1,"ms"))},Bh.format=function(t){t||(t=this.isUtc()?Ir.defaultFormatUtc:Ir.defaultFormat);var e=bs(this,t);return this.localeData().postformat(e)},Bh.from=function(t,e){return this.isValid()&&(Zr(t)&&t.isValid()||rh(t).isValid())?zh({to:this,from:t}).locale(this.locale()).humanize(!e):this.localeData().invalidDate()},Bh.fromNow=function(t){return this.from(rh(),t)},Bh.to=function(t,e){return this.isValid()&&(Zr(t)&&t.isValid()||rh(t).isValid())?zh({from:this,to:t}).locale(this.locale()).humanize(!e):this.localeData().invalidDate()},Bh.toNow=function(t){return this.to(rh(),t)},Bh.get=function(t){return rs(this[t=ds(t)])?this[t]():this},Bh.invalidAt=function(){return jr(this).overflow},Bh.isAfter=function(t,e){var i=Zr(t)?t:rh(t);return!(!this.isValid()||!i.isValid())&&("millisecond"===(e=ds(Rr(e)?"millisecond":e))?this.valueOf()>i.valueOf():i.valueOf()<this.clone().startOf(e).valueOf())},Bh.isBefore=function(t,e){var i=Zr(t)?t:rh(t);return!(!this.isValid()||!i.isValid())&&("millisecond"===(e=ds(Rr(e)?"millisecond":e))?this.valueOf()<i.valueOf():this.clone().endOf(e).valueOf()<i.valueOf())},Bh.isBetween=function(t,e,i,n){return("("===(n=n||"()")[0]?this.isAfter(t,i):!this.isBefore(t,i))&&(")"===n[1]?this.isBefore(e,i):!this.isAfter(e,i))},Bh.isSame=function(t,e){var i,n=Zr(t)?t:rh(t);return!(!this.isValid()||!n.isValid())&&("millisecond"===(e=ds(e||"millisecond"))?this.valueOf()===n.valueOf():(i=n.valueOf(),this.clone().startOf(e).valueOf()<=i&&i<=this.clone().endOf(e).valueOf()))},Bh.isSameOrAfter=function(t,e){return this.isSame(t,e)||this.isAfter(t,e)},Bh.isSameOrBefore=function(t,e){return this.isSame(t,e)||this.isBefore(t,e)},Bh.isValid=function(){return qr(this)},Bh.lang=Lh,Bh.locale=Vh,Bh.localeData=Th,Bh.max=lh,Bh.min=sh,Bh.parsingFlags=function(){return $r({},jr(this))},Bh.set=function(t,e){if("object"==typeof t)for(var i=function(t){var e=[];for(var i in t)e.push({unit:i,priority:us[i]});return e.sort(function(t,e){return t.priority-e.priority}),e}(t=ps(t)),n=0;n<i.length;n++)this[i[n].unit](t[i[n].unit]);else if(rs(this[t=ds(t)]))return this[t](e);return this},Bh.startOf=function(t){switch(t=ds(t)){case"year":this.month(0);case"quarter":case"month":this.date(1);case"week":case"isoWeek":case"day":case"date":this.hours(0);case"hour":this.minutes(0);case"minute":this.seconds(0);case"second":this.milliseconds(0)}return"week"===t&&this.weekday(0),"isoWeek"===t&&this.isoWeekday(1),"quarter"===t&&this.month(3*Math.floor(this.month()/3)),this},Bh.subtract=kh,Bh.toArray=function(){var t=this;return[t.year(),t.month(),t.date(),t.hour(),t.minute(),t.second(),t.millisecond()]},Bh.toObject=function(){var t=this;return{years:t.year(),months:t.month(),date:t.date(),hours:t.hours(),minutes:t.minutes(),seconds:t.seconds(),milliseconds:t.milliseconds()}},Bh.toDate=function(){return new Date(this.valueOf())},Bh.toISOString=function(t){if(!this.isValid())return null;var e=!0!==t,i=e?this.clone().utc():this;return i.year()<0||i.year()>9999?bs(i,e?"YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]":"YYYYYY-MM-DD[T]HH:mm:ss.SSSZ"):rs(Date.prototype.toISOString)?e?this.toDate().toISOString():new Date(this.valueOf()+60*this.utcOffset()*1e3).toISOString().replace("Z",bs(i,"Z")):bs(i,e?"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]":"YYYY-MM-DD[T]HH:mm:ss.SSSZ")},Bh.inspect=function(){if(!this.isValid())return"moment.invalid(/* "+this._i+" */)";var t="moment",e="";this.isLocal()||(t=0===this.utcOffset()?"moment.utc":"moment.parseZone",e="Z");var i="["+t+'("]',n=0<=this.year()&&this.year()<=9999?"YYYY":"YYYYYY",a=e+'[")]';return this.format(i+n+"-MM-DD[T]HH:mm:ss.SSS"+a)},Bh.toJSON=function(){return this.isValid()?this.toISOString():null},Bh.toString=function(){return this.clone().locale("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")},Bh.unix=function(){return Math.floor(this.valueOf()/1e3)},Bh.valueOf=function(){return this._d.valueOf()-6e4*(this._offset||0)},Bh.creationData=function(){return{input:this._i,format:this._f,locale:this._locale,isUTC:this._isUTC,strict:this._strict}},Bh.year=ol,Bh.isLeapYear=function(){return nl(this.year())},Bh.weekYear=function(t){return Ih.call(this,t,this.week(),this.weekday(),this.localeData()._week.dow,this.localeData()._week.doy)},Bh.isoWeekYear=function(t){return Ih.call(this,t,this.isoWeek(),this.isoWeekday(),1,4)},Bh.quarter=Bh.quarters=function(t){return null==t?Math.ceil((this.month()+1)/3):this.month(3*(t-1)+this.month()%3)},Bh.month=Al,Bh.daysInMonth=function(){return hl(this.year(),this.month())},Bh.week=Bh.weeks=function(t){var e=this.localeData().week(this);return null==t?e:this.add(7*(t-e),"d")},Bh.isoWeek=Bh.isoWeeks=function(t){var e=bl(this,1,4).week;return null==t?e:this.add(7*(t-e),"d")},Bh.weeksInYear=function(){var t=this.localeData()._week;return zl(this.year(),t.dow,t.doy)},Bh.isoWeeksInYear=function(){return zl(this.year(),1,4)},Bh.date=Ph,Bh.day=Bh.days=function(t){if(!this.isValid())return null!=t?this:NaN;var e=this._isUTC?this._d.getUTCDay():this._d.getDay();return null!=t?(t=function(t,e){return"string"!=typeof t?t:isNaN(t)?"number"==typeof(t=e.weekdaysParse(t))?t:null:parseInt(t,10)}(t,this.localeData()),this.add(t-e,"d")):e},Bh.weekday=function(t){if(!this.isValid())return null!=t?this:NaN;var e=(this.day()+7-this.localeData()._week.dow)%7;return null==t?e:this.add(t-e,"d")},Bh.isoWeekday=function(t){if(!this.isValid())return null!=t?this:NaN;if(null!=t){var e=function(t,e){return"string"==typeof t?e.weekdaysParse(t)%7||7:isNaN(t)?null:t}(t,this.localeData());return this.day(this.day()%7?e:e-7)}return this.day()||7},Bh.dayOfYear=function(t){var e=Math.round((this.clone().startOf("day")-this.clone().startOf("year"))/864e5)+1;return null==t?e:this.add(t-e,"d")},Bh.hour=Bh.hours=Il,Bh.minute=Bh.minutes=Oh,Bh.second=Bh.seconds=Nh,Bh.millisecond=Bh.milliseconds=Fh,Bh.utcOffset=function(t,e,i){var n,a=this._offset||0;if(!this.isValid())return null!=t?this:NaN;if(null!=t){if("string"==typeof t){if(null===(t=fh(Rs,t)))return this}else Math.abs(t)<16&&!i&&(t*=60);return!this._isUTC&&e&&(n=vh(this)),this._offset=t,this._isUTC=!0,null!=n&&this.add(n,"m"),a!==t&&(!e||this._changeInProgress?Sh(this,zh(t-a,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,Ir.updateOffset(this,!0),this._changeInProgress=null)),this}return this._isUTC?a:vh(this)},Bh.utc=function(t){return this.utcOffset(0,t)},Bh.local=function(t){return this._isUTC&&(this.utcOffset(0,t),this._isUTC=!1,t&&this.subtract(vh(this),"m")),this},Bh.parseZone=function(){if(null!=this._tzm)this.utcOffset(this._tzm,!1,!0);else if("string"==typeof this._i){var t=fh(Os,this._i);null!=t?this.utcOffset(t):this.utcOffset(0,!0)}return this},Bh.hasAlignedHourOffset=function(t){return!!this.isValid()&&(t=t?rh(t).utcOffset():0,(this.utcOffset()-t)%60==0)},Bh.isDST=function(){return this.utcOffset()>this.clone().month(0).utcOffset()||this.utcOffset()>this.clone().month(5).utcOffset()},Bh.isLocal=function(){return!!this.isValid()&&!this._isUTC},Bh.isUtcOffset=function(){return!!this.isValid()&&this._isUTC},Bh.isUtc=_h,Bh.isUTC=_h,Bh.zoneAbbr=function(){return this._isUTC?"UTC":""},Bh.zoneName=function(){return this._isUTC?"Coordinated Universal Time":""},Bh.dates=is("dates accessor is deprecated. Use date instead.",Ph),Bh.months=is("months accessor is deprecated. Use month instead",Al),Bh.years=is("years accessor is deprecated. Use year instead",ol),Bh.zone=is("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/",function(t,e){return null!=t?("string"!=typeof t&&(t=-t),this.utcOffset(t,e),this):-this.utcOffset()}),Bh.isDSTShifted=is("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information",function(){if(!Rr(this._isDSTShifted))return this._isDSTShifted;var t={};if(Gr(t,this),(t=ah(t))._a){var e=t._isUTC?Yr(t._a):rh(t._a);this._isDSTShifted=this.isValid()&&ts(t._a,e.toArray())>0}else this._isDSTShifted=!1;return this._isDSTShifted});var Yh=ls.prototype;function jh(t,e,i,n){var a=$l(),o=Yr().set(n,e);return a[i](o,t)}function qh(t,e,i){if(Nr(t)&&(e=t,t=void 0),t=t||"",null!=e)return jh(t,e,i,"month");var n,a=[];for(n=0;n<12;n++)a[n]=jh(t,n,i,"month");return a}function Uh(t,e,i,n){"boolean"==typeof t?(Nr(e)&&(i=e,e=void 0),e=e||""):(i=e=t,t=!1,Nr(e)&&(i=e,e=void 0),e=e||"");var a,o=$l(),r=t?o._week.dow:0;if(null!=i)return jh(e,(i+r)%7,n,"day");var s=[];for(a=0;a<7;a++)s[a]=jh(e,(a+r)%7,n,"day");return s}Yh.calendar=function(t,e,i){var n=this._calendar[t]||this._calendar.sameElse;return rs(n)?n.call(e,i):n},Yh.longDateFormat=function(t){var e=this._longDateFormat[t],i=this._longDateFormat[t.toUpperCase()];return e||!i?e:(this._longDateFormat[t]=i.replace(/MMMM|MM|DD|dddd/g,function(t){return t.slice(1)}),this._longDateFormat[t])},Yh.invalidDate=function(){return this._invalidDate},Yh.ordinal=function(t){return this._ordinal.replace("%d",t)},Yh.preparse=$h,Yh.postformat=$h,Yh.relativeTime=function(t,e,i,n){var a=this._relativeTime[i];return rs(a)?a(t,e,i,n):a.replace(/%d/i,t)},Yh.pastFuture=function(t,e){var i=this._relativeTime[t>0?"future":"past"];return rs(i)?i(e):i.replace(/%s/i,e)},Yh.set=function(t){var e,i;for(i in t)rs(e=t[i])?this[i]=e:this["_"+i]=e;this._config=t,this._dayOfMonthOrdinalParseLenient=new RegExp((this._dayOfMonthOrdinalParse.source||this._ordinalParse.source)+"|"+/\d{1,2}/.source)},Yh.months=function(t,e){return t?Pr(this._months)?this._months[t.month()]:this._months[(this._months.isFormat||cl).test(e)?"format":"standalone"][t.month()]:Pr(this._months)?this._months:this._months.standalone},Yh.monthsShort=function(t,e){return t?Pr(this._monthsShort)?this._monthsShort[t.month()]:this._monthsShort[cl.test(e)?"format":"standalone"][t.month()]:Pr(this._monthsShort)?this._monthsShort:this._monthsShort.standalone},Yh.monthsParse=function(t,e,i){var n,a,o;if(this._monthsParseExact)return function(t,e,i){var n,a,o,r=t.toLocaleLowerCase();if(!this._monthsParse)for(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[],n=0;n<12;++n)o=Yr([2e3,n]),this._shortMonthsParse[n]=this.monthsShort(o,"").toLocaleLowerCase(),this._longMonthsParse[n]=this.months(o,"").toLocaleLowerCase();return i?"MMM"===e?-1!==(a=al.call(this._shortMonthsParse,r))?a:null:-1!==(a=al.call(this._longMonthsParse,r))?a:null:"MMM"===e?-1!==(a=al.call(this._shortMonthsParse,r))?a:-1!==(a=al.call(this._longMonthsParse,r))?a:null:-1!==(a=al.call(this._longMonthsParse,r))?a:-1!==(a=al.call(this._shortMonthsParse,r))?a:null}.call(this,t,e,i);for(this._monthsParse||(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[]),n=0;n<12;n++){if(a=Yr([2e3,n]),i&&!this._longMonthsParse[n]&&(this._longMonthsParse[n]=new RegExp("^"+this.months(a,"").replace(".","")+"$","i"),this._shortMonthsParse[n]=new RegExp("^"+this.monthsShort(a,"").replace(".","")+"$","i")),i||this._monthsParse[n]||(o="^"+this.months(a,"")+"|^"+this.monthsShort(a,""),this._monthsParse[n]=new RegExp(o.replace(".",""),"i")),i&&"MMMM"===e&&this._longMonthsParse[n].test(t))return n;if(i&&"MMM"===e&&this._shortMonthsParse[n].test(t))return n;if(!i&&this._monthsParse[n].test(t))return n}},Yh.monthsRegex=function(t){return this._monthsParseExact?(Br(this,"_monthsRegex")||gl.call(this),t?this._monthsStrictRegex:this._monthsRegex):(Br(this,"_monthsRegex")||(this._monthsRegex=fl),this._monthsStrictRegex&&t?this._monthsStrictRegex:this._monthsRegex)},Yh.monthsShortRegex=function(t){return this._monthsParseExact?(Br(this,"_monthsRegex")||gl.call(this),t?this._monthsShortStrictRegex:this._monthsShortRegex):(Br(this,"_monthsShortRegex")||(this._monthsShortRegex=ml),this._monthsShortStrictRegex&&t?this._monthsShortStrictRegex:this._monthsShortRegex)},Yh.week=function(t){return bl(t,this._week.dow,this._week.doy).week},Yh.firstDayOfYear=function(){return this._week.doy},Yh.firstDayOfWeek=function(){return this._week.dow},Yh.weekdays=function(t,e){return t?Pr(this._weekdays)?this._weekdays[t.day()]:this._weekdays[this._weekdays.isFormat.test(e)?"format":"standalone"][t.day()]:Pr(this._weekdays)?this._weekdays:this._weekdays.standalone},Yh.weekdaysMin=function(t){return t?this._weekdaysMin[t.day()]:this._weekdaysMin},Yh.weekdaysShort=function(t){return t?this._weekdaysShort[t.day()]:this._weekdaysShort},Yh.weekdaysParse=function(t,e,i){var n,a,o;if(this._weekdaysParseExact)return function(t,e,i){var n,a,o,r=t.toLocaleLowerCase();if(!this._weekdaysParse)for(this._weekdaysParse=[],this._shortWeekdaysParse=[],this._minWeekdaysParse=[],n=0;n<7;++n)o=Yr([2e3,1]).day(n),this._minWeekdaysParse[n]=this.weekdaysMin(o,"").toLocaleLowerCase(),this._shortWeekdaysParse[n]=this.weekdaysShort(o,"").toLocaleLowerCase(),this._weekdaysParse[n]=this.weekdays(o,"").toLocaleLowerCase();return i?"dddd"===e?-1!==(a=al.call(this._weekdaysParse,r))?a:null:"ddd"===e?-1!==(a=al.call(this._shortWeekdaysParse,r))?a:null:-1!==(a=al.call(this._minWeekdaysParse,r))?a:null:"dddd"===e?-1!==(a=al.call(this._weekdaysParse,r))?a:-1!==(a=al.call(this._shortWeekdaysParse,r))?a:-1!==(a=al.call(this._minWeekdaysParse,r))?a:null:"ddd"===e?-1!==(a=al.call(this._shortWeekdaysParse,r))?a:-1!==(a=al.call(this._weekdaysParse,r))?a:-1!==(a=al.call(this._minWeekdaysParse,r))?a:null:-1!==(a=al.call(this._minWeekdaysParse,r))?a:-1!==(a=al.call(this._weekdaysParse,r))?a:-1!==(a=al.call(this._shortWeekdaysParse,r))?a:null}.call(this,t,e,i);for(this._weekdaysParse||(this._weekdaysParse=[],this._minWeekdaysParse=[],this._shortWeekdaysParse=[],this._fullWeekdaysParse=[]),n=0;n<7;n++){if(a=Yr([2e3,1]).day(n),i&&!this._fullWeekdaysParse[n]&&(this._fullWeekdaysParse[n]=new RegExp("^"+this.weekdays(a,"").replace(".","\\.?")+"$","i"),this._shortWeekdaysParse[n]=new RegExp("^"+this.weekdaysShort(a,"").replace(".","\\.?")+"$","i"),this._minWeekdaysParse[n]=new RegExp("^"+this.weekdaysMin(a,"").replace(".","\\.?")+"$","i")),this._weekdaysParse[n]||(o="^"+this.weekdays(a,"")+"|^"+this.weekdaysShort(a,"")+"|^"+this.weekdaysMin(a,""),this._weekdaysParse[n]=new RegExp(o.replace(".",""),"i")),i&&"dddd"===e&&this._fullWeekdaysParse[n].test(t))return n;if(i&&"ddd"===e&&this._shortWeekdaysParse[n].test(t))return n;if(i&&"dd"===e&&this._minWeekdaysParse[n].test(t))return n;if(!i&&this._weekdaysParse[n].test(t))return n}},Yh.weekdaysRegex=function(t){return this._weekdaysParseExact?(Br(this,"_weekdaysRegex")||Hl.call(this),t?this._weekdaysStrictRegex:this._weekdaysRegex):(Br(this,"_weekdaysRegex")||(this._weekdaysRegex=Sl),this._weekdaysStrictRegex&&t?this._weekdaysStrictRegex:this._weekdaysRegex)},Yh.weekdaysShortRegex=function(t){return this._weekdaysParseExact?(Br(this,"_weekdaysRegex")||Hl.call(this),t?this._weekdaysShortStrictRegex:this._weekdaysShortRegex):(Br(this,"_weekdaysShortRegex")||(this._weekdaysShortRegex=Cl),this._weekdaysShortStrictRegex&&t?this._weekdaysShortStrictRegex:this._weekdaysShortRegex)},Yh.weekdaysMinRegex=function(t){return this._weekdaysParseExact?(Br(this,"_weekdaysRegex")||Hl.call(this),t?this._weekdaysMinStrictRegex:this._weekdaysMinRegex):(Br(this,"_weekdaysMinRegex")||(this._weekdaysMinRegex=kl),this._weekdaysMinStrictRegex&&t?this._weekdaysMinStrictRegex:this._weekdaysMinRegex)},Yh.isPM=function(t){return"p"===(t+"").toLowerCase().charAt(0)},Yh.meridiem=function(t,e,i){return t>11?i?"pm":"PM":i?"am":"AM"},Fl("en",{dayOfMonthOrdinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(t){var e=t%10;return t+(1===Jr(t%100/10)?"th":1===e?"st":2===e?"nd":3===e?"rd":"th")}}),Ir.lang=is("moment.lang is deprecated. Use moment.locale instead.",Fl),Ir.langData=is("moment.langData is deprecated. Use moment.localeData instead.",$l);var Wh=Math.abs;function Gh(t,e,i,n){var a=zh(e,i);return t._milliseconds+=n*a._milliseconds,t._days+=n*a._days,t._months+=n*a._months,t._bubble()}function Kh(t){return t<0?Math.floor(t):Math.ceil(t)}function Qh(t){return 4800*t/146097}function Zh(t){return 146097*t/4800}function Xh(t){return function(){return this.as(t)}}var Jh=Xh("ms"),tc=Xh("s"),ec=Xh("m"),ic=Xh("h"),nc=Xh("d"),ac=Xh("w"),oc=Xh("M"),rc=Xh("y");function sc(t){return function(){return this.isValid()?this._data[t]:NaN}}var lc=sc("milliseconds"),hc=sc("seconds"),cc=sc("minutes"),dc=sc("hours"),pc=sc("days"),uc=sc("months"),Ac=sc("years");var mc=Math.round,fc={ss:44,s:45,m:45,h:22,d:26,M:11};var gc=Math.abs;function vc(t){return(t>0)-(t<0)||+t}function _c(){if(!this.isValid())return this.localeData().invalidDate();var t,e,i=gc(this._milliseconds)/1e3,n=gc(this._days),a=gc(this._months);t=Xr(i/60),e=Xr(t/60),i%=60,t%=60;var o=Xr(a/12),r=a%=12,s=n,l=e,h=t,c=i?i.toFixed(3).replace(/\.?0+$/,""):"",d=this.asSeconds();if(!d)return"P0D";var p=d<0?"-":"",u=vc(this._months)!==vc(d)?"-":"",A=vc(this._days)!==vc(d)?"-":"",m=vc(this._milliseconds)!==vc(d)?"-":"";return p+"P"+(o?u+o+"Y":"")+(r?u+r+"M":"")+(s?A+s+"D":"")+(l||h||c?"T":"")+(l?m+l+"H":"")+(h?m+h+"M":"")+(c?m+c+"S":"")}var yc=dh.prototype;yc.isValid=function(){return this._isValid},yc.abs=function(){var t=this._data;return this._milliseconds=Wh(this._milliseconds),this._days=Wh(this._days),this._months=Wh(this._months),t.milliseconds=Wh(t.milliseconds),t.seconds=Wh(t.seconds),t.minutes=Wh(t.minutes),t.hours=Wh(t.hours),t.months=Wh(t.months),t.years=Wh(t.years),this},yc.add=function(t,e){return Gh(this,t,e,1)},yc.subtract=function(t,e){return Gh(this,t,e,-1)},yc.as=function(t){if(!this.isValid())return NaN;var e,i,n=this._milliseconds;if("month"===(t=ds(t))||"year"===t)return e=this._days+n/864e5,i=this._months+Qh(e),"month"===t?i:i/12;switch(e=this._days+Math.round(Zh(this._months)),t){case"week":return e/7+n/6048e5;case"day":return e+n/864e5;case"hour":return 24*e+n/36e5;case"minute":return 1440*e+n/6e4;case"second":return 86400*e+n/1e3;case"millisecond":return Math.floor(864e5*e)+n;default:throw new Error("Unknown unit "+t)}},yc.asMilliseconds=Jh,yc.asSeconds=tc,yc.asMinutes=ec,yc.asHours=ic,yc.asDays=nc,yc.asWeeks=ac,yc.asMonths=oc,yc.asYears=rc,yc.valueOf=function(){return this.isValid()?this._milliseconds+864e5*this._days+this._months%12*2592e6+31536e6*Jr(this._months/12):NaN},yc._bubble=function(){var t,e,i,n,a,o=this._milliseconds,r=this._days,s=this._months,l=this._data;return o>=0&&r>=0&&s>=0||o<=0&&r<=0&&s<=0||(o+=864e5*Kh(Zh(s)+r),r=0,s=0),l.milliseconds=o%1e3,t=Xr(o/1e3),l.seconds=t%60,e=Xr(t/60),l.minutes=e%60,i=Xr(e/60),l.hours=i%24,r+=Xr(i/24),s+=a=Xr(Qh(r)),r-=Kh(Zh(a)),n=Xr(s/12),s%=12,l.days=r,l.months=s,l.years=n,this},yc.clone=function(){return zh(this)},yc.get=function(t){return t=ds(t),this.isValid()?this[t+"s"]():NaN},yc.milliseconds=lc,yc.seconds=hc,yc.minutes=cc,yc.hours=dc,yc.days=pc,yc.weeks=function(){return Xr(this.days()/7)},yc.months=uc,yc.years=Ac,yc.humanize=function(t){if(!this.isValid())return this.localeData().invalidDate();var e=this.localeData(),i=function(t,e,i){var n=zh(t).abs(),a=mc(n.as("s")),o=mc(n.as("m")),r=mc(n.as("h")),s=mc(n.as("d")),l=mc(n.as("M")),h=mc(n.as("y")),c=a<=fc.ss&&["s",a]||a<fc.s&&["ss",a]||o<=1&&["m"]||o<fc.m&&["mm",o]||r<=1&&["h"]||r<fc.h&&["hh",r]||s<=1&&["d"]||s<fc.d&&["dd",s]||l<=1&&["M"]||l<fc.M&&["MM",l]||h<=1&&["y"]||["yy",h];return c[2]=e,c[3]=+t>0,c[4]=i,function(t,e,i,n,a){return a.relativeTime(e||1,!!i,t,n)}.apply(null,c)}(this,!t,e);return t&&(i=e.pastFuture(+this,i)),e.postformat(i)},yc.toISOString=_c,yc.toString=_c,yc.toJSON=_c,yc.locale=Vh,yc.localeData=Th,yc.toIsoString=is("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",_c),yc.lang=Lh,ys("X",0,0,"unix"),ys("x",0,0,"valueOf"),Fs("x",Ps),Fs("X",/[+-]?\d+(\.\d{1,3})?/),js("X",function(t,e,i){i._d=new Date(1e3*parseFloat(t,10))}),js("x",function(t,e,i){i._d=new Date(Jr(t))}),Ir.version="2.22.2",Lr=rh,Ir.fn=Bh,Ir.min=function(){return hh("isBefore",[].slice.call(arguments,0))},Ir.max=function(){return hh("isAfter",[].slice.call(arguments,0))},Ir.now=function(){return Date.now?Date.now():+new Date},Ir.utc=Yr,Ir.unix=function(t){return rh(1e3*t)},Ir.months=function(t,e){return qh(t,e,"months")},Ir.isDate=Dr,Ir.locale=Fl,Ir.invalid=Ur,Ir.duration=zh,Ir.isMoment=Zr,Ir.weekdays=function(t,e,i){return Uh(t,e,i,"weekdays")},Ir.parseZone=function(){return rh.apply(null,arguments).parseZone()},Ir.localeData=$l,Ir.isDuration=ph,Ir.monthsShort=function(t,e){return qh(t,e,"monthsShort")},Ir.weekdaysMin=function(t,e,i){return Uh(t,e,i,"weekdaysMin")},Ir.defineLocale=Bl,Ir.updateLocale=function(t,e){if(null!=e){var i,n,a=Pl;null!=(n=Dl(t))&&(a=n._config),(i=new ls(e=ss(a,e))).parentLocale=Ol[t],Ol[t]=i,Fl(t)}else null!=Ol[t]&&(null!=Ol[t].parentLocale?Ol[t]=Ol[t].parentLocale:null!=Ol[t]&&delete Ol[t]);return Ol[t]},Ir.locales=function(){return ns(Ol)},Ir.weekdaysShort=function(t,e,i){return Uh(t,e,i,"weekdaysShort")},Ir.normalizeUnits=ds,Ir.relativeTimeRounding=function(t){return void 0===t?mc:"function"==typeof t&&(mc=t,!0)},Ir.relativeTimeThreshold=function(t,e){return void 0!==fc[t]&&(void 0===e?fc[t]:(fc[t]=e,"s"===t&&(fc.ss=e-1),!0))},Ir.calendarFormat=function(t,e){var i=t.diff(e,"days",!0);return i<-6?"sameElse":i<-1?"lastWeek":i<0?"lastDay":i<1?"sameDay":i<2?"nextDay":i<7?"nextWeek":"sameElse"},Ir.prototype=Bh,Ir.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"YYYY-[W]WW",MONTH:"YYYY-MM"},Ir.defineLocale("zh-tw",{months:"一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),weekdaysShort:"週日_週一_週二_週三_週四_週五_週六".split("_"),weekdaysMin:"日_一_二_三_四_五_六".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日 HH:mm",LLLL:"YYYY年M月D日dddd HH:mm",l:"YYYY/M/D",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日dddd HH:mm"},meridiemParse:/凌晨|早上|上午|中午|下午|晚上/,meridiemHour:function(t,e){return 12===t&&(t=0),"凌晨"===e||"早上"===e||"上午"===e?t:"中午"===e?t>=11?t:t+12:"下午"===e||"晚上"===e?t+12:void 0},meridiem:function(t,e,i){var n=100*t+e;return n<600?"凌晨":n<900?"早上":n<1130?"上午":n<1230?"中午":n<1800?"下午":"晚上"},calendar:{sameDay:"[今天] LT",nextDay:"[明天] LT",nextWeek:"[下]dddd LT",lastDay:"[昨天] LT",lastWeek:"[上]dddd LT",sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}(日|月|週)/,ordinal:function(t,e){switch(e){case"d":case"D":case"DDD":return t+"日";case"M":return t+"月";case"w":case"W":return t+"週";default:return t}},relativeTime:{future:"%s內",past:"%s前",s:"幾秒",ss:"%d 秒",m:"1 分鐘",mm:"%d 分鐘",h:"1 小時",hh:"%d 小時",d:"1 天",dd:"%d 天",M:"1 個月",MM:"%d 個月",y:"1 年",yy:"%d 年"}}),Ir.defineLocale("ja",{months:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"日曜日_月曜日_火曜日_水曜日_木曜日_金曜日_土曜日".split("_"),weekdaysShort:"日_月_火_水_木_金_土".split("_"),weekdaysMin:"日_月_火_水_木_金_土".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日 HH:mm",LLLL:"YYYY年M月D日 dddd HH:mm",l:"YYYY/MM/DD",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日(ddd) HH:mm"},meridiemParse:/午前|午後/i,isPM:function(t){return"午後"===t},meridiem:function(t,e,i){return t<12?"午前":"午後"},calendar:{sameDay:"[今日] LT",nextDay:"[明日] LT",nextWeek:function(t){return t.week()<this.week()?"[来週]dddd LT":"dddd LT"},lastDay:"[昨日] LT",lastWeek:function(t){return this.week()<t.week()?"[先週]dddd LT":"dddd LT"},sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}日/,ordinal:function(t,e){switch(e){case"d":case"D":case"DDD":return t+"日";default:return t}},relativeTime:{future:"%s後",past:"%s前",s:"数秒",ss:"%d秒",m:"1分",mm:"%d分",h:"1時間",hh:"%d時間",d:"1日",dd:"%d日",M:"1ヶ月",MM:"%dヶ月",y:"1年",yy:"%d年"}}),Ir.locale(window.navigator.userLanguage||window.navigator.language);window.customElements.define("moe-post-header",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
}
...
`}static get properties(){return{boardId:{type:Number},threadNo:{type:Number},no:{type:Number},tripId:{type:String},createdAt:{type:String},flagAdminThreadStop:{type:Boolean,value:!1}}}formatCreatedAt(t){return Ir(t).calendar()}fullyFormatCreatedAt(t){return Ir(t).toString()}_onPostHeaderNoClick(t){if(this.flagAdminThreadStop)return!1;this.dispatchEvent(new CustomEvent("post-header-no-click",{composed:!0,bubbles:!0,detail:{boardId:this.get("boardId"),threadNo:this.get("threadNo"),no:this.get("no")}}))}});window.customElements.define("moe-post-image",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
    max-width: 100%;
...
`;bc.setAttribute("style","display: none;"),document.body.appendChild(bc.content),Cn({is:"paper-icon-button-light",behaviors:[Na],ready:function(){Ji(this,()=>{this.addEventListener("down",this._rippleDown.bind(this)),this.addEventListener("up",this._rippleUp.bind(this));var t=this.getEffectiveChildren()[0];this._rippleContainer=t,t.addEventListener("focus",this._rippleDown.bind(this)),t.addEventListener("blur",this._rippleUp.bind(this))})},_rippleDown:function(){this.getRipple().uiDownAction()},_rippleUp:function(){this.getRipple().uiUpAction()},ensureRipple:function(t){var e=this._ripple;Na.ensureRipple.apply(this,arguments),this._ripple&&this._ripple!==e&&(this._ripple.center=!0,this._ripple.classList.add("circle"))}});window.customElements.define("moe-post-menu-action-button",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
    position: relative;
...
`}static get properties(){return{boardId:{type:Number},threadNo:{type:Number},no:{type:Number},action:{type:String},text:{type:String},icon:{type:String}}}_onClick(t){this.blur()}});window.customElements.define("moe-rate",class extends qt{static get template(){return jt`
      <style>
        :host {
          display: block;
    ...
    `}static get properties(){return{dislike:{type:Number,value:0},like:{type:Number,value:0},disabled:{type:Boolean,reflectToAttribute:!0,value:!1}}}onLikeClick(t){this.dispatchEvent(new CustomEvent("onLikeClick"))}onDislikeClick(t){this.dispatchEvent(new CustomEvent("onDislikeClick"))}}),Cn({is:"iron-selector",behaviors:[Ho]});const zc={properties:{libraryLoaded:{type:Boolean,value:!1,notify:!0,readOnly:!0},libraryErrorMessage:{type:String,value:null,notify:!0,readOnly:!0}},observers:["_libraryUrlChanged(libraryUrl)"],_libraryUrlChanged:function(t){this._isReady&&this.libraryUrl&&this._loadLibrary()},_libraryLoadCallback:function(t,e){t?(ia._warn("Library load failed:",t.message),this._setLibraryErrorMessage(t.message)):(this._setLibraryErrorMessage(null),this._setLibraryLoaded(!0),this.notifyEvent&&this.fire(this.notifyEvent,e,{composed:!0}))},_loadLibrary:function(){wc.require(this.libraryUrl,this._libraryLoadCallback.bind(this),this.callbackName)},ready:function(){this._isReady=!0,this.libraryUrl&&this._loadLibrary()}};var wc={apiMap:{},require:function(t,e,i){var n=this.nameFromUrl(t);this.apiMap[n]||(this.apiMap[n]=new xc(n,t,i)),this.apiMap[n].requestNotify(e)},nameFromUrl:function(t){return t.replace(/[\:\/\%\?\&\.\=\-\,]/g,"_")+"_api"}},xc=function(t,e,i){if(this.notifiers=[],!i){if(!(e.indexOf(this.callbackMacro)>=0))return void(this.error=new Error("IronJsonpLibraryBehavior a %%callback%% parameter is required in libraryUrl"));i=t+"_loaded",e=e.replace(this.callbackMacro,i)}this.callbackName=i,window[this.callbackName]=this.success.bind(this),this.addScript(e)};xc.prototype={callbackMacro:"%%callback%%",loaded:!1,addScript:function(t){var e=document.createElement("script");e.src=t,e.onerror=this.handleError.bind(this);var i=document.querySelector("script")||document.body;i.parentNode.insertBefore(e,i),this.script=e},removeScript:function(){this.script.parentNode&&this.script.parentNode.removeChild(this.script),this.script=null},handleError:function(t){this.error=new Error("Library failed to load"),this.notifyAll(),this.cleanup()},success:function(){this.loaded=!0,this.result=Array.prototype.slice.call(arguments),this.notifyAll(),this.cleanup()},cleanup:function(){delete window[this.callbackName]},notifyAll:function(){this.notifiers.forEach(function(t){t(this.error,this.result)}.bind(this)),this.notifiers=[]},requestNotify:function(t){this.loaded||this.error?t(this.error,this.result):this.notifiers.push(t)}},Cn({is:"iron-jsonp-library",behaviors:[zc],properties:{libraryUrl:String,callbackName:String,notifyEvent:String}}),Cn({is:"google-youtube-api",behaviors:[zc],properties:{libraryUrl:{type:String,value:"https://www.youtube.com/iframe_api"},notifyEvent:{type:String,value:"api-load"},callbackName:{type:String,value:"onYouTubeIframeAPIReady"}},get api(){return YT}}),Cn({_template:jt`
    <style>
      :host {
        display: block;
      }
...
`}static get properties(){return{data:{type:Array,value:[],observer:"_dataChanged",notify:!0},width:{type:String},height:{type:String},showList:{type:Boolean,reflectToAttribute:!0,computed:"_computeShowList(data)"},listLength:{type:Number,value:0},playing:{type:Boolean,value:!1,notify:!0,reflectToAttribute:!0},playingVideoId:{type:String,reflectToAttribute:!0,notify:!0},prevPlayedVideo:{type:String},showPlaceHolder:{type:Boolean,computed:"_computeShowPlaceHolder(playing)"},placeHolderStyle:{type:String,computed:"_computePlaceHolderStyle(selectedVideoIndex, data)"},startVideoIndex:{type:Number,value:0},selectedVideoIndex:{type:Number,reflectToAttribute:!0},selectedVideoIndexDisplay:{type:Number,computed:"_computeSelectedVideoIndexDisplay(selectedVideoIndex)"},holderHref:{type:String,reflectToAttribute:!0,computed:"_computeHolderHref(selectedVideoIndex)"},holderTitle:{type:String,reflectToAttribute:!0,computed:"_computeHolderTitle(selectedVideoIndex)"},playSupported:{type:Boolean},playIcon:{type:String,computed:"_computePlayIcon(data)"},mobile:{type:Boolean,reflectToAttribute:!0},layoutClasses:{type:String,reflectToAttribute:!0,computed:"_computeLayoutClasses(mobile)"}}}ready(){super.ready(),this._mediaQuery(),window.addEventListener("resize",()=>this._mediaQuery())}_mediaQuery(){this.set("mobile",window.matchMedia("(max-width: 600px)").matches)}play(t){if(void 0!==t&&""!==t)this.mobile&&(this._checkPlaySupport(),this.playSupported&&(this.set("playing",!0),this.set("playingVideoId",t))),this.set("playing",!0),this.set("playingVideoId",t);else{if(!this.data||!md(this.data,"0.res_id"))return;this.play(this.data[0].res_id)}}stop(){this.set("prevPlayedVideo",this.playingVideoId),this.set("playingVideoId",""),this.set("playing",!1)}_dataChanged(){void 0!==this.data&&void 0!==this.data[0]&&(this.selectedVideoIndex=this.startVideoIndex?this.startVideoIndex:0,this.listLength=this.data.length,this.listLength>1&&this.set("list-toggle",!0),this.set("selectedVideoIndex",0),this.set("playing",!1))}_computePlaceHolderStyle(t,e){if(e.length>0&&t>=0)return"background-image: url("+this.data[t].thumb+");"}_handleStateChanged(t){0===md(t,"detail.data")&&this._nextVideo()}_handleHolderTap(t){this.play(md(this.data,`${this.selectedVideoIndex}.res_id`))}_handleChipTap(t){this.play(t.model.item.res_id)}_handlePlayControl(t){switch(t.currentTarget.getAttribute("action-type")){case"next":this._nextVideo();break;case"prev":this._prevVideo();break;case"stop":this.stop()}}_nextVideo(){this.selectedVideoIndex<this.data.length-1?this.selectedVideoIndex++:this.selectedVideoIndex=0;var t=md(this.data,this.selectedVideoIndex+".res_id");t?this.play(t):console.warn("videoId not found at data[selectedVideoIndex]: "+this.selectedVideoIndex)}_prevVideo(){this.selectedVideoIndex>0?this.selectedVideoIndex--:this.selectedVideoIndex=this.data.length-1,this.play(this.data[this.selectedVideoIndex].res_id)}_computeLayoutClasses(t){return t?"layout vertical":"layout horizontal"}_computeShowList(t){return(t||[]).length>1}_computePlayIcon(t){return t[0]&&void 0!==t?"av:play-arrow":"refresh"}_computeContainerClass(t){return t?"layout vertical":"layout horizontal"}_computeSelectedVideoIndexDisplay(t){return t+1}_computeShowPlaceHolder(t){return!t}_computeHolderHref(t){return"https://www.youtube.com/watch?v="+this.data[t].res_id}_computeHolderTitle(t){return this.data[t].title}_computeStartIndex(t){return t}_checkPlaySupport(){}_mobilePlay(t){}});window.customElements.define("moe-embeds",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
    width: 100%;
...
`}static get properties(){return{boardId:{type:Number},threadNo:{type:Number},no:{type:Number},embeds:{type:Array},images:{type:Array},com:{type:String},tripId:{type:String},createdAt:{type:String},displayShowMore:{type:Boolean,value:!1},flagAdminThreadStop:{type:Boolean,value:!1}}}_onMoePostCommentProcessed(){this.set("displayShowMore",this.$.comment.scrollHeight>this.$.comment.clientHeight)}_onShowMoreClick(){this.$.comment.style.maxHeight=this.$.comment.scrollHeight+"px",this.set("displayShowMore",!1)}});var fd=function(){function t(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,i,n){return i&&t(e.prototype,i),n&&t(e,n),e}}();function gd(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var vd=function(){function t(){var e=this;gd(this,t),this.interceptors=[],this.fetch=function(){for(var t=arguments.length,i=Array(t),n=0;n<t;n++)i[n]=arguments[n];return e.interceptorWrapper.apply(e,[fetch].concat(i))}}return fd(t,[{key:"addInterceptors",value:function(t){var e=this,i=[];return Array.isArray(t)?t.map(function(t){return i.push(e.interceptors.length),e.interceptors.push(t)}):t instanceof Object&&(i.push(this.interceptors.length),this.interceptors.push(t)),this.updateInterceptors(),function(){return e.removeInterceptors(i)}}},{key:"removeInterceptors",value:function(t){var e=this;Array.isArray(t)&&(t.map(function(t){return e.interceptors.splice(t,1)}),this.updateInterceptors())}},{key:"updateInterceptors",value:function(){this.reversedInterceptors=this.interceptors.reduce(function(t,e){return[e].concat(t)},[])}},{key:"clearInterceptors",value:function(){this.interceptors=[],this.updateInterceptors()}},{key:"interceptorWrapper",value:function(t){for(var e=arguments.length,i=Array(e>1?e-1:0),n=1;n<e;n++)i[n-1]=arguments[n];var a=Promise.resolve(i);return this.reversedInterceptors.forEach(function(t){var e=t.request,n=t.requestError;(e||n)&&(a=a.then(function(){return e.apply(void 0,i)},n))}),a=a.then(function(){return t.apply(void 0,i)}),this.reversedInterceptors.forEach(function(t){var e=t.response,i=t.responseError;(e||i)&&(a=a.then(e,i))}),a}}]),t}(),_d=function(t){function e(t){var i=t.url,n=t.interceptors,a=t.headers,o=t.onStart,r=t.onEnd,s=t.omitEmptyVariables,l=void 0!==s&&s,h=t.requestOptions,c=void 0===h?{}:h;gd(this,e);var d=function(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}(this,(e.__proto__||Object.getPrototypeOf(e)).call(this));return d.requestObject=Object.assign({},{method:"POST",headers:Object.assign({},{Accept:"application/json","Content-Type":"application/json"},a),credentials:"same-origin"},c),d.url=i,d.omitEmptyVariables=l,d.requestQueueLength=0,d.EnumMap={},d.callbacks={onStart:o,onEnd:r},d.addInterceptors(n),d}return function(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}(e,vd),fd(e,[{key:"query",value:function(t){var e=this,i=t.operationName,n=t.query,a=t.variables,o=t.opts,r=void 0===o?{}:o,s=t.requestOptions,l=void 0===s?{}:s,h=Object.assign({},this.requestObject,l),c={operationName:i,query:n,variables:this.omitEmptyVariables||r.omitEmptyVariables?this.doOmitEmptyVariables(a):a};return h.body=JSON.stringify(c),this.onStart(),this.fetch(this.url,h).then(function(t){return t.ok?t.json():{errors:[{message:t.statusText,stack:t}]}}).then(function(t){var i=t.data,n=t.errors;return new Promise(function(t,a){return e.onEnd(),i?Object.keys(i).every(function(t){return!i[t]})?a(n):t({data:i,errors:n}):a(n||[{}])})})}},{key:"getUrl",value:function(){return this.url}},{key:"setUrl",value:function(t){this.url=t}},{key:"getEnumTypes",value:function(t){var e=this,i={},n=t.filter(function(t){return!e.EnumMap[t]||(i[t]=e.EnumMap[t],!1)});if(!n.length)return new Promise(function(t){t({data:i})});var a="\n      query {\n        "+n.map(function(t){return t+': __type(name: "'+t+'") {\n        ...EnumFragment\n      }'}).join("\n")+"\n      }\n      \n      fragment EnumFragment on __Type {\n        kind\n        description\n        enumValues {\n          name\n          description\n        }\n      }",o=Object.assign({},this.requestObject);return o.body=JSON.stringify({query:a}),this.onStart(),this.fetch(this.url,o).then(function(t){return t.ok?t.json():{errors:[{message:t.statusText,stack:t}]}}).then(function(t){var n=t.data,a=t.errors;return new Promise(function(t,o){if(e.onEnd(),!n)return o(a||[{message:"Do not get any data."}]);if(Object.keys(n).every(function(t){return!n[t]})&&a&&a.length)return o(a);var r=Object.assign(i,n);return Object.keys(n).map(function(t){return e.EnumMap[t]=n[t],t}),t({data:r,errors:a})})})}},{key:"onStart",value:function(){this.requestQueueLength++,this.requestQueueLength>1||!this.callbacks.onStart||this.callbacks.onStart(this.requestQueueLength)}},{key:"onEnd",value:function(){this.requestQueueLength--,!this.requestQueueLength&&this.callbacks.onEnd&&this.callbacks.onEnd(this.requestQueueLength)}},{key:"doOmitEmptyVariables",value:function(t){var e=this,i={};return Object.keys(t).map(function(n){var a=t[n];return"string"==typeof a&&0===a.length||null==a?n:(a instanceof Object?i[n]=e.doOmitEmptyVariables(a):i[n]=a,n)}),i}}]),e}();class yd extends qt{static get template(){return jt``}static get properties(){return{server:{type:String,observer:"_observeServer"},fetchQL:{type:Object}}}static postTransformer(t,e,i,n){return Object.assign({},n,{images:n.images.map(n=>yd.imageTransformer(t,e,i,n))})}static imageTransformer(t,e,i,n){const a=t=>"function"==typeof i[t]?i[t]:t=>t;return Object.assign({},n,{imageSrc:a(n.imageServer)(n.imageSrc,t,e),thumbSrc:a(n.thumbServer)(n.thumbSrc,t,e)})}getBoardById(t){return this.fetchQL.query({operationName:"",query:`{\n    getBoardById(boardId: ${t}) {\n        id\n        subdomain\n        alias\n        name\n        description\n        config {\n            topLinks {\n                link\n                text\n            }\n            descriptionLinks {\n                link\n                text\n            }\n        }\n        embedRequestServer\n        postServer\n        pollServer\n    }\n    getValidationCriteria(boardId: ${t}) {\n        nameMaxLength\n        emailMaxLength\n        subjectMaxLength\n        commentMaxLength\n        fileMaxSize\n        videoMaxEmbeds\n        pollTitleMaxLength\n        pollMinItems\n        pollMaxItems\n        pollItemMaxLength    \n    }\n}`})}getThreads(t,e,i,n,a){return this.fetchQL.query({operationName:"",query:`{\n  getThreads(boardId:${t}, offset:${e},limit:${i}) {\n      ...ThreadFields\n      firstPost {\n        ...PostFields\n      }\n      replies(offset:${n},limit:${a}) {\n        ...PostFields\n      }\n  }\n}\n${this.FRAGMENT_THREAD_FIELDS}\n${this.FRAGMENT_POST_FIELDS}`})}getThreadByNo(t,e,i,n){return this.fetchQL.query({operationName:"",query:`{\n  getThreadByNo(boardId:${t}, no:${e}) {\n      ...ThreadFields\n      firstPost {\n        ...PostFields\n      }\n      replies(offset:${i},limit:${n}) {\n        ...PostFields\n      }\n  }\n}\n${this.FRAGMENT_THREAD_FIELDS}\n${this.FRAGMENT_POST_FIELDS}`})}getReplyAck(t,e,i){return this.fetchQL.query({operationName:"",query:`{\n    getThreadByNo(boardId:${t},no:${e}) {\n        boardId\n        no\n        replyCount\n    }\n    getPostByNo(boardId:${t},no:${i}) {\n        ...PostFields\n    }\n}\n${this.FRAGMENT_POST_FIELDS}`})}getDeleteReplyAck(t,e){return this.fetchQL.query({operationName:"",query:`{\n    getThreadByNo(boardId:${t},no:${e}) {\n        boardId\n        no\n        replyCount\n    }\n}`})}getMoreReplies(t,e,i,n){return this.fetchQL.query({operationName:"",query:`{\n    getMoreReplies(boardId:${t},no:${e},before:${i},limit:${n}) { ...PostFields }\n}\n${this.FRAGMENT_POST_FIELDS}`})}get FRAGMENT_THREAD_FIELDS(){return"fragment ThreadFields on Thread {\n    boardId\n    no\n    replyCount\n    flagAdminSticky\n    flagAdminThreadStop\n    flagAdminSage        \n}"}get FRAGMENT_POST_FIELDS(){return"fragment PostFields on Post {\n  id\n  boardId\n  threadNo\n  no\n  sub\n  tripId\n  name\n  email\n  com\n  embeds {\n    data\n  }\n  images {\n    imageServer\n    imageSrc\n    imageHeight\n    imageWidth\n    thumbServer\n    thumbSrc\n    thumbHeight\n    thumbWidth\n  }\n  poll {\n    subject\n    items {\n      text\n      votes\n    }\n    voted\n  }\n  rate {\n    like\n    dislike\n    rated\n  }\n  createdAt\n  bumpedAt\n}"}_observeServer(t){this.fetchQL=new _d({url:t})}}window.customElements.define("moe-graphql",yd);var bd=function(t){var e,i=t.Symbol;return"function"==typeof i?i.observable?e=i.observable:(e=i("observable"),i.observable=e):e="@@observable",e}("undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof module?module:Function("return this")());const zd={INIT:"@@redux/INIT"+Math.random().toString(36).substring(7).split("").join("."),REPLACE:"@@redux/REPLACE"+Math.random().toString(36).substring(7).split("").join(".")};const wd="UPDATE_THREADS",xd="UPDATE_THREAD",Md="REMOVE_THREAD",Sd="PREPEND_REPLIES_TO_THREAD",Cd="APPEND_REPLY_TO_THREAD",kd="REMOVE_REPLY_FROM_THREAD";var Hd=200;function Vd(t){var e=this.__data__=new Xc(t);this.size=e.size}Vd.prototype.clear=function(){this.__data__=new Xc,this.size=0},Vd.prototype.delete=function(t){var e=this.__data__,i=e.delete(t);return this.size=e.size,i},Vd.prototype.get=function(t){return this.__data__.get(t)},Vd.prototype.has=function(t){return this.__data__.has(t)},Vd.prototype.set=function(t,e){var i=this.__data__;if(i instanceof Xc){var n=i.__data__;if(!Jc||n.length<Hd-1)return n.push([t,e]),this.size=++i.size,this;i=this.__data__=new ed(n)}return i.set(t,e),this.size=i.size,this};var Ld=function(){try{var t=$c(Object,"defineProperty");return t({},"",{}),t}catch(t){}}();function Td(t,e,i){"__proto__"==e&&Ld?Ld(t,e,{configurable:!0,enumerable:!0,value:i,writable:!0}):t[e]=i}function Ed(t,e,i){(void 0===i||Kc(t[e],i))&&(void 0!==i||e in t)||Td(t,e,i)}var Id,Pd=function(t,e,i){for(var n=-1,a=Object(t),o=i(t),r=o.length;r--;){var s=o[Id?r:++n];if(!1===e(a[s],s,a))break}return t},Od="object"==typeof exports&&exports&&!exports.nodeType&&exports,Rd=Od&&"object"==typeof module&&module&&!module.nodeType&&module,Nd=Rd&&Rd.exports===Od?Yo.Buffer:void 0,Dd=Nd?Nd.allocUnsafe:void 0;var Fd=Yo.Uint8Array;function Bd(t,e){var i,n,a=e?(i=t.buffer,n=new i.constructor(i.byteLength),new Fd(n).set(new Fd(i)),n):t.buffer;return new t.constructor(a,t.byteOffset,t.length)}var $d=Object.create,Yd=function(){function t(){}return function(e){if(!tr(e))return{};if($d)return $d(e);t.prototype=e;var i=new t;return t.prototype=void 0,i}}();var jd,qd,Ud=(jd=Object.getPrototypeOf,qd=Object,function(t){return jd(qd(t))}),Wd=Object.prototype;function Gd(t){var e=t&&t.constructor;return t===("function"==typeof e&&e.prototype||Wd)}var Kd="[object Arguments]";function Qd(t){return Sc(t)&&Jo(t)==Kd}var Zd=Object.prototype,Xd=Zd.hasOwnProperty,Jd=Zd.propertyIsEnumerable,tp=Qd(function(){return arguments}())?Qd:function(t){return Sc(t)&&Xd.call(t,"callee")&&!Jd.call(t,"callee")};var ep="object"==typeof exports&&exports&&!exports.nodeType&&exports,ip=ep&&"object"==typeof module&&module&&!module.nodeType&&module,np=ip&&ip.exports===ep?Yo.Buffer:void 0,ap=(np?np.isBuffer:void 0)||function(){return!1},op="[object Object]",rp=Function.prototype,sp=Object.prototype,lp=rp.toString,hp=sp.hasOwnProperty,cp=lp.call(Object);function dp(t){if(!Sc(t)||Jo(t)!=op)return!1;var e=Ud(t);if(null===e)return!0;var i=hp.call(e,"constructor")&&e.constructor;return"function"==typeof i&&i instanceof i&&lp.call(i)==cp}var pp={};pp["[object Float32Array]"]=pp["[object Float64Array]"]=pp["[object Int8Array]"]=pp["[object Int16Array]"]=pp["[object Int32Array]"]=pp["[object Uint8Array]"]=pp["[object Uint8ClampedArray]"]=pp["[object Uint16Array]"]=pp["[object Uint32Array]"]=!0,pp["[object Arguments]"]=pp["[object Array]"]=pp["[object ArrayBuffer]"]=pp["[object Boolean]"]=pp["[object DataView]"]=pp["[object Date]"]=pp["[object Error]"]=pp["[object Function]"]=pp["[object Map]"]=pp["[object Number]"]=pp["[object Object]"]=pp["[object RegExp]"]=pp["[object Set]"]=pp["[object String]"]=pp["[object WeakMap]"]=!1;var up="object"==typeof exports&&exports&&!exports.nodeType&&exports,Ap=up&&"object"==typeof module&&module&&!module.nodeType&&module,mp=Ap&&Ap.exports===up&&Bo.process,fp=function(){try{var t=Ap&&Ap.require&&Ap.require("util").types;return t||mp&&mp.binding&&mp.binding("util")}catch(t){}}(),gp=fp&&fp.isTypedArray,vp=gp?function(t){return function(e){return t(e)}}(gp):function(t){return Sc(t)&&sr(t.length)&&!!pp[Jo(t)]};function _p(t,e){if("__proto__"!=e)return t[e]}var yp=Object.prototype.hasOwnProperty;function bp(t,e,i){var n=t[e];yp.call(t,e)&&Kc(n,i)&&(void 0!==i||e in t)||Td(t,e,i)}var zp=9007199254740991,wp=/^(?:0|[1-9]\d*)$/;function xp(t,e){var i=typeof t;return!!(e=null==e?zp:e)&&("number"==i||"symbol"!=i&&wp.test(t))&&t>-1&&t%1==0&&t<e}var Mp=Object.prototype.hasOwnProperty;function Sp(t,e){var i=Mc(t),n=!i&&tp(t),a=!i&&!n&&ap(t),o=!i&&!n&&!a&&vp(t),r=i||n||a||o,s=r?function(t,e){for(var i=-1,n=Array(t);++i<t;)n[i]=e(i);return n}(t.length,String):[],l=s.length;for(var h in t)!e&&!Mp.call(t,h)||r&&("length"==h||a&&("offset"==h||"parent"==h)||o&&("buffer"==h||"byteLength"==h||"byteOffset"==h)||xp(h,l))||s.push(h);return s}var Cp=Object.prototype.hasOwnProperty;function kp(t){if(!tr(t))return function(t){var e=[];if(null!=t)for(var i in Object(t))e.push(i);return e}(t);var e=Gd(t),i=[];for(var n in t)("constructor"!=n||!e&&Cp.call(t,n))&&i.push(n);return i}function Hp(t){return lr(t)?Sp(t,!0):kp(t)}function Vp(t){return function(t,e,i,n){var a=!i;i||(i={});for(var o=-1,r=e.length;++o<r;){var s=e[o],l=n?n(i[s],t[s],s,i,t):void 0;void 0===l&&(l=t[s]),a?Td(i,s,l):bp(i,s,l)}return i}(t,Hp(t))}function Lp(t,e,i,n,a,o,r){var s=_p(t,i),l=_p(e,i),h=r.get(l);if(h)Ed(t,i,h);else{var c,d=o?o(s,l,i+"",t,e,r):void 0,p=void 0===d;if(p){var u=Mc(l),A=!u&&ap(l),m=!u&&!A&&vp(l);d=l,u||A||m?Mc(s)?d=s:Sc(c=s)&&lr(c)?d=function(t,e){var i=-1,n=t.length;for(e||(e=Array(n));++i<n;)e[i]=t[i];return e}(s):A?(p=!1,d=function(t,e){if(e)return t.slice();var i=t.length,n=Dd?Dd(i):new t.constructor(i);return t.copy(n),n}(l,!0)):m?(p=!1,d=Bd(l,!0)):d=[]:dp(l)||tp(l)?(d=s,tp(s)?d=Vp(s):tr(s)&&!or(s)||(d=function(t){return"function"!=typeof t.constructor||Gd(t)?{}:Yd(Ud(t))}(l))):p=!1}p&&(r.set(l,d),a(d,l,n,o,r),r.delete(l)),Ed(t,i,d)}}function Tp(t,e,i,n,a){t!==e&&Pd(e,function(o,r){if(tr(o))a||(a=new Vd),Lp(t,e,r,i,Tp,n,a);else{var s=n?n(_p(t,r),o,r+"",t,e,a):void 0;void 0===s&&(s=o),Ed(t,r,s)}},Hp)}function Ep(t){return t}var Ip=Math.max;var Pp=Ld?function(t,e){return Ld(t,"toString",{configurable:!0,enumerable:!1,value:(i=e,function(){return i}),writable:!0});var i}:Ep,Op=800,Rp=16,Np=Date.now;var Dp=function(t){var e=0,i=0;return function(){var n=Np(),a=Rp-(n-i);if(i=n,a>0){if(++e>=Op)return arguments[0]}else e=0;return t.apply(void 0,arguments)}}(Pp);function Fp(t,e){return Dp(function(t,e,i){return e=Ip(void 0===e?t.length-1:e,0),function(){for(var n=arguments,a=-1,o=Ip(n.length-e,0),r=Array(o);++a<o;)r[a]=n[e+a];a=-1;for(var s=Array(e+1);++a<e;)s[a]=n[a];return s[e]=i(r),function(t,e,i){switch(i.length){case 0:return t.call(e);case 1:return t.call(e,i[0]);case 2:return t.call(e,i[0],i[1]);case 3:return t.call(e,i[0],i[1],i[2])}return t.apply(e,i)}(t,this,s)}}(t,e,Ep),t+"")}var Bp,$p=(Bp=function(t,e,i){Tp(t,e,i)},Fp(function(t,e){var i=-1,n=e.length,a=n>1?e[n-1]:void 0,o=n>2?e[2]:void 0;for(a=Bp.length>3&&"function"==typeof a?(n--,a):void 0,o&&function(t,e,i){if(!tr(i))return!1;var n=typeof e;return!!("number"==n?lr(i)&&xp(e,i.length):"string"==n&&e in i)&&Kc(i[e],t)}(e[0],e[1],o)&&(a=n<3?void 0:a,n=1),t=Object(t);++i<n;){var r=e[i];r&&Bp(t,r,i,a)}return t}));const Yp=t=>`${t.boardId}:${t.no}`,jp=(t,e)=>(t.threadMap[Yp(e)]?t.threadMap[Yp(e)]=$p(t.threadMap[Yp(e)],e):Object.assign(t.threadMap,{[Yp(e)]:e}),t),qp=t=>`${t.boardId}:${t.no}`,Up=(t,e)=>(t.replyMap[qp(e)]?t.replyMap[qp(e)]=$p(t.replyMap[qp(e)],e):Object.assign(t.replyMap,{[qp(e)]:e}),t),Wp=function(t){if(!t)throw new TypeError("PolymerRedux: expecting a redux store.");if(!["getState","dispatch","subscribe"].every(e=>"function"==typeof t[e]))throw new TypeError("PolymerRedux: invalid store object.");const e=new Map,i=(t,e)=>{let i={};for(;t;)i=Object.assign({},t[e],i),t=Object.getPrototypeOf(t);return i};return n=>(class extends n{constructor(){super();const t=i(this.constructor,"actions");Object.defineProperty(this,"_reduxActions",{configurable:!0,value:t})}connectedCallback(){super.connectedCallback(),((i,n)=>{const a=Object.keys(n).filter(t=>{const e=n[t];return!!Object.prototype.hasOwnProperty.call(e,"statePath")&&(!e.readOnly&&e.notify&&console.warn(`PolymerRedux: <${i.constructor.is}>.${t} has "notify" enabled, two-way bindings goes against Redux's paradigm`),!0)}),o=t=>{let e=!1;a.forEach(a=>{const{statePath:o}=n[a],r="function"==typeof o?o.call(i,t):I(t,o),s=i._setPendingPropertyOrPath(a,r,!0);e=e||s}),e&&i._invalidateProperties()},r=t.subscribe(()=>{const e=t.getState();o(e),i.dispatchEvent(new CustomEvent("state-changed",{detail:e}))});e.set(i,r),o(t.getState())})(this,i(this.constructor,"properties"))}disconnectedCallback(){super.disconnectedCallback(),(t=>{const i=e.get(t);"function"==typeof i&&i()})(this)}dispatch(...e){const i=this._reduxActions;let[n]=e;if("string"==typeof n){if("function"!=typeof i[n])throw new TypeError(`PolymerRedux: <${this.constructor.is}> invalid action creator "${n}"`);n=i[n](...e.slice(1))}if("function"==typeof n){const t=n;n=((...e)=>(e.splice(0,1,(...t)=>this.dispatch(...t)),t(...e))),Object.keys(t).forEach(e=>{n[e]=t[e]})}return t.dispatch(n)}getState(){return t.getState()}})}(function t(e,i,n){if("function"==typeof i&&void 0===n&&(n=i,i=void 0),void 0!==n){if("function"!=typeof n)throw new Error("Expected the enhancer to be a function.");return n(t)(e,i)}if("function"!=typeof e)throw new Error("Expected the reducer to be a function.");let a=e,o=i,r=[],s=r,l=!1;function h(){s===r&&(s=r.slice())}function c(){if(l)throw new Error("You may not call store.getState() while the reducer is executing. The reducer has already received the state as an argument. Pass it down from the top reducer instead of reading it from the store.");return o}function d(t){if("function"!=typeof t)throw new Error("Expected the listener to be a function.");if(l)throw new Error("You may not call store.subscribe() while the reducer is executing. If you would like to be notified after the store has been updated, subscribe from a component and invoke store.getState() in the callback to access the latest state. See https://redux.js.org/api-reference/store#subscribe(listener) for more details.");let e=!0;return h(),s.push(t),function(){if(!e)return;if(l)throw new Error("You may not unsubscribe from a store listener while the reducer is executing. See https://redux.js.org/api-reference/store#subscribe(listener) for more details.");e=!1,h();const i=s.indexOf(t);s.splice(i,1)}}function p(t){if(!function(t){if("object"!=typeof t||null===t)return!1;let e=t;for(;null!==Object.getPrototypeOf(e);)e=Object.getPrototypeOf(e);return Object.getPrototypeOf(t)===e}(t))throw new Error("Actions must be plain objects. Use custom middleware for async actions.");if(void 0===t.type)throw new Error('Actions may not have an undefined "type" property. Have you misspelled a constant?');if(l)throw new Error("Reducers may not dispatch actions.");try{l=!0,o=a(o,t)}finally{l=!1}const e=r=s;for(let t=0;t<e.length;t++)(0,e[t])();return t}return p({type:zd.INIT}),{dispatch:p,subscribe:d,getState:c,replaceReducer:function(t){if("function"!=typeof t)throw new Error("Expected the nextReducer to be a function.");a=t,p({type:zd.REPLACE})},[bd]:function(){const t=d;return{subscribe(e){if("object"!=typeof e||null===e)throw new TypeError("Expected the observer to be an object.");function i(){e.next&&e.next(c())}return i(),{unsubscribe:t(i)}},[bd](){return this}}}}}(function(t,e){switch(e.type){case wd:return e.threads.forEach(e=>{e.replies.forEach(e=>t=Up(t,e)),e.replies=e.replies.map(t=>qp(t)),t=jp(t,e)}),t.pageThreadKeys=e.threads.map(t=>`${t.boardId}:${t.no}`),t;case xd:return jp(t,e.thread);case Md:{t.threadMap[Yp(e.thread)].replies.forEach(e=>delete t.replyMap[qp(e)]);const i=t.pageThreadKeys.indexOf(Yp(e.thread));return i>=0&&t.pageThreadKeys.splice(i,1),delete t.threadMap[Yp(e.thread)],t}case Sd:for(const i of e.replies){const e=`${i.boardId}:${i.threadNo}`;t.threadMap[e].replies.unshift(qp(i)),t=Up(t,i)}return t;case Cd:{const i=e.reply,n=`${i.boardId}:${i.threadNo}`;return t.threadMap[n].replies.push(qp(i)),t=Up(t,i)}case kd:{const i=e.reply,n=`${i.boardId}:${i.threadNo}`,a=t.threadMap[n].replies.indexOf(qp(i));return a>=0&&t.threadMap[n].replies.splice(a,1),delete t.replyMap[qp(i)],t}case"UPDATE_VALIDATION_CRITERIA":return Object.assign(t.validationCriteria,e.validationCriteria),t;default:return t}},{threadMap:{},pageThreadKeys:[],replyMap:{},validationCriteria:{nameMaxLength:0,emailMaxLength:0,subjectMaxLength:0,commentMaxLength:0,fileMaxSize:0,videoMaxEmbeds:0,pollTitleMaxLength:0,pollMinItems:0,pollMaxItems:0,pollItemMaxLength:0}},function(...t){return 0===t.length?t=>t:1===t.length?t[0]:t.reduce((t,e)=>(...i)=>t(e(...i)))}(window.devToolsExtension?window.devToolsExtension():t=>t))),Gp=t=>t.pageThreadKeys.map(e=>t.threadMap[e]);window.customElements.define("moe-thread",class extends(Hn(Wp(qt))){static get template(){return jt`
<style>
    :host {
        display: block;
    }
...
`}static get properties(){return{boardId:Number,boardAlias:String,boardSubdomain:String,route:{type:Object,notify:!0},routeData:{type:Object,notify:!0},graphqlServer:String,pollServer:String,imageServers:Object,isAdmin:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0},threads:{type:Array,statePath:Gp},page:{type:Number,reflectToAttribute:!0,observer:"_observePage"},threadsPerPage:Number,repliesPerThread:Number,loading:{type:Boolean,value:!0},hasPrevPage:{type:Boolean,computed:"_computeHasPrevPage(page)"},hasNextPage:{type:Boolean,computed:"_computeHasNextPage(threads)"}}}static get observers(){return["_observeRoutePage(route.path)"]}ready(){super.ready(),this.addEventListener("reply-ack",t=>{this.$.moeGraphQL.getReplyAck(t.detail.boardId,t.detail.threadNo,t.detail.no).then(t=>{this.dispatch({type:xd,thread:t.data.getThreadByNo}),this.dispatch({type:Cd,reply:this._postTransformer(t.data.getPostByNo)})}).catch(t=>console.error(t))}),this.addEventListener("create-thread-ack",t=>{this.goHome()})}load(){return window.scrollTo({left:0,top:0,behavior:"instant"}),this.set("loading",!0),this.$.moeGraphQL.getThreads(this.boardId,this.page*this.threadsPerPage,this.threadsPerPage,0,this.repliesPerThread).then(t=>{this.dispatch({type:wd,threads:t.data.getThreads.map(t=>this._threadTransformer(t))})}).catch(t=>console.log(t)).finally(()=>this.set("loading",!1))}_threadTransformer(t){return Object.assign({},t,{firstPost:this._postTransformer(t.firstPost),replies:(t.replies||[]).reverse().map(t=>this._postTransformer(t))})}_postTransformer(t){return yd.postTransformer(this.boardSubdomain,this.boardAlias,this.imageServers,t)}reload(){return this.set("threads",[]),this.load()}goHome(){return this.set("routeData.page",0),this.reload()}loadPrevPage(){this.hasPrevPage&&this.set("routeData.page",this.page-1)}loadNextPage(){this.hasNextPage&&this.set("routeData.page",this.page+1)}_computeHasPrevPage(t){return t>0}_computeHasNextPage(t){return t.length>0}_observePage(t){this.set("threads",[]),this.load(),this.dispatchEvent(new CustomEvent("page-change",{detail:{page:t}}))}_observeRoutePage(){console.log("moe-threads: _observeRoutePage",this.route,this.routeData);const t=parseInt(this.routeData.page);"number"==typeof t&&t>=0?this.set("page",t):this.set("route.path","/0")}_sortByBump(t,e){if(t=t.firstPost,e=e.firstPost,!t.bumpedAt&&!e.bumpedAt)return 0;if(!t.bumpedAt&&e.bumpedAt)return-1;if(t.bumpedAt&&!e.bumpedAt)return 1;const i=new Date(t.bumpedAt),n=new Date(e.bumpedAt);return i===n?0:i<n?1:0}});const Kp={properties:{value:{type:Number,value:0,notify:!0,reflectToAttribute:!0},min:{type:Number,value:0,notify:!0},max:{type:Number,value:100,notify:!0},step:{type:Number,value:1,notify:!0},ratio:{type:Number,value:0,readOnly:!0,notify:!0}},observers:["_update(value, min, max, step)"],_calcRatio:function(t){return(this._clampValue(t)-this.min)/(this.max-this.min)},_clampValue:function(t){return Math.min(this.max,Math.max(this.min,this._calcStep(t)))},_calcStep:function(t){if(t=parseFloat(t),!this.step)return t;var e=Math.round((t-this.min)/this.step);return this.step<1?e/(1/this.step)+this.min:e*this.step+this.min},_validateValue:function(){var t=this._clampValue(this.value);return this.value=this.oldValue=isNaN(t)?this.oldValue:t,this.value!==t},_update:function(){this._validateValue(),this._setRatio(100*this._calcRatio(this.value))}};Cn({_template:jt`
    <style>
      :host {
        display: block;
        width: 200px;
...
`,is:"paper-progress",behaviors:[Kp],properties:{secondaryProgress:{type:Number,value:0},secondaryRatio:{type:Number,value:0,readOnly:!0},indeterminate:{type:Boolean,value:!1,observer:"_toggleIndeterminate"},disabled:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_disabledChanged"}},observers:["_progressChanged(secondaryProgress, value, min, max, indeterminate)"],hostAttributes:{role:"progressbar"},_toggleIndeterminate:function(t){this.toggleClass("indeterminate",t,this.$.primaryProgress)},_transformProgress:function(t,e){var i="scaleX("+e/100+")";t.style.transform=t.style.webkitTransform=i},_mainRatioChanged:function(t){this._transformProgress(this.$.primaryProgress,t)},_progressChanged:function(t,e,i,n,a){t=this._clampValue(t),e=this._clampValue(e);var o=100*this._calcRatio(t),r=100*this._calcRatio(e);this._setSecondaryRatio(o),this._transformProgress(this.$.secondaryProgress,o),this._transformProgress(this.$.primaryProgress,r),this.secondaryProgress=t,a?this.removeAttribute("aria-valuenow"):this.setAttribute("aria-valuenow",e),this.setAttribute("aria-valuemin",i),this.setAttribute("aria-valuemax",n)},_disabledChanged:function(t){this.setAttribute("aria-disabled",t?"true":"false")},_hideSecondaryProgress:function(t){return 0===t}});let Qp=null;const Zp={properties:{validator:{type:String},invalid:{notify:!0,reflectToAttribute:!0,type:Boolean,value:!1,observer:"_invalidChanged"}},registered:function(){Qp=new ua({type:"validator"})},_invalidChanged:function(){this.invalid?this.setAttribute("aria-invalid","true"):this.removeAttribute("aria-invalid")},get _validator(){return Qp&&Qp.byKey(this.validator)},hasValidator:function(){return null!=this._validator},validate:function(t){return void 0===t&&void 0!==this.value?this.invalid=!this._getValidity(this.value):this.invalid=!this._getValidity(t),!this.invalid},_getValidity:function(t){return!this.hasValidator()||this._validator.validate(t)}};Cn({_template:jt`
    <style>
      :host {
        display: inline-block;
      }
...
`,is:"paper-input-char-counter",behaviors:[Xp],properties:{_charCounterStr:{type:String,value:"0"}},update:function(t){if(t.inputElement){t.value=t.value||"";var e=t.value.toString().length.toString();t.inputElement.hasAttribute("maxlength")&&(e+="/"+t.inputElement.getAttribute("maxlength")),this._charCounterStr=e}}});const Jp=jt`
<custom-style>
  <style is="custom-style">
    html {
...
`;Jp.setAttribute("style","display: none;"),document.head.appendChild(Jp.content),Cn({_template:jt`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
`,is:"paper-input-container",properties:{noLabelFloat:{type:Boolean,value:!1},alwaysFloatLabel:{type:Boolean,value:!1},attrForValue:{type:String,value:"bind-value"},autoValidate:{type:Boolean,value:!1},invalid:{observer:"_invalidChanged",type:Boolean,value:!1},focused:{readOnly:!0,type:Boolean,value:!1,notify:!0},_addons:{type:Array},_inputHasContent:{type:Boolean,value:!1},_inputSelector:{type:String,value:"input,iron-input,textarea,.paper-input-input"},_boundOnFocus:{type:Function,value:function(){return this._onFocus.bind(this)}},_boundOnBlur:{type:Function,value:function(){return this._onBlur.bind(this)}},_boundOnInput:{type:Function,value:function(){return this._onInput.bind(this)}},_boundValueChanged:{type:Function,value:function(){return this._onValueChanged.bind(this)}}},listeners:{"addon-attached":"_onAddonAttached","iron-input-validate":"_onIronInputValidate"},get _valueChangedEvent(){return this.attrForValue+"-changed"},get _propertyForValue(){return D(this.attrForValue)},get _inputElement(){return bn(this).querySelector(this._inputSelector)},get _inputElementValue(){return this._inputElement[this._propertyForValue]||this._inputElement.value},ready:function(){this.__isFirstValueUpdate=!0,this._addons||(this._addons=[]),this.addEventListener("focus",this._boundOnFocus,!0),this.addEventListener("blur",this._boundOnBlur,!0)},attached:function(){this.attrForValue?this._inputElement.addEventListener(this._valueChangedEvent,this._boundValueChanged):this.addEventListener("input",this._onInput),this._inputElementValue&&""!=this._inputElementValue?this._handleValueAndAutoValidate(this._inputElement):this._handleValue(this._inputElement)},_onAddonAttached:function(t){this._addons||(this._addons=[]);var e=t.target;-1===this._addons.indexOf(e)&&(this._addons.push(e),this.isAttached&&this._handleValue(this._inputElement))},_onFocus:function(){this._setFocused(!0)},_onBlur:function(){this._setFocused(!1),this._handleValueAndAutoValidate(this._inputElement)},_onInput:function(t){this._handleValueAndAutoValidate(t.target)},_onValueChanged:function(t){var e=t.target;this.__isFirstValueUpdate&&(this.__isFirstValueUpdate=!1,void 0===e.value||""===e.value)||this._handleValueAndAutoValidate(t.target)},_handleValue:function(t){var e=this._inputElementValue;e||0===e||"number"===t.type&&!t.checkValidity()?this._inputHasContent=!0:this._inputHasContent=!1,this.updateAddons({inputElement:t,value:e,invalid:this.invalid})},_handleValueAndAutoValidate:function(t){var e;this.autoValidate&&t&&(e=t.validate?t.validate(this._inputElementValue):t.checkValidity(),this.invalid=!e);this._handleValue(t)},_onIronInputValidate:function(t){this.invalid=this._inputElement.invalid},_invalidChanged:function(){this._addons&&this.updateAddons({invalid:this.invalid})},updateAddons:function(t){for(var e,i=0;e=this._addons[i];i++)e.update(t)},_computeInputContentClass:function(t,e,i,n,a){var o="input-content";if(t)a&&(o+=" label-is-hidden"),n&&(o+=" is-invalid");else{var r=this.querySelector("label");e||a?(o+=" label-is-floating",this.$.labelAndInputContainer.style.position="static",n?o+=" is-invalid":i&&(o+=" label-is-highlighted")):(r&&(this.$.labelAndInputContainer.style.position="relative"),n&&(o+=" is-invalid"))}return i&&(o+=" focused"),o},_computeUnderlineClass:function(t,e){var i="underline";return e?i+=" is-invalid":t&&(i+=" is-highlighted"),i},_computeAddOnContentClass:function(t,e){var i="add-on-content";return e?i+=" is-invalid":t&&(i+=" is-highlighted"),i}}),Cn({_template:jt`
    ...
    <slot></slot>
`,is:"paper-input-error",behaviors:[Xp],properties:{invalid:{readOnly:!0,reflectToAttribute:!0,type:Boolean}},update:function(t){this._setInvalid(t.invalid)}});const tu={properties:{name:{type:String},value:{notify:!0,type:String},required:{type:Boolean,value:!1}},attached:function(){},detached:function(){}},eu={NextLabelID:1,NextAddonID:1,NextInputID:1},iu={properties:{label:{type:String},value:{notify:!0,type:String},disabled:{type:Boolean,value:!1},invalid:{type:Boolean,value:!1,notify:!0},allowedPattern:{type:String},type:{type:String},list:{type:String},pattern:{type:String},required:{type:Boolean,value:!1},errorMessage:{type:String},charCounter:{type:Boolean,value:!1},noLabelFloat:{type:Boolean,value:!1},alwaysFloatLabel:{type:Boolean,value:!1},autoValidate:{type:Boolean,value:!1},validator:{type:String},autocomplete:{type:String,value:"off"},autofocus:{type:Boolean,observer:"_autofocusChanged"},inputmode:{type:String},minlength:{type:Number},maxlength:{type:Number},min:{type:String},max:{type:String},step:{type:String},name:{type:String},placeholder:{type:String,value:""},readonly:{type:Boolean,value:!1},size:{type:Number},autocapitalize:{type:String,value:"none"},autocorrect:{type:String,value:"off"},autosave:{type:String},results:{type:Number},accept:{type:String},multiple:{type:Boolean},_ariaDescribedBy:{type:String,value:""},_ariaLabelledBy:{type:String,value:""},_inputId:{type:String,value:""}},listeners:{"addon-attached":"_onAddonAttached"},keyBindings:{"shift+tab:keydown":"_onShiftTabDown"},hostAttributes:{tabindex:0},get inputElement(){return this.$||(this.$={}),this.$.input||(this._generateInputId(),this.$.input=this.$$("#"+this._inputId)),this.$.input},get _focusableElement(){return this.inputElement},created:function(){this._typesThatHaveText=["date","datetime","datetime-local","month","time","week","file"]},attached:function(){this._updateAriaLabelledBy(),!qt&&this.inputElement&&-1!==this._typesThatHaveText.indexOf(this.inputElement.type)&&(this.alwaysFloatLabel=!0)},_appendStringWithSpace:function(t,e){return t=t?t+" "+e:e},_onAddonAttached:function(t){var e=bn(t).rootTarget;if(e.id)this._ariaDescribedBy=this._appendStringWithSpace(this._ariaDescribedBy,e.id);else{var i="paper-input-add-on-"+eu.NextAddonID++;e.id=i,this._ariaDescribedBy=this._appendStringWithSpace(this._ariaDescribedBy,i)}},validate:function(){return this.inputElement.validate()},_focusBlurHandler:function(t){_a._focusBlurHandler.call(this,t),this.focused&&!this._shiftTabPressed&&this._focusableElement&&this._focusableElement.focus()},_onShiftTabDown:function(t){var e=this.getAttribute("tabindex");this._shiftTabPressed=!0,this.setAttribute("tabindex","-1"),this.async(function(){this.setAttribute("tabindex",e),this._shiftTabPressed=!1},1)},_handleAutoValidate:function(){this.autoValidate&&this.validate()},updateValueAndPreserveCaret:function(t){try{var e=this.inputElement.selectionStart;this.value=t,this.inputElement.selectionStart=e,this.inputElement.selectionEnd=e}catch(e){this.value=t}},_computeAlwaysFloatLabel:function(t,e){return e||t},_updateAriaLabelledBy:function(){var t,e=bn(this.root).querySelector("label");e?(e.id?t=e.id:(t="paper-input-label-"+eu.NextLabelID++,e.id=t),this._ariaLabelledBy=t):this._ariaLabelledBy=""},_generateInputId:function(){this._inputId&&""!==this._inputId||(this._inputId="input-"+eu.NextInputID++)},_onChange:function(t){this.shadowRoot&&this.fire(t.type,{sourceEvent:t},{node:this,bubbles:t.bubbles,cancelable:t.cancelable})},_autofocusChanged:function(){if(this.autofocus&&this._focusableElement){var t=document.activeElement;t instanceof HTMLElement&&t!==document.body&&t!==document.documentElement||this._focusableElement.focus()}}},nu=[_a,Ta,iu];Cn({is:"paper-input",_template:jt`
    <style>
      :host {
        display: block;
      }
  ...
  `,behaviors:[nu,tu],properties:{value:{type:String}},get _focusableElement(){return this.inputElement._inputElement},listeners:{"iron-input-ready":"_onIronInputReady"},_onIronInputReady:function(){this.$.nativeInput||(this.$.nativeInput=this.$$("input")),this.inputElement&&-1!==this._typesThatHaveText.indexOf(this.$.nativeInput.type)&&(this.alwaysFloatLabel=!0),this.inputElement.bindValue&&this.$.container._handleValueAndAutoValidate(this.inputElement)}}),Cn({_template:jt`
    <style>
      :host {
        display: inline-block;
        position: relative;
...
`;au.setAttribute("strip-whitespace",""),Cn({_template:au,is:"paper-spinner",behaviors:[yo]});window.customElements.define("moe-file-button",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
}
...
`}static get properties(){return{accept:{type:String,value:"image/*"},file:{type:Object,notify:!0},fileSelected:{type:Boolean,computed:"_computeFileSelected(file)",notify:!0},disabled:{type:Boolean,value:!1,reflectToAttribute:!0}}}cancel(){this.$.file.value="",this.$.file.dispatchEvent(new Event("change"))}_onFileChange(){const t=this.$.file.files;t.length>0?(this.dispatchEvent(new CustomEvent("change",{detail:{file:t[0]}})),this.set("file",t[0])):(this.dispatchEvent(new CustomEvent("change",{detail:{file:null}})),this.set("file",null))}_computeFileSelected(t){return!!t}});window.customElements.define("moe-form-video-embed",class extends qt{static get template(){return jt`
<style>
:host: {
    display: inline-block;
}
...
`}static get properties(){return{index:{type:Number},image:{type:String},title:{type:String},disabled:{type:Boolean,value:!1,reflectToAttribute:!0}}}_onRemoveButtonClick(){this.dispatchEvent(new CustomEvent("remove"))}});window.customElements.define("moe-form-video-embeds",class extends qt{static get template(){return jt`
<style>
:host {
    height: auto;
    width: 100%;
...
`}static get properties(){return{maxLength:{type:Number},value:{type:String,notify:!0,reflectToAttribute:!0},disabled:{type:Boolean,value:!1,reflectToAttribute:!0}}}reset(){this.value=""}focus(){this.$.input.focus()}cancel(){this.dispatchEvent(new CustomEvent("cancel"))}_onCancelClick(t){this.cancel()}});window.customElements.define("moe-form-poll-item-input",class extends qt{static get template(){return jt`
<style>
:host {
    @apply --layout-horizontal;
    @apply --layout-center-center;
...
`}static get properties(){return{dialogTitle:String,dragging:{type:Boolean,value:!1},draggingXDelta:{type:Number,value:0},draggingYDelta:{type:Number,value:0},loading:{type:Boolean,value:!1},width:Number,height:Number,formElement:Object}}static get observedAttributes(){return["hidden","dialog-title"]}ready(){super.ready(),this.shadowRoot.querySelectorAll(".handle").forEach(t=>t.addEventListener("mousedown",this._onHandleMouseDown.bind(this))),this.addEventListener("dragstart",this._onDragStart.bind(this)),this.addEventListener("drag",this._onDrag.bind(this)),this.addEventListener("dragend",this._onDragEnd.bind(this));for(let t of this.$.form.assignedNodes())if("object"==typeof t&&(t instanceof cu||t instanceof hu)){this.formElement=t;break}this.formElement?(this.formElement.addEventListener("on-loading-start",()=>{this.set("loading",!0)}),this.formElement.addEventListener("on-loading-end",()=>{this.set("loading",!1)})):console.error("There must be a moe-form/moe-reply-form slotted inside of moe-form-dialog",this)}attributeChangedCallback(t,e,i){"hidden"===t&&null!==e&&null===i&&this.centralizeDialog(),"dialog-title"===t&&(this.dialogTitle=i)}centralizeDialog(){window.matchMedia("(max-width: 500px)").matches?this.style.top=this.style.left="0":(this.style.left=document.documentElement.clientWidth/2-this.offsetWidth/2+"px",this.style.top="16px")}_onHandleMouseDown(t){this.draggable=!0}_onDragStart(t){this.draggingXDelta=t.clientX-this.offsetLeft,this.draggingYDelta=t.clientY-this.offsetTop,t.dataTransfer.setDragImage(document.createElement("img"),0,0)}_onDrag(t){t.clientX>0&&t.clientX<document.documentElement.clientWidth&&t.clientY>0&&t.clientY<document.documentElement.clientHeight&&(this.style.top=Math.min(Math.max(0,t.clientY-this.draggingYDelta),document.documentElement.clientHeight-this.clientHeight)+"px",this.style.left=Math.min(Math.max(0,t.clientX-this.draggingXDelta),document.documentElement.clientWidth-this.clientWidth)+"px")}_onDragEnd(t){this.draggable=!1}_onCloseClick(){this.dispatchEvent(new CustomEvent("close"))}_onSendClick(){this.dispatchEvent(new CustomEvent("submit",{detail:this.formElement.getFormData()}))}});window.customElements.define("pixmicat-request",class extends qt{static get template(){return jt`<style>:host{display:none;}</style>
`}static get properties(){return{server:{type:String},method:{type:String},progress:{type:Object,notify:!0},request:{type:Object,value:null}}}inFlight(){return this.request&&4!==this.request.readyState}makeThread(t,e,i=null,n=null,a=null,o="",r="",s="",l=""){if(this.inFlight())return Promise.reject("Request in progress");const h=this._makeRegistFormData(t,null,e,i,a,n,o,r,s,l);return this._sendRegistRequest(h)}makeReply(t,e,i,n=null,a=null,o="",r="",s="",l=""){if(this.inFlight())return Promise.reject("Request in progress");const h=this._makeRegistFormData(t,e,i,n,a,null,o,r,s,l);return this._sendRegistRequest(h)}_makeRegistFormData(t,e,i,n,a,o,r,s,l,h){const c=new FormData;return c.append("bvUFbdrIC",l),c.append("ObHGyhdTR",s),c.append("SJBgiFbhj",r),c.append("pOBvrtyJK",i),n&&c.append("upfile",new Blob([n],{type:n.type})),a&&a.length&&a.forEach(t=>{c.append("resid[]",`${t.data.type}:${t.data.res_id}`)}),o&&o.isValid()&&(c.append("p_title",o.title),o.items.forEach(t=>{c.append("p_item[]",t)})),c.append("mode","regist"),c.append("noimg","on"),c.append("pwd",h),e&&c.append("resto",`${e}`),c.append("email","foo@foo.bar"),c.append("name","spammer"),c.append("sub","DO NOT FIX THIS"),c.append("com","EID OG SMAPS"),c.append("reply",""),c}_sendRegistRequest(t){return this._sendRequest(this.server+"?mode=regist",t)}delete(t,e,i=""){const n=new FormData;return n.append("pwd",i),n.append("func","delete"),n.append(`${e}`,"delete"),this._sendRequest(this.server+"?mode=usrdel",n)}_sendRequest(t,e){return new Promise((i,n)=>{this.request=new XMLHttpRequest,this.request.addEventListener("progress",t=>{this.set("progress",{lengthComputable:t.lengthComputable,loaded:t.loaded,total:t.total})}),this.request.addEventListener("readystatechange",t=>{switch(this.request.readyState){case 0:n(new Error("Aborted"));break;case 4:200===this.request.status?i(this.request.response):this.request.response&&this.request.response.error?n(new Error(this.request.response.error)):this.request.statusText?n(new Error(`${this.request.statusText} (${this.request.status})`)):n(new Error("Network error"))}}),this.request.open("POST",t),this.request.setRequestHeader("x-requested-with","pixmicat-request"),this.request.withCredentials=!0,this.request.responseType="json",this.request.send(e)})}});var du="[object DOMException]",pu="[object Error]";function uu(t){if(!Sc(t))return!1;var e=Jo(t);return e==pu||e==du||"string"==typeof t.message&&"string"==typeof t.name&&!dp(t)}window.customElements.define("moe-board",class extends(Wp(qt)){static get template(){return jt`
<style>
:host {
    display: block;
    font-family: 'Roboto', 'Noto', sans-serif;
