...
`;eo.setAttribute("strip-whitespace",""),Cn({_template:eo,is:"paper-spinner-lite",behaviors:[to]});const io=jt`
  <style include="paper-material-styles">
  ...
  <slot></slot>`;io.setAttribute("strip-whitespace",""),Cn({_template:io,is:"paper-button",behaviors:[qa],properties:{raised:{type:Boolean,reflectToAttribute:!0,value:!1,observer:"_calculateElevation"}},_calculateElevation:function(){this.raised?ja._calculateElevation.apply(this):this._setElevation(0)}});const no=jt`
<custom-style>
  <style is="custom-style">
    html {
...
`;no.setAttribute("style","display: none;"),document.head.appendChild(no.content),Cn({_template:jt`
    <style>
      :host {
        display: inline-block;
        overflow: hidden;
...
`,is:"paper-menu-button",behaviors:[Ta,_a],properties:{opened:{type:Boolean,value:!1,notify:!0,observer:"_openedChanged"},horizontalAlign:{type:String,value:"left",reflectToAttribute:!0},verticalAlign:{type:String,value:"top",reflectToAttribute:!0},dynamicAlign:{type:Boolean},horizontalOffset:{type:Number,value:0,notify:!0},verticalOffset:{type:Number,value:0,notify:!0},noOverlap:{type:Boolean},noAnimations:{type:Boolean,value:!1},ignoreSelect:{type:Boolean,value:!1},closeOnActivate:{type:Boolean,value:!1},openAnimationConfig:{type:Object,value:function(){return[{name:"fade-in-animation",timing:{delay:100,duration:200}},{name:"paper-menu-grow-width-animation",timing:{delay:100,duration:150,easing:wo.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-grow-height-animation",timing:{delay:100,duration:275,easing:wo.ANIMATION_CUBIC_BEZIER}}]}},closeAnimationConfig:{type:Object,value:function(){return[{name:"fade-out-animation",timing:{duration:150}},{name:"paper-menu-shrink-width-animation",timing:{delay:100,duration:50,easing:wo.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-shrink-height-animation",timing:{duration:200,easing:"ease-in"}}]}},allowOutsideScroll:{type:Boolean,value:!1},restoreFocusOnClose:{type:Boolean,value:!0},_dropdownContent:{type:Object}},hostAttributes:{role:"group","aria-haspopup":"true"},listeners:{"iron-activate":"_onIronActivate","iron-select":"_onIronSelect"},get contentElement(){for(var t=bn(this.$.content).getDistributedNodes(),e=0,i=t.length;e<i;e++)if(t[e].nodeType===Node.ELEMENT_NODE)return t[e]},toggle:function(){this.opened?this.close():this.open()},open:function(){this.disabled||this.$.dropdown.open()},close:function(){this.$.dropdown.close()},_onIronSelect:function(t){this.ignoreSelect||this.close()},_onIronActivate:function(t){this.closeOnActivate&&this.close()},_openedChanged:function(t,e){t?(this._dropdownContent=this.contentElement,this.fire("paper-dropdown-open")):null!=e&&this.fire("paper-dropdown-close")},_disabledChanged:function(t){_a._disabledChanged.apply(this,arguments),t&&this.opened&&this.close()},__onIronOverlayCanceled:function(t){var e=t.detail,i=this.$.trigger;bn(e).path.indexOf(i)>-1&&t.preventDefault()}});Object.keys(wo).forEach(function(t){xo[t]=wo[t]});const Mo={properties:{multi:{type:Boolean,value:!1,observer:"multiChanged"},selectedValues:{type:Array,notify:!0,value:function(){return[]}},selectedItems:{type:Array,readOnly:!0,notify:!0,value:function(){return[]}}},observers:["_updateSelected(selectedValues.splices)"],select:function(t){this.multi?this._toggleSelected(t):this.selected=t},multiChanged:function(t){this._selection.multi=t,this._updateSelected()},get _shouldUpdateSelection(){return null!=this.selected||null!=this.selectedValues&&this.selectedValues.length},_updateAttrForSelected:function(){this.multi?this.selectedItems&&this.selectedItems.length>0&&(this.selectedValues=this.selectedItems.map(function(t){return this._indexToValue(this.indexOf(t))},this).filter(function(t){return null!=t},this)):Xa._updateAttrForSelected.apply(this)},_updateSelected:function(){this.multi?this._selectMulti(this.selectedValues):this._selectSelected(this.selected)},_selectMulti:function(t){t=t||[];var e=(this._valuesToItems(t)||[]).filter(function(t){return null!=t});this._selection.clear(e);for(var i=0;i<e.length;i++)this._selection.setItemSelected(e[i],!0);this.fallbackSelection&&!this._selection.get().length&&(this._valueToItem(this.fallbackSelection)&&this.select(this.fallbackSelection))},_selectionChange:function(){var t=this._selection.get();this.multi?(this._setSelectedItems(t),this._setSelectedItem(t.length?t[0]:null)):null!=t?(this._setSelectedItems([t]),this._setSelectedItem(t)):(this._setSelectedItems([]),this._setSelectedItem(null))},_toggleSelected:function(t){var e=this.selectedValues.indexOf(t);e<0?this.push("selectedValues",t):this.splice("selectedValues",e,1)},_valuesToItems:function(t){return null==t?null:t.map(function(t){return this._valueToItem(t)},this)}},So=[Xa,Mo],Co={properties:{focusedItem:{observer:"_focusedItemChanged",readOnly:!0,type:Object},attrForItemTitle:{type:String},disabled:{type:Boolean,value:!1,observer:"_disabledChanged"}},_MODIFIER_KEYS:["Alt","AltGraph","CapsLock","Control","Fn","FnLock","Hyper","Meta","NumLock","OS","ScrollLock","Shift","Super","Symbol","SymbolLock"],_SEARCH_RESET_TIMEOUT_MS:1e3,_previousTabIndex:0,hostAttributes:{role:"menu"},observers:["_updateMultiselectable(multi)"],listeners:{focus:"_onFocus",keydown:"_onKeydown","iron-items-changed":"_onIronItemsChanged"},keyBindings:{up:"_onUpKey",down:"_onDownKey",esc:"_onEscKey","shift+tab:keydown":"_onShiftTabDown"},attached:function(){this._resetTabindices()},select:function(t){this._defaultFocusAsync&&(this.cancelAsync(this._defaultFocusAsync),this._defaultFocusAsync=null);var e=this._valueToItem(t);e&&e.hasAttribute("disabled")||(this._setFocusedItem(e),Mo.select.apply(this,arguments))},_resetTabindices:function(){var t=this.multi?this.selectedItems&&this.selectedItems[0]:this.selectedItem;this.items.forEach(function(e){e.setAttribute("tabindex",e===t?"0":"-1")},this)},_updateMultiselectable:function(t){t?this.setAttribute("aria-multiselectable","true"):this.removeAttribute("aria-multiselectable")},_focusWithKeyboardEvent:function(t){if(-1===this._MODIFIER_KEYS.indexOf(t.key)){this.cancelDebouncer("_clearSearchText");for(var e,i=this._searchText||"",n=(i+=(t.key&&1==t.key.length?t.key:String.fromCharCode(t.keyCode)).toLocaleLowerCase()).length,a=0;e=this.items[a];a++)if(!e.hasAttribute("disabled")){var o=this.attrForItemTitle||"textContent",r=(e[o]||e.getAttribute(o)||"").trim();if(!(r.length<n)&&r.slice(0,n).toLocaleLowerCase()==i){this._setFocusedItem(e);break}}this._searchText=i,this.debounce("_clearSearchText",this._clearSearchText,this._SEARCH_RESET_TIMEOUT_MS)}},_clearSearchText:function(){this._searchText=""},_focusPrevious:function(){for(var t=this.items.length,e=Number(this.indexOf(this.focusedItem)),i=1;i<t+1;i++){var n=this.items[(e-i+t)%t];if(!n.hasAttribute("disabled")){var a=bn(n).getOwnerRoot()||document;if(this._setFocusedItem(n),bn(a).activeElement==n)return}}},_focusNext:function(){for(var t=this.items.length,e=Number(this.indexOf(this.focusedItem)),i=1;i<t+1;i++){var n=this.items[(e+i)%t];if(!n.hasAttribute("disabled")){var a=bn(n).getOwnerRoot()||document;if(this._setFocusedItem(n),bn(a).activeElement==n)return}}},_applySelection:function(t,e){e?t.setAttribute("aria-selected","true"):t.removeAttribute("aria-selected"),Xa._applySelection.apply(this,arguments)},_focusedItemChanged:function(t,e){e&&e.setAttribute("tabindex","-1"),!t||t.hasAttribute("disabled")||this.disabled||(t.setAttribute("tabindex","0"),t.focus())},_onIronItemsChanged:function(t){t.detail.addedNodes.length&&this._resetTabindices()},_onShiftTabDown:function(t){var e=this.getAttribute("tabindex");Co._shiftTabPressed=!0,this._setFocusedItem(null),this.setAttribute("tabindex","-1"),this.async(function(){this.setAttribute("tabindex",e),Co._shiftTabPressed=!1},1)},_onFocus:function(t){if(!Co._shiftTabPressed){var e=bn(t).rootTarget;(e===this||void 0===e.tabIndex||this.isLightDescendant(e))&&(this._defaultFocusAsync=this.async(function(){var t=this.multi?this.selectedItems&&this.selectedItems[0]:this.selectedItem;this._setFocusedItem(null),t?this._setFocusedItem(t):this.items[0]&&this._focusNext()}))}},_onUpKey:function(t){this._focusPrevious(),t.detail.keyboardEvent.preventDefault()},_onDownKey:function(t){this._focusNext(),t.detail.keyboardEvent.preventDefault()},_onEscKey:function(t){var e=this.focusedItem;e&&e.blur()},_onKeydown:function(t){this.keyboardEventMatchesKeys(t,"up down esc")||this._focusWithKeyboardEvent(t),t.stopPropagation()},_activateHandler:function(t){Xa._activateHandler.call(this,t),t.stopPropagation()},_disabledChanged:function(t){t?(this._previousTabIndex=this.hasAttribute("tabindex")?this.tabIndex:0,this.removeAttribute("tabindex")):this.hasAttribute("tabindex")||this.setAttribute("tabindex",this._previousTabIndex)},_shiftTabPressed:!1};Cn({_template:jt`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[[So,Ta,Co]],hostAttributes:{role:"listbox"}}),Cn({_template:jt`
    ...
    <slot></slot>
`,is:"paper-item",behaviors:[Ga]}),Cn({_template:jt`
    <style>
      :host {
        display: block;
        position: absolute;
...
</iron-iconset-svg>`;document.head.appendChild(ko.content);const Ho=jt`<iron-iconset-svg name="communication" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(Ho.content);var Vo=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),Lo=Vo&&Vo[1]>=8,To=null!=mn,Eo=To?K:0,Io=To?G:1,Po=To?Q:2;ea||(Polymer.OptionalMutableDataBehavior={}),Cn({_template:jt`
    <style>
      :host {
        display: block;
      }
...
</iron-iconset-svg>`;document.head.appendChild(Oo.content);window.customElements.define("moe-pixmicat-pushpost",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
    background: white;
...
`}static get properties(){return{}}});const No=jt`<iron-iconset-svg name="social" size="24">
<svg><defs>
...
</iron-iconset-svg>`;document.head.appendChild(No.content);window.customElements.define("moe-poll",class extends qt{static get template(){return jt`
<style>
:host {
    min-width: 300px;
    display: table;
...
`}static get properties(){return{text:{type:String}}}});const Ro=9007199254740991;function Do(t){return null!=t&&"function"!=typeof t&&function(t){return"number"==typeof t&&t>-1&&t%1==0&&t<=Ro}(t.length)}class Fo extends qt{static get template(){return jt`<style>:host{display:none;}</style>
`}static get properties(){return{server:{type:String}}}static errorMessage(t){switch(t){case"VOTED":return"你已經投過了";case"NOT_FOUND":return"投票已被刪除";default:return t}}vote(t,e){return fetch(this.server,{method:"POST",mode:"cors",headers:{"Content-Type":"application/json; charset=utf-8","X-Requested-With":"moe-poll-request"},body:JSON.stringify({poll_no:t,poll_item:e})}).then(t=>t.json()).then(t=>{if(t.error)return Promise.reject(new Error(Fo.errorMessage(t.error)));if(!(t.items&&function(t){const e=typeof t;return null!=t&&("object"==e||"function"==e)}(t.items)&&Do(t.items.k)&&Do(t.items.v)))return Promise.reject(new Error("Invalid response"));const e=[];for(let i in t.items.k)e.push({text:t.items.k[i],votes:parseInt(t.items.v[i])});return Promise.resolve(e)})}}window.customElements.define("moe-poll-request",Fo);var Bo=["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"],$o=["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","audio","canvas","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","video","view","vkern"],Yo=["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"],jo=["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmuliscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mpspace","msqrt","mystyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover"],qo=["#text"],Uo=["accept","action","align","alt","autocomplete","background","bgcolor","border","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","coords","crossorigin","datetime","default","dir","disabled","download","enctype","face","for","headers","height","hidden","high","href","hreflang","id","integrity","ismap","label","lang","list","loop","low","max","maxlength","media","method","min","multiple","name","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","type","usemap","valign","value","width","xmlns"],Wo=["accent-height","accumulate","additivive","alignment-baseline","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","fill","fill-opacity","fill-rule","filter","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","specularconstant","specularexponent","spreadmethod","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","tabindex","targetx","targety","transform","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"],Ko=["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"],Go=["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"];function Qo(t,e){for(var i=e.length;i--;)"string"==typeof e[i]&&(e[i]=e[i].toLowerCase()),t[e[i]]=!0;return t}function Zo(t){var e={},i=void 0;for(i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e}var Xo=/\{\{[\s\S]*|[\s\S]*\}\}/gm,Jo=/<%[\s\S]*|[\s\S]*%>/gm,tr=/^data-[\-\w.\u00B7-\uFFFF]/,er=/^aria-[\-\w]+$/,ir=/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i,nr=/^(?:\w+script|data):/i,ar=/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,or="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};function rr(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}var sr=function(){return"undefined"==typeof window?null:window};var lr,hr,cr=function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:sr(),i=function(e){return t(e)};if(i.version="1.0.8",i.removed=[],!e||!e.document||9!==e.document.nodeType)return i.isSupported=!1,i;var n=e.document,a=!1,o=!1,r=e.document,s=e.DocumentFragment,l=e.HTMLTemplateElement,h=e.Node,c=e.NodeFilter,d=e.NamedNodeMap,p=void 0===d?e.NamedNodeMap||e.MozNamedAttrMap:d,u=e.Text,A=e.Comment,m=e.DOMParser;if("function"==typeof l){var f=r.createElement("template");f.content&&f.content.ownerDocument&&(r=f.content.ownerDocument)}var g=r,v=g.implementation,_=g.createNodeIterator,y=g.getElementsByTagName,b=g.createDocumentFragment,z=n.importNode,w={};i.isSupported=v&&void 0!==v.createHTMLDocument&&9!==r.documentMode;var x=Xo,M=Jo,S=tr,C=er,k=nr,H=ar,V=ir,L=null,T=Qo({},[].concat(rr(Bo),rr($o),rr(Yo),rr(jo),rr(qo))),E=null,I=Qo({},[].concat(rr(Uo),rr(Wo),rr(Ko),rr(Go))),P=null,O=null,N=!0,R=!0,D=!1,F=!1,B=!1,$=!1,Y=!1,j=!1,q=!1,U=!1,W=!1,K=!0,G=!0,Q=!1,Z={},X=Qo({},["audio","head","math","script","style","template","svg","video"]),J=Qo({},["audio","video","img","source","image"]),tt=Qo({},["alt","class","for","id","label","name","pattern","placeholder","summary","title","value","style","xmlns"]),et=null,it=r.createElement("form"),nt=function(t){"object"!==(void 0===t?"undefined":or(t))&&(t={}),L="ALLOWED_TAGS"in t?Qo({},t.ALLOWED_TAGS):T,E="ALLOWED_ATTR"in t?Qo({},t.ALLOWED_ATTR):I,P="FORBID_TAGS"in t?Qo({},t.FORBID_TAGS):{},O="FORBID_ATTR"in t?Qo({},t.FORBID_ATTR):{},Z="USE_PROFILES"in t&&t.USE_PROFILES,N=!1!==t.ALLOW_ARIA_ATTR,R=!1!==t.ALLOW_DATA_ATTR,D=t.ALLOW_UNKNOWN_PROTOCOLS||!1,F=t.SAFE_FOR_JQUERY||!1,B=t.SAFE_FOR_TEMPLATES||!1,$=t.WHOLE_DOCUMENT||!1,q=t.RETURN_DOM||!1,U=t.RETURN_DOM_FRAGMENT||!1,W=t.RETURN_DOM_IMPORT||!1,j=t.FORCE_BODY||!1,K=!1!==t.SANITIZE_DOM,G=!1!==t.KEEP_CONTENT,Q=t.IN_PLACE||!1,V=t.ALLOWED_URI_REGEXP||V,B&&(R=!1),U&&(q=!0),Z&&(L=Qo({},[].concat(rr(qo))),E=[],!0===Z.html&&(Qo(L,Bo),Qo(E,Uo)),!0===Z.svg&&(Qo(L,$o),Qo(E,Wo),Qo(E,Go)),!0===Z.svgFilters&&(Qo(L,Yo),Qo(E,Wo),Qo(E,Go)),!0===Z.mathMl&&(Qo(L,jo),Qo(E,Ko),Qo(E,Go))),t.ADD_TAGS&&(L===T&&(L=Zo(L)),Qo(L,t.ADD_TAGS)),t.ADD_ATTR&&(E===I&&(E=Zo(E)),Qo(E,t.ADD_ATTR)),t.ADD_URI_SAFE_ATTR&&Qo(tt,t.ADD_URI_SAFE_ATTR),G&&(L["#text"]=!0),$&&Qo(L,["html","head","body"]),L.table&&Qo(L,["tbody"]),Object&&"freeze"in Object&&Object.freeze(t),et=t},at=function(t){i.removed.push({element:t});try{t.parentNode.removeChild(t)}catch(e){t.outerHTML=""}},ot=function(t,e){try{i.removed.push({attribute:e.getAttributeNode(t),from:e})}catch(t){i.removed.push({attribute:null,from:e})}e.removeAttribute(t)},rt=function(t){var e=void 0;if(j&&(t="<remove></remove>"+t),a)try{e=(new m).parseFromString(t,"text/html")}catch(t){}if(o&&Qo(P,["title"]),!e||!e.documentElement){var i=(e=v.createHTMLDocument("")).body;i.parentNode.removeChild(i.parentNode.firstElementChild),i.outerHTML=t}return y.call(e,$?"html":"body")[0]};i.isSupported&&(function(){try{rt('<svg><p><style><img src="</style><img src=x onerror=alert(1)//">').querySelector("svg img")&&(a=!0)}catch(t){}}(),function(){try{rt("<x/><title>&lt;/title&gt;&lt;img&gt;").querySelector("title").textContent.match(/<\/title/)&&(o=!0)}catch(t){}}());var st=function(t){return _.call(t.ownerDocument||t,t,c.SHOW_ELEMENT|c.SHOW_COMMENT|c.SHOW_TEXT,function(){return c.FILTER_ACCEPT},!1)},lt=function(t){return"object"===(void 0===h?"undefined":or(h))?t instanceof h:t&&"object"===(void 0===t?"undefined":or(t))&&"number"==typeof t.nodeType&&"string"==typeof t.nodeName},ht=function(t,e,n){w[t]&&w[t].forEach(function(t){t.call(i,e,n,et)})},ct=function(t){var e,n=void 0;if(ht("beforeSanitizeElements",t,null),!((e=t)instanceof u||e instanceof A||"string"==typeof e.nodeName&&"string"==typeof e.textContent&&"function"==typeof e.removeChild&&e.attributes instanceof p&&"function"==typeof e.removeAttribute&&"function"==typeof e.setAttribute))return at(t),!0;var a=t.nodeName.toLowerCase();if(ht("uponSanitizeElement",t,{tagName:a,allowedTags:L}),!L[a]||P[a]){if(G&&!X[a]&&"function"==typeof t.insertAdjacentHTML)try{t.insertAdjacentHTML("AfterEnd",t.innerHTML)}catch(t){}return at(t),!0}return!F||t.firstElementChild||t.content&&t.content.firstElementChild||!/</g.test(t.textContent)||(i.removed.push({element:t.cloneNode()}),t.innerHTML?t.innerHTML=t.innerHTML.replace(/</g,"&lt;"):t.innerHTML=t.textContent.replace(/</g,"&lt;")),B&&3===t.nodeType&&(n=(n=(n=t.textContent).replace(x," ")).replace(M," "),t.textContent!==n&&(i.removed.push({element:t.cloneNode()}),t.textContent=n)),ht("afterSanitizeElements",t,null),!1},dt=function(t,e,i){if(K&&("id"===e||"name"===e)&&(i in r||i in it))return!1;if(B&&(i=(i=i.replace(x," ")).replace(M," ")),R&&S.test(e));else if(N&&C.test(e));else{if(!E[e]||O[e])return!1;if(tt[e]);else if(V.test(i.replace(H,"")));else if("src"!==e&&"xlink:href"!==e||"script"===t||0!==i.indexOf("data:")||!J[t])if(D&&!k.test(i.replace(H,"")));else if(i)return!1}return!0},pt=function(t){var e=void 0,n=void 0,a=void 0,o=void 0,r=void 0;ht("beforeSanitizeAttributes",t,null);var s=t.attributes;if(s){var l={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:E};for(r=s.length;r--;){var h=e=s[r],c=h.name,d=h.namespaceURI;if(n=e.value.trim(),a=c.toLowerCase(),l.attrName=a,l.attrValue=n,l.keepAttr=!0,ht("uponSanitizeAttribute",t,l),n=l.attrValue,"name"===a&&"IMG"===t.nodeName&&s.id)o=s.id,s=Array.prototype.slice.apply(s),ot("id",t),ot(c,t),s.indexOf(o)>r&&t.setAttribute("id",o.value);else{if("INPUT"===t.nodeName&&"type"===a&&"file"===n&&(E[a]||!O[a]))continue;"id"===c&&t.setAttribute(c,""),ot(c,t)}if(l.keepAttr){var p=t.nodeName.toLowerCase();if(dt(p,a,n))try{d?t.setAttributeNS(d,c,n):t.setAttribute(c,n),i.removed.pop()}catch(t){}}}ht("afterSanitizeAttributes",t,null)}},ut=function t(e){var i=void 0,n=st(e);for(ht("beforeSanitizeShadowDOM",e,null);i=n.nextNode();)ht("uponSanitizeShadowNode",i,null),ct(i)||(i.content instanceof s&&t(i.content),pt(i));ht("afterSanitizeShadowDOM",e,null)};return i.sanitize=function(t,a){var o=void 0,r=void 0,l=void 0,c=void 0,d=void 0;if(t||(t="\x3c!--\x3e"),"string"!=typeof t&&!lt(t)){if("function"!=typeof t.toString)throw new TypeError("toString is not a function");if("string"!=typeof(t=t.toString()))throw new TypeError("dirty is not a string, aborting")}if(!i.isSupported){if("object"===or(e.toStaticHTML)||"function"==typeof e.toStaticHTML){if("string"==typeof t)return e.toStaticHTML(t);if(lt(t))return e.toStaticHTML(t.outerHTML)}return t}if(Y||nt(a),i.removed=[],Q);else if(t instanceof h)1===(r=(o=rt("\x3c!--\x3e")).ownerDocument.importNode(t,!0)).nodeType&&"BODY"===r.nodeName?o=r:o.appendChild(r);else{if(!q&&!$&&-1===t.indexOf("<"))return t;if(!(o=rt(t)))return q?null:""}o&&j&&at(o.firstChild);for(var p=st(Q?t:o);l=p.nextNode();)3===l.nodeType&&l===c||ct(l)||(l.content instanceof s&&ut(l.content),pt(l),c=l);if(Q)return t;if(q){if(U)for(d=b.call(o.ownerDocument);o.firstChild;)d.appendChild(o.firstChild);else d=o;return W&&(d=z.call(n,d,!0)),d}return $?o.outerHTML:o.innerHTML},i.setConfig=function(t){nt(t),Y=!0},i.clearConfig=function(){et=null,Y=!1},i.isValidAttribute=function(t,e,i){et||nt({});var n=t.toLowerCase(),a=e.toLowerCase();return dt(n,a,i)},i.addHook=function(t,e){"function"==typeof e&&(w[t]=w[t]||[],w[t].push(e))},i.removeHook=function(t){w[t]&&w[t].pop()},i.removeHooks=function(t){w[t]&&(w[t]=[])},i.removeAllHooks=function(){w={}},i}();window.customElements.define("moe-quote-link",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline;
...
`}static get properties(){return{no:{type:Number}}}_onClick(t){this.dispatchEvent(new CustomEvent("quoteLinkClick",{bubbles:!0,composed:!0,detail:{no:this.no}}))}});function dr(){return lr.apply(null,arguments)}function pr(t){return t instanceof Array||"[object Array]"===Object.prototype.toString.call(t)}function ur(t){return null!=t&&"[object Object]"===Object.prototype.toString.call(t)}function Ar(t){return void 0===t}function mr(t){return"number"==typeof t||"[object Number]"===Object.prototype.toString.call(t)}function fr(t){return t instanceof Date||"[object Date]"===Object.prototype.toString.call(t)}function gr(t,e){var i,n=[];for(i=0;i<t.length;++i)n.push(e(t[i],i));return n}function vr(t,e){return Object.prototype.hasOwnProperty.call(t,e)}function _r(t,e){for(var i in e)vr(e,i)&&(t[i]=e[i]);return vr(e,"toString")&&(t.toString=e.toString),vr(e,"valueOf")&&(t.valueOf=e.valueOf),t}function yr(t,e,i,n){return Ol(t,e,i,n,!0).utc()}function br(t){return null==t._pf&&(t._pf={empty:!1,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:!1,invalidMonth:null,invalidFormat:!1,userInvalidated:!1,iso:!1,parsedDateParts:[],meridiem:null,rfc2822:!1,weekdayMismatch:!1}),t._pf}function zr(t){if(null==t._isValid){var e=br(t),i=hr.call(e.parsedDateParts,function(t){return null!=t}),n=!isNaN(t._d.getTime())&&e.overflow<0&&!e.empty&&!e.invalidMonth&&!e.invalidWeekday&&!e.weekdayMismatch&&!e.nullInput&&!e.invalidFormat&&!e.userInvalidated&&(!e.meridiem||e.meridiem&&i);if(t._strict&&(n=n&&0===e.charsLeftOver&&0===e.unusedTokens.length&&void 0===e.bigHour),null!=Object.isFrozen&&Object.isFrozen(t))return n;t._isValid=n}return t._isValid}function wr(t){var e=yr(NaN);return null!=t?_r(br(e),t):br(e).userInvalidated=!0,e}window.customElements.define("moe-post-comment",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
    height: auto;
...
`}static get properties(){return{comment:{type:String,observer:"_observeComment"}}}_observeComment(t){if(!t)return;let e=t;e=this._linkQuotes(e),e=this._highlightQuotes(e),e=this._modPushpost(e),this.$.content.innerHTML=cr.sanitize(e,{ALLOWED_TAGS:["br","code","pre","span","div","moe-quote-link"]}),this.$.content.querySelectorAll("img").forEach(t=>{t.addEventListener("load",()=>{this.dispatchEvent(new CustomEvent("processed"))})}),setTimeout(()=>this.dispatchEvent(new CustomEvent("processed")),0)}_highlightQuotes(t){return t.replace(/(^|<br(?: \/)?>)((?:&gt;|＞).*?)(?=<br(?: \/)?>|$)/gm,'$1<span class="highlight-quote">$2</span>')}_linkQuotes(t){return t.replace(/((?:&gt;|＞)+)(?:No\.)?(\d+)/i,'<moe-quote-link no="$2">No.$2</moe-quote-link>')}_modPushpost(t){const e=/\[MOD_PUSHPOST_USE\]<br(?: \/)?>([\w\W]+$)/gm,i=e.exec(t);return i?(this.$.pushpost.innerHTML=i[1],this.$.pushpost.style.display="block"):(this.$.pushpost.innerHTML="",this.$.pushpost.style.display="none"),t.replace(e,"")}}),hr=Array.prototype.some?Array.prototype.some:function(t){for(var e=Object(this),i=e.length>>>0,n=0;n<i;n++)if(n in e&&t.call(this,e[n],n,e))return!0;return!1};var xr=dr.momentProperties=[];function Mr(t,e){var i,n,a;if(Ar(e._isAMomentObject)||(t._isAMomentObject=e._isAMomentObject),Ar(e._i)||(t._i=e._i),Ar(e._f)||(t._f=e._f),Ar(e._l)||(t._l=e._l),Ar(e._strict)||(t._strict=e._strict),Ar(e._tzm)||(t._tzm=e._tzm),Ar(e._isUTC)||(t._isUTC=e._isUTC),Ar(e._offset)||(t._offset=e._offset),Ar(e._pf)||(t._pf=br(e)),Ar(e._locale)||(t._locale=e._locale),xr.length>0)for(i=0;i<xr.length;i++)Ar(a=e[n=xr[i]])||(t[n]=a);return t}var Sr=!1;function Cr(t){Mr(this,t),this._d=new Date(null!=t._d?t._d.getTime():NaN),this.isValid()||(this._d=new Date(NaN)),!1===Sr&&(Sr=!0,dr.updateOffset(this),Sr=!1)}function kr(t){return t instanceof Cr||null!=t&&null!=t._isAMomentObject}function Hr(t){return t<0?Math.ceil(t)||0:Math.floor(t)}function Vr(t){var e=+t,i=0;return 0!==e&&isFinite(e)&&(i=Hr(e)),i}function Lr(t,e,i){var n,a=Math.min(t.length,e.length),o=Math.abs(t.length-e.length),r=0;for(n=0;n<a;n++)(i&&t[n]!==e[n]||!i&&Vr(t[n])!==Vr(e[n]))&&r++;return r+o}function Tr(t){!1===dr.suppressDeprecationWarnings&&"undefined"!=typeof console&&console.warn&&console.warn("Deprecation warning: "+t)}function Er(t,e){var i=!0;return _r(function(){if(null!=dr.deprecationHandler&&dr.deprecationHandler(null,t),i){for(var n,a=[],o=0;o<arguments.length;o++){if(n="","object"==typeof arguments[o]){for(var r in n+="\n["+o+"] ",arguments[0])n+=r+": "+arguments[0][r]+", ";n=n.slice(0,-2)}else n=arguments[o];a.push(n)}Tr(t+"\nArguments: "+Array.prototype.slice.call(a).join("")+"\n"+(new Error).stack),i=!1}return e.apply(this,arguments)},e)}var Ir,Pr={};function Or(t,e){null!=dr.deprecationHandler&&dr.deprecationHandler(t,e),Pr[t]||(Tr(e),Pr[t]=!0)}function Nr(t){return t instanceof Function||"[object Function]"===Object.prototype.toString.call(t)}function Rr(t,e){var i,n=_r({},t);for(i in e)vr(e,i)&&(ur(t[i])&&ur(e[i])?(n[i]={},_r(n[i],t[i]),_r(n[i],e[i])):null!=e[i]?n[i]=e[i]:delete n[i]);for(i in t)vr(t,i)&&!vr(e,i)&&ur(t[i])&&(n[i]=_r({},n[i]));return n}function Dr(t){null!=t&&this.set(t)}dr.suppressDeprecationWarnings=!1,dr.deprecationHandler=null,Ir=Object.keys?Object.keys:function(t){var e,i=[];for(e in t)vr(t,e)&&i.push(e);return i};var Fr={};function Br(t,e){var i=t.toLowerCase();Fr[i]=Fr[i+"s"]=Fr[e]=t}function $r(t){return"string"==typeof t?Fr[t]||Fr[t.toLowerCase()]:void 0}function Yr(t){var e,i,n={};for(i in t)vr(t,i)&&(e=$r(i))&&(n[e]=t[i]);return n}var jr={};function qr(t,e){jr[t]=e}function Ur(t,e,i){var n=""+Math.abs(t),a=e-n.length;return(t>=0?i?"+":"":"-")+Math.pow(10,Math.max(0,a)).toString().substr(1)+n}var Wr=/(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,Kr=/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,Gr={},Qr={};function Zr(t,e,i,n){var a=n;"string"==typeof n&&(a=function(){return this[n]()}),t&&(Qr[t]=a),e&&(Qr[e[0]]=function(){return Ur(a.apply(this,arguments),e[1],e[2])}),i&&(Qr[i]=function(){return this.localeData().ordinal(a.apply(this,arguments),t)})}function Xr(t,e){return t.isValid()?(e=Jr(e,t.localeData()),Gr[e]=Gr[e]||function(t){var e,i,n,a=t.match(Wr);for(e=0,i=a.length;e<i;e++)Qr[a[e]]?a[e]=Qr[a[e]]:a[e]=(n=a[e]).match(/\[[\s\S]/)?n.replace(/^\[|\]$/g,""):n.replace(/\\/g,"");return function(e){var n,o="";for(n=0;n<i;n++)o+=Nr(a[n])?a[n].call(e,t):a[n];return o}}(e),Gr[e](t)):t.localeData().invalidDate()}function Jr(t,e){var i=5;function n(t){return e.longDateFormat(t)||t}for(Kr.lastIndex=0;i>=0&&Kr.test(t);)t=t.replace(Kr,n),Kr.lastIndex=0,i-=1;return t}var ts=/\d/,es=/\d\d/,is=/\d{3}/,ns=/\d{4}/,as=/[+-]?\d{6}/,os=/\d\d?/,rs=/\d\d\d\d?/,ss=/\d\d\d\d\d\d?/,ls=/\d{1,3}/,hs=/\d{1,4}/,cs=/[+-]?\d{1,6}/,ds=/\d+/,ps=/[+-]?\d+/,us=/Z|[+-]\d\d:?\d\d/gi,As=/Z|[+-]\d\d(?::?\d\d)?/gi,ms=/[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i,fs={};function gs(t,e,i){fs[t]=Nr(e)?e:function(t,n){return t&&i?i:e}}function vs(t,e){return vr(fs,t)?fs[t](e._strict,e._locale):new RegExp(_s(t.replace("\\","").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(t,e,i,n,a){return e||i||n||a})))}function _s(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}var ys={};function bs(t,e){var i,n=e;for("string"==typeof t&&(t=[t]),mr(e)&&(n=function(t,i){i[e]=Vr(t)}),i=0;i<t.length;i++)ys[t[i]]=n}function zs(t,e){bs(t,function(t,i,n,a){n._w=n._w||{},e(t,n._w,n,a)})}function ws(t,e,i){null!=e&&vr(ys,t)&&ys[t](e,i._a,i,t)}var xs=0,Ms=1,Ss=2,Cs=3,ks=4,Hs=5,Vs=6,Ls=7,Ts=8;function Es(t){return Is(t)?366:365}function Is(t){return t%4==0&&t%100!=0||t%400==0}Zr("Y",0,0,function(){var t=this.year();return t<=9999?""+t:"+"+t}),Zr(0,["YY",2],0,function(){return this.year()%100}),Zr(0,["YYYY",4],0,"year"),Zr(0,["YYYYY",5],0,"year"),Zr(0,["YYYYYY",6,!0],0,"year"),Br("year","y"),qr("year",1),gs("Y",ps),gs("YY",os,es),gs("YYYY",hs,ns),gs("YYYYY",cs,as),gs("YYYYYY",cs,as),bs(["YYYYY","YYYYYY"],xs),bs("YYYY",function(t,e){e[xs]=2===t.length?dr.parseTwoDigitYear(t):Vr(t)}),bs("YY",function(t,e){e[xs]=dr.parseTwoDigitYear(t)}),bs("Y",function(t,e){e[xs]=parseInt(t,10)}),dr.parseTwoDigitYear=function(t){return Vr(t)+(Vr(t)>68?1900:2e3)};var Ps,Os=Ns("FullYear",!0);function Ns(t,e){return function(i){return null!=i?(Ds(this,t,i),dr.updateOffset(this,e),this):Rs(this,t)}}function Rs(t,e){return t.isValid()?t._d["get"+(t._isUTC?"UTC":"")+e]():NaN}function Ds(t,e,i){t.isValid()&&!isNaN(i)&&("FullYear"===e&&Is(t.year())&&1===t.month()&&29===t.date()?t._d["set"+(t._isUTC?"UTC":"")+e](i,t.month(),Fs(i,t.month())):t._d["set"+(t._isUTC?"UTC":"")+e](i))}function Fs(t,e){if(isNaN(t)||isNaN(e))return NaN;var i,n=(e%(i=12)+i)%i;return t+=(e-n)/12,1===n?Is(t)?29:28:31-n%7%2}Ps=Array.prototype.indexOf?Array.prototype.indexOf:function(t){var e;for(e=0;e<this.length;++e)if(this[e]===t)return e;return-1},Zr("M",["MM",2],"Mo",function(){return this.month()+1}),Zr("MMM",0,0,function(t){return this.localeData().monthsShort(this,t)}),Zr("MMMM",0,0,function(t){return this.localeData().months(this,t)}),Br("month","M"),qr("month",8),gs("M",os),gs("MM",os,es),gs("MMM",function(t,e){return e.monthsShortRegex(t)}),gs("MMMM",function(t,e){return e.monthsRegex(t)}),bs(["M","MM"],function(t,e){e[Ms]=Vr(t)-1}),bs(["MMM","MMMM"],function(t,e,i,n){var a=i._locale.monthsParse(t,n,i._strict);null!=a?e[Ms]=a:br(i).invalidMonth=t});var Bs=/D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,$s="January_February_March_April_May_June_July_August_September_October_November_December".split("_");var Ys="Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_");function js(t,e){var i;if(!t.isValid())return t;if("string"==typeof e)if(/^\d+$/.test(e))e=Vr(e);else if(!mr(e=t.localeData().monthsParse(e)))return t;return i=Math.min(t.date(),Fs(t.year(),e)),t._d["set"+(t._isUTC?"UTC":"")+"Month"](e,i),t}function qs(t){return null!=t?(js(this,t),dr.updateOffset(this,!0),this):Rs(this,"Month")}var Us=ms;var Ws=ms;function Ks(){function t(t,e){return e.length-t.length}var e,i,n=[],a=[],o=[];for(e=0;e<12;e++)i=yr([2e3,e]),n.push(this.monthsShort(i,"")),a.push(this.months(i,"")),o.push(this.months(i,"")),o.push(this.monthsShort(i,""));for(n.sort(t),a.sort(t),o.sort(t),e=0;e<12;e++)n[e]=_s(n[e]),a[e]=_s(a[e]);for(e=0;e<24;e++)o[e]=_s(o[e]);this._monthsRegex=new RegExp("^("+o.join("|")+")","i"),this._monthsShortRegex=this._monthsRegex,this._monthsStrictRegex=new RegExp("^("+a.join("|")+")","i"),this._monthsShortStrictRegex=new RegExp("^("+n.join("|")+")","i")}function Gs(t){var e=new Date(Date.UTC.apply(null,arguments));return t<100&&t>=0&&isFinite(e.getUTCFullYear())&&e.setUTCFullYear(t),e}function Qs(t,e,i){var n=7+e-i;return-((7+Gs(t,0,n).getUTCDay()-e)%7)+n-1}function Zs(t,e,i,n,a){var o,r,s=1+7*(e-1)+(7+i-n)%7+Qs(t,n,a);return s<=0?r=Es(o=t-1)+s:s>Es(t)?(o=t+1,r=s-Es(t)):(o=t,r=s),{year:o,dayOfYear:r}}function Xs(t,e,i){var n,a,o=Qs(t.year(),e,i),r=Math.floor((t.dayOfYear()-o-1)/7)+1;return r<1?n=r+Js(a=t.year()-1,e,i):r>Js(t.year(),e,i)?(n=r-Js(t.year(),e,i),a=t.year()+1):(a=t.year(),n=r),{week:n,year:a}}function Js(t,e,i){var n=Qs(t,e,i),a=Qs(t+1,e,i);return(Es(t)-n+a)/7}Zr("w",["ww",2],"wo","week"),Zr("W",["WW",2],"Wo","isoWeek"),Br("week","w"),Br("isoWeek","W"),qr("week",5),qr("isoWeek",5),gs("w",os),gs("ww",os,es),gs("W",os),gs("WW",os,es),zs(["w","ww","W","WW"],function(t,e,i,n){e[n.substr(0,1)]=Vr(t)});Zr("d",0,"do","day"),Zr("dd",0,0,function(t){return this.localeData().weekdaysMin(this,t)}),Zr("ddd",0,0,function(t){return this.localeData().weekdaysShort(this,t)}),Zr("dddd",0,0,function(t){return this.localeData().weekdays(this,t)}),Zr("e",0,0,"weekday"),Zr("E",0,0,"isoWeekday"),Br("day","d"),Br("weekday","e"),Br("isoWeekday","E"),qr("day",11),qr("weekday",11),qr("isoWeekday",11),gs("d",os),gs("e",os),gs("E",os),gs("dd",function(t,e){return e.weekdaysMinRegex(t)}),gs("ddd",function(t,e){return e.weekdaysShortRegex(t)}),gs("dddd",function(t,e){return e.weekdaysRegex(t)}),zs(["dd","ddd","dddd"],function(t,e,i,n){var a=i._locale.weekdaysParse(t,n,i._strict);null!=a?e.d=a:br(i).invalidWeekday=t}),zs(["d","e","E"],function(t,e,i,n){e[n]=Vr(t)});var tl="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_");var el="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_");var il="Su_Mo_Tu_We_Th_Fr_Sa".split("_");var nl=ms;var al=ms;var ol=ms;function rl(){function t(t,e){return e.length-t.length}var e,i,n,a,o,r=[],s=[],l=[],h=[];for(e=0;e<7;e++)i=yr([2e3,1]).day(e),n=this.weekdaysMin(i,""),a=this.weekdaysShort(i,""),o=this.weekdays(i,""),r.push(n),s.push(a),l.push(o),h.push(n),h.push(a),h.push(o);for(r.sort(t),s.sort(t),l.sort(t),h.sort(t),e=0;e<7;e++)s[e]=_s(s[e]),l[e]=_s(l[e]),h[e]=_s(h[e]);this._weekdaysRegex=new RegExp("^("+h.join("|")+")","i"),this._weekdaysShortRegex=this._weekdaysRegex,this._weekdaysMinRegex=this._weekdaysRegex,this._weekdaysStrictRegex=new RegExp("^("+l.join("|")+")","i"),this._weekdaysShortStrictRegex=new RegExp("^("+s.join("|")+")","i"),this._weekdaysMinStrictRegex=new RegExp("^("+r.join("|")+")","i")}function sl(){return this.hours()%12||12}function ll(t,e){Zr(t,0,0,function(){return this.localeData().meridiem(this.hours(),this.minutes(),e)})}function hl(t,e){return e._meridiemParse}Zr("H",["HH",2],0,"hour"),Zr("h",["hh",2],0,sl),Zr("k",["kk",2],0,function(){return this.hours()||24}),Zr("hmm",0,0,function(){return""+sl.apply(this)+Ur(this.minutes(),2)}),Zr("hmmss",0,0,function(){return""+sl.apply(this)+Ur(this.minutes(),2)+Ur(this.seconds(),2)}),Zr("Hmm",0,0,function(){return""+this.hours()+Ur(this.minutes(),2)}),Zr("Hmmss",0,0,function(){return""+this.hours()+Ur(this.minutes(),2)+Ur(this.seconds(),2)}),ll("a",!0),ll("A",!1),Br("hour","h"),qr("hour",13),gs("a",hl),gs("A",hl),gs("H",os),gs("h",os),gs("k",os),gs("HH",os,es),gs("hh",os,es),gs("kk",os,es),gs("hmm",rs),gs("hmmss",ss),gs("Hmm",rs),gs("Hmmss",ss),bs(["H","HH"],Cs),bs(["k","kk"],function(t,e,i){var n=Vr(t);e[Cs]=24===n?0:n}),bs(["a","A"],function(t,e,i){i._isPm=i._locale.isPM(t),i._meridiem=t}),bs(["h","hh"],function(t,e,i){e[Cs]=Vr(t),br(i).bigHour=!0}),bs("hmm",function(t,e,i){var n=t.length-2;e[Cs]=Vr(t.substr(0,n)),e[ks]=Vr(t.substr(n)),br(i).bigHour=!0}),bs("hmmss",function(t,e,i){var n=t.length-4,a=t.length-2;e[Cs]=Vr(t.substr(0,n)),e[ks]=Vr(t.substr(n,2)),e[Hs]=Vr(t.substr(a)),br(i).bigHour=!0}),bs("Hmm",function(t,e,i){var n=t.length-2;e[Cs]=Vr(t.substr(0,n)),e[ks]=Vr(t.substr(n))}),bs("Hmmss",function(t,e,i){var n=t.length-4,a=t.length-2;e[Cs]=Vr(t.substr(0,n)),e[ks]=Vr(t.substr(n,2)),e[Hs]=Vr(t.substr(a))});var cl,dl=Ns("Hours",!0),pl={calendar:{sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},longDateFormat:{LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"},invalidDate:"Invalid date",ordinal:"%d",dayOfMonthOrdinalParse:/\d{1,2}/,relativeTime:{future:"in %s",past:"%s ago",s:"a few seconds",ss:"%d seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},months:$s,monthsShort:Ys,week:{dow:0,doy:6},weekdays:tl,weekdaysMin:il,weekdaysShort:el,meridiemParse:/[ap]\.?m?\.?/i},ul={},Al={};function ml(t){return t?t.toLowerCase().replace("_","-"):t}function fl(t){var e=null;if(!ul[t]&&"undefined"!=typeof module&&module&&module.exports)try{e=cl._abbr,require("./locale/"+t),gl(e)}catch(t){}return ul[t]}function gl(t,e){var i;return t&&((i=Ar(e)?_l(t):vl(t,e))?cl=i:"undefined"!=typeof console&&console.warn&&console.warn("Locale "+t+" not found. Did you forget to load it?")),cl._abbr}function vl(t,e){if(null!==e){var i,n=pl;if(e.abbr=t,null!=ul[t])Or("defineLocaleOverride","use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."),n=ul[t]._config;else if(null!=e.parentLocale)if(null!=ul[e.parentLocale])n=ul[e.parentLocale]._config;else{if(null==(i=fl(e.parentLocale)))return Al[e.parentLocale]||(Al[e.parentLocale]=[]),Al[e.parentLocale].push({name:t,config:e}),null;n=i._config}return ul[t]=new Dr(Rr(n,e)),Al[t]&&Al[t].forEach(function(t){vl(t.name,t.config)}),gl(t),ul[t]}return delete ul[t],null}function _l(t){var e;if(t&&t._locale&&t._locale._abbr&&(t=t._locale._abbr),!t)return cl;if(!pr(t)){if(e=fl(t))return e;t=[t]}return function(t){for(var e,i,n,a,o=0;o<t.length;){for(e=(a=ml(t[o]).split("-")).length,i=(i=ml(t[o+1]))?i.split("-"):null;e>0;){if(n=fl(a.slice(0,e).join("-")))return n;if(i&&i.length>=e&&Lr(a,i,!0)>=e-1)break;e--}o++}return cl}(t)}function yl(t){var e,i=t._a;return i&&-2===br(t).overflow&&(e=i[Ms]<0||i[Ms]>11?Ms:i[Ss]<1||i[Ss]>Fs(i[xs],i[Ms])?Ss:i[Cs]<0||i[Cs]>24||24===i[Cs]&&(0!==i[ks]||0!==i[Hs]||0!==i[Vs])?Cs:i[ks]<0||i[ks]>59?ks:i[Hs]<0||i[Hs]>59?Hs:i[Vs]<0||i[Vs]>999?Vs:-1,br(t)._overflowDayOfYear&&(e<xs||e>Ss)&&(e=Ss),br(t)._overflowWeeks&&-1===e&&(e=Ls),br(t)._overflowWeekday&&-1===e&&(e=Ts),br(t).overflow=e),t}function bl(t,e,i){return null!=t?t:null!=e?e:i}function zl(t){var e,i,n,a,o,r=[];if(!t._d){for(n=function(t){var e=new Date(dr.now());return t._useUTC?[e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate()]:[e.getFullYear(),e.getMonth(),e.getDate()]}(t),t._w&&null==t._a[Ss]&&null==t._a[Ms]&&function(t){var e,i,n,a,o,r,s,l;if(null!=(e=t._w).GG||null!=e.W||null!=e.E)o=1,r=4,i=bl(e.GG,t._a[xs],Xs(Nl(),1,4).year),n=bl(e.W,1),((a=bl(e.E,1))<1||a>7)&&(l=!0);else{o=t._locale._week.dow,r=t._locale._week.doy;var h=Xs(Nl(),o,r);i=bl(e.gg,t._a[xs],h.year),n=bl(e.w,h.week),null!=e.d?((a=e.d)<0||a>6)&&(l=!0):null!=e.e?(a=e.e+o,(e.e<0||e.e>6)&&(l=!0)):a=o}n<1||n>Js(i,o,r)?br(t)._overflowWeeks=!0:null!=l?br(t)._overflowWeekday=!0:(s=Zs(i,n,a,o,r),t._a[xs]=s.year,t._dayOfYear=s.dayOfYear)}(t),null!=t._dayOfYear&&(o=bl(t._a[xs],n[xs]),(t._dayOfYear>Es(o)||0===t._dayOfYear)&&(br(t)._overflowDayOfYear=!0),i=Gs(o,0,t._dayOfYear),t._a[Ms]=i.getUTCMonth(),t._a[Ss]=i.getUTCDate()),e=0;e<3&&null==t._a[e];++e)t._a[e]=r[e]=n[e];for(;e<7;e++)t._a[e]=r[e]=null==t._a[e]?2===e?1:0:t._a[e];24===t._a[Cs]&&0===t._a[ks]&&0===t._a[Hs]&&0===t._a[Vs]&&(t._nextDay=!0,t._a[Cs]=0),t._d=(t._useUTC?Gs:function(t,e,i,n,a,o,r){var s=new Date(t,e,i,n,a,o,r);return t<100&&t>=0&&isFinite(s.getFullYear())&&s.setFullYear(t),s}).apply(null,r),a=t._useUTC?t._d.getUTCDay():t._d.getDay(),null!=t._tzm&&t._d.setUTCMinutes(t._d.getUTCMinutes()-t._tzm),t._nextDay&&(t._a[Cs]=24),t._w&&void 0!==t._w.d&&t._w.d!==a&&(br(t).weekdayMismatch=!0)}}var wl=/^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,xl=/^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,Ml=/Z|[+-]\d\d(?::?\d\d)?/,Sl=[["YYYYYY-MM-DD",/[+-]\d{6}-\d\d-\d\d/],["YYYY-MM-DD",/\d{4}-\d\d-\d\d/],["GGGG-[W]WW-E",/\d{4}-W\d\d-\d/],["GGGG-[W]WW",/\d{4}-W\d\d/,!1],["YYYY-DDD",/\d{4}-\d{3}/],["YYYY-MM",/\d{4}-\d\d/,!1],["YYYYYYMMDD",/[+-]\d{10}/],["YYYYMMDD",/\d{8}/],["GGGG[W]WWE",/\d{4}W\d{3}/],["GGGG[W]WW",/\d{4}W\d{2}/,!1],["YYYYDDD",/\d{7}/]],Cl=[["HH:mm:ss.SSSS",/\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss,SSSS",/\d\d:\d\d:\d\d,\d+/],["HH:mm:ss",/\d\d:\d\d:\d\d/],["HH:mm",/\d\d:\d\d/],["HHmmss.SSSS",/\d\d\d\d\d\d\.\d+/],["HHmmss,SSSS",/\d\d\d\d\d\d,\d+/],["HHmmss",/\d\d\d\d\d\d/],["HHmm",/\d\d\d\d/],["HH",/\d\d/]],kl=/^\/?Date\((\-?\d+)/i;function Hl(t){var e,i,n,a,o,r,s=t._i,l=wl.exec(s)||xl.exec(s);if(l){for(br(t).iso=!0,e=0,i=Sl.length;e<i;e++)if(Sl[e][1].exec(l[1])){a=Sl[e][0],n=!1!==Sl[e][2];break}if(null==a)return void(t._isValid=!1);if(l[3]){for(e=0,i=Cl.length;e<i;e++)if(Cl[e][1].exec(l[3])){o=(l[2]||" ")+Cl[e][0];break}if(null==o)return void(t._isValid=!1)}if(!n&&null!=o)return void(t._isValid=!1);if(l[4]){if(!Ml.exec(l[4]))return void(t._isValid=!1);r="Z"}t._f=a+(o||"")+(r||""),Il(t)}else t._isValid=!1}var Vl=/^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;function Ll(t,e,i,n,a,o){var r=[function(t){var e=parseInt(t,10);if(e<=49)return 2e3+e;if(e<=999)return 1900+e;return e}(t),Ys.indexOf(e),parseInt(i,10),parseInt(n,10),parseInt(a,10)];return o&&r.push(parseInt(o,10)),r}var Tl={UT:0,GMT:0,EDT:-240,EST:-300,CDT:-300,CST:-360,MDT:-360,MST:-420,PDT:-420,PST:-480};function El(t){var e=Vl.exec(t._i.replace(/\([^)]*\)|[\n\t]/g," ").replace(/(\s\s+)/g," ").replace(/^\s\s*/,"").replace(/\s\s*$/,""));if(e){var i=Ll(e[4],e[3],e[2],e[5],e[6],e[7]);if(!function(t,e,i){return!t||el.indexOf(t)===new Date(e[0],e[1],e[2]).getDay()||(br(i).weekdayMismatch=!0,i._isValid=!1,!1)}(e[1],i,t))return;t._a=i,t._tzm=function(t,e,i){if(t)return Tl[t];if(e)return 0;var n=parseInt(i,10),a=n%100;return(n-a)/100*60+a}(e[8],e[9],e[10]),t._d=Gs.apply(null,t._a),t._d.setUTCMinutes(t._d.getUTCMinutes()-t._tzm),br(t).rfc2822=!0}else t._isValid=!1}function Il(t){if(t._f!==dr.ISO_8601)if(t._f!==dr.RFC_2822){t._a=[],br(t).empty=!0;var e,i,n,a,o,r=""+t._i,s=r.length,l=0;for(n=Jr(t._f,t._locale).match(Wr)||[],e=0;e<n.length;e++)a=n[e],(i=(r.match(vs(a,t))||[])[0])&&((o=r.substr(0,r.indexOf(i))).length>0&&br(t).unusedInput.push(o),r=r.slice(r.indexOf(i)+i.length),l+=i.length),Qr[a]?(i?br(t).empty=!1:br(t).unusedTokens.push(a),ws(a,i,t)):t._strict&&!i&&br(t).unusedTokens.push(a);br(t).charsLeftOver=s-l,r.length>0&&br(t).unusedInput.push(r),t._a[Cs]<=12&&!0===br(t).bigHour&&t._a[Cs]>0&&(br(t).bigHour=void 0),br(t).parsedDateParts=t._a.slice(0),br(t).meridiem=t._meridiem,t._a[Cs]=function(t,e,i){var n;if(null==i)return e;return null!=t.meridiemHour?t.meridiemHour(e,i):null!=t.isPM?((n=t.isPM(i))&&e<12&&(e+=12),n||12!==e||(e=0),e):e}(t._locale,t._a[Cs],t._meridiem),zl(t),yl(t)}else El(t);else Hl(t)}function Pl(t){var e=t._i,i=t._f;return t._locale=t._locale||_l(t._l),null===e||void 0===i&&""===e?wr({nullInput:!0}):("string"==typeof e&&(t._i=e=t._locale.preparse(e)),kr(e)?new Cr(yl(e)):(fr(e)?t._d=e:pr(i)?function(t){var e,i,n,a,o;if(0===t._f.length)return br(t).invalidFormat=!0,void(t._d=new Date(NaN));for(a=0;a<t._f.length;a++)o=0,e=Mr({},t),null!=t._useUTC&&(e._useUTC=t._useUTC),e._f=t._f[a],Il(e),zr(e)&&(o+=br(e).charsLeftOver,o+=10*br(e).unusedTokens.length,br(e).score=o,(null==n||o<n)&&(n=o,i=e));_r(t,i||e)}(t):i?Il(t):function(t){var e=t._i;Ar(e)?t._d=new Date(dr.now()):fr(e)?t._d=new Date(e.valueOf()):"string"==typeof e?function(t){var e=kl.exec(t._i);null===e?(Hl(t),!1===t._isValid&&(delete t._isValid,El(t),!1===t._isValid&&(delete t._isValid,dr.createFromInputFallback(t)))):t._d=new Date(+e[1])}(t):pr(e)?(t._a=gr(e.slice(0),function(t){return parseInt(t,10)}),zl(t)):ur(e)?function(t){if(!t._d){var e=Yr(t._i);t._a=gr([e.year,e.month,e.day||e.date,e.hour,e.minute,e.second,e.millisecond],function(t){return t&&parseInt(t,10)}),zl(t)}}(t):mr(e)?t._d=new Date(e):dr.createFromInputFallback(t)}(t),zr(t)||(t._d=null),t))}function Ol(t,e,i,n,a){var o,r={};return!0!==i&&!1!==i||(n=i,i=void 0),(ur(t)&&function(t){if(Object.getOwnPropertyNames)return 0===Object.getOwnPropertyNames(t).length;var e;for(e in t)if(t.hasOwnProperty(e))return!1;return!0}(t)||pr(t)&&0===t.length)&&(t=void 0),r._isAMomentObject=!0,r._useUTC=r._isUTC=a,r._l=i,r._i=t,r._f=e,r._strict=n,(o=new Cr(yl(Pl(r))))._nextDay&&(o.add(1,"d"),o._nextDay=void 0),o}function Nl(t,e,i,n){return Ol(t,e,i,n,!1)}dr.createFromInputFallback=Er("value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to js Date(), which is not reliable across all browsers and versions. Non RFC2822/ISO date formats are discouraged and will be removed in an upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.",function(t){t._d=new Date(t._i+(t._useUTC?" UTC":""))}),dr.ISO_8601=function(){},dr.RFC_2822=function(){};var Rl=Er("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var t=Nl.apply(null,arguments);return this.isValid()&&t.isValid()?t<this?this:t:wr()}),Dl=Er("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var t=Nl.apply(null,arguments);return this.isValid()&&t.isValid()?t>this?this:t:wr()});function Fl(t,e){var i,n;if(1===e.length&&pr(e[0])&&(e=e[0]),!e.length)return Nl();for(i=e[0],n=1;n<e.length;++n)e[n].isValid()&&!e[n][t](i)||(i=e[n]);return i}var Bl=["year","quarter","month","week","day","hour","minute","second","millisecond"];function $l(t){var e=Yr(t),i=e.year||0,n=e.quarter||0,a=e.month||0,o=e.week||0,r=e.day||0,s=e.hour||0,l=e.minute||0,h=e.second||0,c=e.millisecond||0;this._isValid=function(t){for(var e in t)if(-1===Ps.call(Bl,e)||null!=t[e]&&isNaN(t[e]))return!1;for(var i=!1,n=0;n<Bl.length;++n)if(t[Bl[n]]){if(i)return!1;parseFloat(t[Bl[n]])!==Vr(t[Bl[n]])&&(i=!0)}return!0}(e),this._milliseconds=+c+1e3*h+6e4*l+1e3*s*60*60,this._days=+r+7*o,this._months=+a+3*n+12*i,this._data={},this._locale=_l(),this._bubble()}function Yl(t){return t instanceof $l}function jl(t){return t<0?-1*Math.round(-1*t):Math.round(t)}function ql(t,e){Zr(t,0,0,function(){var t=this.utcOffset(),i="+";return t<0&&(t=-t,i="-"),i+Ur(~~(t/60),2)+e+Ur(~~t%60,2)})}ql("Z",":"),ql("ZZ",""),gs("Z",As),gs("ZZ",As),bs(["Z","ZZ"],function(t,e,i){i._useUTC=!0,i._tzm=Wl(As,t)});var Ul=/([\+\-]|\d\d)/gi;function Wl(t,e){var i=(e||"").match(t);if(null===i)return null;var n=((i[i.length-1]||[])+"").match(Ul)||["-",0,0],a=60*n[1]+Vr(n[2]);return 0===a?0:"+"===n[0]?a:-a}function Kl(t,e){var i,n;return e._isUTC?(i=e.clone(),n=(kr(t)||fr(t)?t.valueOf():Nl(t).valueOf())-i.valueOf(),i._d.setTime(i._d.valueOf()+n),dr.updateOffset(i,!1),i):Nl(t).local()}function Gl(t){return 15*-Math.round(t._d.getTimezoneOffset()/15)}function Ql(){return!!this.isValid()&&(this._isUTC&&0===this._offset)}dr.updateOffset=function(){};var Zl=/^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/,Xl=/^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;function Jl(t,e){var i,n,a,o=t,r=null;return Yl(t)?o={ms:t._milliseconds,d:t._days,M:t._months}:mr(t)?(o={},e?o[e]=t:o.milliseconds=t):(r=Zl.exec(t))?(i="-"===r[1]?-1:1,o={y:0,d:Vr(r[Ss])*i,h:Vr(r[Cs])*i,m:Vr(r[ks])*i,s:Vr(r[Hs])*i,ms:Vr(jl(1e3*r[Vs]))*i}):(r=Xl.exec(t))?(i="-"===r[1]?-1:(r[1],1),o={y:th(r[2],i),M:th(r[3],i),w:th(r[4],i),d:th(r[5],i),h:th(r[6],i),m:th(r[7],i),s:th(r[8],i)}):null==o?o={}:"object"==typeof o&&("from"in o||"to"in o)&&(a=function(t,e){var i;if(!t.isValid()||!e.isValid())return{milliseconds:0,months:0};e=Kl(e,t),t.isBefore(e)?i=eh(t,e):((i=eh(e,t)).milliseconds=-i.milliseconds,i.months=-i.months);return i}(Nl(o.from),Nl(o.to)),(o={}).ms=a.milliseconds,o.M=a.months),n=new $l(o),Yl(t)&&vr(t,"_locale")&&(n._locale=t._locale),n}function th(t,e){var i=t&&parseFloat(t.replace(",","."));return(isNaN(i)?0:i)*e}function eh(t,e){var i={milliseconds:0,months:0};return i.months=e.month()-t.month()+12*(e.year()-t.year()),t.clone().add(i.months,"M").isAfter(e)&&--i.months,i.milliseconds=+e-+t.clone().add(i.months,"M"),i}function ih(t,e){return function(i,n){var a;return null===n||isNaN(+n)||(Or(e,"moment()."+e+"(period, number) is deprecated. Please use moment()."+e+"(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),a=i,i=n,n=a),nh(this,Jl(i="string"==typeof i?+i:i,n),t),this}}function nh(t,e,i,n){var a=e._milliseconds,o=jl(e._days),r=jl(e._months);t.isValid()&&(n=null==n||n,r&&js(t,Rs(t,"Month")+r*i),o&&Ds(t,"Date",Rs(t,"Date")+o*i),a&&t._d.setTime(t._d.valueOf()+a*i),n&&dr.updateOffset(t,o||r))}Jl.fn=$l.prototype,Jl.invalid=function(){return Jl(NaN)};var ah=ih(1,"add"),oh=ih(-1,"subtract");function rh(t,e){var i=12*(e.year()-t.year())+(e.month()-t.month()),n=t.clone().add(i,"months");return-(i+(e-n<0?(e-n)/(n-t.clone().add(i-1,"months")):(e-n)/(t.clone().add(i+1,"months")-n)))||0}function sh(t){var e;return void 0===t?this._locale._abbr:(null!=(e=_l(t))&&(this._locale=e),this)}dr.defaultFormat="YYYY-MM-DDTHH:mm:ssZ",dr.defaultFormatUtc="YYYY-MM-DDTHH:mm:ss[Z]";var lh=Er("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(t){return void 0===t?this.localeData():this.locale(t)});function hh(){return this._locale}function ch(t,e){Zr(0,[t,t.length],0,e)}function dh(t,e,i,n,a){var o;return null==t?Xs(this,n,a).year:(e>(o=Js(t,n,a))&&(e=o),function(t,e,i,n,a){var o=Zs(t,e,i,n,a),r=Gs(o.year,0,o.dayOfYear);return this.year(r.getUTCFullYear()),this.month(r.getUTCMonth()),this.date(r.getUTCDate()),this}.call(this,t,e,i,n,a))}Zr(0,["gg",2],0,function(){return this.weekYear()%100}),Zr(0,["GG",2],0,function(){return this.isoWeekYear()%100}),ch("gggg","weekYear"),ch("ggggg","weekYear"),ch("GGGG","isoWeekYear"),ch("GGGGG","isoWeekYear"),Br("weekYear","gg"),Br("isoWeekYear","GG"),qr("weekYear",1),qr("isoWeekYear",1),gs("G",ps),gs("g",ps),gs("GG",os,es),gs("gg",os,es),gs("GGGG",hs,ns),gs("gggg",hs,ns),gs("GGGGG",cs,as),gs("ggggg",cs,as),zs(["gggg","ggggg","GGGG","GGGGG"],function(t,e,i,n){e[n.substr(0,2)]=Vr(t)}),zs(["gg","GG"],function(t,e,i,n){e[n]=dr.parseTwoDigitYear(t)}),Zr("Q",0,"Qo","quarter"),Br("quarter","Q"),qr("quarter",7),gs("Q",ts),bs("Q",function(t,e){e[Ms]=3*(Vr(t)-1)}),Zr("D",["DD",2],"Do","date"),Br("date","D"),qr("date",9),gs("D",os),gs("DD",os,es),gs("Do",function(t,e){return t?e._dayOfMonthOrdinalParse||e._ordinalParse:e._dayOfMonthOrdinalParseLenient}),bs(["D","DD"],Ss),bs("Do",function(t,e){e[Ss]=Vr(t.match(os)[0])});var ph=Ns("Date",!0);Zr("DDD",["DDDD",3],"DDDo","dayOfYear"),Br("dayOfYear","DDD"),qr("dayOfYear",4),gs("DDD",ls),gs("DDDD",is),bs(["DDD","DDDD"],function(t,e,i){i._dayOfYear=Vr(t)}),Zr("m",["mm",2],0,"minute"),Br("minute","m"),qr("minute",14),gs("m",os),gs("mm",os,es),bs(["m","mm"],ks);var uh=Ns("Minutes",!1);Zr("s",["ss",2],0,"second"),Br("second","s"),qr("second",15),gs("s",os),gs("ss",os,es),bs(["s","ss"],Hs);var Ah,mh=Ns("Seconds",!1);for(Zr("S",0,0,function(){return~~(this.millisecond()/100)}),Zr(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),Zr(0,["SSS",3],0,"millisecond"),Zr(0,["SSSS",4],0,function(){return 10*this.millisecond()}),Zr(0,["SSSSS",5],0,function(){return 100*this.millisecond()}),Zr(0,["SSSSSS",6],0,function(){return 1e3*this.millisecond()}),Zr(0,["SSSSSSS",7],0,function(){return 1e4*this.millisecond()}),Zr(0,["SSSSSSSS",8],0,function(){return 1e5*this.millisecond()}),Zr(0,["SSSSSSSSS",9],0,function(){return 1e6*this.millisecond()}),Br("millisecond","ms"),qr("millisecond",16),gs("S",ls,ts),gs("SS",ls,es),gs("SSS",ls,is),Ah="SSSS";Ah.length<=9;Ah+="S")gs(Ah,ds);function fh(t,e){e[Vs]=Vr(1e3*("0."+t))}for(Ah="S";Ah.length<=9;Ah+="S")bs(Ah,fh);var gh=Ns("Milliseconds",!1);Zr("z",0,0,"zoneAbbr"),Zr("zz",0,0,"zoneName");var vh=Cr.prototype;function _h(t){return t}vh.add=ah,vh.calendar=function(t,e){var i=t||Nl(),n=Kl(i,this).startOf("day"),a=dr.calendarFormat(this,n)||"sameElse",o=e&&(Nr(e[a])?e[a].call(this,i):e[a]);return this.format(o||this.localeData().calendar(a,this,Nl(i)))},vh.clone=function(){return new Cr(this)},vh.diff=function(t,e,i){var n,a,o;if(!this.isValid())return NaN;if(!(n=Kl(t,this)).isValid())return NaN;switch(a=6e4*(n.utcOffset()-this.utcOffset()),e=$r(e)){case"year":o=rh(this,n)/12;break;case"month":o=rh(this,n);break;case"quarter":o=rh(this,n)/3;break;case"second":o=(this-n)/1e3;break;case"minute":o=(this-n)/6e4;break;case"hour":o=(this-n)/36e5;break;case"day":o=(this-n-a)/864e5;break;case"week":o=(this-n-a)/6048e5;break;default:o=this-n}return i?o:Hr(o)},vh.endOf=function(t){return void 0===(t=$r(t))||"millisecond"===t?this:("date"===t&&(t="day"),this.startOf(t).add(1,"isoWeek"===t?"week":t).subtract(1,"ms"))},vh.format=function(t){t||(t=this.isUtc()?dr.defaultFormatUtc:dr.defaultFormat);var e=Xr(this,t);return this.localeData().postformat(e)},vh.from=function(t,e){return this.isValid()&&(kr(t)&&t.isValid()||Nl(t).isValid())?Jl({to:this,from:t}).locale(this.locale()).humanize(!e):this.localeData().invalidDate()},vh.fromNow=function(t){return this.from(Nl(),t)},vh.to=function(t,e){return this.isValid()&&(kr(t)&&t.isValid()||Nl(t).isValid())?Jl({from:this,to:t}).locale(this.locale()).humanize(!e):this.localeData().invalidDate()},vh.toNow=function(t){return this.to(Nl(),t)},vh.get=function(t){return Nr(this[t=$r(t)])?this[t]():this},vh.invalidAt=function(){return br(this).overflow},vh.isAfter=function(t,e){var i=kr(t)?t:Nl(t);return!(!this.isValid()||!i.isValid())&&("millisecond"===(e=$r(Ar(e)?"millisecond":e))?this.valueOf()>i.valueOf():i.valueOf()<this.clone().startOf(e).valueOf())},vh.isBefore=function(t,e){var i=kr(t)?t:Nl(t);return!(!this.isValid()||!i.isValid())&&("millisecond"===(e=$r(Ar(e)?"millisecond":e))?this.valueOf()<i.valueOf():this.clone().endOf(e).valueOf()<i.valueOf())},vh.isBetween=function(t,e,i,n){return("("===(n=n||"()")[0]?this.isAfter(t,i):!this.isBefore(t,i))&&(")"===n[1]?this.isBefore(e,i):!this.isAfter(e,i))},vh.isSame=function(t,e){var i,n=kr(t)?t:Nl(t);return!(!this.isValid()||!n.isValid())&&("millisecond"===(e=$r(e||"millisecond"))?this.valueOf()===n.valueOf():(i=n.valueOf(),this.clone().startOf(e).valueOf()<=i&&i<=this.clone().endOf(e).valueOf()))},vh.isSameOrAfter=function(t,e){return this.isSame(t,e)||this.isAfter(t,e)},vh.isSameOrBefore=function(t,e){return this.isSame(t,e)||this.isBefore(t,e)},vh.isValid=function(){return zr(this)},vh.lang=lh,vh.locale=sh,vh.localeData=hh,vh.max=Dl,vh.min=Rl,vh.parsingFlags=function(){return _r({},br(this))},vh.set=function(t,e){if("object"==typeof t)for(var i=function(t){var e=[];for(var i in t)e.push({unit:i,priority:jr[i]});return e.sort(function(t,e){return t.priority-e.priority}),e}(t=Yr(t)),n=0;n<i.length;n++)this[i[n].unit](t[i[n].unit]);else if(Nr(this[t=$r(t)]))return this[t](e);return this},vh.startOf=function(t){switch(t=$r(t)){case"year":this.month(0);case"quarter":case"month":this.date(1);case"week":case"isoWeek":case"day":case"date":this.hours(0);case"hour":this.minutes(0);case"minute":this.seconds(0);case"second":this.milliseconds(0)}return"week"===t&&this.weekday(0),"isoWeek"===t&&this.isoWeekday(1),"quarter"===t&&this.month(3*Math.floor(this.month()/3)),this},vh.subtract=oh,vh.toArray=function(){var t=this;return[t.year(),t.month(),t.date(),t.hour(),t.minute(),t.second(),t.millisecond()]},vh.toObject=function(){var t=this;return{years:t.year(),months:t.month(),date:t.date(),hours:t.hours(),minutes:t.minutes(),seconds:t.seconds(),milliseconds:t.milliseconds()}},vh.toDate=function(){return new Date(this.valueOf())},vh.toISOString=function(t){if(!this.isValid())return null;var e=!0!==t,i=e?this.clone().utc():this;return i.year()<0||i.year()>9999?Xr(i,e?"YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]":"YYYYYY-MM-DD[T]HH:mm:ss.SSSZ"):Nr(Date.prototype.toISOString)?e?this.toDate().toISOString():new Date(this.valueOf()+60*this.utcOffset()*1e3).toISOString().replace("Z",Xr(i,"Z")):Xr(i,e?"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]":"YYYY-MM-DD[T]HH:mm:ss.SSSZ")},vh.inspect=function(){if(!this.isValid())return"moment.invalid(/* "+this._i+" */)";var t="moment",e="";this.isLocal()||(t=0===this.utcOffset()?"moment.utc":"moment.parseZone",e="Z");var i="["+t+'("]',n=0<=this.year()&&this.year()<=9999?"YYYY":"YYYYYY",a=e+'[")]';return this.format(i+n+"-MM-DD[T]HH:mm:ss.SSS"+a)},vh.toJSON=function(){return this.isValid()?this.toISOString():null},vh.toString=function(){return this.clone().locale("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")},vh.unix=function(){return Math.floor(this.valueOf()/1e3)},vh.valueOf=function(){return this._d.valueOf()-6e4*(this._offset||0)},vh.creationData=function(){return{input:this._i,format:this._f,locale:this._locale,isUTC:this._isUTC,strict:this._strict}},vh.year=Os,vh.isLeapYear=function(){return Is(this.year())},vh.weekYear=function(t){return dh.call(this,t,this.week(),this.weekday(),this.localeData()._week.dow,this.localeData()._week.doy)},vh.isoWeekYear=function(t){return dh.call(this,t,this.isoWeek(),this.isoWeekday(),1,4)},vh.quarter=vh.quarters=function(t){return null==t?Math.ceil((this.month()+1)/3):this.month(3*(t-1)+this.month()%3)},vh.month=qs,vh.daysInMonth=function(){return Fs(this.year(),this.month())},vh.week=vh.weeks=function(t){var e=this.localeData().week(this);return null==t?e:this.add(7*(t-e),"d")},vh.isoWeek=vh.isoWeeks=function(t){var e=Xs(this,1,4).week;return null==t?e:this.add(7*(t-e),"d")},vh.weeksInYear=function(){var t=this.localeData()._week;return Js(this.year(),t.dow,t.doy)},vh.isoWeeksInYear=function(){return Js(this.year(),1,4)},vh.date=ph,vh.day=vh.days=function(t){if(!this.isValid())return null!=t?this:NaN;var e=this._isUTC?this._d.getUTCDay():this._d.getDay();return null!=t?(t=function(t,e){return"string"!=typeof t?t:isNaN(t)?"number"==typeof(t=e.weekdaysParse(t))?t:null:parseInt(t,10)}(t,this.localeData()),this.add(t-e,"d")):e},vh.weekday=function(t){if(!this.isValid())return null!=t?this:NaN;var e=(this.day()+7-this.localeData()._week.dow)%7;return null==t?e:this.add(t-e,"d")},vh.isoWeekday=function(t){if(!this.isValid())return null!=t?this:NaN;if(null!=t){var e=function(t,e){return"string"==typeof t?e.weekdaysParse(t)%7||7:isNaN(t)?null:t}(t,this.localeData());return this.day(this.day()%7?e:e-7)}return this.day()||7},vh.dayOfYear=function(t){var e=Math.round((this.clone().startOf("day")-this.clone().startOf("year"))/864e5)+1;return null==t?e:this.add(t-e,"d")},vh.hour=vh.hours=dl,vh.minute=vh.minutes=uh,vh.second=vh.seconds=mh,vh.millisecond=vh.milliseconds=gh,vh.utcOffset=function(t,e,i){var n,a=this._offset||0;if(!this.isValid())return null!=t?this:NaN;if(null!=t){if("string"==typeof t){if(null===(t=Wl(As,t)))return this}else Math.abs(t)<16&&!i&&(t*=60);return!this._isUTC&&e&&(n=Gl(this)),this._offset=t,this._isUTC=!0,null!=n&&this.add(n,"m"),a!==t&&(!e||this._changeInProgress?nh(this,Jl(t-a,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,dr.updateOffset(this,!0),this._changeInProgress=null)),this}return this._isUTC?a:Gl(this)},vh.utc=function(t){return this.utcOffset(0,t)},vh.local=function(t){return this._isUTC&&(this.utcOffset(0,t),this._isUTC=!1,t&&this.subtract(Gl(this),"m")),this},vh.parseZone=function(){if(null!=this._tzm)this.utcOffset(this._tzm,!1,!0);else if("string"==typeof this._i){var t=Wl(us,this._i);null!=t?this.utcOffset(t):this.utcOffset(0,!0)}return this},vh.hasAlignedHourOffset=function(t){return!!this.isValid()&&(t=t?Nl(t).utcOffset():0,(this.utcOffset()-t)%60==0)},vh.isDST=function(){return this.utcOffset()>this.clone().month(0).utcOffset()||this.utcOffset()>this.clone().month(5).utcOffset()},vh.isLocal=function(){return!!this.isValid()&&!this._isUTC},vh.isUtcOffset=function(){return!!this.isValid()&&this._isUTC},vh.isUtc=Ql,vh.isUTC=Ql,vh.zoneAbbr=function(){return this._isUTC?"UTC":""},vh.zoneName=function(){return this._isUTC?"Coordinated Universal Time":""},vh.dates=Er("dates accessor is deprecated. Use date instead.",ph),vh.months=Er("months accessor is deprecated. Use month instead",qs),vh.years=Er("years accessor is deprecated. Use year instead",Os),vh.zone=Er("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/",function(t,e){return null!=t?("string"!=typeof t&&(t=-t),this.utcOffset(t,e),this):-this.utcOffset()}),vh.isDSTShifted=Er("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information",function(){if(!Ar(this._isDSTShifted))return this._isDSTShifted;var t={};if(Mr(t,this),(t=Pl(t))._a){var e=t._isUTC?yr(t._a):Nl(t._a);this._isDSTShifted=this.isValid()&&Lr(t._a,e.toArray())>0}else this._isDSTShifted=!1;return this._isDSTShifted});var yh=Dr.prototype;function bh(t,e,i,n){var a=_l(),o=yr().set(n,e);return a[i](o,t)}function zh(t,e,i){if(mr(t)&&(e=t,t=void 0),t=t||"",null!=e)return bh(t,e,i,"month");var n,a=[];for(n=0;n<12;n++)a[n]=bh(t,n,i,"month");return a}function wh(t,e,i,n){"boolean"==typeof t?(mr(e)&&(i=e,e=void 0),e=e||""):(i=e=t,t=!1,mr(e)&&(i=e,e=void 0),e=e||"");var a,o=_l(),r=t?o._week.dow:0;if(null!=i)return bh(e,(i+r)%7,n,"day");var s=[];for(a=0;a<7;a++)s[a]=bh(e,(a+r)%7,n,"day");return s}yh.calendar=function(t,e,i){var n=this._calendar[t]||this._calendar.sameElse;return Nr(n)?n.call(e,i):n},yh.longDateFormat=function(t){var e=this._longDateFormat[t],i=this._longDateFormat[t.toUpperCase()];return e||!i?e:(this._longDateFormat[t]=i.replace(/MMMM|MM|DD|dddd/g,function(t){return t.slice(1)}),this._longDateFormat[t])},yh.invalidDate=function(){return this._invalidDate},yh.ordinal=function(t){return this._ordinal.replace("%d",t)},yh.preparse=_h,yh.postformat=_h,yh.relativeTime=function(t,e,i,n){var a=this._relativeTime[i];return Nr(a)?a(t,e,i,n):a.replace(/%d/i,t)},yh.pastFuture=function(t,e){var i=this._relativeTime[t>0?"future":"past"];return Nr(i)?i(e):i.replace(/%s/i,e)},yh.set=function(t){var e,i;for(i in t)Nr(e=t[i])?this[i]=e:this["_"+i]=e;this._config=t,this._dayOfMonthOrdinalParseLenient=new RegExp((this._dayOfMonthOrdinalParse.source||this._ordinalParse.source)+"|"+/\d{1,2}/.source)},yh.months=function(t,e){return t?pr(this._months)?this._months[t.month()]:this._months[(this._months.isFormat||Bs).test(e)?"format":"standalone"][t.month()]:pr(this._months)?this._months:this._months.standalone},yh.monthsShort=function(t,e){return t?pr(this._monthsShort)?this._monthsShort[t.month()]:this._monthsShort[Bs.test(e)?"format":"standalone"][t.month()]:pr(this._monthsShort)?this._monthsShort:this._monthsShort.standalone},yh.monthsParse=function(t,e,i){var n,a,o;if(this._monthsParseExact)return function(t,e,i){var n,a,o,r=t.toLocaleLowerCase();if(!this._monthsParse)for(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[],n=0;n<12;++n)o=yr([2e3,n]),this._shortMonthsParse[n]=this.monthsShort(o,"").toLocaleLowerCase(),this._longMonthsParse[n]=this.months(o,"").toLocaleLowerCase();return i?"MMM"===e?-1!==(a=Ps.call(this._shortMonthsParse,r))?a:null:-1!==(a=Ps.call(this._longMonthsParse,r))?a:null:"MMM"===e?-1!==(a=Ps.call(this._shortMonthsParse,r))?a:-1!==(a=Ps.call(this._longMonthsParse,r))?a:null:-1!==(a=Ps.call(this._longMonthsParse,r))?a:-1!==(a=Ps.call(this._shortMonthsParse,r))?a:null}.call(this,t,e,i);for(this._monthsParse||(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[]),n=0;n<12;n++){if(a=yr([2e3,n]),i&&!this._longMonthsParse[n]&&(this._longMonthsParse[n]=new RegExp("^"+this.months(a,"").replace(".","")+"$","i"),this._shortMonthsParse[n]=new RegExp("^"+this.monthsShort(a,"").replace(".","")+"$","i")),i||this._monthsParse[n]||(o="^"+this.months(a,"")+"|^"+this.monthsShort(a,""),this._monthsParse[n]=new RegExp(o.replace(".",""),"i")),i&&"MMMM"===e&&this._longMonthsParse[n].test(t))return n;if(i&&"MMM"===e&&this._shortMonthsParse[n].test(t))return n;if(!i&&this._monthsParse[n].test(t))return n}},yh.monthsRegex=function(t){return this._monthsParseExact?(vr(this,"_monthsRegex")||Ks.call(this),t?this._monthsStrictRegex:this._monthsRegex):(vr(this,"_monthsRegex")||(this._monthsRegex=Ws),this._monthsStrictRegex&&t?this._monthsStrictRegex:this._monthsRegex)},yh.monthsShortRegex=function(t){return this._monthsParseExact?(vr(this,"_monthsRegex")||Ks.call(this),t?this._monthsShortStrictRegex:this._monthsShortRegex):(vr(this,"_monthsShortRegex")||(this._monthsShortRegex=Us),this._monthsShortStrictRegex&&t?this._monthsShortStrictRegex:this._monthsShortRegex)},yh.week=function(t){return Xs(t,this._week.dow,this._week.doy).week},yh.firstDayOfYear=function(){return this._week.doy},yh.firstDayOfWeek=function(){return this._week.dow},yh.weekdays=function(t,e){return t?pr(this._weekdays)?this._weekdays[t.day()]:this._weekdays[this._weekdays.isFormat.test(e)?"format":"standalone"][t.day()]:pr(this._weekdays)?this._weekdays:this._weekdays.standalone},yh.weekdaysMin=function(t){return t?this._weekdaysMin[t.day()]:this._weekdaysMin},yh.weekdaysShort=function(t){return t?this._weekdaysShort[t.day()]:this._weekdaysShort},yh.weekdaysParse=function(t,e,i){var n,a,o;if(this._weekdaysParseExact)return function(t,e,i){var n,a,o,r=t.toLocaleLowerCase();if(!this._weekdaysParse)for(this._weekdaysParse=[],this._shortWeekdaysParse=[],this._minWeekdaysParse=[],n=0;n<7;++n)o=yr([2e3,1]).day(n),this._minWeekdaysParse[n]=this.weekdaysMin(o,"").toLocaleLowerCase(),this._shortWeekdaysParse[n]=this.weekdaysShort(o,"").toLocaleLowerCase(),this._weekdaysParse[n]=this.weekdays(o,"").toLocaleLowerCase();return i?"dddd"===e?-1!==(a=Ps.call(this._weekdaysParse,r))?a:null:"ddd"===e?-1!==(a=Ps.call(this._shortWeekdaysParse,r))?a:null:-1!==(a=Ps.call(this._minWeekdaysParse,r))?a:null:"dddd"===e?-1!==(a=Ps.call(this._weekdaysParse,r))?a:-1!==(a=Ps.call(this._shortWeekdaysParse,r))?a:-1!==(a=Ps.call(this._minWeekdaysParse,r))?a:null:"ddd"===e?-1!==(a=Ps.call(this._shortWeekdaysParse,r))?a:-1!==(a=Ps.call(this._weekdaysParse,r))?a:-1!==(a=Ps.call(this._minWeekdaysParse,r))?a:null:-1!==(a=Ps.call(this._minWeekdaysParse,r))?a:-1!==(a=Ps.call(this._weekdaysParse,r))?a:-1!==(a=Ps.call(this._shortWeekdaysParse,r))?a:null}.call(this,t,e,i);for(this._weekdaysParse||(this._weekdaysParse=[],this._minWeekdaysParse=[],this._shortWeekdaysParse=[],this._fullWeekdaysParse=[]),n=0;n<7;n++){if(a=yr([2e3,1]).day(n),i&&!this._fullWeekdaysParse[n]&&(this._fullWeekdaysParse[n]=new RegExp("^"+this.weekdays(a,"").replace(".","\\.?")+"$","i"),this._shortWeekdaysParse[n]=new RegExp("^"+this.weekdaysShort(a,"").replace(".","\\.?")+"$","i"),this._minWeekdaysParse[n]=new RegExp("^"+this.weekdaysMin(a,"").replace(".","\\.?")+"$","i")),this._weekdaysParse[n]||(o="^"+this.weekdays(a,"")+"|^"+this.weekdaysShort(a,"")+"|^"+this.weekdaysMin(a,""),this._weekdaysParse[n]=new RegExp(o.replace(".",""),"i")),i&&"dddd"===e&&this._fullWeekdaysParse[n].test(t))return n;if(i&&"ddd"===e&&this._shortWeekdaysParse[n].test(t))return n;if(i&&"dd"===e&&this._minWeekdaysParse[n].test(t))return n;if(!i&&this._weekdaysParse[n].test(t))return n}},yh.weekdaysRegex=function(t){return this._weekdaysParseExact?(vr(this,"_weekdaysRegex")||rl.call(this),t?this._weekdaysStrictRegex:this._weekdaysRegex):(vr(this,"_weekdaysRegex")||(this._weekdaysRegex=nl),this._weekdaysStrictRegex&&t?this._weekdaysStrictRegex:this._weekdaysRegex)},yh.weekdaysShortRegex=function(t){return this._weekdaysParseExact?(vr(this,"_weekdaysRegex")||rl.call(this),t?this._weekdaysShortStrictRegex:this._weekdaysShortRegex):(vr(this,"_weekdaysShortRegex")||(this._weekdaysShortRegex=al),this._weekdaysShortStrictRegex&&t?this._weekdaysShortStrictRegex:this._weekdaysShortRegex)},yh.weekdaysMinRegex=function(t){return this._weekdaysParseExact?(vr(this,"_weekdaysRegex")||rl.call(this),t?this._weekdaysMinStrictRegex:this._weekdaysMinRegex):(vr(this,"_weekdaysMinRegex")||(this._weekdaysMinRegex=ol),this._weekdaysMinStrictRegex&&t?this._weekdaysMinStrictRegex:this._weekdaysMinRegex)},yh.isPM=function(t){return"p"===(t+"").toLowerCase().charAt(0)},yh.meridiem=function(t,e,i){return t>11?i?"pm":"PM":i?"am":"AM"},gl("en",{dayOfMonthOrdinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(t){var e=t%10;return t+(1===Vr(t%100/10)?"th":1===e?"st":2===e?"nd":3===e?"rd":"th")}}),dr.lang=Er("moment.lang is deprecated. Use moment.locale instead.",gl),dr.langData=Er("moment.langData is deprecated. Use moment.localeData instead.",_l);var xh=Math.abs;function Mh(t,e,i,n){var a=Jl(e,i);return t._milliseconds+=n*a._milliseconds,t._days+=n*a._days,t._months+=n*a._months,t._bubble()}function Sh(t){return t<0?Math.floor(t):Math.ceil(t)}function Ch(t){return 4800*t/146097}function kh(t){return 146097*t/4800}function Hh(t){return function(){return this.as(t)}}var Vh=Hh("ms"),Lh=Hh("s"),Th=Hh("m"),Eh=Hh("h"),Ih=Hh("d"),Ph=Hh("w"),Oh=Hh("M"),Nh=Hh("y");function Rh(t){return function(){return this.isValid()?this._data[t]:NaN}}var Dh=Rh("milliseconds"),Fh=Rh("seconds"),Bh=Rh("minutes"),$h=Rh("hours"),Yh=Rh("days"),jh=Rh("months"),qh=Rh("years");var Uh=Math.round,Wh={ss:44,s:45,m:45,h:22,d:26,M:11};var Kh=Math.abs;function Gh(t){return(t>0)-(t<0)||+t}function Qh(){if(!this.isValid())return this.localeData().invalidDate();var t,e,i=Kh(this._milliseconds)/1e3,n=Kh(this._days),a=Kh(this._months);t=Hr(i/60),e=Hr(t/60),i%=60,t%=60;var o=Hr(a/12),r=a%=12,s=n,l=e,h=t,c=i?i.toFixed(3).replace(/\.?0+$/,""):"",d=this.asSeconds();if(!d)return"P0D";var p=d<0?"-":"",u=Gh(this._months)!==Gh(d)?"-":"",A=Gh(this._days)!==Gh(d)?"-":"",m=Gh(this._milliseconds)!==Gh(d)?"-":"";return p+"P"+(o?u+o+"Y":"")+(r?u+r+"M":"")+(s?A+s+"D":"")+(l||h||c?"T":"")+(l?m+l+"H":"")+(h?m+h+"M":"")+(c?m+c+"S":"")}var Zh=$l.prototype;Zh.isValid=function(){return this._isValid},Zh.abs=function(){var t=this._data;return this._milliseconds=xh(this._milliseconds),this._days=xh(this._days),this._months=xh(this._months),t.milliseconds=xh(t.milliseconds),t.seconds=xh(t.seconds),t.minutes=xh(t.minutes),t.hours=xh(t.hours),t.months=xh(t.months),t.years=xh(t.years),this},Zh.add=function(t,e){return Mh(this,t,e,1)},Zh.subtract=function(t,e){return Mh(this,t,e,-1)},Zh.as=function(t){if(!this.isValid())return NaN;var e,i,n=this._milliseconds;if("month"===(t=$r(t))||"year"===t)return e=this._days+n/864e5,i=this._months+Ch(e),"month"===t?i:i/12;switch(e=this._days+Math.round(kh(this._months)),t){case"week":return e/7+n/6048e5;case"day":return e+n/864e5;case"hour":return 24*e+n/36e5;case"minute":return 1440*e+n/6e4;case"second":return 86400*e+n/1e3;case"millisecond":return Math.floor(864e5*e)+n;default:throw new Error("Unknown unit "+t)}},Zh.asMilliseconds=Vh,Zh.asSeconds=Lh,Zh.asMinutes=Th,Zh.asHours=Eh,Zh.asDays=Ih,Zh.asWeeks=Ph,Zh.asMonths=Oh,Zh.asYears=Nh,Zh.valueOf=function(){return this.isValid()?this._milliseconds+864e5*this._days+this._months%12*2592e6+31536e6*Vr(this._months/12):NaN},Zh._bubble=function(){var t,e,i,n,a,o=this._milliseconds,r=this._days,s=this._months,l=this._data;return o>=0&&r>=0&&s>=0||o<=0&&r<=0&&s<=0||(o+=864e5*Sh(kh(s)+r),r=0,s=0),l.milliseconds=o%1e3,t=Hr(o/1e3),l.seconds=t%60,e=Hr(t/60),l.minutes=e%60,i=Hr(e/60),l.hours=i%24,r+=Hr(i/24),s+=a=Hr(Ch(r)),r-=Sh(kh(a)),n=Hr(s/12),s%=12,l.days=r,l.months=s,l.years=n,this},Zh.clone=function(){return Jl(this)},Zh.get=function(t){return t=$r(t),this.isValid()?this[t+"s"]():NaN},Zh.milliseconds=Dh,Zh.seconds=Fh,Zh.minutes=Bh,Zh.hours=$h,Zh.days=Yh,Zh.weeks=function(){return Hr(this.days()/7)},Zh.months=jh,Zh.years=qh,Zh.humanize=function(t){if(!this.isValid())return this.localeData().invalidDate();var e=this.localeData(),i=function(t,e,i){var n=Jl(t).abs(),a=Uh(n.as("s")),o=Uh(n.as("m")),r=Uh(n.as("h")),s=Uh(n.as("d")),l=Uh(n.as("M")),h=Uh(n.as("y")),c=a<=Wh.ss&&["s",a]||a<Wh.s&&["ss",a]||o<=1&&["m"]||o<Wh.m&&["mm",o]||r<=1&&["h"]||r<Wh.h&&["hh",r]||s<=1&&["d"]||s<Wh.d&&["dd",s]||l<=1&&["M"]||l<Wh.M&&["MM",l]||h<=1&&["y"]||["yy",h];return c[2]=e,c[3]=+t>0,c[4]=i,function(t,e,i,n,a){return a.relativeTime(e||1,!!i,t,n)}.apply(null,c)}(this,!t,e);return t&&(i=e.pastFuture(+this,i)),e.postformat(i)},Zh.toISOString=Qh,Zh.toString=Qh,Zh.toJSON=Qh,Zh.locale=sh,Zh.localeData=hh,Zh.toIsoString=Er("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",Qh),Zh.lang=lh,Zr("X",0,0,"unix"),Zr("x",0,0,"valueOf"),gs("x",ps),gs("X",/[+-]?\d+(\.\d{1,3})?/),bs("X",function(t,e,i){i._d=new Date(1e3*parseFloat(t,10))}),bs("x",function(t,e,i){i._d=new Date(Vr(t))}),dr.version="2.22.2",lr=Nl,dr.fn=vh,dr.min=function(){return Fl("isBefore",[].slice.call(arguments,0))},dr.max=function(){return Fl("isAfter",[].slice.call(arguments,0))},dr.now=function(){return Date.now?Date.now():+new Date},dr.utc=yr,dr.unix=function(t){return Nl(1e3*t)},dr.months=function(t,e){return zh(t,e,"months")},dr.isDate=fr,dr.locale=gl,dr.invalid=wr,dr.duration=Jl,dr.isMoment=kr,dr.weekdays=function(t,e,i){return wh(t,e,i,"weekdays")},dr.parseZone=function(){return Nl.apply(null,arguments).parseZone()},dr.localeData=_l,dr.isDuration=Yl,dr.monthsShort=function(t,e){return zh(t,e,"monthsShort")},dr.weekdaysMin=function(t,e,i){return wh(t,e,i,"weekdaysMin")},dr.defineLocale=vl,dr.updateLocale=function(t,e){if(null!=e){var i,n,a=pl;null!=(n=fl(t))&&(a=n._config),(i=new Dr(e=Rr(a,e))).parentLocale=ul[t],ul[t]=i,gl(t)}else null!=ul[t]&&(null!=ul[t].parentLocale?ul[t]=ul[t].parentLocale:null!=ul[t]&&delete ul[t]);return ul[t]},dr.locales=function(){return Ir(ul)},dr.weekdaysShort=function(t,e,i){return wh(t,e,i,"weekdaysShort")},dr.normalizeUnits=$r,dr.relativeTimeRounding=function(t){return void 0===t?Uh:"function"==typeof t&&(Uh=t,!0)},dr.relativeTimeThreshold=function(t,e){return void 0!==Wh[t]&&(void 0===e?Wh[t]:(Wh[t]=e,"s"===t&&(Wh.ss=e-1),!0))},dr.calendarFormat=function(t,e){var i=t.diff(e,"days",!0);return i<-6?"sameElse":i<-1?"lastWeek":i<0?"lastDay":i<1?"sameDay":i<2?"nextDay":i<7?"nextWeek":"sameElse"},dr.prototype=vh,dr.HTML5_FMT={DATETIME_LOCAL:"YYYY-MM-DDTHH:mm",DATETIME_LOCAL_SECONDS:"YYYY-MM-DDTHH:mm:ss",DATETIME_LOCAL_MS:"YYYY-MM-DDTHH:mm:ss.SSS",DATE:"YYYY-MM-DD",TIME:"HH:mm",TIME_SECONDS:"HH:mm:ss",TIME_MS:"HH:mm:ss.SSS",WEEK:"YYYY-[W]WW",MONTH:"YYYY-MM"},dr.defineLocale("zh-tw",{months:"一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),weekdaysShort:"週日_週一_週二_週三_週四_週五_週六".split("_"),weekdaysMin:"日_一_二_三_四_五_六".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日 HH:mm",LLLL:"YYYY年M月D日dddd HH:mm",l:"YYYY/M/D",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日dddd HH:mm"},meridiemParse:/凌晨|早上|上午|中午|下午|晚上/,meridiemHour:function(t,e){return 12===t&&(t=0),"凌晨"===e||"早上"===e||"上午"===e?t:"中午"===e?t>=11?t:t+12:"下午"===e||"晚上"===e?t+12:void 0},meridiem:function(t,e,i){var n=100*t+e;return n<600?"凌晨":n<900?"早上":n<1130?"上午":n<1230?"中午":n<1800?"下午":"晚上"},calendar:{sameDay:"[今天] LT",nextDay:"[明天] LT",nextWeek:"[下]dddd LT",lastDay:"[昨天] LT",lastWeek:"[上]dddd LT",sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}(日|月|週)/,ordinal:function(t,e){switch(e){case"d":case"D":case"DDD":return t+"日";case"M":return t+"月";case"w":case"W":return t+"週";default:return t}},relativeTime:{future:"%s內",past:"%s前",s:"幾秒",ss:"%d 秒",m:"1 分鐘",mm:"%d 分鐘",h:"1 小時",hh:"%d 小時",d:"1 天",dd:"%d 天",M:"1 個月",MM:"%d 個月",y:"1 年",yy:"%d 年"}}),dr.defineLocale("ja",{months:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"日曜日_月曜日_火曜日_水曜日_木曜日_金曜日_土曜日".split("_"),weekdaysShort:"日_月_火_水_木_金_土".split("_"),weekdaysMin:"日_月_火_水_木_金_土".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY/MM/DD",LL:"YYYY年M月D日",LLL:"YYYY年M月D日 HH:mm",LLLL:"YYYY年M月D日 dddd HH:mm",l:"YYYY/MM/DD",ll:"YYYY年M月D日",lll:"YYYY年M月D日 HH:mm",llll:"YYYY年M月D日(ddd) HH:mm"},meridiemParse:/午前|午後/i,isPM:function(t){return"午後"===t},meridiem:function(t,e,i){return t<12?"午前":"午後"},calendar:{sameDay:"[今日] LT",nextDay:"[明日] LT",nextWeek:function(t){return t.week()<this.week()?"[来週]dddd LT":"dddd LT"},lastDay:"[昨日] LT",lastWeek:function(t){return this.week()<t.week()?"[先週]dddd LT":"dddd LT"},sameElse:"L"},dayOfMonthOrdinalParse:/\d{1,2}日/,ordinal:function(t,e){switch(e){case"d":case"D":case"DDD":return t+"日";default:return t}},relativeTime:{future:"%s後",past:"%s前",s:"数秒",ss:"%d秒",m:"1分",mm:"%d分",h:"1時間",hh:"%d時間",d:"1日",dd:"%d日",M:"1ヶ月",MM:"%dヶ月",y:"1年",yy:"%d年"}}),dr.locale(window.navigator.userLanguage||window.navigator.language);window.customElements.define("moe-post-header",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
}
...
`}static get properties(){return{boardId:{type:Number},threadNo:{type:Number},no:{type:Number},tripId:{type:String},createdAt:{type:String},flagAdminThreadStop:{type:Boolean,value:!1}}}formatCreatedAt(t){return dr(t).calendar()}fullyFormatCreatedAt(t){return dr(t).toString()}_onPostHeaderNoClick(t){if(this.flagAdminThreadStop)return!1;this.dispatchEvent(new CustomEvent("post-header-no-click",{composed:!0,bubbles:!0,detail:{boardId:this.get("boardId"),threadNo:this.get("threadNo"),no:this.get("no")}}))}});window.customElements.define("moe-post-image",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
    max-width: 100%;
...
`;Xh.setAttribute("style","display: none;"),document.body.appendChild(Xh.content),Cn({is:"paper-icon-button-light",behaviors:[Ra],ready:function(){Ji(this,()=>{this.addEventListener("down",this._rippleDown.bind(this)),this.addEventListener("up",this._rippleUp.bind(this));var t=this.getEffectiveChildren()[0];this._rippleContainer=t,t.addEventListener("focus",this._rippleDown.bind(this)),t.addEventListener("blur",this._rippleUp.bind(this))})},_rippleDown:function(){this.getRipple().uiDownAction()},_rippleUp:function(){this.getRipple().uiUpAction()},ensureRipple:function(t){var e=this._ripple;Ra.ensureRipple.apply(this,arguments),this._ripple&&this._ripple!==e&&(this._ripple.center=!0,this._ripple.classList.add("circle"))}});window.customElements.define("moe-post-menu-action-button",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
    position: relative;
...
`}static get properties(){return{boardId:{type:Number},threadNo:{type:Number},no:{type:Number},action:{type:String},text:{type:String},icon:{type:String}}}_onClick(t){this.blur()}});window.customElements.define("moe-rate",class extends qt{static get template(){return jt`
    ...
    `}static get properties(){return{dislike:{type:Number,value:0},like:{type:Number,value:0},disabled:{type:Boolean,reflectToAttribute:!0,value:!1}}}onLikeClick(t){this.dispatchEvent(new CustomEvent("onLikeClick"))}onDislikeClick(t){this.dispatchEvent(new CustomEvent("onDislikeClick"))}}),Cn({is:"iron-selector",behaviors:[So]});const Jh={properties:{libraryLoaded:{type:Boolean,value:!1,notify:!0,readOnly:!0},libraryErrorMessage:{type:String,value:null,notify:!0,readOnly:!0}},observers:["_libraryUrlChanged(libraryUrl)"],_libraryUrlChanged:function(t){this._isReady&&this.libraryUrl&&this._loadLibrary()},_libraryLoadCallback:function(t,e){t?(ia._warn("Library load failed:",t.message),this._setLibraryErrorMessage(t.message)):(this._setLibraryErrorMessage(null),this._setLibraryLoaded(!0),this.notifyEvent&&this.fire(this.notifyEvent,e,{composed:!0}))},_loadLibrary:function(){tc.require(this.libraryUrl,this._libraryLoadCallback.bind(this),this.callbackName)},ready:function(){this._isReady=!0,this.libraryUrl&&this._loadLibrary()}};var tc={apiMap:{},require:function(t,e,i){var n=this.nameFromUrl(t);this.apiMap[n]||(this.apiMap[n]=new ec(n,t,i)),this.apiMap[n].requestNotify(e)},nameFromUrl:function(t){return t.replace(/[\:\/\%\?\&\.\=\-\,]/g,"_")+"_api"}},ec=function(t,e,i){if(this.notifiers=[],!i){if(!(e.indexOf(this.callbackMacro)>=0))return void(this.error=new Error("IronJsonpLibraryBehavior a %%callback%% parameter is required in libraryUrl"));i=t+"_loaded",e=e.replace(this.callbackMacro,i)}this.callbackName=i,window[this.callbackName]=this.success.bind(this),this.addScript(e)};ec.prototype={callbackMacro:"%%callback%%",loaded:!1,addScript:function(t){var e=document.createElement("script");e.src=t,e.onerror=this.handleError.bind(this);var i=document.querySelector("script")||document.body;i.parentNode.insertBefore(e,i),this.script=e},removeScript:function(){this.script.parentNode&&this.script.parentNode.removeChild(this.script),this.script=null},handleError:function(t){this.error=new Error("Library failed to load"),this.notifyAll(),this.cleanup()},success:function(){this.loaded=!0,this.result=Array.prototype.slice.call(arguments),this.notifyAll(),this.cleanup()},cleanup:function(){delete window[this.callbackName]},notifyAll:function(){this.notifiers.forEach(function(t){t(this.error,this.result)}.bind(this)),this.notifiers=[]},requestNotify:function(t){this.loaded||this.error?t(this.error,this.result):this.notifiers.push(t)}},Cn({is:"iron-jsonp-library",behaviors:[Jh],properties:{libraryUrl:String,callbackName:String,notifyEvent:String}}),Cn({is:"google-youtube-api",behaviors:[Jh],properties:{libraryUrl:{type:String,value:"https://www.youtube.com/iframe_api"},notifyEvent:{type:String,value:"api-load"},callbackName:{type:String,value:"onYouTubeIframeAPIReady"}},get api(){return YT}}),Cn({_template:jt`
    <style>
      :host {
        display: block;
      }
...
`}static get properties(){return{data:{type:Array,value:[],observer:"_dataChanged",notify:!0},width:{type:String},height:{type:String},showList:{type:Boolean,reflectToAttribute:!0,computed:"_computeShowList(data)"},listLength:{type:Number,value:0},playing:{type:Boolean,value:!1,notify:!0,reflectToAttribute:!0},playingVideoId:{type:String,reflectToAttribute:!0,notify:!0},prevPlayedVideo:{type:String},showPlaceHolder:{type:Boolean,computed:"_computeShowPlaceHolder(playing)"},placeHolderStyle:{type:String,computed:"_computePlaceHolderStyle(selectedVideoIndex, data)"},startVideoIndex:{type:Number,value:0},selectedVideoIndex:{type:Number,reflectToAttribute:!0},selectedVideoIndexDisplay:{type:Number,computed:"_computeSelectedVideoIndexDisplay(selectedVideoIndex)"},holderHref:{type:String,reflectToAttribute:!0,computed:"_computeHolderHref(selectedVideoIndex)"},holderTitle:{type:String,reflectToAttribute:!0,computed:"_computeHolderTitle(selectedVideoIndex)"},playSupported:{type:Boolean},playIcon:{type:String,computed:"_computePlayIcon(data)"},mobile:{type:Boolean,reflectToAttribute:!0},layoutClasses:{type:String,reflectToAttribute:!0,computed:"_computeLayoutClasses(mobile)"}}}ready(){super.ready(),this._mediaQuery(),window.addEventListener("resize",()=>this._mediaQuery())}_mediaQuery(){this.set("mobile",window.matchMedia("(max-width: 600px)").matches)}play(t){if(void 0!==t&&""!==t)this.mobile&&(this._checkPlaySupport(),this.playSupported&&(this.set("playing",!0),this.set("playingVideoId",t))),this.set("playing",!0),this.set("playingVideoId",t);else{if(!this.data||!Tc(this.data,"0.res_id"))return;this.play(this.data[0].res_id)}}stop(){this.set("prevPlayedVideo",this.playingVideoId),this.set("playingVideoId",""),this.set("playing",!1)}_dataChanged(){void 0!==this.data&&void 0!==this.data[0]&&(this.selectedVideoIndex=this.startVideoIndex?this.startVideoIndex:0,this.listLength=this.data.length,this.listLength>1&&this.set("list-toggle",!0),this.set("selectedVideoIndex",0),this.set("playing",!1))}_computePlaceHolderStyle(t,e){if(e.length>0&&t>=0)return"background-image: url("+this.data[t].thumb+");"}_handleStateChanged(t){0===Tc(t,"detail.data")&&this._nextVideo()}_handleHolderTap(t){this.play(Tc(this.data,`${this.selectedVideoIndex}.res_id`))}_handleChipTap(t){this.play(t.model.item.res_id)}_handlePlayControl(t){switch(t.currentTarget.getAttribute("action-type")){case"next":this._nextVideo();break;case"prev":this._prevVideo();break;case"stop":this.stop()}}_nextVideo(){this.selectedVideoIndex<this.data.length-1?this.selectedVideoIndex++:this.selectedVideoIndex=0;var t=Tc(this.data,this.selectedVideoIndex+".res_id");t?this.play(t):console.warn("videoId not found at data[selectedVideoIndex]: "+this.selectedVideoIndex)}_prevVideo(){this.selectedVideoIndex>0?this.selectedVideoIndex--:this.selectedVideoIndex=this.data.length-1,this.play(this.data[this.selectedVideoIndex].res_id)}_computeLayoutClasses(t){return t?"layout vertical":"layout horizontal"}_computeShowList(t){return(t||[]).length>1}_computePlayIcon(t){return t[0]&&void 0!==t?"av:play-arrow":"refresh"}_computeContainerClass(t){return t?"layout vertical":"layout horizontal"}_computeSelectedVideoIndexDisplay(t){return t+1}_computeShowPlaceHolder(t){return!t}_computeHolderHref(t){return"https://www.youtube.com/watch?v="+this.data[t].res_id}_computeHolderTitle(t){return this.data[t].title}_computeStartIndex(t){return t}_checkPlaySupport(){}_mobilePlay(t){}});window.customElements.define("moe-embeds",class extends qt{static get template(){return jt`
<style>
:host {
    display: block;
    width: 100%;
...
`}static get properties(){return{boardId:Number,boardAlias:String,boardSubdomain:String,route:{type:Object,notify:!0},routeData:{type:Object,notify:!0},graphqlServer:String,pollServer:String,imageServers:Object,isAdmin:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0},threads:{type:Array,statePath:Uc},page:{type:Number,reflectToAttribute:!0,observer:"_observePage"},threadsPerPage:Number,repliesPerThread:Number,loading:{type:Boolean,value:!0},hasPrevPage:{type:Boolean,computed:"_computeHasPrevPage(page)"},hasNextPage:{type:Boolean,computed:"_computeHasNextPage(threads)"}}}static get observers(){return["_observeRoutePage(route.path)"]}ready(){super.ready(),this.addEventListener("reply-ack",t=>{this.$.moeGraphQL.getReplyAck(t.detail.boardId,t.detail.threadNo,t.detail.no).then(t=>{this.dispatch({type:Bc,thread:t.data.getThreadByNo}),this.dispatch({type:$c,reply:this._postTransformer(t.data.getPostByNo)})}).catch(t=>console.error(t))}),this.addEventListener("create-thread-ack",t=>{this.$.moeGraphQL.getThreadByNo(t.detail.boardId,t.detail.threadNo,0,this.repliesPerThread).then(t=>{this.goHome()}).catch(t=>console.error(t))})}load(){return window.scrollTo({left:0,top:0,behavior:"instant"}),this.set("loading",!0),this.$.moeGraphQL.getThreads(this.boardId,this.page*this.threadsPerPage,this.threadsPerPage,0,this.repliesPerThread).then(t=>{this.dispatch({type:Fc,threads:t.data.getThreads.map(t=>this._threadTransformer(t))})}).catch(t=>console.log(t)).finally(()=>this.set("loading",!1))}_threadTransformer(t){return Object.assign({},t,{firstPost:this._postTransformer(t.firstPost),replies:(t.replies||[]).reverse().map(t=>this._postTransformer(t))})}_postTransformer(t){return Nc.postTransformer(this.boardSubdomain,this.boardAlias,this.imageServers,t)}reload(){return this.set("threads",[]),this.load()}goHome(){return this.set("routeData.page",0),this.reload()}loadPrevPage(){this.hasPrevPage&&this.set("routeData.page",this.page-1)}loadNextPage(){this.hasNextPage&&this.set("routeData.page",this.page+1)}_computeHasPrevPage(t){return t>0}_computeHasNextPage(t){return t.length>0}_observePage(t){this.set("threads",[]),this.load(),this.dispatchEvent(new CustomEvent("page-change",{detail:{page:t}}))}_observeRoutePage(){console.log("moe-threads: _observeRoutePage",this.route,this.routeData);const t=parseInt(this.routeData.page);"number"==typeof t&&t>=0?this.set("page",t):this.set("route.path","/0")}_sortByBump(t,e){if(t=t.firstPost,e=e.firstPost,!t.bumpedAt&&!e.bumpedAt)return 0;if(!t.bumpedAt&&e.bumpedAt)return-1;if(t.bumpedAt&&!e.bumpedAt)return 1;const i=new Date(t.bumpedAt),n=new Date(e.bumpedAt);return i===n?0:i<n?1:0}});const Wc={properties:{value:{type:Number,value:0,notify:!0,reflectToAttribute:!0},min:{type:Number,value:0,notify:!0},max:{type:Number,value:100,notify:!0},step:{type:Number,value:1,notify:!0},ratio:{type:Number,value:0,readOnly:!0,notify:!0}},observers:["_update(value, min, max, step)"],_calcRatio:function(t){return(this._clampValue(t)-this.min)/(this.max-this.min)},_clampValue:function(t){return Math.min(this.max,Math.max(this.min,this._calcStep(t)))},_calcStep:function(t){if(t=parseFloat(t),!this.step)return t;var e=Math.round((t-this.min)/this.step);return this.step<1?e/(1/this.step)+this.min:e*this.step+this.min},_validateValue:function(){var t=this._clampValue(this.value);return this.value=this.oldValue=isNaN(t)?this.oldValue:t,this.value!==t},_update:function(){this._validateValue(),this._setRatio(100*this._calcRatio(this.value))}};Cn({_template:jt`
    <style>
      :host {
        display: block;
        width: 200px;
...
`,is:"iron-a11y-announcer",properties:{mode:{type:String,value:"polite"},_text:{type:String,value:""}},created:function(){Kc.instance||(Kc.instance=this),document.body.addEventListener("iron-announce",this._onIronAnnounce.bind(this))},announce:function(t){this._text="",this.async(function(){this._text=t},100)},_onIronAnnounce:function(t){t.detail&&t.detail.text&&this.announce(t.detail.text)}});Kc.instance=null,Kc.requestAvailability=function(){Kc.instance||(Kc.instance=document.createElement("iron-a11y-announcer")),document.body.appendChild(Kc.instance)};let Gc=null;const Qc={properties:{validator:{type:String},invalid:{notify:!0,reflectToAttribute:!0,type:Boolean,value:!1,observer:"_invalidChanged"}},registered:function(){Gc=new ua({type:"validator"})},_invalidChanged:function(){this.invalid?this.setAttribute("aria-invalid","true"):this.removeAttribute("aria-invalid")},get _validator(){return Gc&&Gc.byKey(this.validator)},hasValidator:function(){return null!=this._validator},validate:function(t){return void 0===t&&void 0!==this.value?this.invalid=!this._getValidity(this.value):this.invalid=!this._getValidity(t),!this.invalid},_getValidity:function(t){return!this.hasValidator()||this._validator.validate(t)}};Cn({_template:jt`
    <style>
      :host {
        display: inline-block;
      }
...
`,is:"paper-input-char-counter",behaviors:[Zc],properties:{_charCounterStr:{type:String,value:"0"}},update:function(t){if(t.inputElement){t.value=t.value||"";var e=t.value.toString().length.toString();t.inputElement.hasAttribute("maxlength")&&(e+="/"+t.inputElement.getAttribute("maxlength")),this._charCounterStr=e}}});const Xc=jt`
<custom-style>
  <style is="custom-style">
    html {
...
`;Xc.setAttribute("style","display: none;"),document.head.appendChild(Xc.content),Cn({_template:jt`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
`,is:"paper-input-container",properties:{noLabelFloat:{type:Boolean,value:!1},alwaysFloatLabel:{type:Boolean,value:!1},attrForValue:{type:String,value:"bind-value"},autoValidate:{type:Boolean,value:!1},invalid:{observer:"_invalidChanged",type:Boolean,value:!1},focused:{readOnly:!0,type:Boolean,value:!1,notify:!0},_addons:{type:Array},_inputHasContent:{type:Boolean,value:!1},_inputSelector:{type:String,value:"input,iron-input,textarea,.paper-input-input"},_boundOnFocus:{type:Function,value:function(){return this._onFocus.bind(this)}},_boundOnBlur:{type:Function,value:function(){return this._onBlur.bind(this)}},_boundOnInput:{type:Function,value:function(){return this._onInput.bind(this)}},_boundValueChanged:{type:Function,value:function(){return this._onValueChanged.bind(this)}}},listeners:{"addon-attached":"_onAddonAttached","iron-input-validate":"_onIronInputValidate"},get _valueChangedEvent(){return this.attrForValue+"-changed"},get _propertyForValue(){return D(this.attrForValue)},get _inputElement(){return bn(this).querySelector(this._inputSelector)},get _inputElementValue(){return this._inputElement[this._propertyForValue]||this._inputElement.value},ready:function(){this.__isFirstValueUpdate=!0,this._addons||(this._addons=[]),this.addEventListener("focus",this._boundOnFocus,!0),this.addEventListener("blur",this._boundOnBlur,!0)},attached:function(){this.attrForValue?this._inputElement.addEventListener(this._valueChangedEvent,this._boundValueChanged):this.addEventListener("input",this._onInput),this._inputElementValue&&""!=this._inputElementValue?this._handleValueAndAutoValidate(this._inputElement):this._handleValue(this._inputElement)},_onAddonAttached:function(t){this._addons||(this._addons=[]);var e=t.target;-1===this._addons.indexOf(e)&&(this._addons.push(e),this.isAttached&&this._handleValue(this._inputElement))},_onFocus:function(){this._setFocused(!0)},_onBlur:function(){this._setFocused(!1),this._handleValueAndAutoValidate(this._inputElement)},_onInput:function(t){this._handleValueAndAutoValidate(t.target)},_onValueChanged:function(t){var e=t.target;this.__isFirstValueUpdate&&(this.__isFirstValueUpdate=!1,void 0===e.value||""===e.value)||this._handleValueAndAutoValidate(t.target)},_handleValue:function(t){var e=this._inputElementValue;e||0===e||"number"===t.type&&!t.checkValidity()?this._inputHasContent=!0:this._inputHasContent=!1,this.updateAddons({inputElement:t,value:e,invalid:this.invalid})},_handleValueAndAutoValidate:function(t){var e;this.autoValidate&&t&&(e=t.validate?t.validate(this._inputElementValue):t.checkValidity(),this.invalid=!e);this._handleValue(t)},_onIronInputValidate:function(t){this.invalid=this._inputElement.invalid},_invalidChanged:function(){this._addons&&this.updateAddons({invalid:this.invalid})},updateAddons:function(t){for(var e,i=0;e=this._addons[i];i++)e.update(t)},_computeInputContentClass:function(t,e,i,n,a){var o="input-content";if(t)a&&(o+=" label-is-hidden"),n&&(o+=" is-invalid");else{var r=this.querySelector("label");e||a?(o+=" label-is-floating",this.$.labelAndInputContainer.style.position="static",n?o+=" is-invalid":i&&(o+=" label-is-highlighted")):(r&&(this.$.labelAndInputContainer.style.position="relative"),n&&(o+=" is-invalid"))}return i&&(o+=" focused"),o},_computeUnderlineClass:function(t,e){var i="underline";return e?i+=" is-invalid":t&&(i+=" is-highlighted"),i},_computeAddOnContentClass:function(t,e){var i="add-on-content";return e?i+=" is-invalid":t&&(i+=" is-highlighted"),i}}),Cn({_template:jt`
    ...
    <slot></slot>
`,is:"paper-input-error",behaviors:[Zc],properties:{invalid:{readOnly:!0,reflectToAttribute:!0,type:Boolean}},update:function(t){this._setInvalid(t.invalid)}});const Jc={properties:{name:{type:String},value:{notify:!0,type:String},required:{type:Boolean,value:!1}},attached:function(){},detached:function(){}},td={NextLabelID:1,NextAddonID:1,NextInputID:1},ed={properties:{label:{type:String},value:{notify:!0,type:String},disabled:{type:Boolean,value:!1},invalid:{type:Boolean,value:!1,notify:!0},allowedPattern:{type:String},type:{type:String},list:{type:String},pattern:{type:String},required:{type:Boolean,value:!1},errorMessage:{type:String},charCounter:{type:Boolean,value:!1},noLabelFloat:{type:Boolean,value:!1},alwaysFloatLabel:{type:Boolean,value:!1},autoValidate:{type:Boolean,value:!1},validator:{type:String},autocomplete:{type:String,value:"off"},autofocus:{type:Boolean,observer:"_autofocusChanged"},inputmode:{type:String},minlength:{type:Number},maxlength:{type:Number},min:{type:String},max:{type:String},step:{type:String},name:{type:String},placeholder:{type:String,value:""},readonly:{type:Boolean,value:!1},size:{type:Number},autocapitalize:{type:String,value:"none"},autocorrect:{type:String,value:"off"},autosave:{type:String},results:{type:Number},accept:{type:String},multiple:{type:Boolean},_ariaDescribedBy:{type:String,value:""},_ariaLabelledBy:{type:String,value:""},_inputId:{type:String,value:""}},listeners:{"addon-attached":"_onAddonAttached"},keyBindings:{"shift+tab:keydown":"_onShiftTabDown"},hostAttributes:{tabindex:0},get inputElement(){return this.$||(this.$={}),this.$.input||(this._generateInputId(),this.$.input=this.$$("#"+this._inputId)),this.$.input},get _focusableElement(){return this.inputElement},created:function(){this._typesThatHaveText=["date","datetime","datetime-local","month","time","week","file"]},attached:function(){this._updateAriaLabelledBy(),!qt&&this.inputElement&&-1!==this._typesThatHaveText.indexOf(this.inputElement.type)&&(this.alwaysFloatLabel=!0)},_appendStringWithSpace:function(t,e){return t=t?t+" "+e:e},_onAddonAttached:function(t){var e=bn(t).rootTarget;if(e.id)this._ariaDescribedBy=this._appendStringWithSpace(this._ariaDescribedBy,e.id);else{var i="paper-input-add-on-"+td.NextAddonID++;e.id=i,this._ariaDescribedBy=this._appendStringWithSpace(this._ariaDescribedBy,i)}},validate:function(){return this.inputElement.validate()},_focusBlurHandler:function(t){_a._focusBlurHandler.call(this,t),this.focused&&!this._shiftTabPressed&&this._focusableElement&&this._focusableElement.focus()},_onShiftTabDown:function(t){var e=this.getAttribute("tabindex");this._shiftTabPressed=!0,this.setAttribute("tabindex","-1"),this.async(function(){this.setAttribute("tabindex",e),this._shiftTabPressed=!1},1)},_handleAutoValidate:function(){this.autoValidate&&this.validate()},updateValueAndPreserveCaret:function(t){try{var e=this.inputElement.selectionStart;this.value=t,this.inputElement.selectionStart=e,this.inputElement.selectionEnd=e}catch(e){this.value=t}},_computeAlwaysFloatLabel:function(t,e){return e||t},_updateAriaLabelledBy:function(){var t,e=bn(this.root).querySelector("label");e?(e.id?t=e.id:(t="paper-input-label-"+td.NextLabelID++,e.id=t),this._ariaLabelledBy=t):this._ariaLabelledBy=""},_generateInputId:function(){this._inputId&&""!==this._inputId||(this._inputId="input-"+td.NextInputID++)},_onChange:function(t){this.shadowRoot&&this.fire(t.type,{sourceEvent:t},{node:this,bubbles:t.bubbles,cancelable:t.cancelable})},_autofocusChanged:function(){if(this.autofocus&&this._focusableElement){var t=document.activeElement;t instanceof HTMLElement&&t!==document.body&&t!==document.documentElement||this._focusableElement.focus()}}},id=[_a,Ta,ed];Cn({is:"paper-input",_template:jt`
    <style>
      :host {
        display: block;
      }
...
`;nd.setAttribute("strip-whitespace",""),Cn({_template:nd,is:"paper-spinner",behaviors:[to]});window.customElements.define("moe-file-button",class extends qt{static get template(){return jt`
<style>
:host {
    display: inline-block;
}
...
`}static get properties(){return{maxLength:{type:Number},value:{type:String,notify:!0,reflectToAttribute:!0},disabled:{type:Boolean,value:!1,reflectToAttribute:!0},index:{type:Number,reflectToAttribute:!0}}}focus(){this.$.input.focus()}_onCancelClick(t){this.dispatchEvent(new CustomEvent("remove"))}});function od(t){const e=typeof t;return"string"==e||"object"==e&&null!=t&&!Array.isArray(t)&&"[object String]"==uc(t)}window.customElements.define("moe-form-poll-items",class extends qt{static get template(){return jt`
<style>
:host {
    display: block
}
