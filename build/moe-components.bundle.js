...
`}static get properties(){return{displayShowMore:{type:Boolean,value:!1}}}ready(){super.ready(),new ResizeObserver(()=>{this.set("displayShowMore",this.$.content.scrollHeight>this.$.content.clientHeight)}).observe(this.$.content)}_onShowMoreClick(){this.$.content.classList.toggle("expanded")}}class MoeQuoteLink extends PolymerElement{static get template(){return html`
<style>
:host {
    display: inline-block;
}
